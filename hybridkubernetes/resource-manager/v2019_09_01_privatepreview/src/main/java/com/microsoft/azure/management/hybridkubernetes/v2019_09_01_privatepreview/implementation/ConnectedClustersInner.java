...
import com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusterPatch;
import com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ErrorResponseException;
...
public class ConnectedClustersInner implements InnerSupportsGet<ConnectedClusterInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ConnectedClusterInner> {
    ...
    interface ConnectedClustersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters getByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters listCredentials" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters listByResourceGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.Kubernetes/connectedClusters")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters listByResourceGroupNext" })
        @GET
        Observable<Response<ResponseBody>> listByResourceGroupNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2019_09_01_privatepreview.ConnectedClusters listNext" })
        @GET
