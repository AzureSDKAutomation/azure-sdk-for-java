...
public interface ConnectedCluster extends HasInner<ConnectedClusterInner>, Resource, GroupableResourceCore<KubernetesManager, ConnectedClusterInner>, HasResourceGroup, Refreshable<ConnectedCluster>, Updatable<ConnectedCluster.Update>, HasManager<KubernetesManager> {
     ...
     */
    DateTime lastConnectivityTime();

    /**
     * @return the managedIdentityCertificateExpirationTime value.
     */
    DateTime managedIdentityCertificateExpirationTime();
...
*/
        ...
        interface WithConnectivityStatus {
            /**
             * Specifies connectivityStatus.
             * @param connectivityStatus Represents the connectivity status of the connected cluster. Possible values include: 'Connecting', 'Connected', 'Offline', 'Expired'
             * @return the next definition stage
             */
         ...
         */
        interface WithCreate extends Creatable<ConnectedCluster>, Resource.DefinitionWithTags<WithCreate>, DefinitionStages.WithConnectivityStatus, DefinitionStages.WithDistribution, DefinitionStages.WithInfrastructure, DefinitionStages.WithProvisioningState {
        }
    }
    /**
