...
public class ConnectedClusterIdentity {
     ...
     * 'SystemAssigned, includes a system created identity.
     */
    ...
    /**
     * Get the type of identity used for the connected cluster. The type 'SystemAssigned, includes a system created identity.
     *
    ...
    /**
     * Set the type of identity used for the connected cluster. The type 'SystemAssigned, includes a system created identity.
     *
     * @param type the type value to set
     * @return the ConnectedClusterIdentity object itself.
     */
    public ConnectedClusterIdentity withType(String type) {
        this.type = type;
        return this;
    }
