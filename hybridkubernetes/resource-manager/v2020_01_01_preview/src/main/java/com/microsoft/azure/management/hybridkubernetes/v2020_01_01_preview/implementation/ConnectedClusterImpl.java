...
class ConnectedClusterImpl extends GroupableResourceCoreImpl<ConnectedCluster, ConnectedClusterInner, ConnectedClusterImpl, KubernetesManager> implements ConnectedCluster, ConnectedCluster.Definition, ConnectedCluster.Update {
    ...
    public String infrastructure() {
        return this.inner().infrastructure();
    }
    ...
    public DateTime lastConnectivityTime() {
        return this.inner().lastConnectivityTime();
    }

    @Override
    public DateTime managedIdentityCertificateExpirationTime() {
        return this.inner().managedIdentityCertificateExpirationTime();
    }

    @Override
    public String offering() {
        return this.inner().offering();
    }
    ...
    public Integer totalCoreCount() {
        return this.inner().totalCoreCount();
    }
    ...
    public ConnectedClusterImpl withConnectivityStatus(ConnectivityStatus connectivityStatus) {
        this.inner().withConnectivityStatus(connectivityStatus);
        return this;
    }

    @Override
    public ConnectedClusterImpl withDistribution(String distribution) {
        this.inner().withDistribution(distribution);
        return this;
    }

    @Override
    public ConnectedClusterImpl withInfrastructure(String infrastructure) {
        this.inner().withInfrastructure(infrastructure);
        return this;
    }
