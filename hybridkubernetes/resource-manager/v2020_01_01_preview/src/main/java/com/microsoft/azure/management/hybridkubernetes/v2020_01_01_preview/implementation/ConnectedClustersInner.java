...
public class ConnectedClustersInner implements InnerSupportsGet<ConnectedClusterInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ConnectedClusterInner> {
    ...
    interface ConnectedClustersService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2020_01_01_preview.ConnectedClusters listClusterUserCredential" })
        ...
        Observable<Response<ResponseBody>> listClusterUserCredential(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("clusterName") String clusterName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.hybridkubernetes.v2020_01_01_preview.ConnectedClusters listProxyConnectionDetail" })
        @POST("subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.Kubernetes/connectedClusters/{clusterName}/listProxyConnectionDetail")
        Observable<Response<ResponseBody>> listProxyConnectionDetail(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("clusterName") String clusterName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     * @throws ErrorResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     * @return the CredentialResultInner object if successful.
     */
    public CredentialResultInner listClusterUserCredential(String resourceGroupName, String clusterName) {
        return listClusterUserCredentialWithServiceResponseAsync(resourceGroupName, clusterName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<CredentialResultInner> listClusterUserCredentialAsync(String resourceGroupName, String clusterName, final ServiceCallback<CredentialResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(listClusterUserCredentialWithServiceResponseAsync(resourceGroupName, clusterName), serviceCallback);
    }
     ...
     * @param clusterName The name of the Kubernetes cluster on which get is called.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the observable to the CredentialResultInner object
     */
    public Observable<CredentialResultInner> listClusterUserCredentialAsync(String resourceGroupName, String clusterName) {
        return listClusterUserCredentialWithServiceResponseAsync(resourceGroupName, clusterName).map(new Func1<ServiceResponse<CredentialResultInner>, CredentialResultInner>() {
            @Override
            public CredentialResultInner call(ServiceResponse<CredentialResultInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the CredentialResultInner object
     */
    public Observable<ServiceResponse<CredentialResultInner>> listClusterUserCredentialWithServiceResponseAsync(String resourceGroupName, String clusterName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        return service.listClusterUserCredential(this.client.subscriptionId(), resourceGroupName, clusterName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<CredentialResultInner>>>() {
                @Override
                public Observable<ServiceResponse<CredentialResultInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<CredentialResultInner> clientResponse = listClusterUserCredentialDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<CredentialResultInner> listClusterUserCredentialDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<CredentialResultInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<CredentialResultInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
    }
     ...
     * @throws ErrorResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     * @return the ConnectedClusterProxyProfileInner object if successful.
     */
    public ConnectedClusterProxyProfileInner listProxyConnectionDetail(String resourceGroupName, String clusterName) {
        return listProxyConnectionDetailWithServiceResponseAsync(resourceGroupName, clusterName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<ConnectedClusterProxyProfileInner> listProxyConnectionDetailAsync(String resourceGroupName, String clusterName, final ServiceCallback<ConnectedClusterProxyProfileInner> serviceCallback) {
        return ServiceFuture.fromResponse(listProxyConnectionDetailWithServiceResponseAsync(resourceGroupName, clusterName), serviceCallback);
    }
     ...
     * @param clusterName The name of the Kubernetes cluster on which get is called.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the observable to the ConnectedClusterProxyProfileInner object
     */
    public Observable<ConnectedClusterProxyProfileInner> listProxyConnectionDetailAsync(String resourceGroupName, String clusterName) {
        return listProxyConnectionDetailWithServiceResponseAsync(resourceGroupName, clusterName).map(new Func1<ServiceResponse<ConnectedClusterProxyProfileInner>, ConnectedClusterProxyProfileInner>() {
            @Override
            public ConnectedClusterProxyProfileInner call(ServiceResponse<ConnectedClusterProxyProfileInner> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the ConnectedClusterProxyProfileInner object
     */
    public Observable<ServiceResponse<ConnectedClusterProxyProfileInner>> listProxyConnectionDetailWithServiceResponseAsync(String resourceGroupName, String clusterName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        return service.listProxyConnectionDetail(this.client.subscriptionId(), resourceGroupName, clusterName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ConnectedClusterProxyProfileInner>>>() {
                @Override
                public Observable<ServiceResponse<ConnectedClusterProxyProfileInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<ConnectedClusterProxyProfileInner> clientResponse = listProxyConnectionDetailDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<ConnectedClusterProxyProfileInner> listProxyConnectionDetailDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ConnectedClusterProxyProfileInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ConnectedClusterProxyProfileInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
    }
