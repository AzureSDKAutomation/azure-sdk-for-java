...
public class ConnectedClustersInner implements InnerSupportsGet<ConnectedClusterInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ConnectedClusterInner> {
    ...
    interface ConnectedClustersService {
        ...
        Observable<Response<ResponseBody>> listClusterUserCredentials(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("clusterName") String clusterName, @Query("api-version") String apiVersion, @Query("ClientProxy") Boolean clientProxy, @Header("accept-language") String acceptLanguage, @Body AuthenticationDetails clientAuthenticationDetails, @Header("User-Agent") String userAgent);
    ...
    public Observable<ServiceResponse<CredentialResultsInner>> listClusterUserCredentialsWithServiceResponseAsync(String resourceGroupName, String clusterName, AuthenticationDetailsValue value) {
        ...
        return service.listClusterUserCredentials(this.client.subscriptionId(), resourceGroupName, clusterName, this.client.apiVersion(), clientProxy, this.client.acceptLanguage(), clientAuthenticationDetails, this.client.userAgent())
     ...
     * @return the CredentialResultsInner object if successful.
     */
    public CredentialResultsInner listClusterUserCredentials(String resourceGroupName, String clusterName, AuthenticationDetailsValue value, Boolean clientProxy) {
        return listClusterUserCredentialsWithServiceResponseAsync(resourceGroupName, clusterName, value, clientProxy).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<CredentialResultsInner> listClusterUserCredentialsAsync(String resourceGroupName, String clusterName, AuthenticationDetailsValue value, Boolean clientProxy, final ServiceCallback<CredentialResultsInner> serviceCallback) {
        return ServiceFuture.fromResponse(listClusterUserCredentialsWithServiceResponseAsync(resourceGroupName, clusterName, value, clientProxy), serviceCallback);
    }
     ...
     * @return the observable to the CredentialResultsInner object
     */
    public Observable<CredentialResultsInner> listClusterUserCredentialsAsync(String resourceGroupName, String clusterName, AuthenticationDetailsValue value, Boolean clientProxy) {
        return listClusterUserCredentialsWithServiceResponseAsync(resourceGroupName, clusterName, value, clientProxy).map(new Func1<ServiceResponse<CredentialResultsInner>, CredentialResultsInner>() {
            @Override
            public CredentialResultsInner call(ServiceResponse<CredentialResultsInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the CredentialResultsInner object
     */
    public Observable<ServiceResponse<CredentialResultsInner>> listClusterUserCredentialsWithServiceResponseAsync(String resourceGroupName, String clusterName, AuthenticationDetailsValue value, Boolean clientProxy) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
