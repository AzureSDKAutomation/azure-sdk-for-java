...
import com.microsoft.azure.management.support.AddCommunication;
import com.microsoft.azure.management.support.CheckNameAvailabilityInput;
import com.microsoft.azure.management.support.CreateSupportTicket;
...
public class MicrosoftSupportImpl extends AzureServiceClient {
    ...
    interface MicrosoftSupportService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.support.MicrosoftSupport addCommunicationToSubscriptionTicket" })
        @POST("subscriptions/{subscriptionId}/providers/Microsoft.Support/supportTickets/{supportTicketName}/addCommunication")
        Observable<Response<ResponseBody>> addCommunicationToSubscriptionTicket(@Path("supportTicketName") String supportTicketName, @Path("subscriptionId") String subscriptionId, @Body AddCommunication addCommunication, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public SupportTicketDetailsInner createSupportTicketForSubscription(String supportTicketName, CreateSupportTicket createSupportTicketParameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SupportTicketDetailsInner> createSupportTicketForSubscriptionAsync(String supportTicketName, CreateSupportTicket createSupportTicketParameters, final ServiceCallback<SupportTicketDetailsInner> serviceCallback) {
     ...
     */
    public Observable<SupportTicketDetailsInner> createSupportTicketForSubscriptionAsync(String supportTicketName, CreateSupportTicket createSupportTicketParameters) {
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponse<SupportTicketDetailsInner>> createSupportTicketForSubscriptionWithServiceResponseAsync(String supportTicketName, CreateSupportTicket createSupportTicketParameters) {
     ...
     * @return the SupportTicketDetailsInner object if successful.
     */
    public SupportTicketDetailsInner beginCreateSupportTicketForSubscription(String supportTicketName, CreateSupportTicket createSupportTicketParameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<SupportTicketDetailsInner> beginCreateSupportTicketForSubscriptionAsync(String supportTicketName, CreateSupportTicket createSupportTicketParameters, final ServiceCallback<SupportTicketDetailsInner> serviceCallback) {
     ...
     */
    public Observable<SupportTicketDetailsInner> beginCreateSupportTicketForSubscriptionAsync(String supportTicketName, CreateSupportTicket createSupportTicketParameters) {
     ...
     * @return the observable to the SupportTicketDetailsInner object
     */
    public Observable<ServiceResponse<SupportTicketDetailsInner>> beginCreateSupportTicketForSubscriptionWithServiceResponseAsync(String supportTicketName, CreateSupportTicket createSupportTicketParameters) {
        if (supportTicketName == null) {
            throw new IllegalArgumentException("Parameter supportTicketName is required and cannot be null.");
        }
        if (this.subscriptionId() == null) {
     ...
     *
     * @param supportTicketName Support ticket id.
     * @param addCommunication Communication object.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @throws ExceptionResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     * @return the CommunicationDetailsInner object if successful.
     */
    public CommunicationDetailsInner addCommunicationToSubscriptionTicket(String supportTicketName, AddCommunication addCommunication) {
        return addCommunicationToSubscriptionTicketWithServiceResponseAsync(supportTicketName, addCommunication).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<CommunicationDetailsInner> addCommunicationToSubscriptionTicketAsync(String supportTicketName, AddCommunication addCommunication, final ServiceCallback<CommunicationDetailsInner> serviceCallback) {
        return ServiceFuture.fromResponse(addCommunicationToSubscriptionTicketWithServiceResponseAsync(supportTicketName, addCommunication), serviceCallback);
    }
     ...
     */
    public Observable<CommunicationDetailsInner> addCommunicationToSubscriptionTicketAsync(String supportTicketName, AddCommunication addCommunication) {
        return addCommunicationToSubscriptionTicketWithServiceResponseAsync(supportTicketName, addCommunication).map(new Func1<ServiceResponse<CommunicationDetailsInner>, CommunicationDetailsInner>() {
            @Override
     ...
     * @return the observable to the CommunicationDetailsInner object
     */
    public Observable<ServiceResponse<CommunicationDetailsInner>> addCommunicationToSubscriptionTicketWithServiceResponseAsync(String supportTicketName, AddCommunication addCommunication) {
        if (supportTicketName == null) {
            throw new IllegalArgumentException("Parameter supportTicketName is required and cannot be null.");
        }
        if (this.subscriptionId() == null) {
        ...
        if (addCommunication == null) {
            throw new IllegalArgumentException("Parameter addCommunication is required and cannot be null.");
        }
        if (this.apiVersion() == null) {
            throw new IllegalArgumentException("Parameter this.apiVersion() is required and cannot be null.");
        }
        Validator.validate(addCommunication);
        return service.addCommunicationToSubscriptionTicket(supportTicketName, this.subscriptionId(), addCommunication, this.apiVersion(), this.acceptLanguage(), this.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<CommunicationDetailsInner>>>() {
                ...
                public Observable<ServiceResponse<CommunicationDetailsInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<CommunicationDetailsInner> clientResponse = addCommunicationToSubscriptionTicketDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<CommunicationDetailsInner> addCommunicationToSubscriptionTicketDelegate(Response<ResponseBody> response) throws ExceptionResponseException, IOException, IllegalArgumentException {
