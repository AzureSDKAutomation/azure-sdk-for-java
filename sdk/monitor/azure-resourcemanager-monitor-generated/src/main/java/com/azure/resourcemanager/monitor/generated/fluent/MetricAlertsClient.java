...
public interface MetricAlertsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    MetricAlertsQuotaInner getQuota(String resourceGroupName, String ruleName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<MetricAlertsQuotaInner> getQuotaWithResponse(String resourceGroupName, String ruleName, Context context);
}
