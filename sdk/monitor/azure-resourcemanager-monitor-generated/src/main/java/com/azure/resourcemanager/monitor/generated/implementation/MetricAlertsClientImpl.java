...
public final class MetricAlertsClientImpl implements MetricAlertsClient {
    ...
    private interface MetricAlertsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Insights"
                + "/metricAlerts/{ruleName}/quota")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MetricAlertsQuotaInner>> getQuota(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("ruleName") String ruleName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the metric alerts quota.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<MetricAlertsQuotaInner>> getQuotaWithResponseAsync(
        String resourceGroupName, String ruleName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<MetricAlertsQuotaInner> getQuotaAsync(String resourceGroupName, String ruleName) {
        return getQuotaWithResponseAsync(resourceGroupName, ruleName)
            .flatMap(
                (Response<MetricAlertsQuotaInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public MetricAlertsQuotaInner getQuota(String resourceGroupName, String ruleName) {
        return getQuotaAsync(resourceGroupName, ruleName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<MetricAlertsQuotaInner> getQuotaWithResponse(
        String resourceGroupName, String ruleName, Context context) {
        return getQuotaWithResponseAsync(resourceGroupName, ruleName, context).block();
    }
}
