...
public final class SignalRResourceImpl implements SignalRResource, SignalRResource.Definition, SignalRResource.Update {
    ...
    public SignalRResourceImpl(String name, SignalRManager serviceManager) {
    ...
    public SignalRResourceImpl(SignalRResourceInner innerObject, SignalRManager serviceManager) {
