...
public final class ServerSecurityAlertPolicyImpl
    ...
    ServerSecurityAlertPolicyImpl(SecurityAlertPolicyName name, MariaDBManager serviceManager) {
    ...
    ServerSecurityAlertPolicyImpl(ServerSecurityAlertPolicyInner innerObject, MariaDBManager serviceManager) {
