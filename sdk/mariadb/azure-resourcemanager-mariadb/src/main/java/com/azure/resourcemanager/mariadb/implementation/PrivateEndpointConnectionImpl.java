...
public final class PrivateEndpointConnectionImpl
    ...
    PrivateEndpointConnectionImpl(String name, MariaDBManager serviceManager) {
    ...
    PrivateEndpointConnectionImpl(PrivateEndpointConnectionInner innerObject, MariaDBManager serviceManager) {
