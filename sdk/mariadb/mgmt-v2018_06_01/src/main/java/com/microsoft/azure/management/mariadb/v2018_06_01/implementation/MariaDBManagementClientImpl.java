...
public class MariaDBManagementClientImpl extends AzureServiceClient {
    ...
    interface MariaDBManagementClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mariadb.v2018_06_01.MariaDBManagementClient resetQueryPerformanceInsightData" })
     ...
     * @return the QueryPerformanceInsightResetDataResultInner object if successful.
     */
    public QueryPerformanceInsightResetDataResultInner resetQueryPerformanceInsightData(String resourceGroupName, String serverName) {
        return resetQueryPerformanceInsightDataWithServiceResponseAsync(resourceGroupName, serverName).toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<QueryPerformanceInsightResetDataResultInner> resetQueryPerformanceInsightDataAsync(String resourceGroupName, String serverName, final ServiceCallback<QueryPerformanceInsightResetDataResultInner> serviceCallback) {
        return ServiceFuture.fromResponse(resetQueryPerformanceInsightDataWithServiceResponseAsync(resourceGroupName, serverName), serviceCallback);
    }
     ...
     * @param serverName The name of the server.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the observable to the QueryPerformanceInsightResetDataResultInner object
     */
    public Observable<QueryPerformanceInsightResetDataResultInner> resetQueryPerformanceInsightDataAsync(String resourceGroupName, String serverName) {
        return resetQueryPerformanceInsightDataWithServiceResponseAsync(resourceGroupName, serverName).map(new Func1<ServiceResponse<QueryPerformanceInsightResetDataResultInner>, QueryPerformanceInsightResetDataResultInner>() {
            @Override
            public QueryPerformanceInsightResetDataResultInner call(ServiceResponse<QueryPerformanceInsightResetDataResultInner> response) {
     ...
     * @return the observable to the QueryPerformanceInsightResetDataResultInner object
     */
    public Observable<ServiceResponse<QueryPerformanceInsightResetDataResultInner>> resetQueryPerformanceInsightDataWithServiceResponseAsync(String resourceGroupName, String serverName) {
        ...
        return service.resetQueryPerformanceInsightData(this.subscriptionId(), resourceGroupName, serverName, this.apiVersion(), this.acceptLanguage(), this.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<QueryPerformanceInsightResetDataResultInner>>>() {
                @Override
                public Observable<ServiceResponse<QueryPerformanceInsightResetDataResultInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<QueryPerformanceInsightResetDataResultInner> clientResponse = resetQueryPerformanceInsightDataDelegate(response);
    ...
    private ServiceResponse<QueryPerformanceInsightResetDataResultInner> resetQueryPerformanceInsightDataDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.restClient().responseBuilderFactory().<QueryPerformanceInsightResetDataResultInner, CloudException>newInstance(this.serializerAdapter())
                .register(200, new TypeToken<QueryPerformanceInsightResetDataResultInner>() { }.getType())
