...
public class ServerBasedPerformanceTiersInner {
     ...
     */
    public ServerBasedPerformanceTiersInner(Retrofit retrofit, MariaDBManagementClientImpl client) {
    ...
    interface ServerBasedPerformanceTiersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.mariadb.v2020_01_01.ServerBasedPerformanceTiers list" })
