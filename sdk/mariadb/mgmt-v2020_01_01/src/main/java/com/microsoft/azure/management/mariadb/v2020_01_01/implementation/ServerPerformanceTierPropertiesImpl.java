...
import com.microsoft.azure.management.mariadb.v2020_01_01.ServerPerformanceTierProperties;
...
class ServerPerformanceTierPropertiesImpl extends WrapperImpl<PerformanceTierPropertiesInner> implements ServerPerformanceTierProperties {
    ...
    ServerPerformanceTierPropertiesImpl(PerformanceTierPropertiesInner inner,  MariaDBManager manager) {
        super(inner);
