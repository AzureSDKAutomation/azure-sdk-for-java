...
public final class PostgresInstanceProperties {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(PostgresInstanceProperties.class);
    ...
    /*
     * Last uploaded date from on premise cluster. Defaults to current date
     * time
     */
    ...
    /**
     * Get the lastUploadedDate property: Last uploaded date from on premise cluster. Defaults to current date time.
     *
    ...
    /**
     * Set the lastUploadedDate property: Last uploaded date from on premise cluster. Defaults to current date time.
     *
