...
public final class PeeringRegisteredAsnImpl
    ...
    public PeeringRegisteredAsnImpl(String name, PeeringManager serviceManager) {
    ...
    public PeeringRegisteredAsnImpl(PeeringRegisteredAsnInner innerObject, PeeringManager serviceManager) {
