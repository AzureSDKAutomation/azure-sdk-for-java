...
public final class PeeringServicePrefixImpl
    ...
    public PeeringServicePrefixImpl(String name, PeeringManager serviceManager) {
    ...
    public PeeringServicePrefixImpl(PeeringServicePrefixInner innerObject, PeeringManager serviceManager) {
