...
public final class PeeringServiceImpl implements PeeringService, PeeringService.Definition, PeeringService.Update {
    ...
    public PeeringServiceImpl(String name, PeeringManager serviceManager) {
    ...
    public PeeringServiceImpl(PeeringServiceInner innerObject, PeeringManager serviceManager) {
