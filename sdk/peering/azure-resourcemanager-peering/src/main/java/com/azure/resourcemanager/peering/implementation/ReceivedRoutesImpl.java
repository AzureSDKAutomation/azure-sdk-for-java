...
public final class ReceivedRoutesImpl implements ReceivedRoutes {
    ...
    public ReceivedRoutesImpl(ReceivedRoutesClient innerClient, PeeringManager serviceManager) {
    ...
    public PagedIterable<PeeringReceivedRoute> listByPeering(String resourceGroupName, String peeringName) {
        ...
        return inner.mapPage(inner1 -> new PeeringReceivedRouteImpl(inner1, this.manager()));
    }
