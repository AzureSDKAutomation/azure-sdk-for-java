...
public final class PeeringRegisteredPrefixImpl
    ...
    public PeeringRegisteredPrefixImpl(String name, PeeringManager serviceManager) {
    ...
    public PeeringRegisteredPrefixImpl(PeeringRegisteredPrefixInner innerObject, PeeringManager serviceManager) {
