...
class AgentPoolImpl extends CreatableUpdatableImpl<AgentPool, AgentPoolInner, AgentPoolImpl> implements AgentPool, AgentPool.Definition, AgentPool.Update {
    ...
    public AgentPoolVersionProfile agentPoolVersionProfile() {
        return this.inner().agentPoolVersionProfile();
    }
    ...
    @Override
    public AgentPoolImpl withAgentPoolVersionProfile(AgentPoolVersionProfile agentPoolVersionProfile) {
        this.inner().withAgentPoolVersionProfile(agentPoolVersionProfile);
        return this;
    }
