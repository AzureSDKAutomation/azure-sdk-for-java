...
import com.microsoft.azure.management.containerservice.v2020_03_01.AgentPoolVersionProfile;
...
public class AgentPoolInner extends SubResource {
    ...
    /**
     * AgentPoolVersionProfile contains the agent pool components' version
     * information.
     */
    @JsonProperty(value = "properties.agentPoolVersionProfile")
    private AgentPoolVersionProfile agentPoolVersionProfile;
    ...
    /**
     * Get agentPoolVersionProfile contains the agent pool components' version information.
     *
     * @return the agentPoolVersionProfile value
     */
    public AgentPoolVersionProfile agentPoolVersionProfile() {
        return this.agentPoolVersionProfile;
    }

    /**
     * Set agentPoolVersionProfile contains the agent pool components' version information.
     *
     * @param agentPoolVersionProfile the agentPoolVersionProfile value to set
     * @return the AgentPoolInner object itself.
     */
    public AgentPoolInner withAgentPoolVersionProfile(AgentPoolVersionProfile agentPoolVersionProfile) {
        this.agentPoolVersionProfile = agentPoolVersionProfile;
        return this;
    }
