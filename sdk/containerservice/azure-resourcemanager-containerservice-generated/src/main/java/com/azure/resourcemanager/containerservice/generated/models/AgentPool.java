...
public interface AgentPool {
    ...
    /**
     * Gets the osSku property: OsSKU to be used to specify os sku. Choose from Ubuntu(default) and CBLMariner for Linux
    ...
    /**
     * Gets the enableFips property: Whether to use FIPS enabled OS.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithOsDiskType {
             ...
             * values are 'Ephemeral' and 'Managed'. If unspecified, defaults to 'Ephemeral' when the VM supports
             * ephemeral OS and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to
             ...
             *     'Ephemeral' and 'Managed'. If unspecified, defaults to 'Ephemeral' when the VM supports ephemeral OS
             *     and has a cache disk larger than the requested OSDiskSizeGB. Otherwise, defaults to 'Managed'. May
        ...
        interface WithOsSku {
            /**
             * Specifies the osSku property: OsSKU to be used to specify os sku. Choose from Ubuntu(default) and
             * CBLMariner for Linux OSType. Not applicable to Windows OSType..
             *
             * @param osSku OsSKU to be used to specify os sku. Choose from Ubuntu(default) and CBLMariner for Linux
             *     OSType. Not applicable to Windows OSType.
             * @return the next definition stage.
             */
        ...
        interface WithEnableFips {
            /**
             * Specifies the enableFips property: Whether to use FIPS enabled OS.
             *
        ...
        interface WithGpuInstanceProfile {
             ...
             *     GPU VM SKU. Supported values are MIG1g, MIG2g, MIG3g, MIG4g and MIG7g.
             * @return the next definition stage.
             */
