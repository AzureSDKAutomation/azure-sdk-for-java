...
public final class MaintenanceConfigurationsClientImpl implements MaintenanceConfigurationsClient {
    ...
    private interface MaintenanceConfigurationsService {
        ...
        Mono<Response<MaintenanceConfigurationListResult>> list(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<MaintenanceConfigurationListResult>> listNext(
    ...
    private PagedFlux<MaintenanceConfigurationInner> listAsync(String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<MaintenanceConfigurationInner> list(String resourceGroupName, String resourceName) {
     ...
     * @param resourceName The name of the managed cluster resource.
     * @param configName The name of the maintenance configuration.
     * @param parameters maintenance configuration.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<MaintenanceConfigurationInner>> listNextSinglePageAsync(
