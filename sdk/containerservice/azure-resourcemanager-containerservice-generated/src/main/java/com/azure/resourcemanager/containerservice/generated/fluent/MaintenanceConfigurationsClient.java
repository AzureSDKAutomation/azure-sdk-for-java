...
public interface MaintenanceConfigurationsClient {
    ...
    PagedIterable<MaintenanceConfigurationInner> list(String resourceGroupName, String resourceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MaintenanceConfigurationInner> list(String resourceGroupName, String resourceName, Context context);
