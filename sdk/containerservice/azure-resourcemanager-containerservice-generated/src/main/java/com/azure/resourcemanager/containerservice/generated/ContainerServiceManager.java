...
import com.azure.resourcemanager.containerservice.generated.implementation.ExtensionAddonsImpl;
...
public final class ContainerServiceManager {
    ...
    private ExtensionAddons extensionAddons;
    ...
    /** @return Resource collection API of ExtensionAddons. */
    public ExtensionAddons extensionAddons() {
        if (this.extensionAddons == null) {
            this.extensionAddons = new ExtensionAddonsImpl(clientObject.getExtensionAddons(), this);
        }
