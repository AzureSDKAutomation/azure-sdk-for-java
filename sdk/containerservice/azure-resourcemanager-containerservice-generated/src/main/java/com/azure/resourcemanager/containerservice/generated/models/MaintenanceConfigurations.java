...
public interface MaintenanceConfigurations {
     ...
     */
    PagedIterable<MaintenanceConfiguration> list(String resourceGroupName, String resourceName);
     ...
     * @return a list of maintenance configurations in the specified managed cluster.
     */
    PagedIterable<MaintenanceConfiguration> list(String resourceGroupName, String resourceName, Context context);
