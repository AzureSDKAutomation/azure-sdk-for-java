...
@Fluent
public final class ManagedClusterCloudErrorBody {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ManagedClusterCloudErrorBody.class);
    ...
    private List<ManagedClusterCloudErrorBody> details;
     ...
     * @return the ManagedClusterCloudErrorBody object itself.
     */
    public ManagedClusterCloudErrorBody withCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * @return the ManagedClusterCloudErrorBody object itself.
     */
    public ManagedClusterCloudErrorBody withMessage(String message) {
     ...
     * @return the ManagedClusterCloudErrorBody object itself.
     */
    public ManagedClusterCloudErrorBody withTarget(String target) {
        this.target = target;
        return this;
    }
     ...
     */
    public List<ManagedClusterCloudErrorBody> details() {
        return this.details;
    }
     ...
     * @return the ManagedClusterCloudErrorBody object itself.
     */
    public ManagedClusterCloudErrorBody withDetails(List<ManagedClusterCloudErrorBody> details) {
