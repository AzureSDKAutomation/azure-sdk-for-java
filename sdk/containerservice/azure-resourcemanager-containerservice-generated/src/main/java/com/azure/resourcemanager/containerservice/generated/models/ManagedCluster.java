...
public interface ManagedCluster {
    ...
    /**
     * Gets the disableLocalAccounts property: If set to true, getting static credential will be disabled for this
    ...
    interface DefinitionStages {
        ...
        interface WithDisableLocalAccounts {
            /**
             * Specifies the disableLocalAccounts property: If set to true, getting static credential will be disabled
             * for this cluster. Expected to only be used for AAD clusters..
             *
             * @param disableLocalAccounts If set to true, getting static credential will be disabled for this cluster.
             *     Expected to only be used for AAD clusters.
             * @return the next definition stage.
             */
