...
public final class AgentPoolImpl implements AgentPool, AgentPool.Definition, AgentPool.Update {
    ...
    public AgentPoolImpl(String name, ContainerServiceManager serviceManager) {
    ...
    public AgentPoolImpl(AgentPoolInner innerObject, ContainerServiceManager serviceManager) {
