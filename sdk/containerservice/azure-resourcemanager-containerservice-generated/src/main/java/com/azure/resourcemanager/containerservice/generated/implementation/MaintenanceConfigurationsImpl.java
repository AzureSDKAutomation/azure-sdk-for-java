...
public final class MaintenanceConfigurationsImpl implements MaintenanceConfigurations {
    ...
    public PagedIterable<MaintenanceConfiguration> list(String resourceGroupName, String resourceName) {
        PagedIterable<MaintenanceConfigurationInner> inner = this.serviceClient().list(resourceGroupName, resourceName);
