...
public class ExtensionInner extends ProxyResource {
    ...
    /*
     * Location of the identity - same as that of the parent resource.
     */
    @JsonProperty(value = "properties.identityLocation")
    ...
    /**
     * Get the identityLocation property: Location of the identity - same as that of the parent resource.
     *
     * @return the identityLocation value.
     */
    ...
    /**
     * Set the identityLocation property: Location of the identity - same as that of the parent resource.
     *
     * @param identityLocation the identityLocation value to set.
     * @return the ExtensionInner object itself.
     */
    public ExtensionInner withIdentityLocation(String identityLocation) {
