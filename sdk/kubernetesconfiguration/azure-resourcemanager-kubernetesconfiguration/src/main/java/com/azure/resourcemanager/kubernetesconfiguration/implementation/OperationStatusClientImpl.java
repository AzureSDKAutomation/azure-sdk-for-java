...
public final class OperationStatusClientImpl implements OperationStatusClient {
    ...
    private interface OperationStatusService {
        ...
        Mono<Response<OperationStatusListInner>> list(
    ...
    private Mono<Response<OperationStatusListInner>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<OperationStatusListInner> listAsync(
        String resourceGroupName,
        ExtensionsClusterRp clusterRp,
        ExtensionsClusterResourceName clusterResourceName,
        String clusterName,
        String extensionName) {
        return listWithResponseAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName, extensionName)
            .flatMap(
                (Response<OperationStatusListInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationStatusListInner list(
        String resourceGroupName,
        ExtensionsClusterRp clusterRp,
        ExtensionsClusterResourceName clusterResourceName,
        String clusterName,
        String extensionName) {
        return listAsync(resourceGroupName, clusterRp, clusterResourceName, clusterName, extensionName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<OperationStatusListInner> listWithResponse(
        String resourceGroupName,
        ExtensionsClusterRp clusterRp,
        ExtensionsClusterResourceName clusterResourceName,
        String clusterName,
