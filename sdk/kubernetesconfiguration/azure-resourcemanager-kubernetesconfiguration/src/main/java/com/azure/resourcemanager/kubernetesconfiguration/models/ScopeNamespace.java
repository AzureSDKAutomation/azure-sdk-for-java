...
public final class ScopeNamespace {
    ...
    /**
     * Get the targetNamespace property: Namespace where the extensionInstance will be created for an Namespace scoped
    ...
    /**
     * Set the targetNamespace property: Namespace where the extensionInstance will be created for an Namespace scoped
     * extensionInstance. If this namespace does not exist, it will be created.
     *
