...
public final class ExtensionStatus {
    ...
    /**
     * Get the displayStatus property: Short description of status of this instance of the extension.
     *
    ...
    /**
     * Set the displayStatus property: Short description of status of this instance of the extension.
     *
    ...
    /**
     * Get the message property: Detailed message of the status from the Extension instance.
     *
    ...
    /**
     * Set the message property: Detailed message of the status from the Extension instance.
     *
