...
import com.azure.resourcemanager.agfood.models.FarmBeatsListResponse;
...
public final class FarmBeatsModelsClientImpl implements FarmBeatsModelsClient {
    private final ClientLogger logger = new ClientLogger(FarmBeatsModelsClientImpl.class);
