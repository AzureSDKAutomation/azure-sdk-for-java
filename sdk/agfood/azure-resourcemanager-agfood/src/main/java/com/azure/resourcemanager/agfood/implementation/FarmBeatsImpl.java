...
public final class FarmBeatsImpl implements FarmBeats, FarmBeats.Definition, FarmBeats.Update {
    ...
    FarmBeatsImpl(String name, com.azure.resourcemanager.agfood.AgfoodManager serviceManager) {
    ...
    FarmBeatsImpl(FarmBeatsInner innerObject, com.azure.resourcemanager.agfood.AgfoodManager serviceManager) {
