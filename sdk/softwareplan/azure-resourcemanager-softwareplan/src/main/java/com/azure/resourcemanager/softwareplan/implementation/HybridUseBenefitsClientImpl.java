...
public final class HybridUseBenefitsClientImpl implements HybridUseBenefitsClient {
    ...
    private Mono<Response<HybridUseBenefitModelInner>> createWithResponseAsync(
        ...
        return FluxUtil
            .withContext(
                context -> service.create(this.client.getEndpoint(), scope, planId, apiVersion, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HybridUseBenefitModelInner>> createWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.create(this.client.getEndpoint(), scope, planId, apiVersion, body, accept, context);
    }
    ...
    private Mono<Response<HybridUseBenefitModelInner>> updateWithResponseAsync(
        ...
        return FluxUtil
            .withContext(
                context -> service.update(this.client.getEndpoint(), scope, planId, apiVersion, body, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HybridUseBenefitModelInner>> updateWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.update(this.client.getEndpoint(), scope, planId, apiVersion, body, accept, context);
    }
    ...
    private Mono<Response<HybridUseBenefitModelInner>> getWithResponseAsync(String scope, String planId) {
        ...
        final String accept = "application/json";
        return FluxUtil
            .withContext(context -> service.get(this.client.getEndpoint(), scope, planId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<HybridUseBenefitModelInner>> getWithResponseAsync(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.get(this.client.getEndpoint(), scope, planId, apiVersion, accept, context);
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String scope, String planId) {
        ...
        return FluxUtil
            .withContext(
                context -> service.delete(this.client.getEndpoint(), scope, planId, apiVersion, accept, context))
            .contextWrite(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext()).readOnly()));
    }
    ...
    private Mono<Response<Void>> deleteWithResponseAsync(String scope, String planId, Context context) {
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.delete(this.client.getEndpoint(), scope, planId, apiVersion, accept, context);
    }
