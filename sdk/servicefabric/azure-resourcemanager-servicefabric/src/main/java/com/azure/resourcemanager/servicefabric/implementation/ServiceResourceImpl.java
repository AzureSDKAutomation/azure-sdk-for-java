...
public final class ServiceResourceImpl implements ServiceResource, ServiceResource.Definition, ServiceResource.Update {
    ...
    public ServiceResourceImpl(String name, ServiceFabricManager serviceManager) {
    ...
    public ServiceResourceImpl(ServiceResourceInner innerObject, ServiceFabricManager serviceManager) {
