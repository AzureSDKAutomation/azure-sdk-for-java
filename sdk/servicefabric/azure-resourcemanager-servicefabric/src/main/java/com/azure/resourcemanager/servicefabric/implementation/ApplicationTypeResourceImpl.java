...
public final class ApplicationTypeResourceImpl
    ...
    public ApplicationTypeResourceImpl(String name, ServiceFabricManager serviceManager) {
    ...
    public ApplicationTypeResourceImpl(ApplicationTypeResourceInner innerObject, ServiceFabricManager serviceManager) {
