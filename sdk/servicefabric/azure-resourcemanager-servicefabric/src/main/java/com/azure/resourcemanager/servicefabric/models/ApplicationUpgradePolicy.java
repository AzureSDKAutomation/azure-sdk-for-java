...
public final class ApplicationUpgradePolicy {
    ...
    /*
     * The next upgrade domain to be updated during a manual upgrade.
     */
    @JsonProperty(value = "targetUpgradeDomain")
    private String targetUpgradeDomain;
    ...
    /**
     * Get the targetUpgradeDomain property: The next upgrade domain to be updated during a manual upgrade.
     *
     * @return the targetUpgradeDomain value.
     */
    public String targetUpgradeDomain() {
        return this.targetUpgradeDomain;
    }

    /**
     * Set the targetUpgradeDomain property: The next upgrade domain to be updated during a manual upgrade.
     *
     * @param targetUpgradeDomain the targetUpgradeDomain value to set.
     * @return the ApplicationUpgradePolicy object itself.
     */
    public ApplicationUpgradePolicy withTargetUpgradeDomain(String targetUpgradeDomain) {
        this.targetUpgradeDomain = targetUpgradeDomain;
        return this;
    }
