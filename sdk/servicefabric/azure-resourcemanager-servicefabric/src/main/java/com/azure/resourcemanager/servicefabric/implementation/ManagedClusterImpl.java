...
public final class ManagedClusterImpl implements ManagedCluster, ManagedCluster.Definition, ManagedCluster.Update {
    ...
    public ManagedClusterImpl(String name, ServiceFabricManager serviceManager) {
    ...
    public ManagedClusterImpl(ManagedClusterInner innerObject, ServiceFabricManager serviceManager) {
