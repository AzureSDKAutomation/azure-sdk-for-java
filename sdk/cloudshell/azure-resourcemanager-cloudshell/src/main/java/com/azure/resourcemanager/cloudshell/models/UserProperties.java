...
public final class UserProperties {
    ...
    /*
     * The network type of the cloud shell.
     */
     ...
     */
    @JsonProperty(value = "vnetSettings")
    private VnetSettings vnetSettings;
    ...
    /**
     * Get the networkType property: The network type of the cloud shell.
     *
    ...
    /**
     * Set the networkType property: The network type of the cloud shell.
     *
     * @param networkType the networkType value to set.
     * @return the UserProperties object itself.
     */
    public UserProperties withNetworkType(NetworkType networkType) {
    ...
    /**
     * Get the vnetSettings property: Settings for virtual network setup.
     *
     * @return the vnetSettings value.
     */
    public VnetSettings vnetSettings() {
        return this.vnetSettings;
    }

    /**
     * Set the vnetSettings property: Settings for virtual network setup.
     *
     * @param vnetSettings the vnetSettings value to set.
     * @return the UserProperties object itself.
     */
    public UserProperties withVnetSettings(VnetSettings vnetSettings) {
        this.vnetSettings = vnetSettings;
        return this;
    }
    ...
    public void validate() {
        if (networkType() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property networkType in model UserProperties"));
        }
        ...
        if (vnetSettings() != null) {
            vnetSettings().validate();
        }
