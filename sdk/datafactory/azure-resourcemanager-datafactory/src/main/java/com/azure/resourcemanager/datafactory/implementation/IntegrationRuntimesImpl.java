...
public final class IntegrationRuntimesImpl implements IntegrationRuntimes {
    ...
    public IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponse outboundNetworkDependenciesEndpoints(
        String resourceGroupName, String factoryName, String integrationRuntimeName) {
        IntegrationRuntimeOutboundNetworkDependenciesEndpointsResponseInner inner =
            this
                .serviceClient()
                .outboundNetworkDependenciesEndpoints(resourceGroupName, factoryName, integrationRuntimeName);
        if (inner != null) {
