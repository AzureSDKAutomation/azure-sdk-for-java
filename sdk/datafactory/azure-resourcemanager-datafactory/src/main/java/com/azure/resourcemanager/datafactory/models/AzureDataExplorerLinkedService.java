    ...
    public void validate() {
        ...
        if (servicePrincipalId() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property servicePrincipalId in model AzureDataExplorerLinkedService"));
        }
        if (servicePrincipalKey() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property servicePrincipalKey in model AzureDataExplorerLinkedService"));
        } else {
        ...
        if (tenant() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property tenant in model AzureDataExplorerLinkedService"));
        }
    }
}
