...
public final class ServicesClientImpl implements ServicesClient {
    ...
    private interface ServicesService {
        ...
        Mono<Response<DeviceServiceInner>> update(
            ...
            @PathParam("deviceName") String deviceName,
            @HeaderParam("If-Match") String ifMatch,
            @BodyParam("application/json") DeviceServiceProperties deviceService,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     * @param resourceGroupName The name of the resource group that contains the Windows IoT Device Service.
     * @param deviceName The name of the Windows IoT Device Service.
     * @param deviceService The description of the Windows IoT Device Service.
     ...
     * @param resourceGroupName The name of the resource group that contains the Windows IoT Device Service.
     * @param deviceName The name of the Windows IoT Device Service.
     * @param deviceService The properties of a Windows IoT Device Service.
    ...
    private Mono<Response<DeviceServiceInner>> updateWithResponseAsync(
        String resourceGroupName, String deviceName, DeviceServiceProperties deviceService, String ifMatch) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<DeviceServiceInner>> updateWithResponseAsync(
        String resourceGroupName,
        String deviceName,
        DeviceServiceProperties deviceService,
        String ifMatch,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DeviceServiceInner> updateAsync(
        String resourceGroupName, String deviceName, DeviceServiceProperties deviceService) {
        final String ifMatch = null;
        return updateWithResponseAsync(resourceGroupName, deviceName, deviceService, ifMatch)
            .flatMap(
                (Response<DeviceServiceInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeviceServiceInner update(
        String resourceGroupName, String deviceName, DeviceServiceProperties deviceService) {
        final String ifMatch = null;
     ...
     *
     * @param deviceServiceCheckNameAvailabilityParameters Input values.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
