...
import com.azure.resourcemanager.windowsiot.models.DeviceServiceProperties;
...
public final class DeviceServiceImpl implements DeviceService, DeviceService.Definition, DeviceService.Update {
    ...
    private DeviceServiceProperties updateDeviceService;
    ...
    public DeviceServiceImpl(String name, WindowsiotManager serviceManager) {
    ...
    public DeviceServiceImpl update() {
        ...
        this.updateDeviceService = new DeviceServiceProperties();
        return this;
    }
    ...
    public DeviceService apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getServices()
                .updateWithResponse(resourceGroupName, deviceName, updateDeviceService, updateIfMatch, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public DeviceService apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getServices()
                .updateWithResponse(resourceGroupName, deviceName, updateDeviceService, updateIfMatch, context)
                .getValue();
        return this;
    }

    public DeviceServiceImpl(DeviceServiceInner innerObject, WindowsiotManager serviceManager) {
    ...
    public DeviceServiceImpl withNotes(String notes) {
        if (isInCreateMode()) {
            ...
            this.updateDeviceService.withNotes(notes);
            return this;
        }
    }
    ...
    public DeviceServiceImpl withQuantity(Long quantity) {
        if (isInCreateMode()) {
            ...
            this.updateDeviceService.withQuantity(quantity);
            return this;
        }
    }
    ...
    public DeviceServiceImpl withBillingDomainName(String billingDomainName) {
        if (isInCreateMode()) {
            ...
            this.updateDeviceService.withBillingDomainName(billingDomainName);
            return this;
        }
    }
    ...
    public DeviceServiceImpl withAdminDomainName(String adminDomainName) {
        if (isInCreateMode()) {
            ...
            this.updateDeviceService.withAdminDomainName(adminDomainName);
            return this;
        }
    }
