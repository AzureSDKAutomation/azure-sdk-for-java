    ...
    public RecoveryPlan create() {
        this.innerObject =
            serviceManager
                ...
                .create(recoveryPlanName, createInput, Context.NONE);
        return this;
    }

    public RecoveryPlan create(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationRecoveryPlans().create(recoveryPlanName, createInput, context);
        return this;
    }

    public RecoveryPlanImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public RecoveryPlan apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationRecoveryPlans()
                .update(recoveryPlanName, updateInput, Context.NONE);
        return this;
    }

    public RecoveryPlan apply(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationRecoveryPlans().update(recoveryPlanName, updateInput, context);
        return this;
    }

    public RecoveryPlanImpl(RecoveryPlanInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public RecoveryPlan refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationRecoveryPlans()
                .getWithResponse(recoveryPlanName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public RecoveryPlan refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationRecoveryPlans()
                .getWithResponse(recoveryPlanName, context)
                .getValue();
        return this;
    }
