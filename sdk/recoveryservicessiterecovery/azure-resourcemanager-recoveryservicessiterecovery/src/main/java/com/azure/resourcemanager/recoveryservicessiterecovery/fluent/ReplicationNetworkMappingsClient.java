...
public interface ReplicationNetworkMappingsClient {
    ...
    PagedIterable<NetworkMappingInner> listByReplicationNetworks(String fabricName, String networkName);
    ...
    NetworkMappingInner get(String fabricName, String networkName, String networkMappingName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<PollResult<Void>, Void> beginDelete(String fabricName, String networkName, String networkMappingName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String fabricName, String networkName, String networkMappingName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String fabricName, String networkName, String networkMappingName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkMappingInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkMappingInner> list(Context context);
}
