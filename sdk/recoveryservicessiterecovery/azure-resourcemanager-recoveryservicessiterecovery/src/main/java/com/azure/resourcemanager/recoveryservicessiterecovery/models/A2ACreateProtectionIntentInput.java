...
public final class A2ACreateProtectionIntentInput extends CreateProtectionIntentProviderSpecificDetails {
    ...
    /*
     * The vm os managed disk input.
     */
    @JsonProperty(value = "vmOSManagedDisk")
    private A2AProtectionIntentOSManagedDiskInputDetails vmOSManagedDisk;
    ...
    /**
     * Get the vmOSManagedDisk property: The vm os managed disk input.
     *
     * @return the vmOSManagedDisk value.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails vmOSManagedDisk() {
        return this.vmOSManagedDisk;
    }

    /**
     * Set the vmOSManagedDisk property: The vm os managed disk input.
     *
     * @param vmOSManagedDisk the vmOSManagedDisk value to set.
     * @return the A2ACreateProtectionIntentInput object itself.
     */
    public A2ACreateProtectionIntentInput withVmOSManagedDisk(
        A2AProtectionIntentOSManagedDiskInputDetails vmOSManagedDisk) {
        this.vmOSManagedDisk = vmOSManagedDisk;
        return this;
    }
    ...
    public void validate() {
        ...
        if (vmOSManagedDisk() != null) {
            vmOSManagedDisk().validate();
        }
