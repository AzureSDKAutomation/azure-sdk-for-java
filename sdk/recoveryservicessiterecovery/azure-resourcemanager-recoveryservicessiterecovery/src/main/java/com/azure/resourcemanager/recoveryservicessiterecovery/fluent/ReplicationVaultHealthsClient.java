...
public interface ReplicationVaultHealthsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VaultHealthDetailsInner> getWithResponse(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<PollResult<VaultHealthDetailsInner>, VaultHealthDetailsInner> beginRefresh(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VaultHealthDetailsInner refresh();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VaultHealthDetailsInner refresh(Context context);
}
