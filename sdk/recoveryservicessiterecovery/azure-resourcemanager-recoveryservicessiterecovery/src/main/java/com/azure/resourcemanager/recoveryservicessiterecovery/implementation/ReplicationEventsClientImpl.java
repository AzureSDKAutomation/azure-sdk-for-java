...
public final class ReplicationEventsClientImpl implements ReplicationEventsClient {
    ...
    private Mono<PagedResponse<EventInner>> listSinglePageAsync(String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<EventInner>> listSinglePageAsync(String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<EventInner> listAsync(String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<EventInner> listAsync(String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<EventInner> list(String filter, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EventInner>> getWithResponseAsync(String eventName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<EventInner>> getWithResponseAsync(String eventName, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<EventInner> getAsync(String eventName) {
        return getWithResponseAsync(eventName)
            .flatMap(
    ...
    public EventInner get(String eventName) {
        return getAsync(eventName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<EventInner> getWithResponse(String eventName, Context context) {
        return getWithResponseAsync(eventName, context).block();
    }
