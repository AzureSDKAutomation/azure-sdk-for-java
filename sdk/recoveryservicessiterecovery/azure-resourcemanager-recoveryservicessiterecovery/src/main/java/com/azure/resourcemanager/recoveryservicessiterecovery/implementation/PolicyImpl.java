...
public final class PolicyImpl implements Policy, Policy.Definition, Policy.Update {
    ...
    public Policy create() {
        this.innerObject =
            serviceManager.serviceClient().getReplicationPolicies().create(policyName, createInput, Context.NONE);
        return this;
    }

    public Policy create(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationPolicies().create(policyName, createInput, context);
        return this;
    }

    public PolicyImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public Policy apply() {
        this.innerObject =
            serviceManager.serviceClient().getReplicationPolicies().update(policyName, updateInput, Context.NONE);
        return this;
    }

    public Policy apply(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationPolicies().update(policyName, updateInput, context);
        return this;
    }

    public PolicyImpl(PolicyInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public Policy refresh() {
        this.innerObject =
            serviceManager
                ...
                .getWithResponse(policyName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public Policy refresh(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationPolicies().getWithResponse(policyName, context).getValue();
        return this;
    }
