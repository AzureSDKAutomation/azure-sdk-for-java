...
public final class SupportedOperatingSystemsOperationsImpl implements SupportedOperatingSystemsOperations {
    ...
    public SupportedOperatingSystems get() {
        SupportedOperatingSystemsInner inner = this.serviceClient().get();
        if (inner != null) {
    ...
    public Response<SupportedOperatingSystems> getWithResponse(Context context) {
        Response<SupportedOperatingSystemsInner> inner = this.serviceClient().getWithResponse(context);
        if (inner != null) {
