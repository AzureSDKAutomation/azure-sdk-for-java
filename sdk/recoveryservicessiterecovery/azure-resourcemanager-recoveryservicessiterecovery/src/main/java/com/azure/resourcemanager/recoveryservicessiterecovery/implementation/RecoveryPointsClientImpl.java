...
public final class RecoveryPointsClientImpl implements RecoveryPointsClient {
    ...
    public PagedIterable<RecoveryPointInner> listByReplicationProtectedItems(
        ...
        return new PagedIterable<>(
            listByReplicationProtectedItemsAsync(fabricName, protectionContainerName, replicatedProtectedItemName));
    }
    ...
    private Mono<RecoveryPointInner> getAsync(
        ...
        String replicatedProtectedItemName,
        String recoveryPointName) {
        return getWithResponseAsync(fabricName, protectionContainerName, replicatedProtectedItemName, recoveryPointName)
            .flatMap(
    ...
    public RecoveryPointInner get(
        ...
        String replicatedProtectedItemName,
        String recoveryPointName) {
        return getAsync(fabricName, protectionContainerName, replicatedProtectedItemName, recoveryPointName).block();
    }
