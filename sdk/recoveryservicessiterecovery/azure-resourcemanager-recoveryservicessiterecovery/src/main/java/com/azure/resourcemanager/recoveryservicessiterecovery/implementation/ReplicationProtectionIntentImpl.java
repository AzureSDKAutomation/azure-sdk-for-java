    ...
    public ReplicationProtectionIntent create() {
        this.innerObject =
            serviceManager
                ...
                .create(resourceName, resourceGroupName, intentObjectName, createInput, Context.NONE);
        return this;
    }
    ...
    public ReplicationProtectionIntent create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionIntents()
                .create(resourceName, resourceGroupName, intentObjectName, createInput, context);
        return this;
    }
