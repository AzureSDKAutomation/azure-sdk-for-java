...
public final class ReplicationEligibilityResultsErrorInfo {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ReplicationEligibilityResultsErrorInfo.class);
    ...
    /**
     * Set the status property: The error status.
     *
     * @param status the status value to set.
     * @return the ReplicationEligibilityResultsErrorInfo object itself.
     */
    public ReplicationEligibilityResultsErrorInfo withStatus(String status) {
        this.status = status;
        return this;
    }
