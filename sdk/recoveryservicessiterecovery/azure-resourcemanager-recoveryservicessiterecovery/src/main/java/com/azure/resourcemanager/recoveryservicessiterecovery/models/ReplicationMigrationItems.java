...
public interface ReplicationMigrationItems {
     ...
     */
    MigrationItem get(String fabricName, String protectionContainerName, String migrationItemName);
     ...
     * @return the list of migration items in the vault.
     */
    PagedIterable<MigrationItem> list(String skipToken, String filter, Context context);
