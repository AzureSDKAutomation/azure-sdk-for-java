...
public final class FabricImpl implements Fabric, Fabric.Definition {
    ...
    public FabricImpl(FabricInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public Fabric create() {
        this.innerObject =
            serviceManager.serviceClient().getReplicationFabrics().create(fabricName, createInput, Context.NONE);
        return this;
    }

    public Fabric create(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationFabrics().create(fabricName, createInput, context);
        return this;
    }

    public FabricImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public Fabric refresh() {
        this.innerObject =
            serviceManager.serviceClient().getReplicationFabrics().getWithResponse(fabricName, Context.NONE).getValue();
        return this;
    }

    public Fabric refresh(Context context) {
        this.innerObject =
            serviceManager.serviceClient().getReplicationFabrics().getWithResponse(fabricName, context).getValue();
        return this;
    }
