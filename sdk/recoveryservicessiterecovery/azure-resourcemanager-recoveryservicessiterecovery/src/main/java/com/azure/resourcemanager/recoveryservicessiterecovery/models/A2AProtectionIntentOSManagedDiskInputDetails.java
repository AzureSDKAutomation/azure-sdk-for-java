...
@Fluent
public final class A2AProtectionIntentOSManagedDiskInputDetails {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(A2AProtectionIntentOSManagedDiskInputDetails.class);
     ...
     * @return the A2AProtectionIntentOSManagedDiskInputDetails object itself.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails withPrimaryStagingStorageAccountCustomInput(
     ...
     * @return the A2AProtectionIntentOSManagedDiskInputDetails object itself.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails withRecoveryResourceGroupCustomInput(
     ...
     * @return the A2AProtectionIntentOSManagedDiskInputDetails object itself.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails withRecoveryReplicaDiskAccountType(
     ...
     * @return the A2AProtectionIntentOSManagedDiskInputDetails object itself.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails withRecoveryTargetDiskAccountType(
     ...
     * @return the A2AProtectionIntentOSManagedDiskInputDetails object itself.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails withRecoveryDiskEncryptionSetId(
     ...
     * @return the A2AProtectionIntentOSManagedDiskInputDetails object itself.
     */
    public A2AProtectionIntentOSManagedDiskInputDetails withDiskEncryptionInfo(DiskEncryptionInfo diskEncryptionInfo) {
