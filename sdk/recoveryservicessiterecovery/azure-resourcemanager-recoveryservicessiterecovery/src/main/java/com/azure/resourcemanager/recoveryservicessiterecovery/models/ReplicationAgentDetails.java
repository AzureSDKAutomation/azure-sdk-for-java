...
@Immutable
public final class ReplicationAgentDetails {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ReplicationAgentDetails.class);
    ...
    /**
     * Get the version property: The replication agent version.
     *
