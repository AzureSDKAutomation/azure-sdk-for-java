...
public interface ReplicationEventsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<EventInner> list(String filter, Context context);
    ...
    EventInner get(String eventName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<EventInner> getWithResponse(String eventName, Context context);
}
