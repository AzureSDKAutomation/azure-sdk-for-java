...
public interface ReplicationAlertSettingsClient {
    ...
    AlertInner get(String alertSettingName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AlertInner> getWithResponse(String alertSettingName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AlertInner create(String alertSettingName, ConfigureAlertRequest request);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AlertInner> createWithResponse(String alertSettingName, ConfigureAlertRequest request, Context context);
}
