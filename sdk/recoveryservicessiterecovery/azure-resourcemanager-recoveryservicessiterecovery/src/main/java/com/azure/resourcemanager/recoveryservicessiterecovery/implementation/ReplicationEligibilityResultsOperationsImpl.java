...
public final class ReplicationEligibilityResultsOperationsImpl implements ReplicationEligibilityResultsOperations {
    ...
    public ReplicationEligibilityResultsCollection list(String virtualMachineName) {
        ReplicationEligibilityResultsCollectionInner inner = this.serviceClient().list(virtualMachineName);
        if (inner != null) {
    ...
    public Response<ReplicationEligibilityResultsCollection> listWithResponse(
        ...
        Response<ReplicationEligibilityResultsCollectionInner> inner =
            this.serviceClient().listWithResponse(virtualMachineName, context);
        if (inner != null) {
    ...
    public ReplicationEligibilityResults get(String virtualMachineName) {
        ReplicationEligibilityResultsInner inner = this.serviceClient().get(virtualMachineName);
        if (inner != null) {
    ...
    public Response<ReplicationEligibilityResults> getWithResponse(String virtualMachineName, Context context) {
        Response<ReplicationEligibilityResultsInner> inner =
            this.serviceClient().getWithResponse(virtualMachineName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
