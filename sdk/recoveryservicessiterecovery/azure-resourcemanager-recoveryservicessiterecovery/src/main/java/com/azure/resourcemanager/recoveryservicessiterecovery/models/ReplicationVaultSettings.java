...
public interface ReplicationVaultSettings {
     ...
     */
    PagedIterable<VaultSetting> list();
     ...
     * @return the list of vault setting.
     */
    PagedIterable<VaultSetting> list(Context context);
     ...
     */
    VaultSetting get(String vaultSettingName);
     ...
     * @return the vault setting.
     */
    Response<VaultSetting> getWithResponse(String vaultSettingName, Context context);
