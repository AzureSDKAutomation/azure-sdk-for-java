...
public final class ReplicationProtectedItemImpl
    ...
    public ReplicationProtectedItem create() {
        this.innerObject =
            serviceManager
                ...
                .create(fabricName, protectionContainerName, replicatedProtectedItemName, createInput, Context.NONE);
        return this;
    }
    ...
    public ReplicationProtectedItem create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectedItems()
                .create(fabricName, protectionContainerName, replicatedProtectedItemName, createInput, context);
        return this;
    }

    public ReplicationProtectedItemImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public ReplicationProtectedItemImpl(ReplicationProtectedItemInner innerObject, SiteRecoveryManager serviceManager) {
