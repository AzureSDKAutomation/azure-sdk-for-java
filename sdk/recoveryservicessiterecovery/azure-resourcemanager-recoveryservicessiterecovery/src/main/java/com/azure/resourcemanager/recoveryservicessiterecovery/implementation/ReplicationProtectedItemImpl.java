...
public final class ReplicationProtectedItemImpl
    ...
    public ReplicationProtectedItem reprotect(ReverseReplicationInput rrInput) {
        return serviceManager
            .replicationProtectedItems()
            .reprotect(
                resourceName,
    ...
    public ReplicationProtectedItem reprotect(ReverseReplicationInput rrInput, Context context) {
        return serviceManager
            .replicationProtectedItems()
            .reprotect(
                resourceName,
    ...
    public ReplicationProtectedItem testFailover(TestFailoverInput failoverInput) {
        return serviceManager
            .replicationProtectedItems()
            .testFailover(
                resourceName,
    ...
    public ReplicationProtectedItem testFailover(TestFailoverInput failoverInput, Context context) {
        return serviceManager
            .replicationProtectedItems()
            .testFailover(
                resourceName,
