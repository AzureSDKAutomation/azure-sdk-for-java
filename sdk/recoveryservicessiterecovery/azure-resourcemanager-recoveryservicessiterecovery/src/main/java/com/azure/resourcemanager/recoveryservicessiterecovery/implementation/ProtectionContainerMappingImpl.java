    ...
    public ProtectionContainerMapping create() {
        this.innerObject =
            serviceManager
                ...
                .create(fabricName, protectionContainerName, mappingName, createCreationInput, Context.NONE);
        return this;
    }
    ...
    public ProtectionContainerMapping create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainerMappings()
                .create(fabricName, protectionContainerName, mappingName, createCreationInput, context);
        return this;
    }

    public ProtectionContainerMappingImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public ProtectionContainerMapping apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainerMappings()
                .update(fabricName, protectionContainerName, mappingName, updateUpdateInput, Context.NONE);
        return this;
    }
    ...
    public ProtectionContainerMapping apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainerMappings()
                .update(fabricName, protectionContainerName, mappingName, updateUpdateInput, context);
        return this;
    }

    public ProtectionContainerMappingImpl(
        ProtectionContainerMappingInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public ProtectionContainerMapping refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainerMappings()
                .getWithResponse(fabricName, protectionContainerName, mappingName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public ProtectionContainerMapping refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainerMappings()
                .getWithResponse(fabricName, protectionContainerName, mappingName, context)
                .getValue();
        return this;
    }
