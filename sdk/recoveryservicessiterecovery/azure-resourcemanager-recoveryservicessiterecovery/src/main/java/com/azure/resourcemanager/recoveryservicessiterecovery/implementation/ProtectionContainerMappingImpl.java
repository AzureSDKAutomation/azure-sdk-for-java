...
public final class ProtectionContainerMappingImpl
    ...
    ProtectionContainerMappingImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    ProtectionContainerMappingImpl(ProtectionContainerMappingInner innerObject, SiteRecoveryManager serviceManager) {
