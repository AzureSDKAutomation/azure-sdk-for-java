...
public interface ReplicationMigrationItemsClient {
    ...
    MigrationItemInner get(String fabricName, String protectionContainerName, String migrationItemName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String fabricName, String protectionContainerName, String migrationItemName, String deleteOption);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void delete(String fabricName, String protectionContainerName, String migrationItemName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<MigrationItemInner> list(String skipToken, String filter, Context context);
}
