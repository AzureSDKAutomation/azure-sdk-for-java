...
public final class ReplicationProtectionContainersClientImpl implements ReplicationProtectionContainersClient {
    ...
    private Mono<PagedResponse<ProtectionContainerInner>> listByReplicationFabricsSinglePageAsync(String fabricName) {
    ...
    private PagedFlux<ProtectionContainerInner> listByReplicationFabricsAsync(String fabricName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProtectionContainerInner> listByReplicationFabricsAsync(String fabricName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProtectionContainerInner> listByReplicationFabrics(String fabricName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProtectionContainerInner> listByReplicationFabrics(String fabricName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProtectionContainerInner> getAsync(String fabricName, String protectionContainerName) {
        return getWithResponseAsync(fabricName, protectionContainerName)
            .flatMap(
    ...
    public ProtectionContainerInner get(String fabricName, String protectionContainerName) {
        return getAsync(fabricName, protectionContainerName).block();
    }
    ...
    public Response<ProtectionContainerInner> getWithResponse(
        String fabricName, String protectionContainerName, Context context) {
        return getWithResponseAsync(fabricName, protectionContainerName, context).block();
    }
    ...
    private PollerFlux<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(fabricName, protectionContainerName, creationInput);
        return this
            .client
    ...
    private PollerFlux<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(fabricName, protectionContainerName, creationInput, context);
        return this
            .client
            .<ProtectionContainerInner, ProtectionContainerInner>getLroResult(
                mono,
    ...
    public SyncPoller<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginCreate(
        String fabricName, String protectionContainerName, CreateProtectionContainerInput creationInput) {
        return beginCreateAsync(fabricName, protectionContainerName, creationInput).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginCreate(
        ...
        CreateProtectionContainerInput creationInput,
        Context context) {
        return beginCreateAsync(fabricName, protectionContainerName, creationInput, context).getSyncPoller();
    }
    ...
    private Mono<ProtectionContainerInner> createAsync(
        String fabricName, String protectionContainerName, CreateProtectionContainerInput creationInput) {
        return beginCreateAsync(fabricName, protectionContainerName, creationInput)
            .last()
    ...
    private Mono<ProtectionContainerInner> createAsync(
        ...
        CreateProtectionContainerInput creationInput,
        Context context) {
        return beginCreateAsync(fabricName, protectionContainerName, creationInput, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ProtectionContainerInner create(
        String fabricName, String protectionContainerName, CreateProtectionContainerInput creationInput) {
        return createAsync(fabricName, protectionContainerName, creationInput).block();
    }
    ...
    public ProtectionContainerInner create(
        ...
        CreateProtectionContainerInput creationInput,
        Context context) {
        return createAsync(fabricName, protectionContainerName, creationInput, context).block();
    }
    ...
    public SyncPoller<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginDiscoverProtectableItem(
        ...
        String protectionContainerName,
        DiscoverProtectableItemRequest discoverProtectableItemRequest) {
        return beginDiscoverProtectableItemAsync(fabricName, protectionContainerName, discoverProtectableItemRequest)
            .getSyncPoller();
    }
    ...
    public ProtectionContainerInner discoverProtectableItem(
        ...
        String protectionContainerName,
        DiscoverProtectableItemRequest discoverProtectableItemRequest) {
        return discoverProtectableItemAsync(fabricName, protectionContainerName, discoverProtectableItemRequest)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(String fabricName, String protectionContainerName) {
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(fabricName, protectionContainerName);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginDeleteAsync(
        String fabricName, String protectionContainerName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(fabricName, protectionContainerName, context);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<Void>, Void> beginDelete(String fabricName, String protectionContainerName) {
        return beginDeleteAsync(fabricName, protectionContainerName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginDelete(
        String fabricName, String protectionContainerName, Context context) {
        return beginDeleteAsync(fabricName, protectionContainerName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String fabricName, String protectionContainerName) {
        return beginDeleteAsync(fabricName, protectionContainerName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> deleteAsync(String fabricName, String protectionContainerName, Context context) {
        return beginDeleteAsync(fabricName, protectionContainerName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void delete(String fabricName, String protectionContainerName) {
        deleteAsync(fabricName, protectionContainerName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void delete(String fabricName, String protectionContainerName, Context context) {
        deleteAsync(fabricName, protectionContainerName, context).block();
    }
    ...
    private PollerFlux<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginSwitchProtectionAsync(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            switchProtectionWithResponseAsync(fabricName, protectionContainerName, switchInput);
        return this
            .client
            .<ProtectionContainerInner, ProtectionContainerInner>getLroResult(
                mono,
    ...
    private PollerFlux<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginSwitchProtectionAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            switchProtectionWithResponseAsync(fabricName, protectionContainerName, switchInput, context);
        return this
            .client
            .<ProtectionContainerInner, ProtectionContainerInner>getLroResult(
                mono,
    ...
    public SyncPoller<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginSwitchProtection(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput) {
        return beginSwitchProtectionAsync(fabricName, protectionContainerName, switchInput).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ProtectionContainerInner>, ProtectionContainerInner> beginSwitchProtection(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput, Context context) {
        return beginSwitchProtectionAsync(fabricName, protectionContainerName, switchInput, context).getSyncPoller();
    }
    ...
    private Mono<ProtectionContainerInner> switchProtectionAsync(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput) {
        return beginSwitchProtectionAsync(fabricName, protectionContainerName, switchInput)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    private Mono<ProtectionContainerInner> switchProtectionAsync(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput, Context context) {
        return beginSwitchProtectionAsync(fabricName, protectionContainerName, switchInput, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ProtectionContainerInner switchProtection(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput) {
        return switchProtectionAsync(fabricName, protectionContainerName, switchInput).block();
    }
    ...
    public ProtectionContainerInner switchProtection(
        String fabricName, String protectionContainerName, SwitchProtectionInput switchInput, Context context) {
        return switchProtectionAsync(fabricName, protectionContainerName, switchInput, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProtectionContainerInner>> listSinglePageAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProtectionContainerInner> listAsync(Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProtectionContainerInner> list(Context context) {
