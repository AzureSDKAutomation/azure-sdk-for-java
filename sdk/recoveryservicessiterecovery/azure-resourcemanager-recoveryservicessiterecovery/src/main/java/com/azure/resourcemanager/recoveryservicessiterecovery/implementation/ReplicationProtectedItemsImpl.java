...
public final class ReplicationProtectedItemsImpl implements ReplicationProtectedItems {
    ...
    public ReplicationProtectedItem get(
        ...
        ReplicationProtectedItemInner inner =
            this.serviceClient().get(fabricName, protectionContainerName, replicatedProtectedItemName);
        if (inner != null) {
    ...
    public Response<ReplicationProtectedItem> getWithResponse(
        ...
        Response<ReplicationProtectedItemInner> inner =
            this
                .serviceClient()
                .getWithResponse(fabricName, protectionContainerName, replicatedProtectedItemName, context);
        if (inner != null) {
    ...
    public void purge(String fabricName, String protectionContainerName, String replicatedProtectedItemName) {
        this.serviceClient().purge(fabricName, protectionContainerName, replicatedProtectedItemName);
    }

    public void purge(
        String fabricName, String protectionContainerName, String replicatedProtectedItemName, Context context) {
        this.serviceClient().purge(fabricName, protectionContainerName, replicatedProtectedItemName, context);
    }
    ...
    public ReplicationProtectedItem addDisks(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .addDisks(fabricName, protectionContainerName, replicatedProtectedItemName, addDisksInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem addDisks(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .addDisks(fabricName, protectionContainerName, replicatedProtectedItemName, addDisksInput, context);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem failoverCancel(
        String fabricName, String protectionContainerName, String replicatedProtectedItemName) {
        ReplicationProtectedItemInner inner =
            this.serviceClient().failoverCancel(fabricName, protectionContainerName, replicatedProtectedItemName);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem failoverCancel(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .failoverCancel(fabricName, protectionContainerName, replicatedProtectedItemName, context);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem failoverCommit(
        String fabricName, String protectionContainerName, String replicatedProtectedItemName) {
        ReplicationProtectedItemInner inner =
            this.serviceClient().failoverCommit(fabricName, protectionContainerName, replicatedProtectedItemName);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem failoverCommit(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .failoverCommit(fabricName, protectionContainerName, replicatedProtectedItemName, context);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem plannedFailover(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .plannedFailover(fabricName, protectionContainerName, replicatedProtectedItemName, failoverInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public void delete(
        ...
        this
            .serviceClient()
            .delete(fabricName, protectionContainerName, replicatedProtectedItemName, disableProtectionInput);
    }
    ...
    public void delete(
        ...
        this
            .serviceClient()
            .delete(fabricName, protectionContainerName, replicatedProtectedItemName, disableProtectionInput, context);
    }
    ...
    public ReplicationProtectedItem removeDisks(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .removeDisks(fabricName, protectionContainerName, replicatedProtectedItemName, removeDisksInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem repairReplication(
        String fabricName, String protectionContainerName, String replicatedProtectedItemName) {
        ReplicationProtectedItemInner inner =
            this.serviceClient().repairReplication(fabricName, protectionContainerName, replicatedProtectedItemName);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem repairReplication(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .repairReplication(fabricName, protectionContainerName, replicatedProtectedItemName, context);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem reprotect(
        ...
        ReplicationProtectedItemInner inner =
            this.serviceClient().reprotect(fabricName, protectionContainerName, replicatedProtectedItemName, rrInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem reprotect(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .reprotect(fabricName, protectionContainerName, replicatedProtectedItemName, rrInput, context);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem testFailover(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .testFailover(fabricName, protectionContainerName, replicatedProtectedItemName, failoverInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem testFailover(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .testFailover(fabricName, protectionContainerName, replicatedProtectedItemName, failoverInput, context);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem testFailoverCleanup(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .testFailoverCleanup(fabricName, protectionContainerName, replicatedProtectedItemName, cleanupInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ReplicationProtectedItem unplannedFailover(
        ...
        ReplicationProtectedItemInner inner =
            this
                .serviceClient()
                .unplannedFailover(fabricName, protectionContainerName, replicatedProtectedItemName, failoverInput);
        if (inner != null) {
            return new ReplicationProtectedItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<ReplicationProtectedItem> list() {
        PagedIterable<ReplicationProtectedItemInner> inner = this.serviceClient().list();
        return inner.mapPage(inner1 -> new ReplicationProtectedItemImpl(inner1, this.manager()));
    }

    public PagedIterable<ReplicationProtectedItem> list(String skipToken, String filter, Context context) {
        PagedIterable<ReplicationProtectedItemInner> inner = this.serviceClient().list(skipToken, filter, context);
        return inner.mapPage(inner1 -> new ReplicationProtectedItemImpl(inner1, this.manager()));
    }
    ...
    public ReplicationProtectedItem getById(String id) {
        ...
        return this
            .getWithResponse(fabricName, protectionContainerName, replicatedProtectedItemName, Context.NONE)
            .getValue();
    }
    ...
    public Response<ReplicationProtectedItem> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(fabricName, protectionContainerName, replicatedProtectedItemName, context);
    }
