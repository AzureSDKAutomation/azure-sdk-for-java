...
public final class ReplicationProtectionIntentsClientImpl implements ReplicationProtectionIntentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<ReplicationProtectionIntentInner>, ReplicationProtectionIntentInner> beginCreateAsync(
        String resourceName, String resourceGroupName, String intentObjectName, CreateProtectionIntentInput input) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceName, resourceGroupName, intentObjectName, input);
        return this
            .client
            .<ReplicationProtectionIntentInner, ReplicationProtectionIntentInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                ReplicationProtectionIntentInner.class,
                ReplicationProtectionIntentInner.class,
                Context.NONE);
    }
    ...
    private PollerFlux<PollResult<ReplicationProtectionIntentInner>, ReplicationProtectionIntentInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceName, resourceGroupName, intentObjectName, input, context);
        return this
            .client
            .<ReplicationProtectionIntentInner, ReplicationProtectionIntentInner>getLroResult(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<ReplicationProtectionIntentInner>, ReplicationProtectionIntentInner> beginCreate(
        String resourceName, String resourceGroupName, String intentObjectName, CreateProtectionIntentInput input) {
        return beginCreateAsync(resourceName, resourceGroupName, intentObjectName, input).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<ReplicationProtectionIntentInner>, ReplicationProtectionIntentInner> beginCreate(
        ...
        CreateProtectionIntentInput input,
        Context context) {
        return beginCreateAsync(resourceName, resourceGroupName, intentObjectName, input, context).getSyncPoller();
    }
    ...
    private Mono<ReplicationProtectionIntentInner> createAsync(
        String resourceName, String resourceGroupName, String intentObjectName, CreateProtectionIntentInput input) {
        return beginCreateAsync(resourceName, resourceGroupName, intentObjectName, input)
            .last()
    ...
    private Mono<ReplicationProtectionIntentInner> createAsync(
        ...
        CreateProtectionIntentInput input,
        Context context) {
        return beginCreateAsync(resourceName, resourceGroupName, intentObjectName, input, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public ReplicationProtectionIntentInner create(
        ...
        CreateProtectionIntentInput input,
        Context context) {
        return createAsync(resourceName, resourceGroupName, intentObjectName, input, context).block();
    }
