...
public final class ReplicationStorageClassificationMappingsImpl implements ReplicationStorageClassificationMappings {
    ...
    public PagedIterable<StorageClassificationMapping> listByReplicationStorageClassifications(
        ...
        PagedIterable<StorageClassificationMappingInner> inner =
            this.serviceClient().listByReplicationStorageClassifications(fabricName, storageClassificationName);
    ...
    public PagedIterable<StorageClassificationMapping> listByReplicationStorageClassifications(
        ...
        PagedIterable<StorageClassificationMappingInner> inner =
            this
                .serviceClient()
                .listByReplicationStorageClassifications(fabricName, storageClassificationName, context);
        return inner.mapPage(inner1 -> new StorageClassificationMappingImpl(inner1, this.manager()));
    }
    ...
    public StorageClassificationMapping get(
        ...
        StorageClassificationMappingInner inner =
            this.serviceClient().get(fabricName, storageClassificationName, storageClassificationMappingName);
        if (inner != null) {
    ...
    public Response<StorageClassificationMapping> getWithResponse(
        ...
        Response<StorageClassificationMappingInner> inner =
            this
                .serviceClient()
                .getWithResponse(fabricName, storageClassificationName, storageClassificationMappingName, context);
        if (inner != null) {
    ...
    public void delete(String fabricName, String storageClassificationName, String storageClassificationMappingName) {
        this.serviceClient().delete(fabricName, storageClassificationName, storageClassificationMappingName);
    }

    public void delete(
        String fabricName, String storageClassificationName, String storageClassificationMappingName, Context context) {
        this.serviceClient().delete(fabricName, storageClassificationName, storageClassificationMappingName, context);
    }

    public PagedIterable<StorageClassificationMapping> list() {
        PagedIterable<StorageClassificationMappingInner> inner = this.serviceClient().list();
        return inner.mapPage(inner1 -> new StorageClassificationMappingImpl(inner1, this.manager()));
    }

    public PagedIterable<StorageClassificationMapping> list(Context context) {
        PagedIterable<StorageClassificationMappingInner> inner = this.serviceClient().list(context);
        return inner.mapPage(inner1 -> new StorageClassificationMappingImpl(inner1, this.manager()));
    }
    ...
    public StorageClassificationMapping getById(String id) {
        ...
        return this
            .getWithResponse(fabricName, storageClassificationName, storageClassificationMappingName, Context.NONE)
            .getValue();
    }
    ...
    public Response<StorageClassificationMapping> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(fabricName, storageClassificationName, storageClassificationMappingName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(fabricName, storageClassificationName, storageClassificationMappingName, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, Context context) {
        ...
        this.delete(fabricName, storageClassificationName, storageClassificationMappingName, context);
    }
