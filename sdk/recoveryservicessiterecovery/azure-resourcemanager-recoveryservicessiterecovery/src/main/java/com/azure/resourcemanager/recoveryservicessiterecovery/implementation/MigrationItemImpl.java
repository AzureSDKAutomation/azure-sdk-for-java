    ...
    public MigrationItem create() {
        this.innerObject =
            serviceManager
                ...
                .create(fabricName, protectionContainerName, migrationItemName, createInput, Context.NONE);
        return this;
    }
    ...
    public MigrationItem create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationMigrationItems()
                .create(fabricName, protectionContainerName, migrationItemName, createInput, context);
        return this;
    }

    public MigrationItemImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public MigrationItem apply() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationMigrationItems()
                .update(fabricName, protectionContainerName, migrationItemName, updateInput, Context.NONE);
        return this;
    }
    ...
    public MigrationItem apply(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationMigrationItems()
                .update(fabricName, protectionContainerName, migrationItemName, updateInput, context);
        return this;
    }

    public MigrationItemImpl(MigrationItemInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public MigrationItem refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationMigrationItems()
                .getWithResponse(fabricName, protectionContainerName, migrationItemName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public MigrationItem refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationMigrationItems()
                .getWithResponse(fabricName, protectionContainerName, migrationItemName, context)
                .getValue();
        return this;
    }
