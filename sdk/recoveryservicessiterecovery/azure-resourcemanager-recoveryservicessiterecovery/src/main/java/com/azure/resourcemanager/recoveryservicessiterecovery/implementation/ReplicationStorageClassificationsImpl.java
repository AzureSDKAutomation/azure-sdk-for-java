...
public final class ReplicationStorageClassificationsImpl implements ReplicationStorageClassifications {
    ...
    public PagedIterable<StorageClassification> listByReplicationFabrics(String fabricName) {
        PagedIterable<StorageClassificationInner> inner = this.serviceClient().listByReplicationFabrics(fabricName);
        return inner.mapPage(inner1 -> new StorageClassificationImpl(inner1, this.manager()));
    }

    public PagedIterable<StorageClassification> listByReplicationFabrics(String fabricName, Context context) {
        PagedIterable<StorageClassificationInner> inner =
            this.serviceClient().listByReplicationFabrics(fabricName, context);
        return inner.mapPage(inner1 -> new StorageClassificationImpl(inner1, this.manager()));
    }

    public StorageClassification get(String fabricName, String storageClassificationName) {
        StorageClassificationInner inner = this.serviceClient().get(fabricName, storageClassificationName);
        if (inner != null) {
    ...
    public Response<StorageClassification> getWithResponse(
        ...
        Response<StorageClassificationInner> inner =
            this.serviceClient().getWithResponse(fabricName, storageClassificationName, context);
        if (inner != null) {
    ...
    public PagedIterable<StorageClassification> list() {
        PagedIterable<StorageClassificationInner> inner = this.serviceClient().list();
        return inner.mapPage(inner1 -> new StorageClassificationImpl(inner1, this.manager()));
    }

    public PagedIterable<StorageClassification> list(Context context) {
        PagedIterable<StorageClassificationInner> inner = this.serviceClient().list(context);
        return inner.mapPage(inner1 -> new StorageClassificationImpl(inner1, this.manager()));
    }
