...
public final class SupportedOperatingSystemsOperationsClientImpl implements SupportedOperatingSystemsOperationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<SupportedOperatingSystemsInner>> getWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SupportedOperatingSystemsInner get() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<SupportedOperatingSystemsInner> getWithResponse(Context context) {
