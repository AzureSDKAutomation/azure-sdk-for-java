...
public final class ReplicationProtectionContainersImpl implements ReplicationProtectionContainers {
    ...
    public PagedIterable<ProtectionContainer> listByReplicationFabrics(String fabricName) {
        PagedIterable<ProtectionContainerInner> inner = this.serviceClient().listByReplicationFabrics(fabricName);
        return inner.mapPage(inner1 -> new ProtectionContainerImpl(inner1, this.manager()));
    }

    public PagedIterable<ProtectionContainer> listByReplicationFabrics(String fabricName, Context context) {
        PagedIterable<ProtectionContainerInner> inner =
            this.serviceClient().listByReplicationFabrics(fabricName, context);
        return inner.mapPage(inner1 -> new ProtectionContainerImpl(inner1, this.manager()));
    }

    public ProtectionContainer get(String fabricName, String protectionContainerName) {
        ProtectionContainerInner inner = this.serviceClient().get(fabricName, protectionContainerName);
        if (inner != null) {
    ...
    public Response<ProtectionContainer> getWithResponse(
        ...
        Response<ProtectionContainerInner> inner =
            this.serviceClient().getWithResponse(fabricName, protectionContainerName, context);
        if (inner != null) {
    ...
    public ProtectionContainer discoverProtectableItem(
        ...
        ProtectionContainerInner inner =
            this
                .serviceClient()
                .discoverProtectableItem(fabricName, protectionContainerName, discoverProtectableItemRequest);
        if (inner != null) {
            return new ProtectionContainerImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ProtectionContainer discoverProtectableItem(
        ...
        ProtectionContainerInner inner =
            this
                .serviceClient()
                .discoverProtectableItem(fabricName, protectionContainerName, discoverProtectableItemRequest, context);
        if (inner != null) {
            return new ProtectionContainerImpl(inner, this.manager());
        } else {
            return null;
    ...
    public void delete(String fabricName, String protectionContainerName) {
        this.serviceClient().delete(fabricName, protectionContainerName);
    }

    public void delete(String fabricName, String protectionContainerName, Context context) {
        this.serviceClient().delete(fabricName, protectionContainerName, context);
    }
    ...
    public ProtectionContainer switchProtection(
        ...
        ProtectionContainerInner inner =
            this.serviceClient().switchProtection(fabricName, protectionContainerName, switchInput);
        if (inner != null) {
            return new ProtectionContainerImpl(inner, this.manager());
        } else {
            return null;
    ...
    public ProtectionContainer switchProtection(
        ...
        ProtectionContainerInner inner =
            this.serviceClient().switchProtection(fabricName, protectionContainerName, switchInput, context);
        if (inner != null) {
            return new ProtectionContainerImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<ProtectionContainer> list() {
        PagedIterable<ProtectionContainerInner> inner = this.serviceClient().list();
        return inner.mapPage(inner1 -> new ProtectionContainerImpl(inner1, this.manager()));
    }

    public PagedIterable<ProtectionContainer> list(Context context) {
        PagedIterable<ProtectionContainerInner> inner = this.serviceClient().list(context);
        return inner.mapPage(inner1 -> new ProtectionContainerImpl(inner1, this.manager()));
    }
    ...
    public ProtectionContainer getById(String id) {
        ...
        return this.getWithResponse(fabricName, protectionContainerName, Context.NONE).getValue();
    }
    ...
    public Response<ProtectionContainer> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(fabricName, protectionContainerName, context);
    }
