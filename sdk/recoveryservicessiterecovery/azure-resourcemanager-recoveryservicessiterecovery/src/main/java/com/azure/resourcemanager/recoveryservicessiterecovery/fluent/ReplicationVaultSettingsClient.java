...
public interface ReplicationVaultSettingsClient {
    ...
    PagedIterable<VaultSettingInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<VaultSettingInner> list(Context context);
    ...
    VaultSettingInner get(String vaultSettingName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<VaultSettingInner> getWithResponse(String vaultSettingName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    VaultSettingInner create(String vaultSettingName, VaultSettingCreationInput input);
