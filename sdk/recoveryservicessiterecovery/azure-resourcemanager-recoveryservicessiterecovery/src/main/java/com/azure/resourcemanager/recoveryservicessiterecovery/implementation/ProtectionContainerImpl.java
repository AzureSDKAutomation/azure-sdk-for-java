...
public final class ProtectionContainerImpl implements ProtectionContainer, ProtectionContainer.Definition {
    ...
    public ProtectionContainerImpl(ProtectionContainerInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public ProtectionContainer create() {
        this.innerObject =
            serviceManager
                ...
                .create(fabricName, protectionContainerName, createCreationInput, Context.NONE);
        return this;
    }
    ...
    public ProtectionContainer create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainers()
                .create(fabricName, protectionContainerName, createCreationInput, context);
        return this;
    }

    public ProtectionContainerImpl(String name, SiteRecoveryManager serviceManager) {
    ...
    public ProtectionContainer refresh() {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainers()
                .getWithResponse(fabricName, protectionContainerName, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public ProtectionContainer refresh(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationProtectionContainers()
                .getWithResponse(fabricName, protectionContainerName, context)
                .getValue();
        return this;
    }
