...
public final class ReplicationLogicalNetworksClientImpl implements ReplicationLogicalNetworksClient {
    ...
    private Mono<PagedResponse<LogicalNetworkInner>> listByReplicationFabricsSinglePageAsync(String fabricName) {
    ...
    private PagedFlux<LogicalNetworkInner> listByReplicationFabricsAsync(String fabricName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<LogicalNetworkInner> listByReplicationFabricsAsync(String fabricName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LogicalNetworkInner> listByReplicationFabrics(String fabricName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<LogicalNetworkInner> listByReplicationFabrics(String fabricName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LogicalNetworkInner>> getWithResponseAsync(String fabricName, String logicalNetworkName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LogicalNetworkInner> getAsync(String fabricName, String logicalNetworkName) {
        return getWithResponseAsync(fabricName, logicalNetworkName)
            .flatMap(
    ...
    public LogicalNetworkInner get(String fabricName, String logicalNetworkName) {
        return getAsync(fabricName, logicalNetworkName).block();
    }
    ...
    public Response<LogicalNetworkInner> getWithResponse(
        String fabricName, String logicalNetworkName, Context context) {
        return getWithResponseAsync(fabricName, logicalNetworkName, context).block();
    }
