...
public interface ReplicationNetworksClient {
    ...
    PagedIterable<NetworkInner> listByReplicationFabrics(String fabricName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkInner> listByReplicationFabrics(String fabricName, Context context);
    ...
    NetworkInner get(String fabricName, String networkName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<NetworkInner> getWithResponse(String fabricName, String networkName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<NetworkInner> list(Context context);
}
