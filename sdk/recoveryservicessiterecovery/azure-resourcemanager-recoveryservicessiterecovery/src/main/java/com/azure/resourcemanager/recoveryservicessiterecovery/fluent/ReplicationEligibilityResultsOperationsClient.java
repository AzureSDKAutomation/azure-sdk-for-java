...
public interface ReplicationEligibilityResultsOperationsClient {
    ...
    ReplicationEligibilityResultsCollectionInner list(String virtualMachineName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ReplicationEligibilityResultsCollectionInner> listWithResponse(String virtualMachineName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ReplicationEligibilityResultsInner get(String virtualMachineName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ReplicationEligibilityResultsInner> getWithResponse(String virtualMachineName, Context context);
}
