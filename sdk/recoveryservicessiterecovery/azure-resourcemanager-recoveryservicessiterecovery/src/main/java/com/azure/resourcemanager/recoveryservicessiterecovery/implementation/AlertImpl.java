    ...
    public Alert create() {
        this.innerObject =
            serviceManager
                ...
                .create(resourceName, resourceGroupName, alertSettingName, createRequest, Context.NONE);
        return this;
    }
    ...
    public Alert create(Context context) {
        this.innerObject =
            serviceManager
                .serviceClient()
                .getReplicationAlertSettings()
                .create(resourceName, resourceGroupName, alertSettingName, createRequest, context);
        return this;
    }
