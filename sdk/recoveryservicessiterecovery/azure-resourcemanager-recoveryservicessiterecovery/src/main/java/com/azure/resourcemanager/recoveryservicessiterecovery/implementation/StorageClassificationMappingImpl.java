...
public final class StorageClassificationMappingImpl
    ...
    public StorageClassificationMappingImpl(
        StorageClassificationMappingInner innerObject, SiteRecoveryManager serviceManager) {
    ...
    public StorageClassificationMappingImpl(String name, SiteRecoveryManager serviceManager) {
