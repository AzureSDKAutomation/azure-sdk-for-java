...
public final class ReplicationAlertSettingsClientImpl implements ReplicationAlertSettingsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<AlertInner>, AlertInner> beginCreateAsync(
        String resourceName, String resourceGroupName, String alertSettingName, ConfigureAlertRequest request) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceName, resourceGroupName, alertSettingName, request);
        return this
            .client
            .<AlertInner, AlertInner>getLroResult(
                mono, this.client.getHttpPipeline(), AlertInner.class, AlertInner.class, Context.NONE);
    }
    ...
    private PollerFlux<PollResult<AlertInner>, AlertInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceName, resourceGroupName, alertSettingName, request, context);
        return this
            .client
            .<AlertInner, AlertInner>getLroResult(
                mono, this.client.getHttpPipeline(), AlertInner.class, AlertInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<AlertInner>, AlertInner> beginCreate(
        String resourceName, String resourceGroupName, String alertSettingName, ConfigureAlertRequest request) {
        return beginCreateAsync(resourceName, resourceGroupName, alertSettingName, request).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<AlertInner>, AlertInner> beginCreate(
        ...
        ConfigureAlertRequest request,
        Context context) {
        return beginCreateAsync(resourceName, resourceGroupName, alertSettingName, request, context).getSyncPoller();
    }
    ...
    private Mono<AlertInner> createAsync(
        String resourceName, String resourceGroupName, String alertSettingName, ConfigureAlertRequest request) {
        return beginCreateAsync(resourceName, resourceGroupName, alertSettingName, request)
            .last()
    ...
    private Mono<AlertInner> createAsync(
        ...
        ConfigureAlertRequest request,
        Context context) {
        return beginCreateAsync(resourceName, resourceGroupName, alertSettingName, request, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public AlertInner create(
        ...
        ConfigureAlertRequest request,
        Context context) {
        return createAsync(resourceName, resourceGroupName, alertSettingName, request, context).block();
    }
