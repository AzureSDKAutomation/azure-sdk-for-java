...
public final class ReplicationProtectableItemsClientImpl implements ReplicationProtectableItemsClient {
    ...
    private Mono<PagedResponse<ProtectableItemInner>> listByReplicationProtectionContainersSinglePageAsync(
        String fabricName, String protectionContainerName, String filter) {
        ...
        return new PagedFlux<>(
            () ->
                listByReplicationProtectionContainersSinglePageAsync(
                    fabricName, protectionContainerName, filter, context),
    ...
    public PagedIterable<ProtectableItemInner> listByReplicationProtectionContainers(
        ...
        return new PagedIterable<>(
            listByReplicationProtectionContainersAsync(fabricName, protectionContainerName, filter));
    }
    ...
    public PagedIterable<ProtectableItemInner> listByReplicationProtectionContainers(
        String fabricName, String protectionContainerName, String filter, Context context) {
        return new PagedIterable<>(
            listByReplicationProtectionContainersAsync(fabricName, protectionContainerName, filter, context));
    }
    ...
    private Mono<ProtectableItemInner> getAsync(
        String fabricName, String protectionContainerName, String protectableItemName) {
        return getWithResponseAsync(fabricName, protectionContainerName, protectableItemName)
            .flatMap(
    ...
    public ProtectableItemInner get(String fabricName, String protectionContainerName, String protectableItemName) {
        return getAsync(fabricName, protectionContainerName, protectableItemName).block();
    }
    ...
    public Response<ProtectableItemInner> getWithResponse(
        String fabricName, String protectionContainerName, String protectableItemName, Context context) {
        return getWithResponseAsync(fabricName, protectionContainerName, protectableItemName, context).block();
    }
