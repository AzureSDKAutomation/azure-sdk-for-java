...
public final class ReplicationMigrationItemsImpl implements ReplicationMigrationItems {
    ...
    public MigrationItem get(String fabricName, String protectionContainerName, String migrationItemName) {
        MigrationItemInner inner = this.serviceClient().get(fabricName, protectionContainerName, migrationItemName);
        if (inner != null) {
    ...
    public Response<MigrationItem> getWithResponse(
        ...
        Response<MigrationItemInner> inner =
            this.serviceClient().getWithResponse(fabricName, protectionContainerName, migrationItemName, context);
        if (inner != null) {
    ...
    public void delete(
        ...
        this.serviceClient().delete(fabricName, protectionContainerName, migrationItemName, deleteOption);
    }

    public void delete(String fabricName, String protectionContainerName, String migrationItemName) {
        this.serviceClient().delete(fabricName, protectionContainerName, migrationItemName);
    }
    ...
    public void delete(
        ...
        String deleteOption,
        Context context) {
        this.serviceClient().delete(fabricName, protectionContainerName, migrationItemName, deleteOption, context);
    }
    ...
    public MigrationItem migrate(
        ...
        MigrationItemInner inner =
            this.serviceClient().migrate(fabricName, protectionContainerName, migrationItemName, migrateInput);
        if (inner != null) {
            return new MigrationItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public MigrationItem migrate(
        ...
        Context context) {
        MigrationItemInner inner =
            this.serviceClient().migrate(fabricName, protectionContainerName, migrationItemName, migrateInput, context);
        if (inner != null) {
            return new MigrationItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public MigrationItem testMigrate(
        ...
        MigrationItemInner inner =
            this.serviceClient().testMigrate(fabricName, protectionContainerName, migrationItemName, testMigrateInput);
        if (inner != null) {
            return new MigrationItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public MigrationItem testMigrate(
        ...
        MigrationItemInner inner =
            this
                .serviceClient()
                .testMigrate(fabricName, protectionContainerName, migrationItemName, testMigrateInput, context);
        if (inner != null) {
            return new MigrationItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public MigrationItem testMigrateCleanup(
        ...
        MigrationItemInner inner =
            this
                .serviceClient()
                .testMigrateCleanup(fabricName, protectionContainerName, migrationItemName, testMigrateCleanupInput);
        if (inner != null) {
            return new MigrationItemImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<MigrationItem> list() {
        PagedIterable<MigrationItemInner> inner = this.serviceClient().list();
        return inner.mapPage(inner1 -> new MigrationItemImpl(inner1, this.manager()));
    }

    public PagedIterable<MigrationItem> list(String skipToken, String filter, Context context) {
        PagedIterable<MigrationItemInner> inner = this.serviceClient().list(skipToken, filter, context);
        return inner.mapPage(inner1 -> new MigrationItemImpl(inner1, this.manager()));
    }
    ...
    public MigrationItem getById(String id) {
        ...
        return this.getWithResponse(fabricName, protectionContainerName, migrationItemName, Context.NONE).getValue();
    }
    ...
    public Response<MigrationItem> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(fabricName, protectionContainerName, migrationItemName, context);
    }
    ...
    public void deleteById(String id) {
        ...
        this.delete(fabricName, protectionContainerName, migrationItemName, localDeleteOption, Context.NONE);
    }
    ...
    public void deleteByIdWithResponse(String id, String deleteOption, Context context) {
        ...
        this.delete(fabricName, protectionContainerName, migrationItemName, deleteOption, context);
    }
