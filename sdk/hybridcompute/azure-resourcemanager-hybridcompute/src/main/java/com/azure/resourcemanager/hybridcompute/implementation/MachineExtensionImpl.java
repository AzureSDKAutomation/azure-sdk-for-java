...
public final class MachineExtensionImpl
    ...
    MachineExtensionImpl(String name, HybridComputeManager serviceManager) {
    ...
    MachineExtensionImpl(MachineExtensionInner innerObject, HybridComputeManager serviceManager) {
