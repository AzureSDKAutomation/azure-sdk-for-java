...
public final class PrivateEndpointConnectionImpl
    ...
    PrivateEndpointConnectionImpl(String name, HybridComputeManager serviceManager) {
    ...
    PrivateEndpointConnectionImpl(PrivateEndpointConnectionInner innerObject, HybridComputeManager serviceManager) {
