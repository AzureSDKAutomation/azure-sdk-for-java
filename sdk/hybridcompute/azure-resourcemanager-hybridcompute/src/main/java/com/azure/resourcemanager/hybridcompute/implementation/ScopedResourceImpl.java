...
public final class ScopedResourceImpl implements ScopedResource, ScopedResource.Definition, ScopedResource.Update {
    ...
    ScopedResourceImpl(String name, HybridComputeManager serviceManager) {
    ...
    ScopedResourceImpl(ScopedResourceInner innerObject, HybridComputeManager serviceManager) {
