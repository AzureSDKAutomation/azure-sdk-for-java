...
public class RegistrationsInner implements InnerSupportsGet<RegistrationInner>, InnerSupportsDelete<Void> {
    ...
    private ServiceResponse<RegistrationInner> createOrUpdateDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<RegistrationInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<RegistrationInner>() { }.getType())
    ...
    private ServiceResponse<ActivationKeyResultInner> getActivationKeyDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ActivationKeyResultInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
