...
public final class LinkedSubscriptionImpl
    ...
    LinkedSubscriptionImpl(String name, AzureStackManager serviceManager) {
    ...
    LinkedSubscriptionImpl(LinkedSubscriptionInner innerObject, AzureStackManager serviceManager) {
