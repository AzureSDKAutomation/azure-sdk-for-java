...
public final class LinkedSubscriptionsImpl implements LinkedSubscriptions {
    ...
    public LinkedSubscriptionsImpl(LinkedSubscriptionsClient innerClient, AzureStackManager serviceManager) {
    ...
    public PagedIterable<LinkedSubscription> listByResourceGroup(String resourceGroup) {
        ...
        return inner.mapPage(inner1 -> new LinkedSubscriptionImpl(inner1, this.manager()));
    }
