...
public class ServerGroupInner extends Resource {
     ...
     */
    @JsonProperty(value = "properties.readReplicas", access = JsonProperty.Access.WRITE_ONLY)
    private List<String> readReplicas;

    /*
     * The source server group id for read replica server groups.
     */
    @JsonProperty(value = "properties.sourceServerGroup", access = JsonProperty.Access.WRITE_ONLY)
