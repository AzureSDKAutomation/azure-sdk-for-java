...
public class FirewallRuleInner extends ProxyResource {
    ...
    /**
     * Get the start IP address of the server group firewall rule. Must be IPv4 format.
     *
    ...
    /**
     * Set the start IP address of the server group firewall rule. Must be IPv4 format.
     *
    ...
    /**
     * Get the end IP address of the server group firewall rule. Must be IPv4 format.
     *
    ...
    /**
     * Set the end IP address of the server group firewall rule. Must be IPv4 format.
     *
