...
/**
 * Initializes a new instance of the HyperscaleCitusManagementClientImpl class.
 */
public class HyperscaleCitusManagementClientImpl extends AzureServiceClient {
     ...
     */
    public HyperscaleCitusManagementClientImpl withSubscriptionId(String subscriptionId) {
     ...
     * @return the service client itself
     */
    public HyperscaleCitusManagementClientImpl withAcceptLanguage(String acceptLanguage) {
     ...
     * @return the service client itself
     */
    public HyperscaleCitusManagementClientImpl withLongRunningOperationRetryTimeout(int longRunningOperationRetryTimeout) {
     ...
     * @return the service client itself
     */
    public HyperscaleCitusManagementClientImpl withGenerateClientRequestId(boolean generateClientRequestId) {
        this.generateClientRequestId = generateClientRequestId;
        return this;
    }

    /**
     * The ServerGroupsInner object to access its operations.
     */
    private ServerGroupsInner serverGroups;

    /**
     * Gets the ServerGroupsInner object to access its operations.
     * @return the ServerGroupsInner object.
     */
    public ServerGroupsInner serverGroups() {
    ...
    /**
     * Initializes an instance of HyperscaleCitusManagementClient client.
     *
     * @param credentials the management credentials for Azure
     */
    public HyperscaleCitusManagementClientImpl(ServiceClientCredentials credentials) {
     ...
     * @param credentials the management credentials for Azure
     */
    public HyperscaleCitusManagementClientImpl(String baseUrl, ServiceClientCredentials credentials) {
     ...
     */
    public HyperscaleCitusManagementClientImpl(RestClient restClient) {
        super(restClient);
        initialize();
    }
    ...
    protected void initialize() {
        ...
        this.serverGroups = new ServerGroupsInner(restClient().retrofit(), this);
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "HyperscaleCitusManagementClient", "2020-10-05-privatepreview");
    }
}
