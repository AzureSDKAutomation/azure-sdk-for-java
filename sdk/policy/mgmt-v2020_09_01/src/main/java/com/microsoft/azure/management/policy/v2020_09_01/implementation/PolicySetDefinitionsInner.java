...
public class PolicySetDefinitionsInner {
    ...
    interface PolicySetDefinitionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions getBuiltIn" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.Authorization/policySetDefinitions")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Query(value = "$filter", encoded = true) String filter, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions listBuiltIn" })
        @GET("providers/Microsoft.Authorization/policySetDefinitions")
        Observable<Response<ResponseBody>> listBuiltIn(@Query("api-version") String apiVersion, @Query(value = "$filter", encoded = true) String filter, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions createOrUpdateAtManagementGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions deleteAtManagementGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions getAtManagementGroup" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions listByManagementGroup" })
        ...
        Observable<Response<ResponseBody>> listByManagementGroup(@Path("managementGroupId") String managementGroupId, @Query("api-version") String apiVersion, @Query(value = "$filter", encoded = true) String filter, @Query("$top") Integer top, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions listNext" })
        @GET
        Observable<Response<ResponseBody>> listNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions listBuiltInNext" })
        @GET
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.policy.v2020_09_01.PolicySetDefinitions listByManagementGroupNext" })
        @GET
     ...
     * @return the PagedList&lt;PolicySetDefinitionInner&gt; object if successful.
     */
    public PagedList<PolicySetDefinitionInner> list(final String filter, final Integer top) {
        ServiceResponse<Page<PolicySetDefinitionInner>> response = listSinglePageAsync(filter, top).toBlocking().single();
        return new PagedList<PolicySetDefinitionInner>(response.body()) {
            @Override
            public Page<PolicySetDefinitionInner> nextPage(String nextPageLink) {
                return listNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<PolicySetDefinitionInner>> listAsync(final String filter, final Integer top, final ListOperationCallback<PolicySetDefinitionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;PolicySetDefinitionInner&gt; object
     */
    public Observable<Page<PolicySetDefinitionInner>> listAsync(final String filter, final Integer top) {
     ...
     * @return the observable to the PagedList&lt;PolicySetDefinitionInner&gt; object
     */
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listWithServiceResponseAsync(final String filter, final Integer top) {
     ...
     * This operation retrieves a list of all the policy set definitions in a given subscription that match the optional given $filter. Valid values for $filter are: 'atExactScope()', 'policyType -eq {value}' or 'category eq '{value}''. If $filter is not provided, the unfiltered list includes all policy set definitions associated with the subscription, including those that apply directly or from management groups that contain the given subscription. If $filter=atExactScope() is provided, the returned list only includes all policy set definitions that at the given subscription. If $filter='policyType -eq {value}' is provided, the returned list only includes all policy set definitions whose type match the {value}. Possible policyType values are NotSpecified, BuiltIn and Custom. If $filter='category -eq {value}' is provided, the returned list only includes all policy set definitions whose category match the {value}.
     *
    ServiceResponse<PageImpl<PolicySetDefinitionInner>> * @param filter The filter to apply on the operation. Valid values for $filter are: 'atExactScope()', 'policyType -eq {value}' or 'category eq '{value}''. If $filter is not provided, no filtering is performed. If $filter=atExactScope() is provided, the returned list only includes all policy set definitions that at the given scope. If $filter='policyType -eq {value}' is provided, the returned list only includes all policy set definitions whose type match the {value}. Possible policyType values are NotSpecified, BuiltIn, Custom, and Static. If $filter='category -eq {value}' is provided, the returned list only includes all policy set definitions whose category match the {value}.
    ServiceResponse<PageImpl<PolicySetDefinitionInner>> * @param top Maximum number of records to return. When the $top filter is not provided, it will return 500 records.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;PolicySetDefinitionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listSinglePageAsync(final String filter, final Integer top) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
    ...
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listBuiltInSinglePageAsync() {
        ...
        final String filter = null;
        final Integer top = null;
        return service.listBuiltIn(this.client.apiVersion(), filter, top, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<PolicySetDefinitionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the PagedList&lt;PolicySetDefinitionInner&gt; object if successful.
     */
    public PagedList<PolicySetDefinitionInner> listBuiltIn(final String filter, final Integer top) {
        ServiceResponse<Page<PolicySetDefinitionInner>> response = listBuiltInSinglePageAsync(filter, top).toBlocking().single();
        return new PagedList<PolicySetDefinitionInner>(response.body()) {
            @Override
            public Page<PolicySetDefinitionInner> nextPage(String nextPageLink) {
                return listBuiltInNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<PolicySetDefinitionInner>> listBuiltInAsync(final String filter, final Integer top, final ListOperationCallback<PolicySetDefinitionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listBuiltInSinglePageAsync(filter, top),
            new Func1<String, Observable<ServiceResponse<Page<PolicySetDefinitionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> call(String nextPageLink) {
                    return listBuiltInNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;PolicySetDefinitionInner&gt; object
     */
    public Observable<Page<PolicySetDefinitionInner>> listBuiltInAsync(final String filter, final Integer top) {
        return listBuiltInWithServiceResponseAsync(filter, top)
            .map(new Func1<ServiceResponse<Page<PolicySetDefinitionInner>>, Page<PolicySetDefinitionInner>>() {
                @Override
                public Page<PolicySetDefinitionInner> call(ServiceResponse<Page<PolicySetDefinitionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;PolicySetDefinitionInner&gt; object
     */
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listBuiltInWithServiceResponseAsync(final String filter, final Integer top) {
        return listBuiltInSinglePageAsync(filter, top)
            .concatMap(new Func1<ServiceResponse<Page<PolicySetDefinitionInner>>, Observable<ServiceResponse<Page<PolicySetDefinitionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> call(ServiceResponse<Page<PolicySetDefinitionInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;PolicySetDefinitionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listBuiltInSinglePageAsync(final String filter, final Integer top) {
        if (this.client.apiVersion() == null) {
            throw new IllegalArgumentException("Parameter this.client.apiVersion() is required and cannot be null.");
        }
        return service.listBuiltIn(this.client.apiVersion(), filter, top, this.client.acceptLanguage(), this.client.userAgent())
    ...
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listByManagementGroupSinglePageAsync(final String managementGroupId) {
        ...
        final String filter = null;
        final Integer top = null;
        return service.listByManagementGroup(managementGroupId, this.client.apiVersion(), filter, top, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<PolicySetDefinitionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> call(Response<ResponseBody> response) {
                    try {
     ...
     * @return the PagedList&lt;PolicySetDefinitionInner&gt; object if successful.
     */
    public PagedList<PolicySetDefinitionInner> listByManagementGroup(final String managementGroupId, final String filter, final Integer top) {
        ServiceResponse<Page<PolicySetDefinitionInner>> response = listByManagementGroupSinglePageAsync(managementGroupId, filter, top).toBlocking().single();
        return new PagedList<PolicySetDefinitionInner>(response.body()) {
            @Override
            public Page<PolicySetDefinitionInner> nextPage(String nextPageLink) {
                return listByManagementGroupNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<PolicySetDefinitionInner>> listByManagementGroupAsync(final String managementGroupId, final String filter, final Integer top, final ListOperationCallback<PolicySetDefinitionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;PolicySetDefinitionInner&gt; object
     */
    public Observable<Page<PolicySetDefinitionInner>> listByManagementGroupAsync(final String managementGroupId, final String filter, final Integer top) {
        return listByManagementGroupWithServiceResponseAsync(managementGroupId, filter, top)
            .map(new Func1<ServiceResponse<Page<PolicySetDefinitionInner>>, Page<PolicySetDefinitionInner>>() {
                @Override
                public Page<PolicySetDefinitionInner> call(ServiceResponse<Page<PolicySetDefinitionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;PolicySetDefinitionInner&gt; object
     */
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listByManagementGroupWithServiceResponseAsync(final String managementGroupId, final String filter, final Integer top) {
        return listByManagementGroupSinglePageAsync(managementGroupId, filter, top)
            .concatMap(new Func1<ServiceResponse<Page<PolicySetDefinitionInner>>, Observable<ServiceResponse<Page<PolicySetDefinitionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> call(ServiceResponse<Page<PolicySetDefinitionInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
     ...
     * @return the PagedList&lt;PolicySetDefinitionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<PolicySetDefinitionInner>>> listByManagementGroupSinglePageAsync(final String managementGroupId, final String filter, final Integer top) {
        if (managementGroupId == null) {
            throw new IllegalArgumentException("Parameter managementGroupId is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
