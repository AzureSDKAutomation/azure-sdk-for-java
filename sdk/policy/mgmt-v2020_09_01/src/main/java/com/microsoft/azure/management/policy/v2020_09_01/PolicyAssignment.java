...
import com.microsoft.azure.management.policy.v2020_09_01.implementation.PolicyAssignmentInner;
...
public interface PolicyAssignment extends HasInner<PolicyAssignmentInner>, Indexable, Updatable<PolicyAssignment.Update>, Refreshable<PolicyAssignment>, HasManager<PolicyManager> {
    ...
    interface DefinitionStages {
        ...
        interface WithNonComplianceMessages {
            /**
             * Specifies nonComplianceMessages.
         ...
         */
        interface WithCreate extends Creatable<PolicyAssignment>, DefinitionStages.WithDescription, DefinitionStages.WithDisplayName, DefinitionStages.WithEnforcementMode, DefinitionStages.WithIdentity, DefinitionStages.WithLocation, DefinitionStages.WithMetadata, DefinitionStages.WithNonComplianceMessages, DefinitionStages.WithNotScopes, DefinitionStages.WithParameters, DefinitionStages.WithPolicyDefinitionId {
        }
    }
    /**
     * The template for a PolicyAssignment update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<PolicyAssignment>, UpdateStages.WithDescription, UpdateStages.WithDisplayName, UpdateStages.WithEnforcementMode, UpdateStages.WithIdentity, UpdateStages.WithLocation, UpdateStages.WithMetadata, UpdateStages.WithNonComplianceMessages, UpdateStages.WithNotScopes, UpdateStages.WithParameters, UpdateStages.WithPolicyDefinitionId {
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the policyassignment update allowing to specify NonComplianceMessages.
         */
        interface WithNonComplianceMessages {
            /**
             * Specifies nonComplianceMessages.
             ...
             * @return the next update stage
             */
            Update withNonComplianceMessages(List<NonComplianceMessage> nonComplianceMessages);
        }
