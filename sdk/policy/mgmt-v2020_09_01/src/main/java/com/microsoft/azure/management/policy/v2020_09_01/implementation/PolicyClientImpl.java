...
public class PolicyClientImpl extends AzureServiceClient {
    ...
    /**
     * The DataPolicyManifestsInner object to access its operations.
     */
    private DataPolicyManifestsInner dataPolicyManifests;

    /**
     * Gets the DataPolicyManifestsInner object to access its operations.
     * @return the DataPolicyManifestsInner object.
     */
    public DataPolicyManifestsInner dataPolicyManifests() {
    ...
    protected void initialize() {
        ...
        this.dataPolicyManifests = new DataPolicyManifestsInner(restClient().retrofit(), this);
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "PolicyClient", "2020-09-01");
    }
}
