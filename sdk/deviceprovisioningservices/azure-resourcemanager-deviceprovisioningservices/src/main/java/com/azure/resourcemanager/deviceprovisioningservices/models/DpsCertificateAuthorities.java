...
/** Resource collection API of DpsCertificateAuthorities. */
public interface DpsCertificateAuthorities {
    /**
     ...
     */
    CertificateResponse createOrUpdate(
        String resourceGroupName,
        String provisioningServiceName,
        String certificateName,
     ...
     * @return the X509 Certificate.
     */
    Response<CertificateResponse> createOrUpdateWithResponse(
        String resourceGroupName,
        String provisioningServiceName,
        String certificateName,
        CertificateBodyDescription certificateDescription,
