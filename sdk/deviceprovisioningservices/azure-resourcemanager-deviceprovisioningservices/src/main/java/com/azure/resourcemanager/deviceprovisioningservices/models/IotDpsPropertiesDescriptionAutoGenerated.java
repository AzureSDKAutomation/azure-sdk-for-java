 ...
 */
@Fluent
public final class IotDpsPropertiesDescriptionAutoGenerated {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(IotDpsPropertiesDescriptionAutoGenerated.class);
    ...
    private EncryptionPropertiesDescriptionAutoGenerated encryption;
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withState(State state) {
        this.state = state;
        return this;
    }
     ...
     */
    public EncryptionPropertiesDescriptionAutoGenerated encryption() {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withEncryption(
        EncryptionPropertiesDescriptionAutoGenerated encryption) {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withPublicNetworkAccess(PublicNetworkAccess publicNetworkAccess) {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withIpFilterRules(List<IpFilterRule> ipFilterRules) {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withPrivateEndpointConnections(
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withProvisioningState(String provisioningState) {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withIotHubs(List<IotHubDefinitionDescription> iotHubs) {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withAllocationPolicy(AllocationPolicy allocationPolicy) {
     ...
     * @return the IotDpsPropertiesDescriptionAutoGenerated object itself.
     */
    public IotDpsPropertiesDescriptionAutoGenerated withAuthorizationPolicies(
