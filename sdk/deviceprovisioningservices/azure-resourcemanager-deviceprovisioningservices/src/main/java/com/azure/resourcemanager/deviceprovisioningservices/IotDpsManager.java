...
import com.azure.resourcemanager.deviceprovisioningservices.implementation.DpsCertificateAuthoritiesImpl;
...
public final class IotDpsManager {
    ...
    private DpsCertificateAuthorities dpsCertificateAuthorities;
    ...
    /** @return Resource collection API of DpsCertificateAuthorities. */
    public DpsCertificateAuthorities dpsCertificateAuthorities() {
        if (this.dpsCertificateAuthorities == null) {
            this.dpsCertificateAuthorities =
                new DpsCertificateAuthoritiesImpl(clientObject.getDpsCertificateAuthorities(), this);
        }
        return dpsCertificateAuthorities;
    }
