...
import com.azure.resourcemanager.deviceprovisioningservices.models.ProvisioningServiceDescriptionListResultAutoGenerated;
...
public final class IotDpsResourcesClientImpl implements IotDpsResourcesClient {
    ...
    private interface IotDpsResourcesService {
        ...
        Mono<Response<ProvisioningServiceDescriptionInner>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorDetailsException.class)
        Mono<Response<ProvisioningServiceDescriptionListResult>> listBySubscription(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorDetailsException.class)
        Mono<Response<ProvisioningServiceDescriptionAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("provisioningServiceName") String provisioningServiceName,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("provisioningServiceName") String provisioningServiceName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") ProvisioningServiceDescriptionAutoGeneratedInner iotDpsDescription,
            @HeaderParam("Accept") String accept,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorDetailsException.class)
        Mono<Response<ProvisioningServiceDescriptionListResultAutoGenerated>> listBySubscription(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @HeaderParam("Accept") String accept,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorDetailsException.class)
        Mono<Response<ProvisioningServiceDescriptionListResultAutoGenerated>> listByResourceGroup(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<ProvisioningServiceDescriptionInner>> getWithResponseAsync(
        ...
        final String apiVersion = "2020-09-01-preview.1";
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProvisioningServiceDescriptionInner> getAsync(
        String resourceGroupName, String provisioningServiceName) {
        return getWithResponseAsync(resourceGroupName, provisioningServiceName)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProvisioningServiceDescriptionInner get(String resourceGroupName, String provisioningServiceName) {
        return getAsync(resourceGroupName, provisioningServiceName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ProvisioningServiceDescriptionInner> getWithResponse(
        String resourceGroupName, String provisioningServiceName, Context context) {
        return getWithResponseAsync(resourceGroupName, provisioningServiceName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProvisioningServiceDescriptionInner>> listBySubscriptionSinglePageAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<ProvisioningServiceDescriptionInner> listBySubscriptionAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProvisioningServiceDescriptionInner> listBySubscriptionAsync(Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProvisioningServiceDescriptionInner> listBySubscription() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProvisioningServiceDescriptionInner> listBySubscription(Context context) {
    ...
    private Mono<Response<NameAvailabilityInfoInner>> checkProvisioningServiceNameAvailabilityWithResponseAsync(
        ...
        return service
            .checkProvisioningServiceNameAvailability(
                this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion, arguments, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ProvisioningServiceDescriptionAutoGeneratedInner>> getWithResponseAsync(
        String provisioningServiceName, String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProvisioningServiceDescriptionAutoGeneratedInner> getAsync(
        String provisioningServiceName, String resourceGroupName) {
        return getWithResponseAsync(provisioningServiceName, resourceGroupName)
            .flatMap(
                (Response<ProvisioningServiceDescriptionAutoGeneratedInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProvisioningServiceDescriptionAutoGeneratedInner get(
        String provisioningServiceName, String resourceGroupName) {
        return getAsync(provisioningServiceName, resourceGroupName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ProvisioningServiceDescriptionAutoGeneratedInner> getWithResponse(
        String provisioningServiceName, String resourceGroupName, Context context) {
        return getWithResponseAsync(provisioningServiceName, resourceGroupName, context).block();
    }
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName,
        String provisioningServiceName,
        ProvisioningServiceDescriptionAutoGeneratedInner iotDpsDescription) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<
            PollResult<ProvisioningServiceDescriptionAutoGeneratedInner>,
            ProvisioningServiceDescriptionAutoGeneratedInner>
        beginCreateOrUpdateAsync(
            String resourceGroupName,
            String provisioningServiceName,
            ProvisioningServiceDescriptionAutoGeneratedInner iotDpsDescription) {
        ...
        return this
            .client
            .<ProvisioningServiceDescriptionAutoGeneratedInner, ProvisioningServiceDescriptionAutoGeneratedInner>
                getLroResult(
                    mono,
                    this.client.getHttpPipeline(),
                    ProvisioningServiceDescriptionAutoGeneratedInner.class,
                    ProvisioningServiceDescriptionAutoGeneratedInner.class,
                    Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProvisioningServiceDescriptionAutoGeneratedInner> createOrUpdateAsync(
        String resourceGroupName,
        String provisioningServiceName,
        ProvisioningServiceDescriptionAutoGeneratedInner iotDpsDescription) {
        return beginCreateOrUpdateAsync(resourceGroupName, provisioningServiceName, iotDpsDescription)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProvisioningServiceDescriptionAutoGeneratedInner createOrUpdate(
        String resourceGroupName,
        String provisioningServiceName,
        ProvisioningServiceDescriptionAutoGeneratedInner iotDpsDescription) {
        return createOrUpdateAsync(resourceGroupName, provisioningServiceName, iotDpsDescription).block();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ProvisioningServiceDescriptionAutoGeneratedInner> updateAsync(
        String resourceGroupName, String provisioningServiceName, TagsResource provisioningServiceTags) {
        return beginUpdateAsync(resourceGroupName, provisioningServiceName, provisioningServiceTags)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ProvisioningServiceDescriptionAutoGeneratedInner update(
        String resourceGroupName, String provisioningServiceName, TagsResource provisioningServiceTags) {
        return updateAsync(resourceGroupName, provisioningServiceName, provisioningServiceTags).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProvisioningServiceDescriptionAutoGeneratedInner>> listBySubscriptionSinglePageAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
            ...
            .withContext(
                context ->
                    service
                        .listBySubscription(
                            this.client.getEndpoint(), this.client.getSubscriptionId(), apiVersion, accept, context))
            .<PagedResponse<ProvisioningServiceDescriptionAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProvisioningServiceDescriptionAutoGeneratedInner> listBySubscriptionAsync() {
        return new PagedFlux<>(
            () -> listBySubscriptionSinglePageAsync(), nextLink -> listBySubscriptionNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProvisioningServiceDescriptionAutoGeneratedInner> listBySubscriptionAsync(Context context) {
        return new PagedFlux<>(
            () -> listBySubscriptionSinglePageAsync(context),
            nextLink -> listBySubscriptionNextSinglePageAsync(nextLink, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> listBySubscription() {
        return new PagedIterable<>(listBySubscriptionAsync());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> listBySubscription(Context context) {
        return new PagedIterable<>(listBySubscriptionAsync(context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ProvisioningServiceDescriptionAutoGeneratedInner>> listByResourceGroupSinglePageAsync(
        String resourceGroupName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ProvisioningServiceDescriptionAutoGeneratedInner> listByResourceGroupAsync(
        String resourceGroupName) {
        return new PagedFlux<>(
            () -> listByResourceGroupSinglePageAsync(resourceGroupName),
            nextLink -> listByResourceGroupNextSinglePageAsync(nextLink));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> listByResourceGroup(
        String resourceGroupName) {
        return new PagedIterable<>(listByResourceGroupAsync(resourceGroupName));
    }
