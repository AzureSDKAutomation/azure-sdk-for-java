...
/** An instance of this class provides access to all the operations defined in DpsCertificateAuthoritiesClient. */
public final class DpsCertificateAuthoritiesClientImpl implements DpsCertificateAuthoritiesClient {
    private final ClientLogger logger = new ClientLogger(DpsCertificateAuthoritiesClientImpl.class);

    /** The proxy service used to perform REST calls. */
    private final DpsCertificateAuthoritiesService service;

    /** The service client containing this operation class. */
    private final IotDpsClientImpl client;

    /**
     * Initializes an instance of DpsCertificateAuthoritiesClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DpsCertificateAuthoritiesClientImpl(IotDpsClientImpl client) {
        this.service =
            RestProxy
                .create(
                    DpsCertificateAuthoritiesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for IotDpsClientDpsCertificateAuthorities to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "IotDpsClientDpsCerti")
    private interface DpsCertificateAuthoritiesService {
        @Headers({"Content-Type: application/json"})
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices"
                + "/provisioningServices/{provisioningServiceName}/certificateAuthorities/{certificateName}")
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices"
                + "/provisioningServices/{provisioningServiceName}/certificateAuthorities")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorDetailsException.class)
