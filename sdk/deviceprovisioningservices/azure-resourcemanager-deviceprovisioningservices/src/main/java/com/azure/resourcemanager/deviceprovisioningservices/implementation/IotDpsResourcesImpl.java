...
public final class IotDpsResourcesImpl implements IotDpsResources {
    ...
    public ProvisioningServiceDescription get(String resourceGroupName, String provisioningServiceName) {
        ProvisioningServiceDescriptionInner inner =
            this.serviceClient().get(resourceGroupName, provisioningServiceName);
        if (inner != null) {
    ...
    public Response<ProvisioningServiceDescription> getWithResponse(
        ...
        Response<ProvisioningServiceDescriptionInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, provisioningServiceName, context);
        if (inner != null) {
    ...
    public PagedIterable<ProvisioningServiceDescription> listBySubscription() {
        PagedIterable<ProvisioningServiceDescriptionInner> inner = this.serviceClient().listBySubscription();
        return inner.mapPage(inner1 -> new ProvisioningServiceDescriptionImpl(inner1, this.manager()));
    }

    public PagedIterable<ProvisioningServiceDescription> listBySubscription(Context context) {
        PagedIterable<ProvisioningServiceDescriptionInner> inner = this.serviceClient().listBySubscription(context);
        return inner.mapPage(inner1 -> new ProvisioningServiceDescriptionImpl(inner1, this.manager()));
    }
    ...
    public ProvisioningServiceDescriptionAutoGenerated get(String provisioningServiceName, String resourceGroupName) {
        ProvisioningServiceDescriptionAutoGeneratedInner inner =
            this.serviceClient().get(provisioningServiceName, resourceGroupName);
        if (inner != null) {
            return new ProvisioningServiceDescriptionAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<ProvisioningServiceDescriptionAutoGenerated> getWithResponse(
        String provisioningServiceName, String resourceGroupName, Context context) {
        Response<ProvisioningServiceDescriptionAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(provisioningServiceName, resourceGroupName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new ProvisioningServiceDescriptionAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public PagedIterable<ProvisioningServiceDescriptionAutoGenerated> listBySubscription() {
        PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> inner =
            this.serviceClient().listBySubscription();
        return inner.mapPage(inner1 -> new ProvisioningServiceDescriptionAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ProvisioningServiceDescriptionAutoGenerated> listBySubscription(Context context) {
        PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> inner =
            this.serviceClient().listBySubscription(context);
        return inner.mapPage(inner1 -> new ProvisioningServiceDescriptionAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ProvisioningServiceDescriptionAutoGenerated> listByResourceGroup(String resourceGroupName) {
        PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> inner =
            this.serviceClient().listByResourceGroup(resourceGroupName);
        return inner.mapPage(inner1 -> new ProvisioningServiceDescriptionAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<ProvisioningServiceDescriptionAutoGenerated> listByResourceGroup(
        String resourceGroupName, Context context) {
        PagedIterable<ProvisioningServiceDescriptionAutoGeneratedInner> inner =
            this.serviceClient().listByResourceGroup(resourceGroupName, context);
        return inner.mapPage(inner1 -> new ProvisioningServiceDescriptionAutoGeneratedImpl(inner1, this.manager()));
    ...
    public ProvisioningServiceDescription getById(String id) {
        ...
        return this.getWithResponse(resourceGroupName, provisioningServiceName, Context.NONE).getValue();
    }
    ...
    public Response<ProvisioningServiceDescription> getByIdWithResponse(String id, Context context) {
        ...
        return this.getWithResponse(resourceGroupName, provisioningServiceName, context);
    }
    ...
    public ProvisioningServiceDescriptionAutoGeneratedImpl define(String name) {
        return new ProvisioningServiceDescriptionAutoGeneratedImpl(name, this.manager());
    }
