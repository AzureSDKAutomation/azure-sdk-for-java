...
public final class CertificateResponseImpl
    ...
    CertificateResponseImpl(String name, IotDpsManager serviceManager) {
    ...
    CertificateResponseImpl(CertificateResponseInner innerObject, IotDpsManager serviceManager) {
