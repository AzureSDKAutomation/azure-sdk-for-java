...
public final class IotDpsClientImpl implements IotDpsClient {
    ...
    /** The DpsCertificateAuthoritiesClient object to access its operations. */
    private final DpsCertificateAuthoritiesClient dpsCertificateAuthorities;

    /**
     * Gets the DpsCertificateAuthoritiesClient object to access its operations.
     *
     * @return the DpsCertificateAuthoritiesClient object.
     */
    public DpsCertificateAuthoritiesClient getDpsCertificateAuthorities() {
        return this.dpsCertificateAuthorities;
    }
    ...
    IotDpsClientImpl(
        ...
        this.dpsCertificateAuthorities = new DpsCertificateAuthoritiesClientImpl(this);
