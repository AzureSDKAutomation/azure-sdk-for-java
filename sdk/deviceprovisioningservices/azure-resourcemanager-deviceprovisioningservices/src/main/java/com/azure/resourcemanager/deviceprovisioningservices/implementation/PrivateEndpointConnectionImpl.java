...
public final class PrivateEndpointConnectionImpl
    ...
    PrivateEndpointConnectionImpl(String name, IotDpsManager serviceManager) {
    ...
    PrivateEndpointConnectionImpl(PrivateEndpointConnectionInner innerObject, IotDpsManager serviceManager) {
