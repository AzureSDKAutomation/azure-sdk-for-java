...
@Fluent
public final class EncryptionPropertiesDescriptionAutoGenerated {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(EncryptionPropertiesDescriptionAutoGenerated.class);
     ...
     * @return the EncryptionPropertiesDescriptionAutoGenerated object itself.
     */
    public EncryptionPropertiesDescriptionAutoGenerated withKeySource(String keySource) {
     ...
     * @return the EncryptionPropertiesDescriptionAutoGenerated object itself.
     */
    public EncryptionPropertiesDescriptionAutoGenerated withKeyVaultProperties(
