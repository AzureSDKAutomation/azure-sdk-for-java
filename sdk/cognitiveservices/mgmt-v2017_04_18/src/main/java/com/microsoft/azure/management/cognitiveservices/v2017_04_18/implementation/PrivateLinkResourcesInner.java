...
public class PrivateLinkResourcesInner {
    ...
    private ServiceResponse<PrivateLinkResourceListResultInner> listDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PrivateLinkResourceListResultInner, ErrorException>newInstance(this.client.serializerAdapter())
