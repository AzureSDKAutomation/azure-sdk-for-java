...
import com.azure.resourcemanager.providerhub.models.CustomRolloutArrayResponseWithContinuationAutoGenerated;
...
public final class CustomRolloutsClientImpl implements CustomRolloutsClient {
    ...
    private interface CustomRolloutsService {
        ...
        Mono<Response<CustomRolloutAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("providerNamespace") String providerNamespace,
            @PathParam("rolloutName") String rolloutName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorAutoGeneratedException.class)
        Mono<Response<CustomRolloutAutoGeneratedInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("providerNamespace") String providerNamespace,
            @PathParam("rolloutName") String rolloutName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorAutoGeneratedException.class)
        Mono<Response<CustomRolloutArrayResponseWithContinuationAutoGenerated>> listByProviderRegistration(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("providerNamespace") String providerNamespace,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<CustomRolloutInner> createOrUpdateAsync(String providerNamespace, String rolloutName) {
        return createOrUpdateWithResponseAsync(providerNamespace, rolloutName)
            .flatMap(
                (Response<CustomRolloutInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Response<CustomRolloutInner> createOrUpdateWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        return createOrUpdateWithResponseAsync(providerNamespace, rolloutName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomRolloutAutoGeneratedInner>> getWithResponseAsync(
        String providerNamespace, String rolloutName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomRolloutAutoGeneratedInner> getAsync(String providerNamespace, String rolloutName) {
        return getWithResponseAsync(providerNamespace, rolloutName)
            .flatMap(
                (Response<CustomRolloutAutoGeneratedInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomRolloutAutoGeneratedInner get(String providerNamespace, String rolloutName) {
        return getAsync(providerNamespace, rolloutName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomRolloutAutoGeneratedInner> getWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        return getWithResponseAsync(providerNamespace, rolloutName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomRolloutAutoGeneratedInner>> createOrUpdateWithResponseAsync(
        String providerNamespace, String rolloutName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CustomRolloutAutoGeneratedInner> createOrUpdateAsync(String providerNamespace, String rolloutName) {
        return createOrUpdateWithResponseAsync(providerNamespace, rolloutName)
            .flatMap(
                (Response<CustomRolloutAutoGeneratedInner> res) -> {
                    if (res.getValue() != null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomRolloutAutoGeneratedInner createOrUpdate(String providerNamespace, String rolloutName) {
        return createOrUpdateAsync(providerNamespace, rolloutName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CustomRolloutAutoGeneratedInner> createOrUpdateWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        return createOrUpdateWithResponseAsync(providerNamespace, rolloutName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CustomRolloutAutoGeneratedInner>> listByProviderRegistrationSinglePageAsync(
        String providerNamespace) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByProviderRegistration(
                            ...
                            accept,
                            context))
            .<PagedResponse<CustomRolloutAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CustomRolloutAutoGeneratedInner> listByProviderRegistrationAsync(String providerNamespace) {
        return new PagedFlux<>(
            () -> listByProviderRegistrationSinglePageAsync(providerNamespace),
            nextLink -> listByProviderRegistrationNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CustomRolloutAutoGeneratedInner> listByProviderRegistrationAsync(
        String providerNamespace, Context context) {
        return new PagedFlux<>(
            () -> listByProviderRegistrationSinglePageAsync(providerNamespace, context),
            nextLink -> listByProviderRegistrationNextSinglePageAsync(nextLink, context));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CustomRolloutAutoGeneratedInner> listByProviderRegistration(String providerNamespace) {
        return new PagedIterable<>(listByProviderRegistrationAsync(providerNamespace));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CustomRolloutAutoGeneratedInner> listByProviderRegistration(
        String providerNamespace, Context context) {
        return new PagedIterable<>(listByProviderRegistrationAsync(providerNamespace, context));
    }
