...
/** The RolloutStatusBaseAutoGenerated model. */
@Fluent
public class RolloutStatusBaseAutoGenerated {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RolloutStatusBaseAutoGenerated.class);
     ...
     * @return the RolloutStatusBaseAutoGenerated object itself.
     */
    public RolloutStatusBaseAutoGenerated withCompletedRegions(List<String> completedRegions) {
     ...
     * @return the RolloutStatusBaseAutoGenerated object itself.
     */
    public RolloutStatusBaseAutoGenerated withFailedOrSkippedRegions(
