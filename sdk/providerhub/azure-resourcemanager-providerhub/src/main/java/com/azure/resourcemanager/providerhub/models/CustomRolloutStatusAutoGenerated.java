...
/** The CustomRolloutStatusAutoGenerated model. */
@Fluent
public class CustomRolloutStatusAutoGenerated {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(CustomRolloutStatusAutoGenerated.class);
    ...
    private Map<String, ExtendedErrorInfoAutoGenerated> failedOrSkippedRegions;
     ...
     * @return the CustomRolloutStatusAutoGenerated object itself.
     */
    public CustomRolloutStatusAutoGenerated withCompletedRegions(List<String> completedRegions) {
     ...
     */
    public Map<String, ExtendedErrorInfoAutoGenerated> failedOrSkippedRegions() {
     ...
     * @return the CustomRolloutStatusAutoGenerated object itself.
     */
    public CustomRolloutStatusAutoGenerated withFailedOrSkippedRegions(
