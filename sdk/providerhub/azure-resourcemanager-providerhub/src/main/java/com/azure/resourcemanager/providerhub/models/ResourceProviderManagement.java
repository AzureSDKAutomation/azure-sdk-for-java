...
public class ResourceProviderManagement {
    ...
    private List<Map<String, String>> resourceAccessRoles;
     ...
     */
    public List<Map<String, String>> resourceAccessRoles() {
     ...
     * @return the ResourceProviderManagement object itself.
     */
    public ResourceProviderManagement withResourceAccessRoles(List<Map<String, String>> resourceAccessRoles) {
