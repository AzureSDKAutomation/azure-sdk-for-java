...
public final class CustomRolloutImpl implements CustomRollout, CustomRollout.Definition, CustomRollout.Update {
    ...
    public CustomRolloutProperties properties() {
        CustomRolloutPropertiesInner inner = this.innerModel().properties();
        if (inner != null) {
            return new CustomRolloutPropertiesImpl(inner, this.manager());
        } else {
            return null;
        }
    }
    ...
    public CustomRolloutImpl withProperties(CustomRolloutPropertiesInner properties) {
