...
import com.azure.resourcemanager.providerhub.models.DefaultRolloutArrayResponseWithContinuationAutoGenerated;
...
public final class DefaultRolloutsClientImpl implements DefaultRolloutsClient {
    ...
    private interface DefaultRolloutsService {
        ...
        Mono<Response<DefaultRolloutAutoGeneratedInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("providerNamespace") String providerNamespace,
            @PathParam("rolloutName") String rolloutName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ErrorAutoGeneratedException.class)
        Mono<Response<DefaultRolloutArrayResponseWithContinuationAutoGenerated>> listByProviderRegistration(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("providerNamespace") String providerNamespace,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<DefaultRolloutAutoGeneratedInner>> getWithResponseAsync(
        String providerNamespace, String rolloutName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DefaultRolloutAutoGeneratedInner> getAsync(String providerNamespace, String rolloutName) {
        return getWithResponseAsync(providerNamespace, rolloutName)
            .flatMap(
                (Response<DefaultRolloutAutoGeneratedInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DefaultRolloutAutoGeneratedInner get(String providerNamespace, String rolloutName) {
        return getAsync(providerNamespace, rolloutName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<DefaultRolloutAutoGeneratedInner> getWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        return getWithResponseAsync(providerNamespace, rolloutName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<DefaultRolloutAutoGeneratedInner>, DefaultRolloutAutoGeneratedInner>
        beginCreateOrUpdateAsync(String providerNamespace, String rolloutName) {
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(providerNamespace, rolloutName);
        return this
            .client
            .<DefaultRolloutAutoGeneratedInner, DefaultRolloutAutoGeneratedInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                DefaultRolloutAutoGeneratedInner.class,
                DefaultRolloutAutoGeneratedInner.class,
                Context.NONE);
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<DefaultRolloutAutoGeneratedInner>, DefaultRolloutAutoGeneratedInner>
        beginCreateOrUpdateAsync(String providerNamespace, String rolloutName, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(providerNamespace, rolloutName, context);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<DefaultRolloutAutoGeneratedInner>, DefaultRolloutAutoGeneratedInner>
        beginCreateOrUpdate(String providerNamespace, String rolloutName) {
        return beginCreateOrUpdateAsync(providerNamespace, rolloutName).getSyncPoller();
    }
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<DefaultRolloutAutoGeneratedInner>, DefaultRolloutAutoGeneratedInner>
        beginCreateOrUpdate(String providerNamespace, String rolloutName, Context context) {
        return beginCreateOrUpdateAsync(providerNamespace, rolloutName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DefaultRolloutAutoGeneratedInner> createOrUpdateAsync(String providerNamespace, String rolloutName) {
        return beginCreateOrUpdateAsync(providerNamespace, rolloutName)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<DefaultRolloutAutoGeneratedInner> createOrUpdateAsync(
        String providerNamespace, String rolloutName, Context context) {
        return beginCreateOrUpdateAsync(providerNamespace, rolloutName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DefaultRolloutAutoGeneratedInner createOrUpdate(String providerNamespace, String rolloutName) {
        return createOrUpdateAsync(providerNamespace, rolloutName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DefaultRolloutAutoGeneratedInner createOrUpdate(
        String providerNamespace, String rolloutName, Context context) {
        return createOrUpdateAsync(providerNamespace, rolloutName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<DefaultRolloutAutoGeneratedInner>> listByProviderRegistrationSinglePageAsync(
        String providerNamespace) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                ...
                context ->
                    service
                        .listByProviderRegistration(
                            ...
                            accept,
                            context))
            .<PagedResponse<DefaultRolloutAutoGeneratedInner>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DefaultRolloutAutoGeneratedInner> listByProviderRegistrationAsync(String providerNamespace) {
        return new PagedFlux<>(
            () -> listByProviderRegistrationSinglePageAsync(providerNamespace),
            nextLink -> listByProviderRegistrationNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<DefaultRolloutAutoGeneratedInner> listByProviderRegistrationAsync(
        String providerNamespace, Context context) {
        return new PagedFlux<>(
            () -> listByProviderRegistrationSinglePageAsync(providerNamespace, context),
            nextLink -> listByProviderRegistrationNextSinglePageAsync(nextLink, context));
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DefaultRolloutAutoGeneratedInner> listByProviderRegistration(String providerNamespace) {
        return new PagedIterable<>(listByProviderRegistrationAsync(providerNamespace));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DefaultRolloutAutoGeneratedInner> listByProviderRegistration(
        String providerNamespace, Context context) {
        return new PagedIterable<>(listByProviderRegistrationAsync(providerNamespace, context));
    }
