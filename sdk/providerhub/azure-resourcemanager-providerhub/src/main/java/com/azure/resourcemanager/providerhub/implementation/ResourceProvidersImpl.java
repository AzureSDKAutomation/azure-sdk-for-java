...
import com.azure.resourcemanager.providerhub.models.ResourceProviderManifestAutoGenerated;
...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public CheckinManifestInfo checkinManifest(String providerNamespace) {
        CheckinManifestInfoInner inner = this.serviceClient().checkinManifest(providerNamespace);
        if (inner != null) {
    ...
    public Response<CheckinManifestInfo> checkinManifestWithResponse(String providerNamespace, Context context) {
        Response<CheckinManifestInfoInner> inner =
            this.serviceClient().checkinManifestWithResponse(providerNamespace, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public ResourceProviderManifestAutoGenerated generateManifest(String providerNamespace) {
        ResourceProviderManifestAutoGeneratedInner inner = this.serviceClient().generateManifest(providerNamespace);
        if (inner != null) {
            return new ResourceProviderManifestAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<ResourceProviderManifestAutoGenerated> generateManifestWithResponse(
        String providerNamespace, Context context) {
        Response<ResourceProviderManifestAutoGeneratedInner> inner =
            this.serviceClient().generateManifestWithResponse(providerNamespace, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new ResourceProviderManifestAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
