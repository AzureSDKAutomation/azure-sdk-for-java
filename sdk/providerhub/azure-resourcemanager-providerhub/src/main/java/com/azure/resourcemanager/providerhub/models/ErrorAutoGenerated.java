...
@Immutable
public class ErrorAutoGenerated extends ManagementError {
    ...
    private List<ErrorAutoGenerated> details;
     ...
     */
    public List<ErrorAutoGenerated> getDetails() {
        return this.details;
    }
     ...
     */
    public InnerErrorAutoGenerated getInnerError() {
