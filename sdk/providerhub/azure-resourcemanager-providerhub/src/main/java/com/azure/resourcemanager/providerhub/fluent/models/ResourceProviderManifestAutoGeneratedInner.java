...
import com.azure.resourcemanager.providerhub.models.ResourceProviderManagementAutoGenerated;
...
/** The ResourceProviderManifestAutoGenerated model. */
@Fluent
public final class ResourceProviderManifestAutoGeneratedInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ResourceProviderManifestAutoGeneratedInner.class);
    ...
    private ResourceProviderManagementAutoGenerated management;
    ...
    private ReRegisterSubscriptionMetadata reRegisterSubscriptionMetadata;
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withProviderAuthentication(
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withProviderAuthorizations(
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withNamespace(String namespace) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withProviderVersion(String providerVersion) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withProviderType(ResourceProviderType providerType) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withRequiredFeatures(List<String> requiredFeatures) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withFeaturesRule(FeaturesRule featuresRule) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withRequestHeaderOptions(
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withResourceTypes(List<ResourceType> resourceTypes) {
     ...
     */
    public ResourceProviderManagementAutoGenerated management() {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withManagement(
        ResourceProviderManagementAutoGenerated management) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withCapabilities(
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withMetadata(Object metadata) {
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withGlobalNotificationEndpoints(
     ...
     * @return the ResourceProviderManifestAutoGeneratedInner object itself.
     */
    public ResourceProviderManifestAutoGeneratedInner withReRegisterSubscriptionMetadata(
