...
public final class CustomRolloutsImpl implements CustomRollouts {
    ...
    public CustomRollout createOrUpdate(String providerNamespace, String rolloutName) {
        CustomRolloutInner inner = this.serviceClient().createOrUpdate(providerNamespace, rolloutName);
        if (inner != null) {
            return new CustomRolloutImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<CustomRollout> createOrUpdateWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        Response<CustomRolloutInner> inner =
            this.serviceClient().createOrUpdateWithResponse(providerNamespace, rolloutName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PagedIterable<CustomRollout> listByProviderRegistration(String providerNamespace) {
        ...
        return inner.mapPage(inner1 -> new CustomRolloutImpl(inner1, this.manager()));
    }
    ...
    public CustomRolloutAutoGenerated get(String providerNamespace, String rolloutName) {
        CustomRolloutAutoGeneratedInner inner = this.serviceClient().get(providerNamespace, rolloutName);
        if (inner != null) {
            return new CustomRolloutAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<CustomRolloutAutoGenerated> getWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        Response<CustomRolloutAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(providerNamespace, rolloutName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new CustomRolloutAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }

    public CustomRolloutAutoGenerated createOrUpdate(String providerNamespace, String rolloutName) {
        CustomRolloutAutoGeneratedInner inner = this.serviceClient().createOrUpdate(providerNamespace, rolloutName);
        if (inner != null) {
            return new CustomRolloutAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<CustomRolloutAutoGenerated> createOrUpdateWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        Response<CustomRolloutAutoGeneratedInner> inner =
            this.serviceClient().createOrUpdateWithResponse(providerNamespace, rolloutName, context);
        if (inner != null) {
    ...
    public PagedIterable<CustomRolloutAutoGenerated> listByProviderRegistration(String providerNamespace) {
        PagedIterable<CustomRolloutAutoGeneratedInner> inner =
            this.serviceClient().listByProviderRegistration(providerNamespace);
        return inner.mapPage(inner1 -> new CustomRolloutAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<CustomRolloutAutoGenerated> listByProviderRegistration(
