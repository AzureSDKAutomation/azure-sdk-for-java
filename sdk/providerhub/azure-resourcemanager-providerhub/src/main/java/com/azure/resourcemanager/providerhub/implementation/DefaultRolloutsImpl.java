...
public final class DefaultRolloutsImpl implements DefaultRollouts {
    ...
    public PagedIterable<DefaultRollout> listByProviderRegistration(String providerNamespace) {
        ...
        return inner.mapPage(inner1 -> new DefaultRolloutImpl(inner1, this.manager()));
    }
    ...
    public DefaultRolloutAutoGenerated get(String providerNamespace, String rolloutName) {
        DefaultRolloutAutoGeneratedInner inner = this.serviceClient().get(providerNamespace, rolloutName);
        if (inner != null) {
            return new DefaultRolloutAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<DefaultRolloutAutoGenerated> getWithResponse(
        String providerNamespace, String rolloutName, Context context) {
        Response<DefaultRolloutAutoGeneratedInner> inner =
            this.serviceClient().getWithResponse(providerNamespace, rolloutName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new DefaultRolloutAutoGeneratedImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public DefaultRolloutAutoGenerated createOrUpdate(String providerNamespace, String rolloutName) {
        DefaultRolloutAutoGeneratedInner inner = this.serviceClient().createOrUpdate(providerNamespace, rolloutName);
        if (inner != null) {
            return new DefaultRolloutAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public DefaultRolloutAutoGenerated createOrUpdate(String providerNamespace, String rolloutName, Context context) {
        DefaultRolloutAutoGeneratedInner inner =
            this.serviceClient().createOrUpdate(providerNamespace, rolloutName, context);
        if (inner != null) {
            return new DefaultRolloutAutoGeneratedImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<DefaultRolloutAutoGenerated> listByProviderRegistration(String providerNamespace) {
        PagedIterable<DefaultRolloutAutoGeneratedInner> inner =
            this.serviceClient().listByProviderRegistration(providerNamespace);
        return inner.mapPage(inner1 -> new DefaultRolloutAutoGeneratedImpl(inner1, this.manager()));
    }

    public PagedIterable<DefaultRolloutAutoGenerated> listByProviderRegistration(
