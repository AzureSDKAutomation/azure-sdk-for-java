...
/** The ResourceProviderManagementAutoGenerated model. */
@Fluent
public class ResourceProviderManagementAutoGenerated {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ResourceProviderManagementAutoGenerated.class);
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withSchemaOwners(List<String> schemaOwners) {
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withManifestOwners(List<String> manifestOwners) {
        this.manifestOwners = manifestOwners;
        return this;
    }

    /**
     * Get the securityGroups property: The securityGroups property.
     *
    ...
    /**
     * Set the securityGroups property: The securityGroups property.
     *
     * @param securityGroups the securityGroups value to set.
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withSecurityGroups(List<String> securityGroups) {
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withIncidentRoutingService(String incidentRoutingService) {
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withIncidentRoutingTeam(String incidentRoutingTeam) {
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withIncidentContactEmail(String incidentContactEmail) {
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withServiceTreeInfos(List<ServiceTreeInfo> serviceTreeInfos) {
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withResourceAccessPolicy(
     ...
     * @return the ResourceProviderManagementAutoGenerated object itself.
     */
    public ResourceProviderManagementAutoGenerated withResourceAccessRoles(List<Object> resourceAccessRoles) {
