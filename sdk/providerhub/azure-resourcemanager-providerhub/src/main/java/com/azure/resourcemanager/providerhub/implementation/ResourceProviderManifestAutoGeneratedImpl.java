...
public final class ResourceProviderManifestAutoGeneratedImpl implements ResourceProviderManifestAutoGenerated {
    private ResourceProviderManifestAutoGeneratedInner innerObject;

    private final ProviderhubManager serviceManager;

    ResourceProviderManifestAutoGeneratedImpl(
        ResourceProviderManifestAutoGeneratedInner innerObject, ProviderhubManager serviceManager) {
    ...
    public ResourceProviderManifestAutoGeneratedInner innerModel() {
