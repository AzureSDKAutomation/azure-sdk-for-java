...
import com.azure.resourcemanager.providerhub.implementation.ResourceTypeRegistrationOperationsImpl;
...
public final class ProviderhubManager {
    ...
    private ResourceTypeRegistrationOperations resourceTypeRegistrationOperations;
    ...
    /** @return Resource collection API of ResourceTypeRegistrationOperations. */
    public ResourceTypeRegistrationOperations resourceTypeRegistrationOperations() {
        if (this.resourceTypeRegistrationOperations == null) {
            this.resourceTypeRegistrationOperations =
                new ResourceTypeRegistrationOperationsImpl(clientObject.getResourceTypeRegistrationOperations(), this);
        }
        return resourceTypeRegistrationOperations;
    }
