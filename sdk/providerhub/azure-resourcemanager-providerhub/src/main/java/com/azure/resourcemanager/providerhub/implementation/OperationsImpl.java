...
public final class OperationsImpl implements Operations {
    ...
    public PagedIterable<OperationsDefinition> list() {
        ...
        return inner.mapPage(inner1 -> new OperationsDefinitionImpl(inner1, this.manager()));
    }
    ...
    public OperationsContent createOrUpdate(String providerNamespace) {
        OperationsContentInner inner = this.serviceClient().createOrUpdate(providerNamespace);
        if (inner != null) {
    ...
    public Response<OperationsContent> createOrUpdateWithResponse(String providerNamespace, Context context) {
        Response<OperationsContentInner> inner =
            this.serviceClient().createOrUpdateWithResponse(providerNamespace, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
