...
/** The CustomRolloutSpecificationAutoGenerated model. */
@Fluent
public class CustomRolloutSpecificationAutoGeneratedInner {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(CustomRolloutSpecificationAutoGeneratedInner.class);
     ...
     * @return the CustomRolloutSpecificationAutoGeneratedInner object itself.
     */
    public CustomRolloutSpecificationAutoGeneratedInner withCanary(TrafficRegions canary) {
        this.canary = canary;
        return this;
    }
     ...
     * @return the CustomRolloutSpecificationAutoGeneratedInner object itself.
     */
    public CustomRolloutSpecificationAutoGeneratedInner withProviderRegistration(
     ...
     * @return the CustomRolloutSpecificationAutoGeneratedInner object itself.
     */
    public CustomRolloutSpecificationAutoGeneratedInner withResourceTypeRegistrations(
            ...
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property canary in model CustomRolloutSpecificationAutoGeneratedInner"));
        } else {
            canary().validate();
        }
