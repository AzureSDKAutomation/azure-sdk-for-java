...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public OperationsContentInner createOrUpdate(String providerNamespace) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<OperationsContentInner> createOrUpdateWithResponse(String providerNamespace, Context context) {
        return createOrUpdateWithResponseAsync(providerNamespace, context).block();
    }
