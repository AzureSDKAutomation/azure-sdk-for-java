...
public interface WebAppsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SiteAuthSettingsInner validateConfigBeforeUpgradeToSiteAuthSettingsV2(String resourceGroupName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SiteAuthSettingsInner> validateConfigBeforeUpgradeToSiteAuthSettingsV2WithResponse(
        String resourceGroupName, String name, Context context);
    ...
    /**
     * Description for Refreshes a web app's Key Vault References to the latest non-specified version and restarts the
     * web app if needed.
     *
     * @param resourceGroupName Name of the resource group to which the resource belongs.
     * @param name Name of the app.
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ApiKVReferenceInner> refreshKeyVaultReferencesForSite(String resourceGroupName, String name);
     ...
     * @param resourceGroupName Name of the resource group to which the resource belongs.
     * @param name Name of the app.
     * @param forceRestart The forceRestart parameter.
     * @param context The context to associate with this operation.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws com.azure.resourcemanager.appservice.generated.models.DefaultErrorResponseErrorException thrown if the
     *     request is rejected by server.
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ApiKVReferenceInner> refreshKeyVaultReferencesForSite(
     ...
     *     request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return array of RemotePrivateEndpointConnectionWrapper.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<RemotePrivateEndpointConnectionWrapperInner> getPrivateEndpointConnectionList(
        String resourceGroupName, String name);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<List<RemotePrivateEndpointConnectionWrapperInner>> getPrivateEndpointConnectionListWithResponse(
        String resourceGroupName, String name, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SiteAuthSettingsInner validateConfigBeforeUpgradeToSiteAuthSettingsV2Slot(
        String resourceGroupName, String name, String slot);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SiteAuthSettingsInner> validateConfigBeforeUpgradeToSiteAuthSettingsV2SlotWithResponse(
        String resourceGroupName, String name, String slot, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ApiKVReferenceInner> refreshKeyVaultReferencesForSiteSlot(
        String resourceGroupName, String name, String slot);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<RemotePrivateEndpointConnectionWrapperInner> getPrivateEndpointConnectionListSlot(
        String resourceGroupName, String name, String slot);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<List<RemotePrivateEndpointConnectionWrapperInner>> getPrivateEndpointConnectionListSlotWithResponse(
        String resourceGroupName, String name, String slot, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateEndpointConnectionResourceInner getPrivateEndpointConnectionSlot(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateEndpointConnectionResourceInner> getPrivateEndpointConnectionSlotWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    PrivateEndpointConnectionResourceInner approveOrRejectPrivateEndpointConnectionSlot(
        String resourceGroupName,
        String name,
        String privateEndpointConnectionName,
        String slot,
