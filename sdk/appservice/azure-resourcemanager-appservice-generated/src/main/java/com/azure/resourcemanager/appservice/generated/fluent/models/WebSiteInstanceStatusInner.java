...
public class WebSiteInstanceStatusInner extends ProxyOnlyResource {
    ...
    /**
     * Get the consoleUrl property: Link to the console to webapp instance.
     *
    ...
    /**
     * Set the consoleUrl property: Link to the console to webapp instance.
     *
    ...
    /**
     * Get the healthCheckUrl property: Link to the console to webapp instance.
     *
    ...
    /**
     * Set the healthCheckUrl property: Link to the console to webapp instance.
     *
