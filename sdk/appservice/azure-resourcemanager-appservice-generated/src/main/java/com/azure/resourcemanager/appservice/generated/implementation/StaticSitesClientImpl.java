...
public final class StaticSitesClientImpl implements StaticSitesClient {
    ...
    private interface StaticSitesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Void>> createZipDeploymentForStaticSiteBuild(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("environmentName") String environmentName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<PrivateEndpointConnectionResourceAutoGeneratedInner>> getPrivateEndpointConnection(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<StaticSiteUserProvidedFunctionAppArmResourceInner>> registerUserProvidedFunctionAppWithStaticSite(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("functionAppName") String functionAppName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Void>> createZipDeploymentForStaticSite(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
            @PathParam("subscriptionId") String subscriptionId,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> createZipDeploymentForStaticSiteBuildWithResponseAsync(
        String resourceGroupName,
        String name,
        String environmentName,
    ...
    private Mono<Void> createZipDeploymentForStaticSiteBuildAsync(
        ...
        String environmentName,
        StaticSiteZipDeploymentArmResource staticSiteZipDeploymentEnvelope) {
        return createZipDeploymentForStaticSiteBuildWithResponseAsync(
    ...
    private Mono<StaticSiteUserProvidedFunctionAppArmResourceInner>
        registerUserProvidedFunctionAppWithStaticSiteBuildAsync(
            ...
            StaticSiteUserProvidedFunctionAppArmResourceInner staticSiteUserProvidedFunctionEnvelope,
            Boolean isForced) {
        return registerUserProvidedFunctionAppWithStaticSiteBuildWithResponseAsync(
                resourceGroupName,
                name,
                environmentName,
                functionAppName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateEndpointConnectionResourceAutoGeneratedInner>>
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionResourceAutoGeneratedInner> getPrivateEndpointConnectionAsync(
        String resourceGroupName, String name, String privateEndpointConnectionName) {
        return getPrivateEndpointConnectionWithResponseAsync(resourceGroupName, name, privateEndpointConnectionName)
            .flatMap(
                (Response<PrivateEndpointConnectionResourceAutoGeneratedInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateEndpointConnectionResourceAutoGeneratedInner getPrivateEndpointConnection(
        String resourceGroupName, String name, String privateEndpointConnectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateEndpointConnectionResourceAutoGeneratedInner> getPrivateEndpointConnectionWithResponse(
        String resourceGroupName, String name, String privateEndpointConnectionName, Context context) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<
            PollResult<PrivateEndpointConnectionResourceAutoGeneratedInner>,
            PrivateEndpointConnectionResourceAutoGeneratedInner>
        ...
        return this
            .client
            .<PrivateEndpointConnectionResourceAutoGeneratedInner, PrivateEndpointConnectionResourceAutoGeneratedInner>
                getLroResult(
                    mono,
                    this.client.getHttpPipeline(),
                    PrivateEndpointConnectionResourceAutoGeneratedInner.class,
                    PrivateEndpointConnectionResourceAutoGeneratedInner.class,
                    Context.NONE);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionResourceAutoGeneratedInner> approveOrRejectPrivateEndpointConnectionAsync(
        String resourceGroupName,
        String name,
        String privateEndpointConnectionName,
        PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateEndpointConnectionResourceAutoGeneratedInner approveOrRejectPrivateEndpointConnection(
        String resourceGroupName,
        String name,
        String privateEndpointConnectionName,
        PrivateLinkConnectionApprovalRequestResource privateEndpointWrapper) {
    ...
    private Mono<StaticSiteUserProvidedFunctionAppArmResourceInner> registerUserProvidedFunctionAppWithStaticSiteAsync(
        ...
        StaticSiteUserProvidedFunctionAppArmResourceInner staticSiteUserProvidedFunctionEnvelope,
        Boolean isForced) {
        return registerUserProvidedFunctionAppWithStaticSiteWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> createZipDeploymentForStaticSiteWithResponseAsync(
    ...
    private Mono<Void> createZipDeploymentForStaticSiteAsync(
        String resourceGroupName, String name, StaticSiteZipDeploymentArmResource staticSiteZipDeploymentEnvelope) {
        return createZipDeploymentForStaticSiteWithResponseAsync(
                resourceGroupName, name, staticSiteZipDeploymentEnvelope)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
