...
@JsonFlatten
@Fluent
public class PrivateEndpointConnectionResourceAutoGenerated extends ProxyOnlyResource {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(PrivateEndpointConnectionResourceAutoGenerated.class);
     ...
     * @return the PrivateEndpointConnectionResourceAutoGenerated object itself.
     */
    public PrivateEndpointConnectionResourceAutoGenerated withPrivateEndpoint(ArmIdWrapper privateEndpoint) {
     ...
     * @return the PrivateEndpointConnectionResourceAutoGenerated object itself.
     */
    public PrivateEndpointConnectionResourceAutoGenerated withPrivateLinkServiceConnectionState(
     ...
     * @return the PrivateEndpointConnectionResourceAutoGenerated object itself.
     */
    public PrivateEndpointConnectionResourceAutoGenerated withIpAddresses(List<String> ipAddresses) {
    ...
    /** {@inheritDoc} */
    @Override
    public PrivateEndpointConnectionResourceAutoGenerated withKind(String kind) {
        super.withKind(kind);
        return this;
    }
