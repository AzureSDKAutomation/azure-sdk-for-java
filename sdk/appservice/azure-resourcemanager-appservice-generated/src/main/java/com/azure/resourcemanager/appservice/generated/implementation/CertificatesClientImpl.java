...
public final class CertificatesClientImpl implements CertificatesClient {
    ...
    private PollerFlux<PollResult<CertificateInner>, CertificateInner> beginCreateOrUpdateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, name, certificateEnvelope);
        return this
            .client
            .<CertificateInner, CertificateInner>getLroResult(
                mono, this.client.getHttpPipeline(), CertificateInner.class, CertificateInner.class, Context.NONE);
    }
    ...
    private PollerFlux<PollResult<CertificateInner>, CertificateInner> beginCreateOrUpdateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, name, certificateEnvelope, context);
        return this
            .client
            .<CertificateInner, CertificateInner>getLroResult(
                mono, this.client.getHttpPipeline(), CertificateInner.class, CertificateInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<CertificateInner>, CertificateInner> beginCreateOrUpdate(
        String resourceGroupName, String name, CertificateInner certificateEnvelope) {
        return beginCreateOrUpdateAsync(resourceGroupName, name, certificateEnvelope).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<CertificateInner>, CertificateInner> beginCreateOrUpdate(
        String resourceGroupName, String name, CertificateInner certificateEnvelope, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, name, certificateEnvelope, context).getSyncPoller();
    }
    ...
    private Mono<CertificateInner> createOrUpdateAsync(
        String resourceGroupName, String name, CertificateInner certificateEnvelope) {
        return beginCreateOrUpdateAsync(resourceGroupName, name, certificateEnvelope)
            .last()
    ...
    private Mono<CertificateInner> createOrUpdateAsync(
        String resourceGroupName, String name, CertificateInner certificateEnvelope, Context context) {
        return beginCreateOrUpdateAsync(resourceGroupName, name, certificateEnvelope, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
