...
public class AseV3NetworkingConfigurationInner extends ProxyOnlyResource {
     ...
     */
    @JsonProperty(value = "properties.externalInboundIpAddresses", access = JsonProperty.Access.WRITE_ONLY)
    private List<String> externalInboundIpAddresses;

    /*
     * The internalInboundIpAddresses property.
     */
    @JsonProperty(value = "properties.internalInboundIpAddresses", access = JsonProperty.Access.WRITE_ONLY)
