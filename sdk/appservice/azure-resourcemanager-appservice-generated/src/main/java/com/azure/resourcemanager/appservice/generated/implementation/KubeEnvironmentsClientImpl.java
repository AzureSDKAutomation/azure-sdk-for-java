...
public final class KubeEnvironmentsClientImpl implements KubeEnvironmentsClient {
    ...
    private interface KubeEnvironmentsService {
        ...
        @Get(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Web"
                + "/kubeEnvironments/{name}/operations/{operationId}")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(DefaultErrorResponseErrorException.class)
        Mono<Response<Object>> getOperation(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("name") String name,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Object>> getOperationWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Object> getOperationAsync(String resourceGroupName, String name, String operationId) {
        return getOperationWithResponseAsync(resourceGroupName, name, operationId)
            .flatMap(
                (Response<Object> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Object getOperation(String resourceGroupName, String name, String operationId) {
        return getOperationAsync(resourceGroupName, name, operationId).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Object> getOperationWithResponse(
        String resourceGroupName, String name, String operationId, Context context) {
        return getOperationWithResponseAsync(resourceGroupName, name, operationId, context).block();
    }
