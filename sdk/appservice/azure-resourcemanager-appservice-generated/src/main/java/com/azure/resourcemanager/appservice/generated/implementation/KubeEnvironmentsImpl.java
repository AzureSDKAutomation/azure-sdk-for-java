...
public final class KubeEnvironmentsImpl implements KubeEnvironments {
    ...
    public Object getOperation(String resourceGroupName, String name, String operationId) {
        return this.serviceClient().getOperation(resourceGroupName, name, operationId);
    }

    public Response<Object> getOperationWithResponse(
        String resourceGroupName, String name, String operationId, Context context) {
        return this.serviceClient().getOperationWithResponse(resourceGroupName, name, operationId, context);
    }
