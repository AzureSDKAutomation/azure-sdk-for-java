...
import com.azure.resourcemanager.appservice.generated.implementation.WorkerAppsImpl;
import com.azure.resourcemanager.appservice.generated.implementation.WorkerAppsRevisionsImpl;
...
public final class AppServiceManager {
    ...
    private WorkerApps workerApps;

    private WorkerAppsRevisions workerAppsRevisions;
    ...
    /** @return Resource collection API of WorkerApps. */
    public WorkerApps workerApps() {
        if (this.workerApps == null) {
            this.workerApps = new WorkerAppsImpl(clientObject.getWorkerApps(), this);
        }
        return workerApps;
    }

    /** @return Resource collection API of WorkerAppsRevisions. */
    public WorkerAppsRevisions workerAppsRevisions() {
        if (this.workerAppsRevisions == null) {
            this.workerAppsRevisions = new WorkerAppsRevisionsImpl(clientObject.getWorkerAppsRevisions(), this);
        }
        return workerAppsRevisions;
    }
