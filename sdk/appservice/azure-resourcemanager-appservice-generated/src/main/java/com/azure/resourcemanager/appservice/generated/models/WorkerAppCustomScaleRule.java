...
@Fluent
public final class WorkerAppCustomScaleRule {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(WorkerAppCustomScaleRule.class);
     ...
     * @return the WorkerAppCustomScaleRule object itself.
     */
    public WorkerAppCustomScaleRule withType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the WorkerAppCustomScaleRule object itself.
     */
    public WorkerAppCustomScaleRule withMetadata(Map<String, String> metadata) {
     ...
     * @return the WorkerAppCustomScaleRule object itself.
     */
    public WorkerAppCustomScaleRule withAuth(List<WorkerAppScaleRuleAuth> auth) {
        this.auth = auth;
        return this;
    }
