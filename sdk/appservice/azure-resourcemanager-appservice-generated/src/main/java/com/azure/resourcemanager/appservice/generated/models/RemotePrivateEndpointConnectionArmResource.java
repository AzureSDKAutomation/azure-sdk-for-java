...
@JsonFlatten
@Fluent
public class RemotePrivateEndpointConnectionArmResource extends ProxyOnlyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RemotePrivateEndpointConnectionArmResource.class);
     ...
     * @return the RemotePrivateEndpointConnectionArmResource object itself.
     */
    public RemotePrivateEndpointConnectionArmResource withPrivateEndpoint(ArmIdWrapper privateEndpoint) {
     ...
     * @return the RemotePrivateEndpointConnectionArmResource object itself.
     */
    public RemotePrivateEndpointConnectionArmResource withPrivateLinkServiceConnectionState(
     ...
     * @return the RemotePrivateEndpointConnectionArmResource object itself.
     */
    public RemotePrivateEndpointConnectionArmResource withIpAddresses(List<String> ipAddresses) {
    ...
    /** {@inheritDoc} */
    @Override
    public RemotePrivateEndpointConnectionArmResource withKind(String kind) {
        super.withKind(kind);
        return this;
    }
