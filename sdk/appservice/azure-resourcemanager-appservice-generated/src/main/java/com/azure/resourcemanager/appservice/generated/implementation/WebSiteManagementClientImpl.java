...
public final class WebSiteManagementClientImpl implements WebSiteManagementClient {
    ...
    /** The WorkerAppsClient object to access its operations. */
    private final WorkerAppsClient workerApps;

    /**
     * Gets the WorkerAppsClient object to access its operations.
     *
     * @return the WorkerAppsClient object.
     */
    public WorkerAppsClient getWorkerApps() {
        return this.workerApps;
    }

    /** The WorkerAppsRevisionsClient object to access its operations. */
    private final WorkerAppsRevisionsClient workerAppsRevisions;

    /**
     * Gets the WorkerAppsRevisionsClient object to access its operations.
     *
     * @return the WorkerAppsRevisionsClient object.
     */
    public WorkerAppsRevisionsClient getWorkerAppsRevisions() {
        return this.workerAppsRevisions;
    }
    ...
    WebSiteManagementClientImpl(
        ...
        this.workerApps = new WorkerAppsClientImpl(this);
        this.workerAppsRevisions = new WorkerAppsRevisionsClientImpl(this);
    }
