...
@JsonFlatten
@Fluent
public class PrivateEndpointConnectionResourceAutoGeneratedInner extends ProxyOnlyResource {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(PrivateEndpointConnectionResourceAutoGeneratedInner.class);
     ...
     * @return the PrivateEndpointConnectionResourceAutoGeneratedInner object itself.
     */
    public PrivateEndpointConnectionResourceAutoGeneratedInner withPrivateEndpoint(ArmIdWrapper privateEndpoint) {
     ...
     * @return the PrivateEndpointConnectionResourceAutoGeneratedInner object itself.
     */
    public PrivateEndpointConnectionResourceAutoGeneratedInner withPrivateLinkServiceConnectionState(
     ...
     * @return the PrivateEndpointConnectionResourceAutoGeneratedInner object itself.
     */
    public PrivateEndpointConnectionResourceAutoGeneratedInner withIpAddresses(List<String> ipAddresses) {
    ...
    /** {@inheritDoc} */
    @Override
    public PrivateEndpointConnectionResourceAutoGeneratedInner withKind(String kind) {
        super.withKind(kind);
        return this;
    }
