...
@Fluent
public final class WorkerAppDapr {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(WorkerAppDapr.class);
    ...
    private List<WorkerAppDaprComponent> components;
     ...
     * @return the WorkerAppDapr object itself.
     */
    public WorkerAppDapr withEnabled(Boolean enabled) {
     ...
     * @return the WorkerAppDapr object itself.
     */
    public WorkerAppDapr withAppId(String appId) {
        this.appId = appId;
        return this;
    }
     ...
     * @return the WorkerAppDapr object itself.
     */
    public WorkerAppDapr withAppPort(Integer appPort) {
     ...
     */
    public List<WorkerAppDaprComponent> components() {
     ...
     * @return the WorkerAppDapr object itself.
     */
    public WorkerAppDapr withComponents(List<WorkerAppDaprComponent> components) {
