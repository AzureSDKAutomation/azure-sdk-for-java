...
public final class WebAppsImpl implements WebApps {
    ...
    public PublishingCredentialsPoliciesCollection listBasicPublishingCredentialsPolicies(
        String resourceGroupName, String name) {
        PublishingCredentialsPoliciesCollectionInner inner =
            this.serviceClient().listBasicPublishingCredentialsPolicies(resourceGroupName, name);
        if (inner != null) {
            return new PublishingCredentialsPoliciesCollectionImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<PublishingCredentialsPoliciesCollection> listBasicPublishingCredentialsPoliciesWithResponse(
        String resourceGroupName, String name, Context context) {
        Response<PublishingCredentialsPoliciesCollectionInner> inner =
            this.serviceClient().listBasicPublishingCredentialsPoliciesWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new PublishingCredentialsPoliciesCollectionImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public PublishingCredentialsPoliciesCollection listBasicPublishingCredentialsPoliciesSlot(
    ...
    public Response<PublishingCredentialsPoliciesCollection> listBasicPublishingCredentialsPoliciesSlotWithResponse(
        String resourceGroupName, String name, String slot, Context context) {
        Response<PublishingCredentialsPoliciesCollectionInner> inner =
            this
                .serviceClient()
                .listBasicPublishingCredentialsPoliciesSlotWithResponse(resourceGroupName, name, slot, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
