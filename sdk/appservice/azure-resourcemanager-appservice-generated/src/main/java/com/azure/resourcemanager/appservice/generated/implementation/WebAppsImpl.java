...
public final class WebAppsImpl implements WebApps {
    ...
    public SiteAuthSettings validateConfigBeforeUpgradeToSiteAuthSettingsV2(String resourceGroupName, String name) {
        SiteAuthSettingsInner inner =
            this.serviceClient().validateConfigBeforeUpgradeToSiteAuthSettingsV2(resourceGroupName, name);
        if (inner != null) {
            return new SiteAuthSettingsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<SiteAuthSettings> validateConfigBeforeUpgradeToSiteAuthSettingsV2WithResponse(
        String resourceGroupName, String name, Context context) {
        Response<SiteAuthSettingsInner> inner =
            this
                .serviceClient()
                .validateConfigBeforeUpgradeToSiteAuthSettingsV2WithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PagedIterable<ApiKVReference> getAppSettingsKeyVaultReferences(String resourceGroupName, String name) {
        ...
        return inner.mapPage(inner1 -> new ApiKVReferenceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ApiKVReference> refreshKeyVaultReferencesForSite(String resourceGroupName, String name) {
        PagedIterable<ApiKVReferenceInner> inner =
            this.serviceClient().refreshKeyVaultReferencesForSite(resourceGroupName, name);
        return inner.mapPage(inner1 -> new ApiKVReferenceImpl(inner1, this.manager()));
    }

    public PagedIterable<ApiKVReference> refreshKeyVaultReferencesForSite(
        String resourceGroupName, String name, Boolean forceRestart, Context context) {
        PagedIterable<ApiKVReferenceInner> inner =
            this.serviceClient().refreshKeyVaultReferencesForSite(resourceGroupName, name, forceRestart, context);
        return inner.mapPage(inner1 -> new ApiKVReferenceImpl(inner1, this.manager()));
    }
    ...
    public List<RemotePrivateEndpointConnectionWrapper> getPrivateEndpointConnectionList(
        String resourceGroupName, String name) {
        List<RemotePrivateEndpointConnectionWrapperInner> inner =
        ...
        if (inner != null) {
            return Collections
                .unmodifiableList(
                    inner
                        .stream()
                        .map(inner1 -> new RemotePrivateEndpointConnectionWrapperImpl(inner1, this.manager()))
                        .collect(Collectors.toList()));
        } else {
            return Collections.emptyList();
        }
    ...
    public Response<List<RemotePrivateEndpointConnectionWrapper>> getPrivateEndpointConnectionListWithResponse(
        String resourceGroupName, String name, Context context) {
        Response<List<RemotePrivateEndpointConnectionWrapperInner>> inner =
            this.serviceClient().getPrivateEndpointConnectionListWithResponse(resourceGroupName, name, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public SiteAuthSettings validateConfigBeforeUpgradeToSiteAuthSettingsV2Slot(
        String resourceGroupName, String name, String slot) {
        SiteAuthSettingsInner inner =
            this.serviceClient().validateConfigBeforeUpgradeToSiteAuthSettingsV2Slot(resourceGroupName, name, slot);
        if (inner != null) {
            return new SiteAuthSettingsImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<SiteAuthSettings> validateConfigBeforeUpgradeToSiteAuthSettingsV2SlotWithResponse(
        String resourceGroupName, String name, String slot, Context context) {
        Response<SiteAuthSettingsInner> inner =
            this
                .serviceClient()
                .validateConfigBeforeUpgradeToSiteAuthSettingsV2SlotWithResponse(
                    resourceGroupName, name, slot, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PagedIterable<ApiKVReference> refreshKeyVaultReferencesForSiteSlot(
        String resourceGroupName, String name, String slot) {
        PagedIterable<ApiKVReferenceInner> inner =
            this.serviceClient().refreshKeyVaultReferencesForSiteSlot(resourceGroupName, name, slot);
        return inner.mapPage(inner1 -> new ApiKVReferenceImpl(inner1, this.manager()));
    }

    public PagedIterable<ApiKVReference> refreshKeyVaultReferencesForSiteSlot(
        String resourceGroupName, String name, String slot, Boolean forceRestart, Context context) {
        PagedIterable<ApiKVReferenceInner> inner =
            this
                .serviceClient()
                .refreshKeyVaultReferencesForSiteSlot(resourceGroupName, name, slot, forceRestart, context);
        return inner.mapPage(inner1 -> new ApiKVReferenceImpl(inner1, this.manager()));
    }
    ...
    public List<RemotePrivateEndpointConnectionWrapper> getPrivateEndpointConnectionListSlot(
        String resourceGroupName, String name, String slot) {
        List<RemotePrivateEndpointConnectionWrapperInner> inner =
    ...
    public Response<List<RemotePrivateEndpointConnectionWrapper>> getPrivateEndpointConnectionListSlotWithResponse(
        String resourceGroupName, String name, String slot, Context context) {
        Response<List<RemotePrivateEndpointConnectionWrapperInner>> inner =
            this
                .serviceClient()
                .getPrivateEndpointConnectionListSlotWithResponse(resourceGroupName, name, slot, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
    ...
    public PrivateEndpointConnectionResource getPrivateEndpointConnectionSlot(
    ...
    public Response<PrivateEndpointConnectionResource> getPrivateEndpointConnectionSlotWithResponse(
    ...
    public PrivateEndpointConnectionResource approveOrRejectPrivateEndpointConnectionSlot(
        String resourceGroupName,
        String name,
