...
public final class UserImpl implements User, User.Definition, User.Update {
    ...
    private UpdateResource updateUser;
    ...
    UserImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public UserImpl update() {
        this.updateUser = new UpdateResource();
        return this;
    }
    ...
    UserImpl(UserInner innerObject, DevTestLabsManager serviceManager) {
