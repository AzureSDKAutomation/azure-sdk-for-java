...
public interface LabsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    LabInner update(String resourceGroupName, String name, UpdateResource lab);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<LabInner> updateWithResponse(String resourceGroupName, String name, UpdateResource lab, Context context);
