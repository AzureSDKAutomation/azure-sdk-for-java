...
public final class NotificationChannelsClientImpl implements NotificationChannelsClient {
    ...
    private interface NotificationChannelsService {
        ...
        Mono<Response<NotificationChannelInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource notificationChannel,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<NotificationChannelInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource notificationChannel) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<NotificationChannelInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource notificationChannel, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
