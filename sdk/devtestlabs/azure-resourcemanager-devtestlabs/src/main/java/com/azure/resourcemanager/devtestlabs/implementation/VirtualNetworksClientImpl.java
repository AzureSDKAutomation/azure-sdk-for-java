...
public final class VirtualNetworksClientImpl implements VirtualNetworksClient {
    ...
    private interface VirtualNetworksService {
        ...
        Mono<Response<VirtualNetworkInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource virtualNetwork,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<VirtualNetworkInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource virtualNetwork) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<VirtualNetworkInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource virtualNetwork, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
