...
public final class PolicyImpl implements Policy, Policy.Definition, Policy.Update {
    ...
    private UpdateResource updatePolicy;
    ...
    PolicyImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public PolicyImpl update() {
        this.updatePolicy = new UpdateResource();
        return this;
    }
    ...
    PolicyImpl(PolicyInner innerObject, DevTestLabsManager serviceManager) {
