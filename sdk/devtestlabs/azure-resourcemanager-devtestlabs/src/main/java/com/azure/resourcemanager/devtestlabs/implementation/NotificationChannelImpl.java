...
public final class NotificationChannelImpl
    ...
    private UpdateResource updateNotificationChannel;
    ...
    NotificationChannelImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public NotificationChannelImpl update() {
        this.updateNotificationChannel = new UpdateResource();
        return this;
    }
    ...
    NotificationChannelImpl(NotificationChannelInner innerObject, DevTestLabsManager serviceManager) {
