...
public final class GlobalSchedulesClientImpl implements GlobalSchedulesClient {
    ...
    private interface GlobalSchedulesService {
        ...
        Mono<Response<ScheduleInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource schedule,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<ScheduleInner>> updateWithResponseAsync(
        String resourceGroupName, String name, UpdateResource schedule) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ScheduleInner>> updateWithResponseAsync(
        String resourceGroupName, String name, UpdateResource schedule, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ScheduleInner> updateAsync(String resourceGroupName, String name, UpdateResource schedule) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ScheduleInner update(String resourceGroupName, String name, UpdateResource schedule) {
