...
public final class ServiceFabricImpl implements ServiceFabric, ServiceFabric.Definition, ServiceFabric.Update {
    ...
    private UpdateResource updateServiceFabric;
    ...
    ServiceFabricImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public ServiceFabricImpl update() {
        this.updateServiceFabric = new UpdateResource();
        return this;
    }
    ...
    ServiceFabricImpl(ServiceFabricInner innerObject, DevTestLabsManager serviceManager) {
