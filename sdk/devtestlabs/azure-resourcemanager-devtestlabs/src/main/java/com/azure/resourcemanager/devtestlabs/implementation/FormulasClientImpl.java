...
public final class FormulasClientImpl implements FormulasClient {
    ...
    private interface FormulasService {
        ...
        Mono<Response<FormulaInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource formula,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<FormulaInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource formula) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<FormulaInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource formula, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public FormulaInner update(String resourceGroupName, String labName, String name, UpdateResource formula) {
