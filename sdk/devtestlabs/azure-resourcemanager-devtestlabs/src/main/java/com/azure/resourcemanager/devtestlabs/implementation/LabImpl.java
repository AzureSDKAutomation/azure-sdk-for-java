...
public final class LabImpl implements Lab, Lab.Definition, Lab.Update {
    ...
    private UpdateResource updateLab;
    ...
    LabImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public LabImpl update() {
        this.updateLab = new UpdateResource();
        return this;
    }
    ...
    LabImpl(LabInner innerObject, DevTestLabsManager serviceManager) {
