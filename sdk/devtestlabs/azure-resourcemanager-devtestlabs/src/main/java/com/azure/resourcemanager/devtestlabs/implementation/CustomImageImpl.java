...
public final class CustomImageImpl implements CustomImage, CustomImage.Definition, CustomImage.Update {
    ...
    private UpdateResource updateCustomImage;
    ...
    CustomImageImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public CustomImageImpl update() {
        this.updateCustomImage = new UpdateResource();
        return this;
    }
    ...
    CustomImageImpl(CustomImageInner innerObject, DevTestLabsManager serviceManager) {
