...
public final class ArtifactSourcesClientImpl implements ArtifactSourcesClient {
    ...
    private interface ArtifactSourcesService {
        ...
        Mono<Response<ArtifactSourceInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource artifactSource,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<ArtifactSourceInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource artifactSource) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ArtifactSourceInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource artifactSource, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
