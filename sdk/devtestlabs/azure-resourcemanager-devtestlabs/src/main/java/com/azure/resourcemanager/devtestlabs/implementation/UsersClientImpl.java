...
public final class UsersClientImpl implements UsersClient {
    ...
    private interface UsersService {
        ...
        Mono<Response<UserInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource user,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<UserInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource user) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<UserInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource user, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<UserInner> updateAsync(String resourceGroupName, String labName, String name, UpdateResource user) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UserInner update(String resourceGroupName, String labName, String name, UpdateResource user) {
