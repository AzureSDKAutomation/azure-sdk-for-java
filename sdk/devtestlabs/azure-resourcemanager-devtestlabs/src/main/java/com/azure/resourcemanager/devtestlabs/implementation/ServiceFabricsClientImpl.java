...
public final class ServiceFabricsClientImpl implements ServiceFabricsClient {
    ...
    private interface ServiceFabricsService {
        ...
        Mono<Response<ServiceFabricInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource serviceFabric,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<ServiceFabricInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String username, String name, UpdateResource serviceFabric) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
