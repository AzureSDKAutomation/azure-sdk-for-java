...
public final class LabVirtualMachineImpl
    ...
    private UpdateResource updateLabVirtualMachine;
    ...
    LabVirtualMachineImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public LabVirtualMachineImpl update() {
        this.updateLabVirtualMachine = new UpdateResource();
        return this;
    }
    ...
    LabVirtualMachineImpl(LabVirtualMachineInner innerObject, DevTestLabsManager serviceManager) {
