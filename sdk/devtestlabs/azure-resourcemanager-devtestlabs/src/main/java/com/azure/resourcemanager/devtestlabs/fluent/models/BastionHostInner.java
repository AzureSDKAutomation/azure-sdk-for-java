...
public class BastionHostInner extends Resource {
     ...
     * BastionHost
     */
    @JsonProperty(value = "properties.externalBastionHostId", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "properties.ipAddressId", access = JsonProperty.Access.WRITE_ONLY)
