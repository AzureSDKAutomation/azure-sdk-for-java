...
public final class LabsClientImpl implements LabsClient {
    ...
    private interface LabsService {
        ...
        Mono<Response<LabInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource lab,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<LabInner>> updateWithResponseAsync(
        String resourceGroupName, String name, UpdateResource lab) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LabInner>> updateWithResponseAsync(
        String resourceGroupName, String name, UpdateResource lab, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<LabInner> updateAsync(String resourceGroupName, String name, UpdateResource lab) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LabInner update(String resourceGroupName, String name, UpdateResource lab) {
