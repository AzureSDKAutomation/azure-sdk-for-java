...
public final class SecretImpl implements Secret, Secret.Definition, Secret.Update {
    ...
    private UpdateResource updateSecret;
    ...
    SecretImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public SecretImpl update() {
        this.updateSecret = new UpdateResource();
        return this;
    }
    ...
    SecretImpl(SecretInner innerObject, DevTestLabsManager serviceManager) {
