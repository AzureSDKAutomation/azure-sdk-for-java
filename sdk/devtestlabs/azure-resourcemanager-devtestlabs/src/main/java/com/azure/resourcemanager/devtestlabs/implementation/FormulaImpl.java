...
public final class FormulaImpl implements Formula, Formula.Definition, Formula.Update {
    ...
    private UpdateResource updateFormula;
    ...
    FormulaImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public FormulaImpl update() {
        this.updateFormula = new UpdateResource();
        return this;
    }
    ...
    FormulaImpl(FormulaInner innerObject, DevTestLabsManager serviceManager) {
