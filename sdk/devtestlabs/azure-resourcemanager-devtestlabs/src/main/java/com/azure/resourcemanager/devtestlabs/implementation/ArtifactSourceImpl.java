...
public final class ArtifactSourceImpl implements ArtifactSource, ArtifactSource.Definition, ArtifactSource.Update {
    ...
    private UpdateResource updateArtifactSource;
    ...
    ArtifactSourceImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public ArtifactSourceImpl update() {
        this.updateArtifactSource = new UpdateResource();
        return this;
    }
    ...
    ArtifactSourceImpl(ArtifactSourceInner innerObject, DevTestLabsManager serviceManager) {
