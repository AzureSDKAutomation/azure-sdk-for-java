...
public final class VirtualMachineSchedulesImpl implements VirtualMachineSchedules {
    ...
    public VirtualMachineSchedulesImpl(VirtualMachineSchedulesClient innerClient, DevTestLabsManager serviceManager) {
    ...
    public Schedule update(
        String resourceGroupName, String labName, String virtualMachineName, String name, UpdateResource schedule) {
        ScheduleInner inner =
