...
public final class BastionHostsImpl implements BastionHosts {
    ...
    public PagedIterable<BastionHost> list(
        ...
        PagedIterable<BastionHostInner> inner =
            this
                .serviceClient()
                .list(resourceGroupName, labName, virtualNetworkName, expand, filter, top, orderby, context);
        return Utils.mapPage(inner, inner1 -> new BastionHostImpl(inner1, this.manager()));
    }
    ...
    public Response<BastionHost> getWithResponse(
        ...
        Response<BastionHostInner> inner =
            this.serviceClient().getWithResponse(resourceGroupName, labName, virtualNetworkName, name, expand, context);
        if (inner != null) {
    ...
    public Response<BastionHost> getByIdWithResponse(String id, String expand, Context context) {
        String resourceGroupName = Utils.getValueFromIdByName(id, "resourceGroups");
        if (resourceGroupName == null) {
            throw logger
                .logExceptionAsError(
        ...
        return this.getWithResponse(resourceGroupName, labName, virtualNetworkName, name, expand, context);
    }
