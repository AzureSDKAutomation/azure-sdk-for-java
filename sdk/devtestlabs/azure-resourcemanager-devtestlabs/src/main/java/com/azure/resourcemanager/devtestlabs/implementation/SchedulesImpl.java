...
public final class SchedulesImpl implements Schedules {
    ...
    public SchedulesImpl(SchedulesClient innerClient, DevTestLabsManager serviceManager) {
    ...
    public Schedule update(String resourceGroupName, String labName, String name, UpdateResource schedule) {
