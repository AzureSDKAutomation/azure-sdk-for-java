...
public final class VirtualNetworkImpl implements VirtualNetwork, VirtualNetwork.Definition, VirtualNetwork.Update {
    ...
    private UpdateResource updateVirtualNetwork;
    ...
    VirtualNetworkImpl(String name, DevTestLabsManager serviceManager) {
    ...
    public VirtualNetworkImpl update() {
        this.updateVirtualNetwork = new UpdateResource();
        return this;
    }
    ...
    VirtualNetworkImpl(VirtualNetworkInner innerObject, DevTestLabsManager serviceManager) {
