...
public final class VirtualMachinesClientImpl implements VirtualMachinesClient {
    ...
    private interface VirtualMachinesService {
        ...
        Mono<Response<LabVirtualMachineInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource labVirtualMachine,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<LabVirtualMachineInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource labVirtualMachine) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<LabVirtualMachineInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource labVirtualMachine, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
