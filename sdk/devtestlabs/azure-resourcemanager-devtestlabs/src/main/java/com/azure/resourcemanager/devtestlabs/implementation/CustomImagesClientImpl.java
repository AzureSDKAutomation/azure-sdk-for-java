...
public final class CustomImagesClientImpl implements CustomImagesClient {
    ...
    private interface CustomImagesService {
        ...
        Mono<Response<CustomImageInner>> update(
            ...
            @PathParam("name") String name,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") UpdateResource customImage,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<CustomImageInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource customImage) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CustomImageInner>> updateWithResponseAsync(
        String resourceGroupName, String labName, String name, UpdateResource customImage, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CustomImageInner update(String resourceGroupName, String labName, String name, UpdateResource customImage) {
