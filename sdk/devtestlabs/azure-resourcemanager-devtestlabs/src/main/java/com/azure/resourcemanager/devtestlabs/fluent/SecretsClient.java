...
public interface SecretsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SecretInner update(String resourceGroupName, String labName, String username, String name, UpdateResource secret);
    ...
    Response<SecretInner> updateWithResponse(
        String resourceGroupName, String labName, String username, String name, UpdateResource secret, Context context);
}
