...
public final class AttachedDatabaseConfigurationImpl
    ...
    public AttachedDatabaseConfigurationImpl(String name, KustoManager serviceManager) {
    ...
    public AttachedDatabaseConfigurationImpl(
        AttachedDatabaseConfigurationInner innerObject, KustoManager serviceManager) {
