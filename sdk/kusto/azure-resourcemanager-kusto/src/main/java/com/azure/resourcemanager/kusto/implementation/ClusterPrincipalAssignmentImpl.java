...
public final class ClusterPrincipalAssignmentImpl
    ...
    public ClusterPrincipalAssignmentImpl(String name, KustoManager serviceManager) {
    ...
    public ClusterPrincipalAssignmentImpl(ClusterPrincipalAssignmentInner innerObject, KustoManager serviceManager) {
