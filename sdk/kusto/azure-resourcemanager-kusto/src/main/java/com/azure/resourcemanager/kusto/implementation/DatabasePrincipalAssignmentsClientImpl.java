...
public final class DatabasePrincipalAssignmentsClientImpl implements DatabasePrincipalAssignmentsClient {
     ...
     * @param principalAssignmentName A principal assignment check name availability request.
     ...
     * @param databaseName The name of the database in the Kusto cluster.
     * @param principalAssignmentName The name of the Kusto principalAssignment.
     * @param parameters Class representing a database principal assignment.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
