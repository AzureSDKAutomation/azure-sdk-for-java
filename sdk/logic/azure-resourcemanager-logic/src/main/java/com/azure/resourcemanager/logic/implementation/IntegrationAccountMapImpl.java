...
public final class IntegrationAccountMapImpl
    ...
    IntegrationAccountMapImpl(String name, LogicManager serviceManager) {
    ...
    IntegrationAccountMapImpl(IntegrationAccountMapInner innerObject, LogicManager serviceManager) {
