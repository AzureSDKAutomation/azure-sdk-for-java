...
public final class LogicManager extends ManagerCore<LogicManager, LogicManagementClientImpl> {
    ...
    private IntegrationAccountUsageConfigurations integrationAccountUsageConfigurations;
    ...
    */
    ...
    /**
     * @return Entry point to manage IntegrationAccountUsageConfigurations.
     */
    public IntegrationAccountUsageConfigurations integrationAccountUsageConfigurations() {
        if (this.integrationAccountUsageConfigurations == null) {
            this.integrationAccountUsageConfigurations = new IntegrationAccountUsageConfigurationsImpl(this);
        }
