...
public class IdentityUpdate extends ProxyResource {
     ...
     * for test only
     */
    @JsonProperty(value = "properties.testNewProperty")
    private String testNewProperty;
    ...
    /**
     * Get the testNewProperty property: for test only.
     *
     * @return the testNewProperty value.
     */
    public String testNewProperty() {
        return this.testNewProperty;
    }

    /**
     * Set the testNewProperty property: for test only.
     *
     * @param testNewProperty the testNewProperty value to set.
     * @return the IdentityUpdate object itself.
     */
    public IdentityUpdate withTestNewProperty(String testNewProperty) {
        this.testNewProperty = testNewProperty;
        return this;
    }
