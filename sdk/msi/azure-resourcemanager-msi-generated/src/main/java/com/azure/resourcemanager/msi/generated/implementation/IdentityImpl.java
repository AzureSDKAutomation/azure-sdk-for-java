...
public final class IdentityImpl implements Identity, Identity.Definition, Identity.Update {
    ...
    public String testNewProperty() {
        return this.innerModel().testNewProperty();
    }
    ...
    public IdentityImpl withTestNewProperty(String testNewProperty) {
        if (isInCreateMode()) {
            this.innerModel().withTestNewProperty(testNewProperty);
            return this;
        } else {
            this.updateParameters.withTestNewProperty(testNewProperty);
            return this;
        }
    }
