...
public final class AciServiceResponse extends ServiceResponseBase {
     ...
     * @return the AciServiceResponse object itself.
     */
    public AciServiceResponse withDataCollection(ModelDataCollection dataCollection) {
     ...
     * @return the AciServiceResponse object itself.
     */
    public AciServiceResponse withEnvironmentImageRequest(EnvironmentImageResponse environmentImageRequest) {
     ...
     * @return the AciServiceResponse object itself.
     */
    public AciServiceResponse withVnetConfiguration(VnetConfiguration vnetConfiguration) {
     ...
     * @return the AciServiceResponse object itself.
     */
    public AciServiceResponse withEncryptionProperties(EncryptionProperties encryptionProperties) {
