...
public interface MachineLearningComputes {
     ...
     */
    AmlComputeNodesInformation listNodes(String resourceGroupName, String workspaceName, String computeName);
     ...
     * @return the details (e.
     */
    Response<AmlComputeNodesInformation> listNodesWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context);
