...
public final class BatchEndpointTrackedResourceArmPaginatedResult {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(BatchEndpointTrackedResourceArmPaginatedResult.class);

    /*
     * An array of objects of type BatchEndpoint.
     */
    @JsonProperty(value = "value")
    private List<BatchEndpointTrackedResourceInner> value;
     ...
     */
    public List<BatchEndpointTrackedResourceInner> value() {
        return this.value;
    }
     ...
     */
    public BatchEndpointTrackedResourceArmPaginatedResult withValue(List<BatchEndpointTrackedResourceInner> value) {
        this.value = value;
        return this;
    }
