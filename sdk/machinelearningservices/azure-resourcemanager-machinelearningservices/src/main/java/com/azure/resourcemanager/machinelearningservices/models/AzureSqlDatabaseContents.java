...
@Fluent
public final class AzureSqlDatabaseContents extends DatastoreContents {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AzureSqlDatabaseContents.class);
     ...
     * @return the AzureSqlDatabaseContents object itself.
     */
    public AzureSqlDatabaseContents withCredentials(DatastoreCredentials credentials) {
     ...
     * @return the AzureSqlDatabaseContents object itself.
     */
    public AzureSqlDatabaseContents withDatabaseName(String databaseName) {
     ...
     * @return the AzureSqlDatabaseContents object itself.
     */
    public AzureSqlDatabaseContents withEndpoint(String endpoint) {
     ...
     * @return the AzureSqlDatabaseContents object itself.
     */
    public AzureSqlDatabaseContents withPortNumber(int portNumber) {
     ...
     * @return the AzureSqlDatabaseContents object itself.
     */
    public AzureSqlDatabaseContents withServerName(String serverName) {
    ...
    public void validate() {
            ...
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property credentials in model AzureSqlDatabaseContents"));
        } else {
        ...
        if (databaseName() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property databaseName in model AzureSqlDatabaseContents"));
        }
        if (endpoint() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property endpoint in model AzureSqlDatabaseContents"));
        }
        if (serverName() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property serverName in model AzureSqlDatabaseContents"));
        }
    }
}
