...
/** AKS properties. */
@Fluent
public final class SynapseAksProperties {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(SynapseAksProperties.class);
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withAutoScaleProperties(AutoScaleProperties autoScaleProperties) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withAutoPauseProperties(AutoPauseProperties autoPauseProperties) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withSparkVersion(String sparkVersion) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withNodeCount(Integer nodeCount) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withNodeSize(String nodeSize) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withNodeSizeFamily(String nodeSizeFamily) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withSubscriptionId(String subscriptionId) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withResourceGroup(String resourceGroup) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withWorkspaceName(String workspaceName) {
     ...
     * @return the SynapseAksProperties object itself.
     */
    public SynapseAksProperties withPoolName(String poolName) {
