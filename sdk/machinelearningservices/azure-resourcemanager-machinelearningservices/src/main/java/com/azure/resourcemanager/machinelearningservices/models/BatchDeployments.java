...
public interface BatchDeployments {
     ...
     */
    BatchDeploymentTrackedResource get(
     ...
     * @return a batch inference deployment by id.
     */
    Response<BatchDeploymentTrackedResource> getWithResponse(
     ...
     */
    PagedIterable<BatchDeploymentTrackedResource> list(
     ...
     * @return a batch inference deployment by id.
     */
    BatchDeploymentTrackedResource getById(String id);
     ...
     * @return a batch inference deployment by id.
     */
    Response<BatchDeploymentTrackedResource> getByIdWithResponse(String id, Context context);
    ...
    /**
     * Begins definition for a new BatchDeploymentTrackedResource resource.
     *
     * @param name resource name.
     * @return the first stage of the new BatchDeploymentTrackedResource definition.
     */
    BatchDeploymentTrackedResource.DefinitionStages.Blank define(String name);
}
