...
public final class MachineLearningServicesClientImpl implements MachineLearningServicesClient {
    ...
    private interface MachineLearningServicesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("serviceName") String serviceName,
            @BodyParam("application/json") CreateServiceRequestInner properties,
            @HeaderParam("Accept") String accept,
            Context context);
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        String resourceGroupName, String workspaceName, String serviceName, CreateServiceRequestInner properties) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        ...
        String workspaceName,
        String serviceName,
        CreateServiceRequestInner properties,
        Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
