...
public final class QuotasImpl implements Quotas {
    ...
    public QuotasImpl(QuotasClient innerClient, MachinelearningservicesManager serviceManager) {
    ...
    public PagedIterable<ResourceQuota> list(String location) {
        ...
        return inner.mapPage(inner1 -> new ResourceQuotaImpl(inner1, this.manager()));
    }
