...
public interface MachineLearningComputesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    AmlComputeNodesInformationInner listNodes(String resourceGroupName, String workspaceName, String computeName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AmlComputeNodesInformationInner> listNodesWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context);
