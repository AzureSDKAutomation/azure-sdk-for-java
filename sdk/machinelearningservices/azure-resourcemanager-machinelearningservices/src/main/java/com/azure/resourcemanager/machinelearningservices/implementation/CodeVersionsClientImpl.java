...
public final class CodeVersionsClientImpl implements CodeVersionsClient {
    private final ClientLogger logger = new ClientLogger(CodeVersionsClientImpl.class);
    ...
    private interface CodeVersionsService {
        ...
        Mono<Response<CodeVersionResourceInner>> createOrUpdate(
            ...
            @BodyParam("application/json") CodeVersionResourceInner body,
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<CodeVersionResourceInner>> get(
            @HostParam("$host") String endpoint,
            @PathParam("name") String name,
            @PathParam("version") String version,
            @QueryParam("api-version") String apiVersion,
    ...
    private Mono<Response<CodeVersionResourceInner>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CodeVersionResourceInner> createOrUpdateAsync(
        String name, String version, String resourceGroupName, String workspaceName, CodeVersionResourceInner body) {
        return createOrUpdateWithResponseAsync(name, version, resourceGroupName, workspaceName, body)
            .flatMap(
                (Response<CodeVersionResourceInner> res) -> {
    ...
    private Mono<CodeVersionResourceInner> createOrUpdateAsync(
        ...
        final CodeVersionResourceInner body = null;
        return createOrUpdateWithResponseAsync(name, version, resourceGroupName, workspaceName, body)
            .flatMap(
                (Response<CodeVersionResourceInner> res) -> {
                    if (res.getValue() != null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CodeVersionResourceInner createOrUpdate(
        String name, String version, String resourceGroupName, String workspaceName) {
        final CodeVersionResourceInner body = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CodeVersionResourceInner> createOrUpdateWithResponse(
        String name,
        String version,
        String resourceGroupName,
        String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<CodeVersionResourceInner>> getWithResponseAsync(
        String name, String version, String resourceGroupName, String workspaceName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<CodeVersionResourceInner> getAsync(
        String name, String version, String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CodeVersionResourceInner get(String name, String version, String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<CodeVersionResourceInner> getWithResponse(
        String name, String version, String resourceGroupName, String workspaceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CodeVersionResourceInner>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            accept,
                            context))
            .<PagedResponse<CodeVersionResourceInner>>map(
                res ->
    ...
    private PagedFlux<CodeVersionResourceInner> listAsync(
        String name, String resourceGroupName, String workspaceName, String skiptoken) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<CodeVersionResourceInner> listAsync(String name, String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CodeVersionResourceInner> list(String name, String resourceGroupName, String workspaceName) {
        final String skiptoken = null;
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<CodeVersionResourceInner> list(
        String name, String resourceGroupName, String workspaceName, String skiptoken, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CodeVersionResourceInner>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<CodeVersionResourceInner>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        if (this.client.getEndpoint() == null) {
