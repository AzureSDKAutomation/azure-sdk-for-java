...
public class EnvironmentImageRequest {
     ...
     */
    public ModelEnvironmentDefinition environment() {
     ...
     * @return the EnvironmentImageRequest object itself.
     */
    public EnvironmentImageRequest withEnvironment(ModelEnvironmentDefinition environment) {
     ...
     * @return the EnvironmentImageRequest object itself.
     */
    public EnvironmentImageRequest withEnvironmentReference(EnvironmentReference environmentReference) {
