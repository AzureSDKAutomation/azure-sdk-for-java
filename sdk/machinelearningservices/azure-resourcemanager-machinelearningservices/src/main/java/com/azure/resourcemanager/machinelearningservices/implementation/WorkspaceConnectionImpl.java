...
public final class WorkspaceConnectionImpl implements WorkspaceConnection, WorkspaceConnection.Definition {
    ...
    WorkspaceConnectionImpl(WorkspaceConnectionInner innerObject, MachinelearningservicesManager serviceManager) {
    ...
    WorkspaceConnectionImpl(String name, MachinelearningservicesManager serviceManager) {
