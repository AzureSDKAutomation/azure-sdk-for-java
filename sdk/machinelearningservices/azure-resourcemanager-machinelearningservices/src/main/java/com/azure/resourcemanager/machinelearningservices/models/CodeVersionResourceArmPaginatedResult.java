...
public final class CodeVersionResourceArmPaginatedResult {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(CodeVersionResourceArmPaginatedResult.class);

    /*
     * An array of objects of type CodeVersion.
     */
    @JsonProperty(value = "value")
    private List<CodeVersionResourceInner> value;
     ...
     */
    public List<CodeVersionResourceInner> value() {
        return this.value;
    }
     ...
     */
    public CodeVersionResourceArmPaginatedResult withValue(List<CodeVersionResourceInner> value) {
        this.value = value;
        return this;
    }
