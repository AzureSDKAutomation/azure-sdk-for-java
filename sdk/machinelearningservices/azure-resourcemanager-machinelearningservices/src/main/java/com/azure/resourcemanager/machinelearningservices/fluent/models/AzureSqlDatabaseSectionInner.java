...
/** The AzureSqlDatabaseSection model. */
@Fluent
public final class AzureSqlDatabaseSectionInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AzureSqlDatabaseSectionInner.class);
     ...
     * @return the AzureSqlDatabaseSectionInner object itself.
     */
    public AzureSqlDatabaseSectionInner withCredentials(DatastoreCredentialsInner credentials) {
     ...
     * @return the AzureSqlDatabaseSectionInner object itself.
     */
    public AzureSqlDatabaseSectionInner withDatabaseName(String databaseName) {
     ...
     * @return the AzureSqlDatabaseSectionInner object itself.
     */
    public AzureSqlDatabaseSectionInner withEndpoint(String endpoint) {
     ...
     * @return the AzureSqlDatabaseSectionInner object itself.
     */
    public AzureSqlDatabaseSectionInner withPortNumber(int portNumber) {
     ...
     * @return the AzureSqlDatabaseSectionInner object itself.
     */
    public AzureSqlDatabaseSectionInner withServerName(String serverName) {
    ...
    public void validate() {
            ...
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property credentials in model AzureSqlDatabaseSectionInner"));
        } else {
        ...
        if (databaseName() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property databaseName in model AzureSqlDatabaseSectionInner"));
        }
        if (endpoint() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property endpoint in model AzureSqlDatabaseSectionInner"));
        }
        if (serverName() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property serverName in model AzureSqlDatabaseSectionInner"));
        }
    }
}
