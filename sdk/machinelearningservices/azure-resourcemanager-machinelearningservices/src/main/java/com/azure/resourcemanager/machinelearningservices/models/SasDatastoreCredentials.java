...
public final class SasDatastoreCredentials extends DatastoreCredentials {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(SasDatastoreCredentials.class);
    ...
    /**
     * Get the secrets property: Storage container secrets.
     *
    ...
    /**
     * Set the secrets property: Storage container secrets.
     *
