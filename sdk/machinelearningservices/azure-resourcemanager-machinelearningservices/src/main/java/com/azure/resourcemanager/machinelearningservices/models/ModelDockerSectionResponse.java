...
public class ModelDockerSectionResponse {
    ...
    private ContainerRegistryResponse baseImageRegistry;
     ...
     */
    public ContainerRegistryResponse baseImageRegistry() {
     ...
     * @return the ModelDockerSectionResponse object itself.
     */
    public ModelDockerSectionResponse withBaseImageRegistry(ContainerRegistryResponse baseImageRegistry) {
