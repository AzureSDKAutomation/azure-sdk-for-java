...
public final class BatchDeploymentsClientImpl implements BatchDeploymentsClient {
    ...
    private interface BatchDeploymentsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BatchDeploymentTrackedResourceInner>> update(
            @HostParam("$host") String endpoint,
            @PathParam("endpointName") String endpointName,
            @PathParam("deploymentName") String deploymentName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BatchDeploymentTrackedResourceInner>> updateWithResponseAsync(
        String endpointName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BatchDeploymentTrackedResourceInner> updateAsync(
        String endpointName,
        String deploymentName,
        String resourceGroupName,
        String workspaceName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BatchDeploymentTrackedResourceInner> updateWithResponse(
        String endpointName,
        String deploymentName,
        String resourceGroupName,
        String workspaceName,
