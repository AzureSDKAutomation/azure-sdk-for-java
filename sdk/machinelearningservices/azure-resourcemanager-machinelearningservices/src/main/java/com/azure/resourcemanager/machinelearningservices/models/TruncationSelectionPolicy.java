...
public final class TruncationSelectionPolicy extends EarlyTerminationPolicy {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(TruncationSelectionPolicy.class);

    /*
     * The truncationPercentage property.
     */
    @JsonProperty(value = "truncationPercentage")
    private Integer truncationPercentage;

    /**
     * Get the truncationPercentage property: The truncationPercentage property.
     *
    ...
    /**
     * Set the truncationPercentage property: The truncationPercentage property.
     *
