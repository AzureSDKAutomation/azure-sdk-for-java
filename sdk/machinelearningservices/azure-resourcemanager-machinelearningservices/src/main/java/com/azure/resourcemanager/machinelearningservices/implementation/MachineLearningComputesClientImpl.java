...
public final class MachineLearningComputesClientImpl implements MachineLearningComputesClient {
    ...
    private interface MachineLearningComputesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<AmlComputeNodesInformationInner>> listNodes(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("workspaceName") String workspaceName,
    ...
    private PagedFlux<ComputeResourceInner> listByWorkspaceAsync(
        String resourceGroupName, String workspaceName, String skiptoken, Context context) {
        return new PagedFlux<>(
            () -> listByWorkspaceSinglePageAsync(resourceGroupName, workspaceName, skiptoken, context),
    ...
    public PagedIterable<ComputeResourceInner> listByWorkspace(String resourceGroupName, String workspaceName) {
        final String skiptoken = null;
        return new PagedIterable<>(listByWorkspaceAsync(resourceGroupName, workspaceName, skiptoken));
    }
    ...
    public PagedIterable<ComputeResourceInner> listByWorkspace(
        String resourceGroupName, String workspaceName, String skiptoken, Context context) {
        return new PagedIterable<>(listByWorkspaceAsync(resourceGroupName, workspaceName, skiptoken, context));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<AmlComputeNodesInformationInner>> listNodesWithResponseAsync(
        String resourceGroupName, String workspaceName, String computeName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<AmlComputeNodesInformationInner> listNodesAsync(
        String resourceGroupName, String workspaceName, String computeName) {
        return listNodesWithResponseAsync(resourceGroupName, workspaceName, computeName)
            .flatMap(
                (Response<AmlComputeNodesInformationInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public AmlComputeNodesInformationInner listNodes(
        String resourceGroupName, String workspaceName, String computeName) {
        return listNodesAsync(resourceGroupName, workspaceName, computeName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<AmlComputeNodesInformationInner> listNodesWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
        return listNodesWithResponseAsync(resourceGroupName, workspaceName, computeName, context).block();
    }
    ...
    private Mono<Void> startAsync(String resourceGroupName, String workspaceName, String computeName) {
        return startWithResponseAsync(resourceGroupName, workspaceName, computeName)
    ...
    public Response<Void> startWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
        return startWithResponseAsync(resourceGroupName, workspaceName, computeName, context).block();
    }
    ...
    private Mono<Void> stopAsync(String resourceGroupName, String workspaceName, String computeName) {
        return stopWithResponseAsync(resourceGroupName, workspaceName, computeName)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public Response<Void> stopWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
        return stopWithResponseAsync(resourceGroupName, workspaceName, computeName, context).block();
    }
