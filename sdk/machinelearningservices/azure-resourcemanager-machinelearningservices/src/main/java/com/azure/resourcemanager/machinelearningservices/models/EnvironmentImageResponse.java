...
@Fluent
public class EnvironmentImageResponse {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(EnvironmentImageResponse.class);
    ...
    private ModelEnvironmentDefinitionResponse environment;
     ...
     * @return the EnvironmentImageResponse object itself.
     */
    public EnvironmentImageResponse withDriverProgram(String driverProgram) {
     ...
     * @return the EnvironmentImageResponse object itself.
     */
    public EnvironmentImageResponse withAssets(List<ImageAsset> assets) {
        this.assets = assets;
        return this;
    }
     ...
     * @return the EnvironmentImageResponse object itself.
     */
    public EnvironmentImageResponse withModelIds(List<String> modelIds) {
     ...
     * @return the EnvironmentImageResponse object itself.
     */
    public EnvironmentImageResponse withModels(List<Model> models) {
        this.models = models;
        return this;
    }
     ...
     */
    public ModelEnvironmentDefinitionResponse environment() {
     ...
     * @return the EnvironmentImageResponse object itself.
     */
    public EnvironmentImageResponse withEnvironment(ModelEnvironmentDefinitionResponse environment) {
     ...
     */
    public EnvironmentReference environmentReference() {
     ...
     * @return the EnvironmentImageResponse object itself.
     */
    public EnvironmentImageResponse withEnvironmentReference(EnvironmentReference environmentReference) {
