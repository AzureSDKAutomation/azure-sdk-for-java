...
public final class EnvironmentImageResponseEnvironment extends ModelEnvironmentDefinitionResponse {
    ...
    /** {@inheritDoc} */
    @Override
    public EnvironmentImageResponseEnvironment withPython(ModelPythonSection python) {
    ...
    /** {@inheritDoc} */
    @Override
    public EnvironmentImageResponseEnvironment withDocker(ModelDockerSectionResponse docker) {
    ...
    /** {@inheritDoc} */
    @Override
    public EnvironmentImageResponseEnvironment withSpark(ModelSparkSection spark) {
    ...
    /** {@inheritDoc} */
    @Override
    public EnvironmentImageResponseEnvironment withR(RSectionResponse r) {
        super.withR(r);
        return this;
    }
