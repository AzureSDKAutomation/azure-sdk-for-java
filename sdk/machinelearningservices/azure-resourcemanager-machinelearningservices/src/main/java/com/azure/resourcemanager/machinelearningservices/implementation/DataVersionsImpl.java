...
public final class DataVersionsImpl implements DataVersions {
    ...
    public PagedIterable<DataVersionResource> list(String name, String resourceGroupName, String workspaceName) {
        ...
        return Utils.mapPage(inner, inner1 -> new DataVersionResourceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<DataVersionResource> list(
        ...
        Context context) {
        PagedIterable<DataVersionResourceInner> inner =
            this.serviceClient().list(name, resourceGroupName, workspaceName, orderBy, top, skip, tags, context);
        return Utils.mapPage(inner, inner1 -> new DataVersionResourceImpl(inner1, this.manager()));
    }
