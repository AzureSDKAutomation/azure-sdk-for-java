...
public final class BatchEndpointInner {
     ...
     */
    public BatchEndpointInner withAuthMode(EndpointAuthModeType authMode) {
     ...
     * @return the BatchEndpointInner object itself.
     */
    public BatchEndpointInner withProperties(Map<String, String> properties) {
     ...
     * @return the BatchEndpointInner object itself.
     */
    public BatchEndpointInner withTrafficRules(Map<String, Integer> trafficRules) {
     ...
     * @return the BatchEndpointInner object itself.
     */
    public BatchEndpointInner withComputeConfiguration(ComputeConfiguration computeConfiguration) {
     ...
     * @return the BatchEndpointInner object itself.
     */
    public BatchEndpointInner withKeys(AuthKeysInner keys) {
        this.keys = keys;
        return this;
    }
     ...
     * @return the BatchEndpointInner object itself.
     */
    public BatchEndpointInner withError(RootError error) {
        this.error = error;
        return this;
    }
