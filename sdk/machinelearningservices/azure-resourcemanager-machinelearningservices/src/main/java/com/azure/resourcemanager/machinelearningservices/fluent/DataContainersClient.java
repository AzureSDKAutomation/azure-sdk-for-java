...
public interface DataContainersClient {
    ...
    DataContainerResourceInner createOrUpdate(String name, String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataContainerResourceInner> createOrUpdateWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<DataContainerResourceInner> getWithResponse(
    ...
    PagedIterable<DataContainerResourceInner> list(String resourceGroupName, String workspaceName);
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<DataContainerResourceInner> list(
