...
public final class CodeVersion {
     ...
     * @return the CodeVersion object itself.
     */
    public CodeVersion withIsAnonymous(Boolean isAnonymous) {
     ...
     * @return the CodeVersion object itself.
     */
    public CodeVersion withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public void validate() {
        if (path() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property path in model CodeVersion"));
        }
    }
}
