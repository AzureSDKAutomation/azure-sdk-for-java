...
public final class DataVersionsClientImpl implements DataVersionsClient {
    ...
    private PagedFlux<DataVersionResourceInner> listAsync(
        ...
        return new PagedFlux<>(
            () -> listSinglePageAsync(name, resourceGroupName, workspaceName, orderBy, top, skip, tags),
    ...
    private PagedFlux<DataVersionResourceInner> listAsync(
        ...
        Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(name, resourceGroupName, workspaceName, orderBy, top, skip, tags, context),
    ...
    public PagedIterable<DataVersionResourceInner> list(String name, String resourceGroupName, String workspaceName) {
        ...
        final String skip = null;
        final String tags = null;
        return new PagedIterable<>(listAsync(name, resourceGroupName, workspaceName, orderBy, top, skip, tags));
    }
    ...
    public PagedIterable<DataVersionResourceInner> list(
        ...
        return new PagedIterable<>(
            listAsync(name, resourceGroupName, workspaceName, orderBy, top, skip, tags, context));
    }
