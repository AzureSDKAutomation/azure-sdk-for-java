...
public final class MachineLearningComputesImpl implements MachineLearningComputes {
    ...
    public MachineLearningComputesImpl(
        MachineLearningComputesClient innerClient, MachinelearningservicesManager serviceManager) {
    ...
    public PagedIterable<ComputeResource> listByWorkspace(String resourceGroupName, String workspaceName) {
        ...
        return inner.mapPage(inner1 -> new ComputeResourceImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<ComputeResource> listByWorkspace(
        ...
        PagedIterable<ComputeResourceInner> inner =
            this.serviceClient().listByWorkspace(resourceGroupName, workspaceName, skiptoken, context);
        return inner.mapPage(inner1 -> new ComputeResourceImpl(inner1, this.manager()));
    }
    ...
    public AmlComputeNodesInformation listNodes(String resourceGroupName, String workspaceName, String computeName) {
        AmlComputeNodesInformationInner inner =
            this.serviceClient().listNodes(resourceGroupName, workspaceName, computeName);
        if (inner != null) {
            return new AmlComputeNodesInformationImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<AmlComputeNodesInformation> listNodesWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
        Response<AmlComputeNodesInformationInner> inner =
            this.serviceClient().listNodesWithResponse(resourceGroupName, workspaceName, computeName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new AmlComputeNodesInformationImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public Response<Void> startWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
        return this.serviceClient().startWithResponse(resourceGroupName, workspaceName, computeName, context);
    }
    ...
    public Response<Void> stopWithResponse(
        String resourceGroupName, String workspaceName, String computeName, Context context) {
        return this.serviceClient().stopWithResponse(resourceGroupName, workspaceName, computeName, context);
    }
