...
public final class DataContainerResourceArmPaginatedResult {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DataContainerResourceArmPaginatedResult.class);

    /*
     * An array of objects of type DataContainer.
     */
    @JsonProperty(value = "value")
    private List<DataContainerResourceInner> value;
     ...
     */
    public List<DataContainerResourceInner> value() {
        return this.value;
    }
     ...
     */
    public DataContainerResourceArmPaginatedResult withValue(List<DataContainerResourceInner> value) {
        this.value = value;
        return this;
    }
