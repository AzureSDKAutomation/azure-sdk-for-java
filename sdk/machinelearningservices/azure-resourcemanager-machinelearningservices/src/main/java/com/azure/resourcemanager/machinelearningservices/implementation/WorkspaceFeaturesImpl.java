...
public final class WorkspaceFeaturesImpl implements WorkspaceFeatures {
    ...
    public WorkspaceFeaturesImpl(WorkspaceFeaturesClient innerClient, MachinelearningservicesManager serviceManager) {
    ...
    public PagedIterable<AmlUserFeature> list(String resourceGroupName, String workspaceName) {
        ...
        return inner.mapPage(inner1 -> new AmlUserFeatureImpl(inner1, this.manager()));
    }
