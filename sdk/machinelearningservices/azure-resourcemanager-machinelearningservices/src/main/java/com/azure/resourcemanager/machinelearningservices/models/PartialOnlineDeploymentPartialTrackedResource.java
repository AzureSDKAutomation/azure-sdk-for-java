...
public final class PartialOnlineDeploymentPartialTrackedResource {
    @JsonIgnore
    private final ClientLogger logger = new ClientLogger(PartialOnlineDeploymentPartialTrackedResource.class);
     ...
     */
    public PartialOnlineDeploymentPartialTrackedResource withIdentity(ResourceIdentity identity) {
