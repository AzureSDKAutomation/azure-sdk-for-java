...
public final class ServiceResourceImpl implements ServiceResource, ServiceResource.Definition, ServiceResource.Update {
    ...
    private CreateServiceRequestInner createProperties;

    private CreateServiceRequestInner updateProperties;
    ...
    ServiceResourceImpl(String name, MachinelearningservicesManager serviceManager) {
        this.innerObject = new ServiceResourceInner();
        this.serviceManager = serviceManager;
        this.serviceName = name;
        this.createProperties = new CreateServiceRequestInner();
    }

    public ServiceResourceImpl update() {
        this.updateProperties = new CreateServiceRequestInner();
        return this;
    }
    ...
    ServiceResourceImpl(ServiceResourceInner innerObject, MachinelearningservicesManager serviceManager) {
    ...
    public ServiceResourceImpl withKeys(AuthKeysInner keys) {
        if (isInCreateMode()) {
    ...
    public ServiceResourceImpl withEnvironmentImageRequest(EnvironmentImageRequest environmentImageRequest) {
        if (isInCreateMode()) {
