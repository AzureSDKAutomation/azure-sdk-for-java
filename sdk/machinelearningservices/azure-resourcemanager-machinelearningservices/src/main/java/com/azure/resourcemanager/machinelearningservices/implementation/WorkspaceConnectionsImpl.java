...
public final class WorkspaceConnectionsImpl implements WorkspaceConnections {
    ...
    public WorkspaceConnectionsImpl(
        WorkspaceConnectionsClient innerClient, MachinelearningservicesManager serviceManager) {
    ...
    public PagedIterable<WorkspaceConnection> list(String resourceGroupName, String workspaceName) {
        ...
        return inner.mapPage(inner1 -> new WorkspaceConnectionImpl(inner1, this.manager()));
    }
