...
@Fluent
public class CreateEndpointVariantRequest extends CreateServiceRequestInner {
    ...
    /** {@inheritDoc} */
    @Override
    public CreateEndpointVariantRequest withKeys(AuthKeysInner keys) {
        super.withKeys(keys);
        return this;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public CreateEndpointVariantRequest withEnvironmentImageRequest(EnvironmentImageRequest environmentImageRequest) {
