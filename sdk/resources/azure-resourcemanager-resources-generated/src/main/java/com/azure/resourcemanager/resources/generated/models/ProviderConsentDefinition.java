...
public final class ProviderConsentDefinition {
     ...
     */
    @JsonProperty(value = "authorizationHeaderValue")
    ...
    /**
     * Get the authorizationHeaderValue property: The authorization header value.
     *
     * @return the authorizationHeaderValue value.
     */
    ...
    /**
     * Set the authorizationHeaderValue property: The authorization header value.
     *
     * @param authorizationHeaderValue the authorizationHeaderValue value to set.
     * @return the ProviderConsentDefinition object itself.
     */
    public ProviderConsentDefinition withAuthorizationHeaderValue(String authorizationHeaderValue) {
