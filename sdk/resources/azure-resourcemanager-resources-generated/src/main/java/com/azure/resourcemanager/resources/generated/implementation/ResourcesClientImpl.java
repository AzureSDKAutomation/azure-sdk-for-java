...
public final class ResourcesClientImpl implements ResourcesClient {
    ...
    private interface ResourcesService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.Resources/copyResources")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceCopyTokenInner>> copyResources(
            @HostParam("$host") String endpoint,
            @QueryParam("validationOnly") Boolean validationOnly,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ResourceCopyInfo parameters,
            @HeaderParam("Accept") String accept,
            Context context);

        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Resources/resourceCopyStatus/{token}")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceCopyStatusInner>> resourceCopyStatus(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.Resources/resourceCopiesStatus")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<ResourceCopyStatusInner>>> resourceCopiesStatus(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @HeaderParam("Accept") String accept,
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/{providerName}/{resourceType}"
                + "/{resourceName}/finalizeResourceCopy/{token}")
        @ExpectedResponses({202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> finalizeResourceCopy(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    /**
     * The resources to be copied from one region to another. If validation is set to true, this operation validates
     * resource copy from one region to another. When source resource group and target resource group are same, source
     * ARM Id and target ARM Id cannot be same. The existingTarget represents the resource which already exists, and it
     * will be used directly. Existing target resources may not be in the same RG with source resource, but they must
     * exist in the target location.
     *
     * @param parameters Parameters for moving resources.
     * @param validationOnly Determines if resource copy operation is only for validation.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceCopyTokenInner>> copyResourcesWithResponseAsync(
        ResourceCopyInfo parameters, Boolean validationOnly) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceCopyTokenInner> copyResourcesAsync(ResourceCopyInfo parameters, Boolean validationOnly) {
        return copyResourcesWithResponseAsync(parameters, validationOnly)
            .flatMap(
                (Response<ResourceCopyTokenInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceCopyTokenInner> copyResourcesAsync(ResourceCopyInfo parameters) {
        final Boolean validationOnly = null;
        return copyResourcesWithResponseAsync(parameters, validationOnly)
            .flatMap(
                (Response<ResourceCopyTokenInner> res) -> {
                    if (res.getValue() != null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ResourceCopyTokenInner copyResources(ResourceCopyInfo parameters) {
        final Boolean validationOnly = null;
        return copyResourcesAsync(parameters, validationOnly).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResourceCopyTokenInner> copyResourcesWithResponse(
        ResourceCopyInfo parameters, Boolean validationOnly, Context context) {
        return copyResourcesWithResponseAsync(parameters, validationOnly, context).block();
    }

    /**
     * This operation returns resource copy status under the given subscription and token.
     *
     * @param token Resource copy token.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return the response.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceCopyStatusInner>> resourceCopyStatusWithResponseAsync(String token) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ResourceCopyStatusInner>> resourceCopyStatusWithResponseAsync(String token, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ResourceCopyStatusInner> resourceCopyStatusAsync(String token) {
        return resourceCopyStatusWithResponseAsync(token)
            .flatMap(
                (Response<ResourceCopyStatusInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ResourceCopyStatusInner resourceCopyStatus(String token) {
        return resourceCopyStatusAsync(token).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ResourceCopyStatusInner> resourceCopyStatusWithResponse(String token, Context context) {
        return resourceCopyStatusWithResponseAsync(token, context).block();
    }

    /**
     * This operation returns all resource copy status under the given subscription.
     *
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return array of ResourceCopyStatus.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<ResourceCopyStatusInner>>> resourceCopiesStatusWithResponseAsync() {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<List<ResourceCopyStatusInner>>> resourceCopiesStatusWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<List<ResourceCopyStatusInner>> resourceCopiesStatusAsync() {
        return resourceCopiesStatusWithResponseAsync()
            .flatMap(
                (Response<List<ResourceCopyStatusInner>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public List<ResourceCopyStatusInner> resourceCopiesStatus() {
        return resourceCopiesStatusAsync().block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<List<ResourceCopyStatusInner>> resourceCopiesStatusWithResponse(Context context) {
        return resourceCopiesStatusWithResponseAsync(context).block();
    }
     ...
     * @param providerName Resource provider.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> finalizeResourceCopyWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> finalizeResourceCopyAsync(
        String resourceGroupName, String providerName, String resourceType, String resourceName, String token) {
        return finalizeResourceCopyWithResponseAsync(resourceGroupName, providerName, resourceType, resourceName, token)
    ...
    public void finalizeResourceCopy(
        String resourceGroupName, String providerName, String resourceType, String resourceName, String token) {
        finalizeResourceCopyAsync(resourceGroupName, providerName, resourceType, resourceName, token).block();
    }
    ...
    public Response<Void> finalizeResourceCopyWithResponse(
        ...
        String token,
        Context context) {
        return finalizeResourceCopyWithResponseAsync(
