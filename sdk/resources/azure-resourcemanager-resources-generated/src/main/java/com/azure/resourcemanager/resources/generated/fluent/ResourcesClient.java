...
public interface ResourcesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ResourceCopyTokenInner copyResources(ResourceCopyInfo parameters);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ResourceCopyTokenInner> copyResourcesWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ResourceCopyStatusInner resourceCopyStatus(String token);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ResourceCopyStatusInner> resourceCopyStatusWithResponse(String token, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    List<ResourceCopyStatusInner> resourceCopiesStatus();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<List<ResourceCopyStatusInner>> resourceCopiesStatusWithResponse(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<Void> finalizeResourceCopyWithResponse(
