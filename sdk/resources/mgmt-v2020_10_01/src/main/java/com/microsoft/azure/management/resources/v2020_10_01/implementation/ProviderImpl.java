...
import com.microsoft.azure.management.resources.v2020_10_01.Provider;
...
class ProviderImpl extends IndexableRefreshableWrapperImpl<Provider, ProviderInner> implements Provider {
    ...
    public List<ProviderResourceType> resourceTypes() {
        List<ProviderResourceType> lst = new ArrayList<ProviderResourceType>();
        if (this.inner().resourceTypes() != null) {
            for (ProviderResourceTypeInner inner : this.inner().resourceTypes()) {
                lst.add( new ProviderResourceTypeImpl(inner, manager()));
            }
        }
        return lst;
    }
