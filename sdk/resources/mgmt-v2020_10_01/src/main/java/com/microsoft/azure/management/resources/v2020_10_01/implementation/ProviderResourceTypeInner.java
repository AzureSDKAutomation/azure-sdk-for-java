...
public class ProviderResourceTypeInner {
     ...
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withResourceType(String resourceType) {
     ...
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withLocations(List<String> locations) {
        this.locations = locations;
        return this;
    }

    /**
     * Get the location mappings that are supported by this resource type.
     *
    ...
    /**
     * Set the location mappings that are supported by this resource type.
     *
     * @param locationMappings the locationMappings value to set
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withLocationMappings(List<ProviderExtendedLocation> locationMappings) {
     ...
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withAliases(List<Alias> aliases) {
     ...
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withApiVersions(List<String> apiVersions) {
     ...
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withCapabilities(String capabilities) {
     ...
     * @return the ProviderResourceTypeInner object itself.
     */
    public ProviderResourceTypeInner withProperties(Map<String, String> properties) {
