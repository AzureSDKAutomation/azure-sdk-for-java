...
public class TemplateLink {
    ...
    /**
     * Get the relativePath property can be used to deploy a linked template at a location relative to the parent. If the parent template was linked with a TemplateSpec, this will reference an artifact in the TemplateSpec.  If the parent was linked with a URI, the child deployment will be a combination of the parent and relativePath URIs.
     *
    ...
    /**
     * Set the relativePath property can be used to deploy a linked template at a location relative to the parent. If the parent template was linked with a TemplateSpec, this will reference an artifact in the TemplateSpec.  If the parent was linked with a URI, the child deployment will be a combination of the parent and relativePath URIs.
     *
    ...
    /**
     * Get the query string (for example, a SAS token) to be used with the templateLink URI.
     *
    ...
    /**
     * Set the query string (for example, a SAS token) to be used with the templateLink URI.
     *
