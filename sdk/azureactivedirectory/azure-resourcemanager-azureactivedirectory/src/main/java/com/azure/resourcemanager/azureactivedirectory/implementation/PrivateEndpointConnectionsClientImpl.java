...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    private interface PrivateEndpointConnectionsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateEndpointConnectionInner>> updateTags(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("policyName") String policyName,
            @PathParam("privateEndpointConnectionName") String privateEndpointConnectionName,
            @BodyParam("application/json") TagsResource privateLinkConnectionTags,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateEndpointConnectionInner>> updateTagsWithResponseAsync(
        String resourceGroupName,
        String policyName,
        String privateEndpointConnectionName,
        ...
        if (privateLinkConnectionTags == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
                        "Parameter privateLinkConnectionTags is required and cannot be null."));
        } else {
    ...
    private Mono<PrivateEndpointConnectionInner> updateTagsAsync(
        ...
        return updateTagsWithResponseAsync(
                resourceGroupName, policyName, privateEndpointConnectionName, privateLinkConnectionTags)
            .flatMap(
                (Response<PrivateEndpointConnectionInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public PrivateEndpointConnectionInner updateTags(
        ...
        String privateEndpointConnectionName,
        TagsResource privateLinkConnectionTags) {
        return updateTagsAsync(resourceGroupName, policyName, privateEndpointConnectionName, privateLinkConnectionTags)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateEndpointConnectionInner> updateTagsWithResponse(
        String resourceGroupName,
        String policyName,
        String privateEndpointConnectionName,
        TagsResource privateLinkConnectionTags,
        Context context) {
        return updateTagsWithResponseAsync(
                resourceGroupName, policyName, privateEndpointConnectionName, privateLinkConnectionTags, context)
            .block();
    }
