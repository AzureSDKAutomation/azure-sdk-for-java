...
import com.microsoft.azure.management.billing.v2019_10_01_preview.InvoicesDownloadHeaders;
...
public class InvoicesInner {
    ...
    interface InvoicesService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Invoices download" })
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoices/{invoiceName}/download")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.Invoices beginDownload" })
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoices/{invoiceName}/download")
    ...
    public Observable<DownloadUrlInner> downloadAsync(String billingAccountName, String billingProfileName, String invoiceName) {
        return downloadWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceName).map(new Func1<ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders>, DownloadUrlInner>() {
            @Override
            public DownloadUrlInner call(ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders>> downloadWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        return client.getAzureClient().getPostOrDeleteResultWithHeadersAsync(observable, new LongRunningOperationOptions().withFinalStateVia(LongRunningFinalState.LOCATION), new TypeToken<DownloadUrlInner>() { }.getType(), InvoicesDownloadHeaders.class);
    }
    ...
    public Observable<DownloadUrlInner> beginDownloadAsync(String billingAccountName, String billingProfileName, String invoiceName) {
        return beginDownloadWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceName).map(new Func1<ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders>, DownloadUrlInner>() {
            @Override
            public DownloadUrlInner call(ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders> response) {
                return response.body();
            }
     ...
     * @return the observable to the DownloadUrlInner object
     */
    public Observable<ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders>> beginDownloadWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        return service.beginDownload(billingAccountName, billingProfileName, invoiceName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders> clientResponse = beginDownloadDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<DownloadUrlInner, InvoicesDownloadHeaders> beginDownloadDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<DownloadUrlInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                ...
                .registerError(ErrorResponseException.class)
                .buildWithHeaders(response, InvoicesDownloadHeaders.class);
    }
