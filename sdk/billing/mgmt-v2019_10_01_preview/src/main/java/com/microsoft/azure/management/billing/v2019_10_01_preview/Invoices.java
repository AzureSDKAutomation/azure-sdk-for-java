...
public interface Invoices extends HasInner<InvoicesInner> {
     ...
     * @return the observable for the request
     */
    Observable<BillingAccountInvoice> getAsync(String billingAccountName, String billingProfileName, String invoiceName);
     ...
     * @return the observable for the request
     */
    Observable<BillingAccountInvoice> listByBillingSubscriptionAsync(final String billingAccountName, final String billingSubscriptionName, final String periodStartDate, final String periodEndDate);
