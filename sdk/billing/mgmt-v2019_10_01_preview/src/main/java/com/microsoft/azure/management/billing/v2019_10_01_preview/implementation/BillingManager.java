...
import com.microsoft.azure.management.billing.v2019_10_01_preview.EaInvoices;
...
public final class BillingManager extends ManagerCore<BillingManager, BillingManagementClientImpl> {
    ...
    private BillingAccountInvoices billingAccountInvoices;
    private EaInvoices eaInvoices;
    private PriceSheets priceSheets;
    private BillingSubscriptionInvoices billingSubscriptionInvoices;
    ...
    */
    ...
    /**
     * @return Entry point to manage BillingAccountInvoices.
     */
    public BillingAccountInvoices billingAccountInvoices() {
        if (this.billingAccountInvoices == null) {
            this.billingAccountInvoices = new BillingAccountInvoicesImpl(this);
        }
        return this.billingAccountInvoices;
    }

    /**
     * @return Entry point to manage EaInvoices.
     */
    public EaInvoices eaInvoices() {
        if (this.eaInvoices == null) {
            this.eaInvoices = new EaInvoicesImpl(this);
        }
    ...
    /**
     * @return Entry point to manage BillingSubscriptionInvoices.
     */
    public BillingSubscriptionInvoices billingSubscriptionInvoices() {
        if (this.billingSubscriptionInvoices == null) {
            this.billingSubscriptionInvoices = new BillingSubscriptionInvoicesImpl(this);
        }
