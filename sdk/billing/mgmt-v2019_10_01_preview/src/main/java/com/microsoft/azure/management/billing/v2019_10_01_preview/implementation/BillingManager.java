...
public final class BillingManager extends ManagerCore<BillingManager, BillingManagementClientImpl> {
    ...
    private BillingActivityLists billingActivityLists;
    private BillingActivityTypesLists billingActivityTypesLists;
    ...
    */
    ...
    /**
     * @return Entry point to manage BillingActivityLists.
     */
    public BillingActivityLists billingActivityLists() {
        if (this.billingActivityLists == null) {
            this.billingActivityLists = new BillingActivityListsImpl(this);
        }
        return this.billingActivityLists;
    }

    /**
     * @return Entry point to manage BillingActivityTypesLists.
     */
    public BillingActivityTypesLists billingActivityTypesLists() {
        if (this.billingActivityTypesLists == null) {
            this.billingActivityTypesLists = new BillingActivityTypesListsImpl(this);
        }
