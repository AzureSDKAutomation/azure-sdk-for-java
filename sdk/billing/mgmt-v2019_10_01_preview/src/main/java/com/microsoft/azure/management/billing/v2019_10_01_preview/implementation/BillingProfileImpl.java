...
class BillingProfileImpl extends CreatableUpdatableImpl<BillingProfile, BillingProfileInner, BillingProfileImpl> implements BillingProfile, BillingProfile.Definition, BillingProfile.Update {
    ...
    public BudgetInformation budgetInformation() {
        return this.inner().budgetInformation();
    }
    ...
    @Override
    public BillingProfileImpl withBudgetInformation(BudgetInformation budgetInformation) {
        this.inner().withBudgetInformation(budgetInformation);
        return this;
    }
