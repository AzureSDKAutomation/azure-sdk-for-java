...
class CustomerBillingProfileBillingAccountTransferDetailsImpl extends IndexableRefreshableWrapperImpl<CustomerBillingProfileBillingAccountTransferDetails, TransferDetailsInner> implements CustomerBillingProfileBillingAccountTransferDetails {
    ...
    protected Observable<TransferDetailsInner> getInnerAsync() {
        ...
        return client.getAsync(this.billingAccountName, this.billingProfileName, this.customerName, this.transferName);
    }
