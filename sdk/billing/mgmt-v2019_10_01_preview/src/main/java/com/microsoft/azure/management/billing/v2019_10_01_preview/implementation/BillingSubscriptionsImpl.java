...
class BillingSubscriptionsImpl extends WrapperImpl<BillingSubscriptionsInner> implements BillingSubscriptions {
    ...
    @Override
    public Observable<BillingSubscription> listByEnrollmentAccountAsync(final String billingAccountName, final String enrollmentAccountName) {
        BillingSubscriptionsInner client = this.inner();
    ...
    @Override
    public Observable<BillingSubscription> listByDepartmentsAsync(final String billingAccountName, final String departmentName) {
        BillingSubscriptionsInner client = this.inner();
        return client.listByDepartmentsAsync(billingAccountName, departmentName)
        .flatMapIterable(new Func1<Page<BillingSubscriptionInner>, Iterable<BillingSubscriptionInner>>() {
            @Override
            public Iterable<BillingSubscriptionInner> call(Page<BillingSubscriptionInner> page) {
                return page.items();
    ...
    @Override
    public Observable<BillingSubscription> updateAsync(String billingAccountName, String billingSubscriptionName, String costCenterName) {
        BillingSubscriptionsInner client = this.inner();
        return client.updateAsync(billingAccountName, billingSubscriptionName, costCenterName)
        .map(new Func1<BillingSubscriptionInner, BillingSubscription>() {
            @Override
            public BillingSubscription call(BillingSubscriptionInner inner) {
                return new BillingSubscriptionImpl(inner, manager());
