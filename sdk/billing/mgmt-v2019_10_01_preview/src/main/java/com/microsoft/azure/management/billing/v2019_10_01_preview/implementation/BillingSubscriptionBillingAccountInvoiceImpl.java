...
class BillingSubscriptionBillingAccountInvoiceImpl extends IndexableRefreshableWrapperImpl<BillingSubscriptionBillingAccountInvoice, InvoiceInner> implements BillingSubscriptionBillingAccountInvoice {
    private final BillingManager manager;
    private String billingSubscriptionName;
    private String invoiceName;

    BillingSubscriptionBillingAccountInvoiceImpl(InvoiceInner inner,  BillingManager manager) {
        super(null, inner);
    ...
    protected Observable<InvoiceInner> getInnerAsync() {
        BillingSubscriptionInvoicesInner client = this.manager().inner().billingSubscriptionInvoices();
        return client.getByIdAsync(this.billingSubscriptionName, this.invoiceName);
    }
    ...
    public String invoiceNumber() {
        return this.inner().invoiceNumber();
    }
