 ...
 */
public interface Departments extends SupportsCreating<Department.DefinitionStages.Blank>, HasInner<DepartmentsInner> {
    /**
     ...
     * @return the observable for the request
     */
    Completable deleteAsync(String billingAccountName, String departmentName);
     ...
     * @return the observable for the request
     */
    Observable<Department> addAsync(String billingAccountName, DepartmentInner parameters);
