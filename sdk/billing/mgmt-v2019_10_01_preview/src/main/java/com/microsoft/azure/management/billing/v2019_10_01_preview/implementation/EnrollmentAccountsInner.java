...
import com.microsoft.azure.management.billing.v2019_10_01_preview.CreateEnrollmentAccount;
 ...
 */
public class EnrollmentAccountsInner implements InnerSupportsDelete<EnrollmentAccountInner> {
    ...
    interface EnrollmentAccountsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.EnrollmentAccounts create" })
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/createEnrollmentAccount")
        Observable<Response<ResponseBody>> create(@Path("billingAccountName") String billingAccountName, @Query("api-version") String apiVersion, @Body CreateEnrollmentAccount parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.EnrollmentAccounts update" })
        @PATCH("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/enrollmentAccounts/{enrollmentAccountName}")
        Observable<Response<ResponseBody>> update(@Path("billingAccountName") String billingAccountName, @Path("enrollmentAccountName") String enrollmentAccountName, @Query("api-version") String apiVersion, @Body UpdateEnrollmentAccount parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.EnrollmentAccounts delete" })
        @HTTP(path = "providers/Microsoft.Billing/billingAccounts/{billingAccountName}/enrollmentAccounts/{enrollmentAccountName}", method = "DELETE", hasBody = true)
        Observable<Response<ResponseBody>> delete(@Path("billingAccountName") String billingAccountName, @Path("enrollmentAccountName") String enrollmentAccountName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public EnrollmentAccountInner create(String billingAccountName, CreateEnrollmentAccount parameters) {
        return createWithServiceResponseAsync(billingAccountName, parameters).toBlocking().single().body();
    }
     ...
     */
    public ServiceFuture<EnrollmentAccountInner> createAsync(String billingAccountName, CreateEnrollmentAccount parameters, final ServiceCallback<EnrollmentAccountInner> serviceCallback) {
        return ServiceFuture.fromResponse(createWithServiceResponseAsync(billingAccountName, parameters), serviceCallback);
    }
     ...
     */
    public Observable<EnrollmentAccountInner> createAsync(String billingAccountName, CreateEnrollmentAccount parameters) {
        return createWithServiceResponseAsync(billingAccountName, parameters).map(new Func1<ServiceResponse<EnrollmentAccountInner>, EnrollmentAccountInner>() {
            @Override
     ...
     * @return the observable to the EnrollmentAccountInner object
     */
    public Observable<ServiceResponse<EnrollmentAccountInner>> createWithServiceResponseAsync(String billingAccountName, CreateEnrollmentAccount parameters) {
        ...
        return service.create(billingAccountName, this.client.apiVersion(), parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<EnrollmentAccountInner>>>() {
                ...
                public Observable<ServiceResponse<EnrollmentAccountInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<EnrollmentAccountInner> clientResponse = createDelegate(response);
    ...
    private ServiceResponse<EnrollmentAccountInner> createDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<EnrollmentAccountInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(201, new TypeToken<EnrollmentAccountInner>() { }.getType())
    ...
    /**
     * Update an enrollment account to an enrollment or department.
     *
     * @param billingAccountName The ID that uniquely identifies a billing account.
     * @param enrollmentAccountName The ID that uniquely identifies an enrollment account.
     * @param parameters Request parameters that are provided to update enrollment account parameters.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @throws ErrorResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     * @return the EnrollmentAccountInner object if successful.
     */
    public EnrollmentAccountInner update(String billingAccountName, String enrollmentAccountName, UpdateEnrollmentAccount parameters) {
        return updateWithServiceResponseAsync(billingAccountName, enrollmentAccountName, parameters).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<EnrollmentAccountInner> updateAsync(String billingAccountName, String enrollmentAccountName, UpdateEnrollmentAccount parameters, final ServiceCallback<EnrollmentAccountInner> serviceCallback) {
        return ServiceFuture.fromResponse(updateWithServiceResponseAsync(billingAccountName, enrollmentAccountName, parameters), serviceCallback);
    }
     ...
     * @return the observable to the EnrollmentAccountInner object
     */
    public Observable<EnrollmentAccountInner> updateAsync(String billingAccountName, String enrollmentAccountName, UpdateEnrollmentAccount parameters) {
        return updateWithServiceResponseAsync(billingAccountName, enrollmentAccountName, parameters).map(new Func1<ServiceResponse<EnrollmentAccountInner>, EnrollmentAccountInner>() {
            @Override
            public EnrollmentAccountInner call(ServiceResponse<EnrollmentAccountInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the EnrollmentAccountInner object
     */
    public Observable<ServiceResponse<EnrollmentAccountInner>> updateWithServiceResponseAsync(String billingAccountName, String enrollmentAccountName, UpdateEnrollmentAccount parameters) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (enrollmentAccountName == null) {
        ...
        Validator.validate(parameters);
        return service.update(billingAccountName, enrollmentAccountName, this.client.apiVersion(), parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<EnrollmentAccountInner>>>() {
                @Override
                public Observable<ServiceResponse<EnrollmentAccountInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<EnrollmentAccountInner> clientResponse = updateDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<EnrollmentAccountInner> updateDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<EnrollmentAccountInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<EnrollmentAccountInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
     ...
     * @return the EnrollmentAccountInner object if successful.
     */
    public EnrollmentAccountInner delete(String billingAccountName, String enrollmentAccountName) {
        return deleteWithServiceResponseAsync(billingAccountName, enrollmentAccountName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<EnrollmentAccountInner> deleteAsync(String billingAccountName, String enrollmentAccountName, final ServiceCallback<EnrollmentAccountInner> serviceCallback) {
        return ServiceFuture.fromResponse(deleteWithServiceResponseAsync(billingAccountName, enrollmentAccountName), serviceCallback);
    }
     ...
     * @return the observable to the EnrollmentAccountInner object
     */
    public Observable<EnrollmentAccountInner> deleteAsync(String billingAccountName, String enrollmentAccountName) {
        return deleteWithServiceResponseAsync(billingAccountName, enrollmentAccountName).map(new Func1<ServiceResponse<EnrollmentAccountInner>, EnrollmentAccountInner>() {
            @Override
            public EnrollmentAccountInner call(ServiceResponse<EnrollmentAccountInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the EnrollmentAccountInner object
     */
    public Observable<ServiceResponse<EnrollmentAccountInner>> deleteWithServiceResponseAsync(String billingAccountName, String enrollmentAccountName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (enrollmentAccountName == null) {
        ...
        return service.delete(billingAccountName, enrollmentAccountName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<EnrollmentAccountInner>>>() {
                @Override
                public Observable<ServiceResponse<EnrollmentAccountInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<EnrollmentAccountInner> clientResponse = deleteDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<EnrollmentAccountInner> deleteDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<EnrollmentAccountInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<EnrollmentAccountInner>() { }.getType())
