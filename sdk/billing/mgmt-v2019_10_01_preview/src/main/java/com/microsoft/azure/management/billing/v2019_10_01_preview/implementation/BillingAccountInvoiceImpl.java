...
class BillingAccountInvoiceImpl extends IndexableRefreshableWrapperImpl<BillingAccountInvoice, InvoiceInner> implements BillingAccountInvoice {
    private final BillingManager manager;
    private String billingAccountName;
    private String invoiceName;

    BillingAccountInvoiceImpl(InvoiceInner inner,  BillingManager manager) {
        super(null, inner);
    ...
    protected Observable<InvoiceInner> getInnerAsync() {
        BillingAccountInvoicesInner client = this.manager().inner().billingAccountInvoices();
