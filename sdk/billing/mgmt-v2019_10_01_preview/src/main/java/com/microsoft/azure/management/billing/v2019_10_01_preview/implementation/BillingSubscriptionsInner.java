...
import com.microsoft.azure.management.billing.v2019_10_01_preview.BillingSubscriptionsUpdateHeaders;
...
public class BillingSubscriptionsInner {
    ...
    interface BillingSubscriptionsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.BillingSubscriptions listByEnrollmentAccount" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.BillingSubscriptions listByDepartments" })
        @GET("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/departments/{departmentName}/billingSubscriptions")
        Observable<Response<ResponseBody>> listByDepartments(@Path("billingAccountName") String billingAccountName, @Path("departmentName") String departmentName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.BillingSubscriptions update" })
        @PUT("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}/{costCenterName}")
        Observable<Response<ResponseBody>> update(@Path("billingAccountName") String billingAccountName, @Path("billingSubscriptionName") String billingSubscriptionName, @Path("costCenterName") String costCenterName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.BillingSubscriptions listByEnrollmentAccountNext" })
        @GET
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2019_10_01_preview.BillingSubscriptions listByDepartmentsNext" })
        @GET
        Observable<Response<ResponseBody>> listByDepartmentsNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    ...
    /**
     * Lists the subscriptions for a billing account. The operation is supported for billing accounts with agreement type Enterprise Agreement.
     *
     * @param billingAccountName The ID that uniquely identifies a billing account.
     ...
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object if successful.
     */
    public PagedList<BillingSubscriptionInner> listByEnrollmentAccount(final String billingAccountName, final String enrollmentAccountName) {
        ServiceResponse<Page<BillingSubscriptionInner>> response = listByEnrollmentAccountSinglePageAsync(billingAccountName, enrollmentAccountName).toBlocking().single();
        return new PagedList<BillingSubscriptionInner>(response.body()) {
            @Override
            public Page<BillingSubscriptionInner> nextPage(String nextPageLink) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<BillingSubscriptionInner>> listByEnrollmentAccountAsync(final String billingAccountName, final String enrollmentAccountName, final ListOperationCallback<BillingSubscriptionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<Page<BillingSubscriptionInner>> listByEnrollmentAccountAsync(final String billingAccountName, final String enrollmentAccountName) {
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByEnrollmentAccountWithServiceResponseAsync(final String billingAccountName, final String enrollmentAccountName) {
     ...
     *
    ServiceResponse<PageImpl<BillingSubscriptionInner>> * @param billingAccountName The ID that uniquely identifies a billing account.
    ServiceResponse<PageImpl<BillingSubscriptionInner>> * @param enrollmentAccountName The ID that uniquely identifies an enrollment account.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByEnrollmentAccountSinglePageAsync(final String billingAccountName, final String enrollmentAccountName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        ...
        return service.listByEnrollmentAccount(billingAccountName, enrollmentAccountName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<BillingSubscriptionInner>> result = listByEnrollmentAccountDelegate(response);
                        return Observable.just(new ServiceResponse<Page<BillingSubscriptionInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<BillingSubscriptionInner>> listByEnrollmentAccountDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<BillingSubscriptionInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<BillingSubscriptionInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
     ...
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object if successful.
     */
    public PagedList<BillingSubscriptionInner> listByDepartments(final String billingAccountName, final String departmentName) {
        ServiceResponse<Page<BillingSubscriptionInner>> response = listByDepartmentsSinglePageAsync(billingAccountName, departmentName).toBlocking().single();
        return new PagedList<BillingSubscriptionInner>(response.body()) {
            @Override
            public Page<BillingSubscriptionInner> nextPage(String nextPageLink) {
                return listByDepartmentsNextSinglePageAsync(nextPageLink).toBlocking().single().body();
            }
        };
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<BillingSubscriptionInner>> listByDepartmentsAsync(final String billingAccountName, final String departmentName, final ListOperationCallback<BillingSubscriptionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByDepartmentsSinglePageAsync(billingAccountName, departmentName),
            new Func1<String, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(String nextPageLink) {
                    return listByDepartmentsNextSinglePageAsync(nextPageLink);
                }
            },
            serviceCallback);
    }
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<Page<BillingSubscriptionInner>> listByDepartmentsAsync(final String billingAccountName, final String departmentName) {
        return listByDepartmentsWithServiceResponseAsync(billingAccountName, departmentName)
            .map(new Func1<ServiceResponse<Page<BillingSubscriptionInner>>, Page<BillingSubscriptionInner>>() {
                @Override
                public Page<BillingSubscriptionInner> call(ServiceResponse<Page<BillingSubscriptionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByDepartmentsWithServiceResponseAsync(final String billingAccountName, final String departmentName) {
        return listByDepartmentsSinglePageAsync(billingAccountName, departmentName)
            .concatMap(new Func1<ServiceResponse<Page<BillingSubscriptionInner>>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(ServiceResponse<Page<BillingSubscriptionInner>> page) {
                    String nextPageLink = page.body().nextPageLink();
                    ...
                    return Observable.just(page).concatWith(listByDepartmentsNextWithServiceResponseAsync(nextPageLink));
                }
            });
    }
     ...
     *
    ServiceResponse<PageImpl<BillingSubscriptionInner>> * @param billingAccountName The ID that uniquely identifies a billing account.
    ServiceResponse<PageImpl<BillingSubscriptionInner>> * @param departmentName The ID that uniquely identifies a department.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByDepartmentsSinglePageAsync(final String billingAccountName, final String departmentName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        ...
        return service.listByDepartments(billingAccountName, departmentName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<BillingSubscriptionInner>> result = listByDepartmentsDelegate(response);
                        return Observable.just(new ServiceResponse<Page<BillingSubscriptionInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<BillingSubscriptionInner>> listByDepartmentsDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<BillingSubscriptionInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<BillingSubscriptionInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
    ...
    /**
     * Updates subscriptions. Currently, only cost center can be updated. The operation is supported only for billing accounts with agreement type Enterprise Agreement.
     *
     * @param billingAccountName The ID that uniquely identifies a billing account.
     * @param billingSubscriptionName The ID that uniquely identifies a subscription.
     * @param costCenterName Request parameters that are provided to the update cost center operation.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @throws ErrorResponseException thrown if the request is rejected by server
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     * @return the BillingSubscriptionInner object if successful.
     */
    public BillingSubscriptionInner update(String billingAccountName, String billingSubscriptionName, String costCenterName) {
        return updateWithServiceResponseAsync(billingAccountName, billingSubscriptionName, costCenterName).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingSubscriptionInner> updateAsync(String billingAccountName, String billingSubscriptionName, String costCenterName, final ServiceCallback<BillingSubscriptionInner> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(updateWithServiceResponseAsync(billingAccountName, billingSubscriptionName, costCenterName), serviceCallback);
    }
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<BillingSubscriptionInner> updateAsync(String billingAccountName, String billingSubscriptionName, String costCenterName) {
        return updateWithServiceResponseAsync(billingAccountName, billingSubscriptionName, costCenterName).map(new Func1<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders>, BillingSubscriptionInner>() {
            @Override
            public BillingSubscriptionInner call(ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable to the BillingSubscriptionInner object
     */
    public Observable<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders>> updateWithServiceResponseAsync(String billingAccountName, String billingSubscriptionName, String costCenterName) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingSubscriptionName == null) {
        ...
        if (costCenterName == null) {
            throw new IllegalArgumentException("Parameter costCenterName is required and cannot be null.");
        }
        if (this.client.apiVersion() == null) {
            throw new IllegalArgumentException("Parameter this.client.apiVersion() is required and cannot be null.");
        }
        return service.update(billingAccountName, billingSubscriptionName, costCenterName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders> clientResponse = updateDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<BillingSubscriptionInner, BillingSubscriptionsUpdateHeaders> updateDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<BillingSubscriptionInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<BillingSubscriptionInner>() { }.getType())
                .register(202, new TypeToken<Void>() { }.getType())
                .registerError(ErrorResponseException.class)
                .buildWithHeaders(response, BillingSubscriptionsUpdateHeaders.class);
    }
     ...
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object if successful.
     */
    public PagedList<BillingSubscriptionInner> listByEnrollmentAccountNext(final String nextPageLink) {
        ServiceResponse<Page<BillingSubscriptionInner>> response = listByEnrollmentAccountNextSinglePageAsync(nextPageLink).toBlocking().single();
        return new PagedList<BillingSubscriptionInner>(response.body()) {
            @Override
            public Page<BillingSubscriptionInner> nextPage(String nextPageLink) {
                return listByEnrollmentAccountNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<BillingSubscriptionInner>> listByEnrollmentAccountNextAsync(final String nextPageLink, final ServiceFuture<List<BillingSubscriptionInner>> serviceFuture, final ListOperationCallback<BillingSubscriptionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<Page<BillingSubscriptionInner>> listByEnrollmentAccountNextAsync(final String nextPageLink) {
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByEnrollmentAccountNextWithServiceResponseAsync(final String nextPageLink) {
        return listByEnrollmentAccountNextSinglePageAsync(nextPageLink)
            .concatMap(new Func1<ServiceResponse<Page<BillingSubscriptionInner>>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(ServiceResponse<Page<BillingSubscriptionInner>> page) {
     ...
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByEnrollmentAccountNextSinglePageAsync(final String nextPageLink) {
        if (nextPageLink == null) {
            throw new IllegalArgumentException("Parameter nextPageLink is required and cannot be null.");
        }
        String nextUrl = String.format("%s", nextPageLink);
        return service.listByEnrollmentAccountNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<BillingSubscriptionInner>> result = listByEnrollmentAccountNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<BillingSubscriptionInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<BillingSubscriptionInner>> listByEnrollmentAccountNextDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<BillingSubscriptionInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<BillingSubscriptionInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
     ...
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object if successful.
     */
    public PagedList<BillingSubscriptionInner> listByDepartmentsNext(final String nextPageLink) {
        ServiceResponse<Page<BillingSubscriptionInner>> response = listByDepartmentsNextSinglePageAsync(nextPageLink).toBlocking().single();
        return new PagedList<BillingSubscriptionInner>(response.body()) {
            @Override
            public Page<BillingSubscriptionInner> nextPage(String nextPageLink) {
                return listByDepartmentsNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<BillingSubscriptionInner>> listByDepartmentsNextAsync(final String nextPageLink, final ServiceFuture<List<BillingSubscriptionInner>> serviceFuture, final ListOperationCallback<BillingSubscriptionInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByDepartmentsNextSinglePageAsync(nextPageLink),
            new Func1<String, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(String nextPageLink) {
                    return listByDepartmentsNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<Page<BillingSubscriptionInner>> listByDepartmentsNextAsync(final String nextPageLink) {
        return listByDepartmentsNextWithServiceResponseAsync(nextPageLink)
            .map(new Func1<ServiceResponse<Page<BillingSubscriptionInner>>, Page<BillingSubscriptionInner>>() {
                @Override
                public Page<BillingSubscriptionInner> call(ServiceResponse<Page<BillingSubscriptionInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;BillingSubscriptionInner&gt; object
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByDepartmentsNextWithServiceResponseAsync(final String nextPageLink) {
        return listByDepartmentsNextSinglePageAsync(nextPageLink)
            .concatMap(new Func1<ServiceResponse<Page<BillingSubscriptionInner>>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(ServiceResponse<Page<BillingSubscriptionInner>> page) {
     ...
     * @return the PagedList&lt;BillingSubscriptionInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> listByDepartmentsNextSinglePageAsync(final String nextPageLink) {
        if (nextPageLink == null) {
            throw new IllegalArgumentException("Parameter nextPageLink is required and cannot be null.");
        }
        String nextUrl = String.format("%s", nextPageLink);
        return service.listByDepartmentsNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<BillingSubscriptionInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<BillingSubscriptionInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<BillingSubscriptionInner>> result = listByDepartmentsNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<BillingSubscriptionInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<BillingSubscriptionInner>> listByDepartmentsNextDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<BillingSubscriptionInner>, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<BillingSubscriptionInner>>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
