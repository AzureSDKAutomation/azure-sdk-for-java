...
public interface BillingSubscriptions extends HasInner<BillingSubscriptionsInner> {
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscription> listByEnrollmentAccountAsync(final String billingAccountName, final String enrollmentAccountName);
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscription> listByDepartmentsAsync(final String billingAccountName, final String departmentName);
     ...
     * @return the observable for the request
     */
    Observable<BillingSubscription> updateAsync(String billingAccountName, String billingSubscriptionName, String costCenterName);
