...
class PayableOverageImpl extends WrapperImpl<PayableOverageInner> implements PayableOverage {
    private final BillingManager manager;
    PayableOverageImpl(PayableOverageInner inner, BillingManager manager) {
        super(inner);
