...
public class BillingProfileInner extends ProxyResource {
    ...
    /**
     * Specifies if the billing profile was created during transition of the
     * billing account from agreement type Microsoft Online Service Program to
     * agreement type Microsoft Customer Agreement.
     */
    @JsonProperty(value = "properties.isTransitioned", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get specifies if the billing profile was created during transition of the billing account from agreement type Microsoft Online Service Program to agreement type Microsoft Customer Agreement.
     *
     * @return the isTransitioned value
     */
