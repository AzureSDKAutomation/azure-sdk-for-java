...
class DepartmentsImpl extends WrapperImpl<DepartmentsInner> implements Departments {
    ...
    @Override
    public DepartmentImpl define(String name) {
    ...
    private DepartmentImpl wrapModel(String name) {
        return new DepartmentImpl(name, this.manager());
    }
    ...
    @Override
    public Completable deleteAsync(String billingAccountName, String departmentName) {
        DepartmentsInner client = this.inner();
        return client.deleteAsync(billingAccountName, departmentName).toCompletable();
    }

    @Override
    public Observable<Department> addAsync(String billingAccountName, DepartmentInner parameters) {
        DepartmentsInner client = this.inner();
        return client.addAsync(billingAccountName, parameters)
