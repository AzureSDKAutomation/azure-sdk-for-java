...
class BillingSubscriptionImpl extends IndexableRefreshableWrapperImpl<BillingSubscription, BillingSubscriptionInner> implements BillingSubscription {
    ...
    public String enrollmentAccountId() {
        return this.inner().enrollmentAccountId();
    }

    @Override
    public String enrollmentAccountName() {
        return this.inner().enrollmentAccountName();
    }

    @Override
    public String enrollmentAccountStartDate() {
        return this.inner().enrollmentAccountStartDate();
    }
    ...
    public BillingEnrollmentAccountSubscriptionStatusType subscriptionEnrollmentAccountStatus() {
        return this.inner().subscriptionEnrollmentAccountStatus();
    }
