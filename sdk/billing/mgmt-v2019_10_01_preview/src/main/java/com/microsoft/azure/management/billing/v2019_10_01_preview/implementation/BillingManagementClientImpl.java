...
public class BillingManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * The BillingAccountInvoicesInner object to access its operations.
     */
    private BillingAccountInvoicesInner billingAccountInvoices;

    /**
     * Gets the BillingAccountInvoicesInner object to access its operations.
     * @return the BillingAccountInvoicesInner object.
     */
    public BillingAccountInvoicesInner billingAccountInvoices() {
        return this.billingAccountInvoices;
    }

    /**
     * The EaInvoicesInner object to access its operations.
     */
    private EaInvoicesInner eaInvoices;

    /**
     * Gets the EaInvoicesInner object to access its operations.
     * @return the EaInvoicesInner object.
     */
    public EaInvoicesInner eaInvoices() {
        return this.eaInvoices;
    }
    ...
    /**
     * The BillingSubscriptionInvoicesInner object to access its operations.
     */
    private BillingSubscriptionInvoicesInner billingSubscriptionInvoices;

    /**
     * Gets the BillingSubscriptionInvoicesInner object to access its operations.
     * @return the BillingSubscriptionInvoicesInner object.
     */
    public BillingSubscriptionInvoicesInner billingSubscriptionInvoices() {
        return this.billingSubscriptionInvoices;
    }
    ...
    protected void initialize() {
        ...
        this.billingAccountInvoices = new BillingAccountInvoicesInner(restClient().retrofit(), this);
        this.eaInvoices = new EaInvoicesInner(restClient().retrofit(), this);
        this.priceSheets = new PriceSheetsInner(restClient().retrofit(), this);
        this.billingSubscriptionInvoices = new BillingSubscriptionInvoicesInner(restClient().retrofit(), this);
