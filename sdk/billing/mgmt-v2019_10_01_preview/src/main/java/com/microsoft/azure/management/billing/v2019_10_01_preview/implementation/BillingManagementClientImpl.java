...
public class BillingManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * The BillingActivityListsInner object to access its operations.
     */
    private BillingActivityListsInner billingActivityLists;

    /**
     * Gets the BillingActivityListsInner object to access its operations.
     * @return the BillingActivityListsInner object.
     */
    public BillingActivityListsInner billingActivityLists() {
        return this.billingActivityLists;
    }

    /**
     * The BillingActivityTypesListsInner object to access its operations.
     */
    private BillingActivityTypesListsInner billingActivityTypesLists;

    /**
     * Gets the BillingActivityTypesListsInner object to access its operations.
     * @return the BillingActivityTypesListsInner object.
     */
    public BillingActivityTypesListsInner billingActivityTypesLists() {
        return this.billingActivityTypesLists;
    }
    ...
    protected void initialize() {
        ...
        this.billingActivityLists = new BillingActivityListsInner(restClient().retrofit(), this);
        this.billingActivityTypesLists = new BillingActivityTypesListsInner(restClient().retrofit(), this);
