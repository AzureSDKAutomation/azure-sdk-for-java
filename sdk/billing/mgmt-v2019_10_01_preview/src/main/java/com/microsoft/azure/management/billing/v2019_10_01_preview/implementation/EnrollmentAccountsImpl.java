...
class EnrollmentAccountsImpl extends WrapperImpl<EnrollmentAccountsInner> implements EnrollmentAccounts {
    ...
    @Override
    public Completable deleteAsync(String billingAccountName, String enrollmentAccountName) {
        EnrollmentAccountsInner client = this.inner();
        return client.deleteAsync(billingAccountName, enrollmentAccountName).toCompletable();
    }

    @Override
    public Observable<EnrollmentAccount> createAsync(String billingAccountName, CreateEnrollmentAccount parameters) {
        EnrollmentAccountsInner client = this.inner();
