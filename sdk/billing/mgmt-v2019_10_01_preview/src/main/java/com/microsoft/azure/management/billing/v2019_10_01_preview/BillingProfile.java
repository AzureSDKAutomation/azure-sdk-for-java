...
public interface BillingProfile extends HasInner<BillingProfileInner>, Indexable, Refreshable<BillingProfile>, Updatable<BillingProfile.Update>, HasManager<BillingManager> {
    ...
    /**
     * @return the budgetInformation value.
     */
    ...
    interface DefinitionStages {
        ...
        /**
         * The stage of the billingprofile definition allowing to specify BudgetInformation.
         */
        interface WithBudgetInformation {
            /**
             * Specifies budgetInformation.
             * @param budgetInformation The budget information associated with the billing profile
             * @return the next definition stage
             */
            WithCreate withBudgetInformation(BudgetInformation budgetInformation);
        }
         ...
         */
        interface WithCreate extends Creatable<BillingProfile>, DefinitionStages.WithAddress, DefinitionStages.WithBudgetInformation, DefinitionStages.WithDisplayName, DefinitionStages.WithEnabledAzurePlans, DefinitionStages.WithInvoiceEmailOptIn, DefinitionStages.WithInvoiceSections, DefinitionStages.WithPoNumber {
        }
    }
    /**
     * The template for a BillingProfile update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<BillingProfile>, UpdateStages.WithAddress, UpdateStages.WithBudgetInformation, UpdateStages.WithDisplayName, UpdateStages.WithEnabledAzurePlans, UpdateStages.WithInvoiceEmailOptIn, UpdateStages.WithInvoiceSections, UpdateStages.WithPoNumber {
    }
    ...
    interface UpdateStages {
        ...
        /**
         * The stage of the billingprofile update allowing to specify BudgetInformation.
         */
        interface WithBudgetInformation {
            /**
             * Specifies budgetInformation.
             ...
             * @return the next update stage
             */
            Update withBudgetInformation(BudgetInformation budgetInformation);
        }
