...
class InvoicesImpl extends WrapperImpl<InvoicesInner> implements Invoices {
    ...
    @Override
    public Observable<BillingAccountInvoice> getAsync(String billingAccountName, String billingProfileName, String invoiceName) {
        InvoicesInner client = this.inner();
        return client.getAsync(billingAccountName, billingProfileName, invoiceName)
        .map(new Func1<InvoiceInner, BillingAccountInvoice>() {
            @Override
            public BillingAccountInvoice call(InvoiceInner inner) {
    ...
    @Override
    public Observable<BillingAccountInvoice> listByBillingSubscriptionAsync(final String billingAccountName, final String billingSubscriptionName, final String periodStartDate, final String periodEndDate) {
        InvoicesInner client = this.inner();
