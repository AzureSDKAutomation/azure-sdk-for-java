...
public interface Transfers extends HasInner<TransfersInner> {
     ...
     * @return the observable for the request
     */
    Observable<TransferDetails> initiateAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, InitiateTransferRequest parameters);
     ...
     * @return the observable for the request
     */
    Completable changeInvoiceSectionAsync(String billingAccountName, String destinationInvoiceSectionId);
