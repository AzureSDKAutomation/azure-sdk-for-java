...
public interface BillingRoleAssignments extends HasInner<BillingRoleAssignmentsInner> {
     ...
     * @return the observable for the request
     */
    Observable<BillingAccountBillingRoleAssignment> listByInvoiceSectionAsync(final String billingAccountName, final String billingProfileName, final String invoiceSectionName);
     ...
     * @return the observable for the request
     */
    Observable<BillingAccountBillingRoleAssignment> listByBillingProfileAsync(final String billingAccountName, final String billingProfileName);
