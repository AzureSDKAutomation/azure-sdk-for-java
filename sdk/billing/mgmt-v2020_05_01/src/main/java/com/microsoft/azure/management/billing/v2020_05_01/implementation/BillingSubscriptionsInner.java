...
import com.microsoft.azure.management.billing.v2020_05_01.BillingSubscriptionsChangeInvoiceSectionHeaders;
...
public class BillingSubscriptionsInner {
    ...
    interface BillingSubscriptionsService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2020_05_01.BillingSubscriptions changeInvoiceSection" })
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/changeInvoiceSection")
        Observable<Response<ResponseBody>> changeInvoiceSection(@Path("billingAccountName") String billingAccountName, @Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body TransferBillingSubscriptionRequestProperties parameters, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.billing.v2020_05_01.BillingSubscriptions beginChangeInvoiceSection" })
        @POST("providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{subscriptionId}/changeInvoiceSection")
        Observable<Response<ResponseBody>> beginChangeInvoiceSection(@Path("billingAccountName") String billingAccountName, @Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Body TransferBillingSubscriptionRequestProperties parameters, @Header("User-Agent") String userAgent);
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    public void changeInvoiceSection(String billingAccountName, String destinationInvoiceSectionId) {
        changeInvoiceSectionWithServiceResponseAsync(billingAccountName, destinationInvoiceSectionId).toBlocking().last().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Void> changeInvoiceSectionAsync(String billingAccountName, String destinationInvoiceSectionId, final ServiceCallback<Void> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(changeInvoiceSectionWithServiceResponseAsync(billingAccountName, destinationInvoiceSectionId), serviceCallback);
    }
     ...
     * @return the observable for the request
     */
    public Observable<Void> changeInvoiceSectionAsync(String billingAccountName, String destinationInvoiceSectionId) {
        return changeInvoiceSectionWithServiceResponseAsync(billingAccountName, destinationInvoiceSectionId).map(new Func1<ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders> response) {
                return response.body();
            }
        });
    }
     ...
     * @return the observable for the request
     */
    public Observable<ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders>> changeInvoiceSectionWithServiceResponseAsync(String billingAccountName, String destinationInvoiceSectionId) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (this.client.subscriptionId() == null) {
        ...
        TransferBillingSubscriptionRequestProperties parameters = new TransferBillingSubscriptionRequestProperties();
        parameters.withDestinationInvoiceSectionId(destinationInvoiceSectionId);
        Observable<Response<ResponseBody>> observable = service.changeInvoiceSection(billingAccountName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), parameters, this.client.userAgent());
        return client.getAzureClient().getPostOrDeleteResultWithHeadersAsync(observable, new TypeToken<Void>() { }.getType(), BillingSubscriptionsChangeInvoiceSectionHeaders.class);
    }
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent
     */
    public void beginChangeInvoiceSection(String billingAccountName, String destinationInvoiceSectionId) {
        beginChangeInvoiceSectionWithServiceResponseAsync(billingAccountName, destinationInvoiceSectionId).toBlocking().single().body();
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Void> beginChangeInvoiceSectionAsync(String billingAccountName, String destinationInvoiceSectionId, final ServiceCallback<Void> serviceCallback) {
        return ServiceFuture.fromHeaderResponse(beginChangeInvoiceSectionWithServiceResponseAsync(billingAccountName, destinationInvoiceSectionId), serviceCallback);
    }
     ...
     */
    public Observable<Void> beginChangeInvoiceSectionAsync(String billingAccountName, String destinationInvoiceSectionId) {
        return beginChangeInvoiceSectionWithServiceResponseAsync(billingAccountName, destinationInvoiceSectionId).map(new Func1<ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders>, Void>() {
            @Override
            public Void call(ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders> response) {
                return response.body();
            }
     ...
     * @return the {@link ServiceResponseWithHeaders} object if successful.
     */
    public Observable<ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders>> beginChangeInvoiceSectionWithServiceResponseAsync(String billingAccountName, String destinationInvoiceSectionId) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (this.client.subscriptionId() == null) {
        ...
        TransferBillingSubscriptionRequestProperties parameters = new TransferBillingSubscriptionRequestProperties();
        parameters.withDestinationInvoiceSectionId(destinationInvoiceSectionId);
        return service.beginChangeInvoiceSection(billingAccountName, this.client.subscriptionId(), apiVersion, this.client.acceptLanguage(), parameters, this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders>>>() {
                @Override
                public Observable<ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders> clientResponse = beginChangeInvoiceSectionDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponseWithHeaders<Void, BillingSubscriptionsChangeInvoiceSectionHeaders> beginChangeInvoiceSectionDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(202, new TypeToken<Void>() { }.getType())
                .registerError(ErrorResponseException.class)
                .buildWithHeaders(response, BillingSubscriptionsChangeInvoiceSectionHeaders.class);
    }
