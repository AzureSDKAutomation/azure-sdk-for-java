...
class TransfersImpl extends WrapperImpl<TransfersInner> implements Transfers {
    ...
    @Override
    public Observable<TransferDetails> initiateAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, InitiateTransferRequest parameters) {
        TransfersInner client = this.inner();
    ...
    @Override
    public Completable changeInvoiceSectionAsync(String billingAccountName, String destinationInvoiceSectionId) {
        TransfersInner client = this.inner();
        return client.changeInvoiceSectionAsync(billingAccountName, destinationInvoiceSectionId).toCompletable();
    }
