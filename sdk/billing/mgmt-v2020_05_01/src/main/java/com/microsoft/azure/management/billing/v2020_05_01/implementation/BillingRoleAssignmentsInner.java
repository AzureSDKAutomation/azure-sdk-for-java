...
import com.microsoft.azure.management.billing.v2020_05_01.BillingRoleAssignmentRequestProperties;
...
public class BillingRoleAssignmentsInner {
    ...
    interface BillingRoleAssignmentsService {
        ...
        Observable<Response<ResponseBody>> addByBillingAccount(@Path("billingAccountName") String billingAccountName, @Query("api-version") String apiVersion, @Body BillingRoleAssignmentRequestProperties parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> addByInvoiceSection(@Path("billingAccountName") String billingAccountName, @Path("billingProfileName") String billingProfileName, @Path("invoiceSectionName") String invoiceSectionName, @Query("api-version") String apiVersion, @Body BillingRoleAssignmentRequestProperties parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
        ...
        Observable<Response<ResponseBody>> addByBillingProfile(@Path("billingAccountName") String billingAccountName, @Path("billingProfileName") String billingProfileName, @Query("api-version") String apiVersion, @Body BillingRoleAssignmentRequestProperties parameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     * @return the BillingRoleAssignmentInner object if successful.
     */
    public BillingRoleAssignmentInner addByBillingAccount(String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingRoleAssignmentInner> addByBillingAccountAsync(String billingAccountName, BillingRoleAssignmentRequestProperties parameters, final ServiceCallback<BillingRoleAssignmentInner> serviceCallback) {
     ...
     * @return the observable to the BillingRoleAssignmentInner object
     */
    public Observable<BillingRoleAssignmentInner> addByBillingAccountAsync(String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
        return addByBillingAccountWithServiceResponseAsync(billingAccountName, parameters).map(new Func1<ServiceResponse<BillingRoleAssignmentInner>, BillingRoleAssignmentInner>() {
            @Override
            public BillingRoleAssignmentInner call(ServiceResponse<BillingRoleAssignmentInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the BillingRoleAssignmentInner object
     */
    public Observable<ServiceResponse<BillingRoleAssignmentInner>> addByBillingAccountWithServiceResponseAsync(String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (parameters == null) {
        ...
        final String apiVersion = "2020-05-01";
        return service.addByBillingAccount(billingAccountName, apiVersion, parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<BillingRoleAssignmentInner>>>() {
                @Override
                public Observable<ServiceResponse<BillingRoleAssignmentInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<BillingRoleAssignmentInner> clientResponse = addByBillingAccountDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<BillingRoleAssignmentInner> addByBillingAccountDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<BillingRoleAssignmentInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(201, new TypeToken<BillingRoleAssignmentInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
    }
     ...
     * @return the BillingRoleAssignmentInner object if successful.
     */
    public BillingRoleAssignmentInner addByInvoiceSection(String billingAccountName, String billingProfileName, String invoiceSectionName, BillingRoleAssignmentRequestProperties parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingRoleAssignmentInner> addByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, BillingRoleAssignmentRequestProperties parameters, final ServiceCallback<BillingRoleAssignmentInner> serviceCallback) {
     ...
     * @return the observable to the BillingRoleAssignmentInner object
     */
    public Observable<BillingRoleAssignmentInner> addByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, BillingRoleAssignmentRequestProperties parameters) {
        return addByInvoiceSectionWithServiceResponseAsync(billingAccountName, billingProfileName, invoiceSectionName, parameters).map(new Func1<ServiceResponse<BillingRoleAssignmentInner>, BillingRoleAssignmentInner>() {
            @Override
            public BillingRoleAssignmentInner call(ServiceResponse<BillingRoleAssignmentInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the BillingRoleAssignmentInner object
     */
    public Observable<ServiceResponse<BillingRoleAssignmentInner>> addByInvoiceSectionWithServiceResponseAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, BillingRoleAssignmentRequestProperties parameters) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        Validator.validate(parameters);
        final String apiVersion = "2020-05-01";
        return service.addByInvoiceSection(billingAccountName, billingProfileName, invoiceSectionName, apiVersion, parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<BillingRoleAssignmentInner>>>() {
                @Override
                public Observable<ServiceResponse<BillingRoleAssignmentInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<BillingRoleAssignmentInner> clientResponse = addByInvoiceSectionDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<BillingRoleAssignmentInner> addByInvoiceSectionDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<BillingRoleAssignmentInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(201, new TypeToken<BillingRoleAssignmentInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
     ...
     * @return the BillingRoleAssignmentInner object if successful.
     */
    public BillingRoleAssignmentInner addByBillingProfile(String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<BillingRoleAssignmentInner> addByBillingProfileAsync(String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters, final ServiceCallback<BillingRoleAssignmentInner> serviceCallback) {
     ...
     * @return the observable to the BillingRoleAssignmentInner object
     */
    public Observable<BillingRoleAssignmentInner> addByBillingProfileAsync(String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        return addByBillingProfileWithServiceResponseAsync(billingAccountName, billingProfileName, parameters).map(new Func1<ServiceResponse<BillingRoleAssignmentInner>, BillingRoleAssignmentInner>() {
            @Override
            public BillingRoleAssignmentInner call(ServiceResponse<BillingRoleAssignmentInner> response) {
                return response.body();
            }
     ...
     * @return the observable to the BillingRoleAssignmentInner object
     */
    public Observable<ServiceResponse<BillingRoleAssignmentInner>> addByBillingProfileWithServiceResponseAsync(String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        if (billingAccountName == null) {
            throw new IllegalArgumentException("Parameter billingAccountName is required and cannot be null.");
        }
        if (billingProfileName == null) {
        ...
        Validator.validate(parameters);
        final String apiVersion = "2020-05-01";
        return service.addByBillingProfile(billingAccountName, billingProfileName, apiVersion, parameters, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<BillingRoleAssignmentInner>>>() {
                @Override
                public Observable<ServiceResponse<BillingRoleAssignmentInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<BillingRoleAssignmentInner> clientResponse = addByBillingProfileDelegate(response);
                        return Observable.just(clientResponse);
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<BillingRoleAssignmentInner> addByBillingProfileDelegate(Response<ResponseBody> response) throws ErrorResponseException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<BillingRoleAssignmentInner, ErrorResponseException>newInstance(this.client.serializerAdapter())
                .register(201, new TypeToken<BillingRoleAssignmentInner>() { }.getType())
                .registerError(ErrorResponseException.class)
                .build(response);
