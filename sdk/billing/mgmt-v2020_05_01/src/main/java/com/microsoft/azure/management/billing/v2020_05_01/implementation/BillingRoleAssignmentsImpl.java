...
import com.microsoft.azure.management.billing.v2020_05_01.BillingAccountBillingRoleAssignment;
...
class BillingRoleAssignmentsImpl extends WrapperImpl<BillingRoleAssignmentsInner> implements BillingRoleAssignments {
    ...
    @Override
    public Observable<BillingAccountBillingRoleAssignment> listByInvoiceSectionAsync(final String billingAccountName, final String billingProfileName, final String invoiceSectionName) {
        BillingRoleAssignmentsInner client = this.inner();
    ...
    @Override
    public Observable<BillingAccountBillingRoleAssignment> listByBillingProfileAsync(final String billingAccountName, final String billingProfileName) {
        BillingRoleAssignmentsInner client = this.inner();
