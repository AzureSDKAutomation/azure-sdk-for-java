...
class BillingRoleAssignmentsImpl extends WrapperImpl<BillingRoleAssignmentsInner> implements BillingRoleAssignments {
    ...
    @Override
    public Observable<BillingRoleAssignment> addByBillingAccountAsync(String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
        BillingRoleAssignmentsInner client = this.inner();
    ...
    @Override
    public Observable<BillingRoleAssignment> addByInvoiceSectionAsync(String billingAccountName, String billingProfileName, String invoiceSectionName, BillingRoleAssignmentRequestProperties parameters) {
        BillingRoleAssignmentsInner client = this.inner();
    ...
    @Override
    public Observable<BillingRoleAssignment> addByBillingProfileAsync(String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        BillingRoleAssignmentsInner client = this.inner();
