...
public interface BillingAccount {
    ...
    /**
     * Gets the subscriptions property: List of subscriptions, associated with billing account.
     *
     * @return the subscriptions value.
     */
    List<BillingAccountSubscriptions> subscriptions();

    /**
     * Gets the tradeScreeningState property: The current trade screening state of the billing account.
     *
