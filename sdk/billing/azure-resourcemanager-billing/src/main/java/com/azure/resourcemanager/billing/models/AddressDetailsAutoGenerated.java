...
/** Address details. */
@Fluent
public final class AddressDetailsAutoGenerated {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AddressDetailsAutoGenerated.class);
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withFirstName(String firstName) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withMiddleName(String middleName) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withLastName(String lastName) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withCompanyName(String companyName) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withAddressLine1(String addressLine1) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withAddressLine2(String addressLine2) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withAddressLine3(String addressLine3) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withCity(String city) {
        this.city = city;
        return this;
    }
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withDistrict(String district) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withRegion(String region) {
        this.region = region;
        return this;
    }
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withCountry(String country) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withPostalCode(String postalCode) {
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withEmail(String email) {
        this.email = email;
        return this;
    }
     ...
     * @return the AddressDetailsAutoGenerated object itself.
     */
    public AddressDetailsAutoGenerated withPhoneNumber(String phoneNumber) {
            ...
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property addressLine1 in model AddressDetailsAutoGenerated"));
        }
        if (country() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property country in model AddressDetailsAutoGenerated"));
        }
    }
}
