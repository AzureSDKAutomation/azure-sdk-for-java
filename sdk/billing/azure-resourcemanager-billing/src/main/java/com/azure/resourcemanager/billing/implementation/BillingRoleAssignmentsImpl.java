...
public final class BillingRoleAssignmentsImpl implements BillingRoleAssignments {
    ...
    public BillingRoleAssignment addByBillingAccount(
        ...
        BillingRoleAssignmentInner inner = this.serviceClient().addByBillingAccount(billingAccountName, parameters);
        if (inner != null) {
    ...
    public Response<BillingRoleAssignment> addByBillingAccountWithResponse(
        ...
        Response<BillingRoleAssignmentInner> inner =
            this.serviceClient().addByBillingAccountWithResponse(billingAccountName, parameters, context);
        if (inner != null) {
    ...
    public BillingRoleAssignment addByInvoiceSection(
        ...
        BillingRoleAssignmentInner inner =
            this
                .serviceClient()
                .addByInvoiceSection(billingAccountName, billingProfileName, invoiceSectionName, parameters);
        if (inner != null) {
            return new BillingRoleAssignmentImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<BillingRoleAssignment> addByInvoiceSectionWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        BillingRoleAssignmentRequestProperties parameters,
        ...
        Response<BillingRoleAssignmentInner> inner =
            this
                .serviceClient()
                .addByInvoiceSectionWithResponse(
    ...
    public BillingRoleAssignment addByBillingProfile(
        String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        BillingRoleAssignmentInner inner =
            this.serviceClient().addByBillingProfile(billingAccountName, billingProfileName, parameters);
        if (inner != null) {
            return new BillingRoleAssignmentImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<BillingRoleAssignment> addByBillingProfileWithResponse(
        String billingAccountName,
        String billingProfileName,
        BillingRoleAssignmentRequestProperties parameters,
        Context context) {
        Response<BillingRoleAssignmentInner> inner =
            this
                .serviceClient()
                .addByBillingProfileWithResponse(billingAccountName, billingProfileName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
