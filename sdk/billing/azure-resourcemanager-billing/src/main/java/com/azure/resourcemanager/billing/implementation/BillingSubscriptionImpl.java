...
public final class BillingSubscriptionImpl implements BillingSubscription {
    ...
    public BillingSubscriptionImpl(BillingSubscriptionInner innerObject, BillingManager serviceManager) {
    ...
    public List<SubscriptionSuspensionReason> suspensionReasons() {
        List<SubscriptionSuspensionReason> inner = this.innerModel().suspensionReasons();
        if (inner != null) {
