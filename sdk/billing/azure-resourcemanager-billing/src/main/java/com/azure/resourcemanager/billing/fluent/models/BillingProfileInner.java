...
public class BillingProfileInner extends ProxyResource {
    ...
    /*
     * The list of email addresses to receive invoices by email for the billing
     * profile.
     */
    @JsonProperty(value = "properties.invoiceRecipients")
     ...
     * @return the BillingProfileInner object itself.
     */
    public BillingProfileInner withInvoiceRecipients(List<String> invoiceRecipients) {
    ...
    /**
     * Set the spendingLimitDetails property: The details of billing profile spending limit.
     *
     * @param spendingLimitDetails the spendingLimitDetails value to set.
     * @return the BillingProfileInner object itself.
     */
    public BillingProfileInner withSpendingLimitDetails(List<SpendingLimitDetails> spendingLimitDetails) {
