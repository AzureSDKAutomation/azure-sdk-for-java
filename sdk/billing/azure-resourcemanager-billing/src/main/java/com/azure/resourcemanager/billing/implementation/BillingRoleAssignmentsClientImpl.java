...
import com.azure.resourcemanager.billing.models.BillingRoleAssignmentRequestProperties;
...
public final class BillingRoleAssignmentsClientImpl implements BillingRoleAssignmentsClient {
    ...
    private interface BillingRoleAssignmentsService {
        ...
        Mono<Response<BillingRoleAssignmentInner>> addByBillingAccount(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("billingAccountName") String billingAccountName,
            @BodyParam("application/json") BillingRoleAssignmentRequestProperties parameters,
        ...
        @Post(
            "/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}"
                + "/invoiceSections/{invoiceSectionName}/createBillingRoleAssignment")
        @ExpectedResponses({201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BillingRoleAssignmentInner>> addByInvoiceSection(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("billingAccountName") String billingAccountName,
        ...
        @ExpectedResponses({201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BillingRoleAssignmentInner>> addByBillingProfile(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("billingAccountName") String billingAccountName,
            @PathParam("billingProfileName") String billingProfileName,
     ...
     * @param parameters The request parameters to add the role assignment on a scope.
    ...
    private Mono<Response<BillingRoleAssignmentInner>> addByBillingAccountWithResponseAsync(
        String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BillingRoleAssignmentInner>> addByBillingAccountWithResponseAsync(
        String billingAccountName, BillingRoleAssignmentRequestProperties parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<BillingRoleAssignmentInner> addByBillingAccountAsync(
        String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
        return addByBillingAccountWithResponseAsync(billingAccountName, parameters)
            .flatMap(
    ...
    public BillingRoleAssignmentInner addByBillingAccount(
        String billingAccountName, BillingRoleAssignmentRequestProperties parameters) {
        return addByBillingAccountAsync(billingAccountName, parameters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BillingRoleAssignmentInner> addByBillingAccountWithResponse(
        String billingAccountName, BillingRoleAssignmentRequestProperties parameters, Context context) {
        return addByBillingAccountWithResponseAsync(billingAccountName, parameters, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BillingRoleAssignmentInner>> addByInvoiceSectionWithResponseAsync(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        BillingRoleAssignmentRequestProperties parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BillingRoleAssignmentInner> addByInvoiceSectionAsync(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        BillingRoleAssignmentRequestProperties parameters) {
        return addByInvoiceSectionWithResponseAsync(
                billingAccountName, billingProfileName, invoiceSectionName, parameters)
            .flatMap(
                (Response<BillingRoleAssignmentInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BillingRoleAssignmentInner addByInvoiceSection(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        BillingRoleAssignmentRequestProperties parameters) {
        return addByInvoiceSectionAsync(billingAccountName, billingProfileName, invoiceSectionName, parameters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BillingRoleAssignmentInner> addByInvoiceSectionWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        BillingRoleAssignmentRequestProperties parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<BillingRoleAssignmentInner>> addByBillingProfileWithResponseAsync(
        String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BillingRoleAssignmentInner> addByBillingProfileAsync(
        String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        return addByBillingProfileWithResponseAsync(billingAccountName, billingProfileName, parameters)
            .flatMap(
                (Response<BillingRoleAssignmentInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BillingRoleAssignmentInner addByBillingProfile(
        String billingAccountName, String billingProfileName, BillingRoleAssignmentRequestProperties parameters) {
        return addByBillingProfileAsync(billingAccountName, billingProfileName, parameters).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<BillingRoleAssignmentInner> addByBillingProfileWithResponse(
        String billingAccountName,
        String billingProfileName,
        BillingRoleAssignmentRequestProperties parameters,
        Context context) {
        return addByBillingProfileWithResponseAsync(billingAccountName, billingProfileName, parameters, context)
            .block();
    }
