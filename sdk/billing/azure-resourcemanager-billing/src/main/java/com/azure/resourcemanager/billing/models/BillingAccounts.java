...
public interface BillingAccounts {
     ...
     * be updated for billing accounts with agreement type Microsoft Online Services Agreement.
     *
     * @param billingAccountName The ID that uniquely identifies a billing account.
     * @param parameters The request properties of the billing account that can be updated.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws com.azure.core.management.exception.ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
