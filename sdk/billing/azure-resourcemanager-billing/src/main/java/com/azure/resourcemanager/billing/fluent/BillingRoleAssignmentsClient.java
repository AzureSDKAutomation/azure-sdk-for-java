...
public interface BillingRoleAssignmentsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BillingRoleAssignmentInner> addByBillingAccountWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BillingRoleAssignmentInner addByInvoiceSection(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BillingRoleAssignmentInner> addByInvoiceSectionWithResponse(
        String billingAccountName,
        String billingProfileName,
        String invoiceSectionName,
        BillingRoleAssignmentRequestProperties parameters,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    BillingRoleAssignmentInner addByBillingProfile(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<BillingRoleAssignmentInner> addByBillingProfileWithResponse(
        String billingAccountName,
        String billingProfileName,
        BillingRoleAssignmentRequestProperties parameters,
        Context context);
