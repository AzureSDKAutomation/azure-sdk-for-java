...
public final class BillingProfileImpl implements BillingProfile {
    ...
    public BillingProfileImpl(BillingProfileInner innerObject, BillingManager serviceManager) {
    ...
    public List<String> invoiceRecipients() {
        List<String> inner = this.innerModel().invoiceRecipients();
        if (inner != null) {
    ...
    public List<SpendingLimitDetails> spendingLimitDetails() {
        List<SpendingLimitDetails> inner = this.innerModel().spendingLimitDetails();
        if (inner != null) {
            return Collections.unmodifiableList(inner);
        } else {
            return Collections.emptyList();
