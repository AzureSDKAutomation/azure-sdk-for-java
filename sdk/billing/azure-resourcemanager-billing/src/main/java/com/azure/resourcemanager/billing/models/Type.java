...
public final class Type extends ExpandableStringEnum<Type> {
    /** Static value FreeAccount for Type. */
    public static final Type FREE_ACCOUNT = fromString("FreeAccount");

    /** Static value Sandbox for Type. */
    public static final Type SANDBOX = fromString("Sandbox");
