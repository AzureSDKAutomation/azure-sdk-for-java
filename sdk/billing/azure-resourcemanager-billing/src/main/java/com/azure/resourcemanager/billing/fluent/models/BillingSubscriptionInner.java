...
public class BillingSubscriptionInner extends ProxyResource {
     ...
     */
    @JsonProperty(value = "properties.SubscriptionBillingStatusReasonDetails")
    private Object subscriptionBillingStatusReasonDetails;
     ...
     * Spending limit details.
     */
    @JsonProperty(value = "properties.spendingLimitDetails")
    private Object spendingLimitDetails;
    ...
    /**
     * Get the subscriptionBillingStatusReasonDetails property: Spending limit details.
     *
     * @return the subscriptionBillingStatusReasonDetails value.
     */
    public Object subscriptionBillingStatusReasonDetails() {
        return this.subscriptionBillingStatusReasonDetails;
    }

    /**
     * Set the subscriptionBillingStatusReasonDetails property: Spending limit details.
     *
     * @param subscriptionBillingStatusReasonDetails the subscriptionBillingStatusReasonDetails value to set.
     * @return the BillingSubscriptionInner object itself.
     */
    public BillingSubscriptionInner withSubscriptionBillingStatusReasonDetails(
        Object subscriptionBillingStatusReasonDetails) {
        this.subscriptionBillingStatusReasonDetails = subscriptionBillingStatusReasonDetails;
        return this;
    }
    ...
    /**
     * Get the spendingLimitDetails property: Spending limit details.
     *
     * @return the spendingLimitDetails value.
     */
    public Object spendingLimitDetails() {
        return this.spendingLimitDetails;
    }

    /**
     * Set the spendingLimitDetails property: Spending limit details.
     *
     * @param spendingLimitDetails the spendingLimitDetails value to set.
     * @return the BillingSubscriptionInner object itself.
     */
    public BillingSubscriptionInner withSpendingLimitDetails(Object spendingLimitDetails) {
