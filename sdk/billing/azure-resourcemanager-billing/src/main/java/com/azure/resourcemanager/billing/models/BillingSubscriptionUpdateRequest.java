...
@JsonFlatten
@Fluent
public class BillingSubscriptionUpdateRequest {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BillingSubscriptionUpdateRequest.class);
     ...
     */
    @JsonProperty(value = "properties.suspensionReasons")
    private List<SubscriptionSuspensionReason> suspensionReasons;
     ...
     * @return the BillingSubscriptionUpdateRequest object itself.
     */
    public BillingSubscriptionUpdateRequest withSubscriptionBillingStatus(
    ...
    /**
     * Get the suspensionReasons property: The suspension reasons for current subscription.
     *
     * @return the suspensionReasons value.
     */
    public List<SubscriptionSuspensionReason> suspensionReasons() {
        return this.suspensionReasons;
    }

    /**
     * Set the suspensionReasons property: The suspension reasons for current subscription.
     *
     * @param suspensionReasons the suspensionReasons value to set.
     * @return the BillingSubscriptionUpdateRequest object itself.
     */
    public BillingSubscriptionUpdateRequest withSuspensionReasons(
        List<SubscriptionSuspensionReason> suspensionReasons) {
     ...
     * @return the BillingSubscriptionUpdateRequest object itself.
     */
    public BillingSubscriptionUpdateRequest withCostCenter(String costCenter) {
     ...
     * @return the BillingSubscriptionUpdateRequest object itself.
     */
    public BillingSubscriptionUpdateRequest withSkuId(String skuId) {
        this.skuId = skuId;
        return this;
    }
    ...
    public void validate() {
        if (suspensionReasons() != null) {
            suspensionReasons().forEach(e -> e.validate());
        }
