...
public interface PrivateLinkResourcesClient {
    ...
    PrivateLinkResourceListResultInner listByHostPool(String resourceGroupName, String hostPoolName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PrivateLinkResourceListResultInner> listByHostPoolWithResponse(
