...
public class SessionHostInner extends ProxyResource {
     ...
     */
    @JsonProperty(value = "properties.sessionHostHealthCheckResult", access = JsonProperty.Access.WRITE_ONLY)
    private List<SessionHostHealthCheckReport> sessionHostHealthCheckResult;
    ...
    /**
     * Get the sessionHostHealthCheckResult property: List of SessionHostHealthCheckReports.
     *
     * @return the sessionHostHealthCheckResult value.
     */
    public List<SessionHostHealthCheckReport> sessionHostHealthCheckResult() {
        return this.sessionHostHealthCheckResult;
    }
    ...
    public void validate() {
        if (sessionHostHealthCheckResult() != null) {
            sessionHostHealthCheckResult().forEach(e -> e.validate());
        }
    }
}
