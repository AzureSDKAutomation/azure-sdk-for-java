...
public final class HostPoolUpdateConfigurationProperties {
    ...
    /**
     * Get the logOffDelayMinutes property: Grace period before logging off users in seconds.
     *
    ...
    /**
     * Set the logOffDelayMinutes property: Grace period before logging off users in seconds.
     *
     * @param logOffDelayMinutes the logOffDelayMinutes value to set.
     * @return the HostPoolUpdateConfigurationProperties object itself.
     */
    public HostPoolUpdateConfigurationProperties withLogOffDelayMinutes(Integer logOffDelayMinutes) {
