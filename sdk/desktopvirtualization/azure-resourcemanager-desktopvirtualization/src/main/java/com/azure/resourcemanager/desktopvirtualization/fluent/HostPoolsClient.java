...
public interface HostPoolsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    RegistrationInfoInner newPath(String resourceGroupName, String hostPoolName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<RegistrationInfoInner> newPathWithResponse(String resourceGroupName, String hostPoolName, Context context);
