...
public interface HostPools {
     ...
     */
    RegistrationInfo newPath(String resourceGroupName, String hostPoolName);
     ...
     * @return represents a RegistrationInfo definition.
     */
    Response<RegistrationInfo> newPathWithResponse(String resourceGroupName, String hostPoolName, Context context);
