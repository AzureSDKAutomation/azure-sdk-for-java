...
public final class PrivateEndpointConnectionsImpl implements PrivateEndpointConnections {
    ...
    public PrivateEndpointConnectionListResultWithSystemData listByHostPool(
        String resourceGroupName, String hostPoolName) {
        PrivateEndpointConnectionListResultWithSystemDataInner inner =
            this.serviceClient().listByHostPool(resourceGroupName, hostPoolName);
        if (inner != null) {
            return new PrivateEndpointConnectionListResultWithSystemDataImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<PrivateEndpointConnectionListResultWithSystemData> listByHostPoolWithResponse(
        String resourceGroupName, String hostPoolName, Context context) {
        Response<PrivateEndpointConnectionListResultWithSystemDataInner> inner =
        ...
        if (inner != null) {
            return new SimpleResponse<>(
                ...
                inner.getStatusCode(),
                inner.getHeaders(),
                new PrivateEndpointConnectionListResultWithSystemDataImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
    ...
    public PrivateEndpointConnectionListResultWithSystemData listByWorkspace(
    ...
    public Response<PrivateEndpointConnectionListResultWithSystemData> listByWorkspaceWithResponse(
