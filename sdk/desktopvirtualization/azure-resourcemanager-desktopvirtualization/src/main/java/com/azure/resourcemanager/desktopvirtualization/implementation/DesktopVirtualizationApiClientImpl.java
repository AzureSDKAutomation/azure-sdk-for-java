...
public final class DesktopVirtualizationApiClientImpl implements DesktopVirtualizationApiClient {
    ...
    /** The HostPoolPostsClient object to access its operations. */
    private final HostPoolPostsClient hostPoolPosts;

    /**
     * Gets the HostPoolPostsClient object to access its operations.
     *
     * @return the HostPoolPostsClient object.
     */
    public HostPoolPostsClient getHostPoolPosts() {
        return this.hostPoolPosts;
    }

    /** The UpdateDetailsClient object to access its operations. */
    private final UpdateDetailsClient updateDetails;

    /**
     * Gets the UpdateDetailsClient object to access its operations.
     *
     * @return the UpdateDetailsClient object.
     */
    public UpdateDetailsClient getUpdateDetails() {
        return this.updateDetails;
    }

    /** The UpdateValidationOperationResultsClient object to access its operations. */
    private final UpdateValidationOperationResultsClient updateValidationOperationResults;

    /**
     * Gets the UpdateValidationOperationResultsClient object to access its operations.
     *
     * @return the UpdateValidationOperationResultsClient object.
     */
    public UpdateValidationOperationResultsClient getUpdateValidationOperationResults() {
        return this.updateValidationOperationResults;
    }

    /** The UpdateOperationResultsClient object to access its operations. */
    private final UpdateOperationResultsClient updateOperationResults;

    /**
     * Gets the UpdateOperationResultsClient object to access its operations.
     *
     * @return the UpdateOperationResultsClient object.
     */
    public UpdateOperationResultsClient getUpdateOperationResults() {
        return this.updateOperationResults;
    }
    ...
    DesktopVirtualizationApiClientImpl(
        ...
        this.hostPoolPosts = new HostPoolPostsClientImpl(this);
        this.updateDetails = new UpdateDetailsClientImpl(this);
        this.updateValidationOperationResults = new UpdateValidationOperationResultsClientImpl(this);
        this.updateOperationResults = new UpdateOperationResultsClientImpl(this);
