...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    private interface PrivateEndpointConnectionsService {
        ...
        Mono<Response<PrivateEndpointConnectionListResultWithSystemDataInner>> listByHostPool(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateEndpointConnectionListResultWithSystemDataInner>> listByWorkspace(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
    ...
    private Mono<Response<PrivateEndpointConnectionListResultWithSystemDataInner>> listByHostPoolWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionListResultWithSystemDataInner> listByHostPoolAsync(
        String resourceGroupName, String hostPoolName) {
        return listByHostPoolWithResponseAsync(resourceGroupName, hostPoolName)
            .flatMap(
                (Response<PrivateEndpointConnectionListResultWithSystemDataInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateEndpointConnectionListResultWithSystemDataInner listByHostPool(
        String resourceGroupName, String hostPoolName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateEndpointConnectionListResultWithSystemDataInner> listByHostPoolWithResponse(
        String resourceGroupName, String hostPoolName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PrivateEndpointConnectionListResultWithSystemDataInner>> listByWorkspaceWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PrivateEndpointConnectionListResultWithSystemDataInner> listByWorkspaceAsync(
        String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PrivateEndpointConnectionListResultWithSystemDataInner listByWorkspace(
        String resourceGroupName, String workspaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PrivateEndpointConnectionListResultWithSystemDataInner> listByWorkspaceWithResponse(
        String resourceGroupName, String workspaceName, Context context) {
