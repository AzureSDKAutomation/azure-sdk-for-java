...
public interface SessionHost {
    ...
    /**
     * Gets the sessionHostConfigurationLastUpdateTime property: This time will match the time in the session host
     * configuration for when the update was initiated.
     *
     * @return the sessionHostConfigurationLastUpdateTime value.
     */
    OffsetDateTime sessionHostConfigurationLastUpdateTime();

    /**
     * Gets the imageResourceId property: The resourceId of the image of session host.
     *
    ...
    /**
     * Gets the imageType property: The type of image session hosts use in the hostpool.
     *
    ...
    /**
     * Gets the updateStatus property: Updating state of the session host.
     *
     * @return the updateStatus value.
     */
    SessionHostUpdateStatus updateStatus();
