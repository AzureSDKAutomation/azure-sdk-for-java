...
public final class SessionHostComponentUpdateType extends ExpandableStringEnum<SessionHostComponentUpdateType> {
    ...
    /** Static value TenantAdminControlled for SessionHostComponentUpdateType. */
    public static final SessionHostComponentUpdateType TENANT_ADMIN_CONTROLLED = fromString("TenantAdminControlled");
