...
public final class HostPoolsClientImpl implements HostPoolsClient {
    ...
    private interface HostPoolsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/controlUpdate")
        @ExpectedResponses({204})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> controlUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> controlUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> controlUpdateAsync(
        String resourceGroupName, String hostPoolName, HostPoolControlParameter hostPoolControlParameter) {
        return controlUpdateWithResponseAsync(resourceGroupName, hostPoolName, hostPoolControlParameter)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void controlUpdate(
        String resourceGroupName, String hostPoolName, HostPoolControlParameter hostPoolControlParameter) {
        controlUpdateAsync(resourceGroupName, hostPoolName, hostPoolControlParameter).block();
    }
    ...
    public Response<Void> controlUpdateWithResponse(
        ...
        HostPoolControlParameter hostPoolControlParameter,
        Context context) {
        return controlUpdateWithResponseAsync(resourceGroupName, hostPoolName, hostPoolControlParameter, context)
            .block();
    }
