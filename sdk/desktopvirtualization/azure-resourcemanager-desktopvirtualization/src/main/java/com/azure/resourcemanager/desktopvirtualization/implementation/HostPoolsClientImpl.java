...
public final class HostPoolsClientImpl implements HostPoolsClient {
    ...
    private interface HostPoolsService {
        ...
        @Post(
            "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers"
                + "/Microsoft.DesktopVirtualization/hostPools/{hostPoolName}/newPath")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RegistrationInfoInner>> newPath(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<RegistrationInfoInner>> newPathWithResponseAsync(
        String resourceGroupName, String hostPoolName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RegistrationInfoInner> newPathAsync(String resourceGroupName, String hostPoolName) {
        return newPathWithResponseAsync(resourceGroupName, hostPoolName)
            .flatMap(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RegistrationInfoInner newPath(String resourceGroupName, String hostPoolName) {
        return newPathAsync(resourceGroupName, hostPoolName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<RegistrationInfoInner> newPathWithResponse(
        String resourceGroupName, String hostPoolName, Context context) {
        return newPathWithResponseAsync(resourceGroupName, hostPoolName, context).block();
    }
