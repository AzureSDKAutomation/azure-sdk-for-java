...
public final class HostPoolUpdateFault {
    ...
    /**
     * Get the faultType property: Hostpool update fault type.
     *
    ...
    /**
     * Set the faultType property: Hostpool update fault type.
     *
     * @param faultType the faultType value to set.
     * @return the HostPoolUpdateFault object itself.
     */
    public HostPoolUpdateFault withFaultType(FaultType faultType) {
