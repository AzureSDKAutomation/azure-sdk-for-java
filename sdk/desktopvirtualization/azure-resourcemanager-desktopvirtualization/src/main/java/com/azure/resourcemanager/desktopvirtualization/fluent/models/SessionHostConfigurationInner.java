...
public class SessionHostConfigurationInner extends ProxyResource {
    ...
    /*
     * The uri to the storage blob containing scripts to be run on the virtual
    ...
    /**
     * Get the vmCustomConfigurationUri property: The uri to the storage blob containing scripts to be run on the
    ...
    /**
     * Set the vmCustomConfigurationUri property: The uri to the storage blob containing scripts to be run on the
     * virtual machine after provisioning.
     *
