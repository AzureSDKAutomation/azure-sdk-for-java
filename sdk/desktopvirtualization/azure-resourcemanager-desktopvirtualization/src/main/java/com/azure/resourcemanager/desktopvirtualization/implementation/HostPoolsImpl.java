...
public final class HostPoolsImpl implements HostPools {
    ...
    public HostPoolsImpl(HostPoolsClient innerClient, DesktopVirtualizationManager serviceManager) {
    ...
    public PagedIterable<HostPool> listByResourceGroup(String resourceGroupName) {
        ...
        return inner.mapPage(inner1 -> new HostPoolImpl(inner1, this.manager()));
    }
