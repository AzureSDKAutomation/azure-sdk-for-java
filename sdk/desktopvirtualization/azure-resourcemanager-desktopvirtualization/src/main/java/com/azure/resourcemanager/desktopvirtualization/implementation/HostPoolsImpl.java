...
public final class HostPoolsImpl implements HostPools {
    ...
    public RegistrationInfo newPath(String resourceGroupName, String hostPoolName) {
        RegistrationInfoInner inner = this.serviceClient().newPath(resourceGroupName, hostPoolName);
        if (inner != null) {
    ...
    public Response<RegistrationInfo> newPathWithResponse(
        String resourceGroupName, String hostPoolName, Context context) {
        Response<RegistrationInfoInner> inner =
            this.serviceClient().newPathWithResponse(resourceGroupName, hostPoolName, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
