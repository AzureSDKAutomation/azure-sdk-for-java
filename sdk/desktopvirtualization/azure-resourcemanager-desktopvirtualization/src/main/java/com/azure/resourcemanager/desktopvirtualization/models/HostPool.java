...
public interface HostPool {
    ...
    /**
     * Gets the sessionHostComponentUpdateConfiguration property: The session host configuration for updating agent,
     * monitoring agent, and stack component.
     *
     * @return the sessionHostComponentUpdateConfiguration value.
     */
    SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration();
    ...
    interface DefinitionStages {
        ...
        interface WithCreate
            extends DefinitionStages.WithTags,
                ...
                DefinitionStages.WithSessionHostComponentUpdateConfiguration {
            /**
        ...
        /** The stage of the HostPool definition allowing to specify sessionHostComponentUpdateConfiguration. */
        interface WithSessionHostComponentUpdateConfiguration {
            /**
             * Specifies the sessionHostComponentUpdateConfiguration property: The session host configuration for
             * updating agent, monitoring agent, and stack component..
             *
             * @param sessionHostComponentUpdateConfiguration The session host configuration for updating agent,
             *     monitoring agent, and stack component.
             * @return the next definition stage.
             */
            WithCreate withSessionHostComponentUpdateConfiguration(
                SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration);
        }
    }
    /**
    ...
    interface Update
        extends UpdateStages.WithTags,
            ...
            UpdateStages.WithSessionHostComponentUpdateConfiguration {
        /**
    ...
    interface UpdateStages {
        ...
        /** The stage of the HostPool update allowing to specify sessionHostComponentUpdateConfiguration. */
        interface WithSessionHostComponentUpdateConfiguration {
            /**
             * Specifies the sessionHostComponentUpdateConfiguration property: The session host configuration for
             * updating agent, monitoring agent, and stack component..
             ...
             * @return the next definition stage.
             */
            Update withSessionHostComponentUpdateConfiguration(
                SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration);
        }
    }
    /**
     ...
     */
    void controlUpdate(HostPoolControlParameter hostPoolControlParameter);
     ...
     * @return the response.
     */
    Response<Void> controlUpdateWithResponse(HostPoolControlParameter hostPoolControlParameter, Context context);
