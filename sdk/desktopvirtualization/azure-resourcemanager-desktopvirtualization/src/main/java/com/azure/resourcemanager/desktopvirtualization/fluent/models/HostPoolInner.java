...
import com.azure.resourcemanager.desktopvirtualization.models.SessionHostComponentUpdateConfigurationProperties;
...
public class HostPoolInner extends ResourceModelWithAllowedPropertySet {
     ...
     * stack component.
     */
    @JsonProperty(value = "properties.sessionHostComponentUpdateConfiguration")
    private SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration;
    ...
    /**
     * Get the sessionHostComponentUpdateConfiguration property: The session host configuration for updating agent,
     * monitoring agent, and stack component.
     *
     * @return the sessionHostComponentUpdateConfiguration value.
     */
    public SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration() {
        return this.sessionHostComponentUpdateConfiguration;
    }

    /**
     * Set the sessionHostComponentUpdateConfiguration property: The session host configuration for updating agent,
     * monitoring agent, and stack component.
     *
     * @param sessionHostComponentUpdateConfiguration the sessionHostComponentUpdateConfiguration value to set.
     * @return the HostPoolInner object itself.
     */
    public HostPoolInner withSessionHostComponentUpdateConfiguration(
        SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration) {
        this.sessionHostComponentUpdateConfiguration = sessionHostComponentUpdateConfiguration;
        return this;
    }
    ...
    public void validate() {
        ...
        if (sessionHostComponentUpdateConfiguration() != null) {
            sessionHostComponentUpdateConfiguration().validate();
        }
    }
}
