...
public final class HostPoolImpl implements HostPool, HostPool.Definition, HostPool.Update {
    ...
    public String newProperty() {
        return this.innerModel().newProperty();
    }
    ...
    public RegistrationInfo newPath() {
        return serviceManager.hostPools().newPath(resourceGroupName, hostPoolName);
    }

    public Response<RegistrationInfo> newPathWithResponse(Context context) {
        return serviceManager.hostPools().newPathWithResponse(resourceGroupName, hostPoolName, context);
    }
    ...
    public HostPoolImpl withNewProperty(String newProperty) {
        this.innerModel().withNewProperty(newProperty);
        return this;
    }
