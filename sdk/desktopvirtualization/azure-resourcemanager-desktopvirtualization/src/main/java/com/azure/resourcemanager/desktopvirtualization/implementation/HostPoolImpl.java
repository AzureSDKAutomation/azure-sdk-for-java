...
public final class HostPoolImpl implements HostPool, HostPool.Definition, HostPool.Update {
    ...
    public SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration() {
        return this.innerModel().sessionHostComponentUpdateConfiguration();
    }
    ...
    public void controlUpdate(HostPoolControlParameter hostPoolControlParameter) {
        serviceManager.hostPools().controlUpdate(resourceGroupName, hostPoolName, hostPoolControlParameter);
    }

    public Response<Void> controlUpdateWithResponse(
        HostPoolControlParameter hostPoolControlParameter, Context context) {
        return serviceManager
            .hostPools()
            .controlUpdateWithResponse(resourceGroupName, hostPoolName, hostPoolControlParameter, context);
    }
    ...
    public HostPoolImpl withSessionHostComponentUpdateConfiguration(
        SessionHostComponentUpdateConfigurationProperties sessionHostComponentUpdateConfiguration) {
        if (isInCreateMode()) {
            this.innerModel().withSessionHostComponentUpdateConfiguration(sessionHostComponentUpdateConfiguration);
            return this;
        } else {
            this.updateHostPool.withSessionHostComponentUpdateConfiguration(sessionHostComponentUpdateConfiguration);
            return this;
        }
    }
