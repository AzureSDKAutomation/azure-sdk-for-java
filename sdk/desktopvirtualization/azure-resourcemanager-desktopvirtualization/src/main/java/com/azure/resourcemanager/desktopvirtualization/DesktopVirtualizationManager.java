...
import com.azure.resourcemanager.desktopvirtualization.implementation.HostPoolPostsImpl;
...
import com.azure.resourcemanager.desktopvirtualization.implementation.UpdateDetailsImpl;
import com.azure.resourcemanager.desktopvirtualization.implementation.UpdateOperationResultsImpl;
import com.azure.resourcemanager.desktopvirtualization.implementation.UpdateValidationOperationResultsImpl;
...
import com.azure.resourcemanager.desktopvirtualization.models.UpdateDetails;
...
public final class DesktopVirtualizationManager {
    ...
    private HostPoolPosts hostPoolPosts;

    private UpdateDetails updateDetails;

    private UpdateValidationOperationResults updateValidationOperationResults;

    private UpdateOperationResults updateOperationResults;
    ...
    /** @return Resource collection API of HostPoolPosts. */
    public HostPoolPosts hostPoolPosts() {
        if (this.hostPoolPosts == null) {
            this.hostPoolPosts = new HostPoolPostsImpl(clientObject.getHostPoolPosts(), this);
        }
        return hostPoolPosts;
    }

    /** @return Resource collection API of UpdateDetails. */
    public UpdateDetails updateDetails() {
        if (this.updateDetails == null) {
            this.updateDetails = new UpdateDetailsImpl(clientObject.getUpdateDetails(), this);
        }
        return updateDetails;
    }

    /** @return Resource collection API of UpdateValidationOperationResults. */
    public UpdateValidationOperationResults updateValidationOperationResults() {
        if (this.updateValidationOperationResults == null) {
            this.updateValidationOperationResults =
                new UpdateValidationOperationResultsImpl(clientObject.getUpdateValidationOperationResults(), this);
        }
        return updateValidationOperationResults;
    }

    /** @return Resource collection API of UpdateOperationResults. */
    public UpdateOperationResults updateOperationResults() {
        if (this.updateOperationResults == null) {
            this.updateOperationResults =
                new UpdateOperationResultsImpl(clientObject.getUpdateOperationResults(), this);
        }
