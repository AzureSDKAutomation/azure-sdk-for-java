 ...
 * in ServerBasedPerformanceTiers.
 */
public class ServerBasedPerformanceTiersInner {
    /** The Retrofit service to perform REST calls. */
    private ServerBasedPerformanceTiersService service;
    /** The service client containing this operation class. */
    private PostgreSQLManagementClientImpl client;

    /**
     * Initializes an instance of ServerBasedPerformanceTiersInner.
     *
     * @param retrofit the Retrofit instance built from a Retrofit Builder.
     * @param client the instance of the service client containing this operation class.
     */
    public ServerBasedPerformanceTiersInner(Retrofit retrofit, PostgreSQLManagementClientImpl client) {
        this.service = retrofit.create(ServerBasedPerformanceTiersService.class);
        this.client = client;
    }

    /**
     * The interface defining all the services for ServerBasedPerformanceTiers to be
     * used by Retrofit to perform actually REST calls.
     */
    interface ServerBasedPerformanceTiersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.postgresql.v2017_12_01_preview.ServerBasedPerformanceTiers list" })
     ...
     */
    public List<PerformanceTierPropertiesInner> list(String resourceGroupName, String serverName) {
     ...
     */
    public ServiceFuture<List<PerformanceTierPropertiesInner>> listAsync(String resourceGroupName, String serverName, final ServiceCallback<List<PerformanceTierPropertiesInner>> serviceCallback) {
     ...
     */
    public Observable<List<PerformanceTierPropertiesInner>> listAsync(String resourceGroupName, String serverName) {
        return listWithServiceResponseAsync(resourceGroupName, serverName).map(new Func1<ServiceResponse<List<PerformanceTierPropertiesInner>>, List<PerformanceTierPropertiesInner>>() {
            @Override
     ...
     * @return the observable to the List&lt;PerformanceTierPropertiesInner&gt; object
     */
    public Observable<ServiceResponse<List<PerformanceTierPropertiesInner>>> listWithServiceResponseAsync(String resourceGroupName, String serverName) {
