...
public class ServerBasedPerformanceTiersInner {
    ...
    interface ServerBasedPerformanceTiersService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.postgresql.v2017_12_01.ServerBasedPerformanceTiers list" })
