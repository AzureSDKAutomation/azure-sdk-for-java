...
import com.azure.resourcemanager.dataprotection.implementation.ResourceOperationGatekeepersImpl;
...
public final class DataProtectionManager {
    ...
    private ResourceOperationGatekeepers resourceOperationGatekeepers;
        ...
        public DataProtectionManager authenticate(TokenCredential credential, AzureProfile profile) {
            ...
            policies
                .add(
                    new UserAgentPolicy(
                        null,
                        "com.azure.resourcemanager.dataprotection",
                        "1.0.0-beta.1",
    ...
    /** @return Resource collection API of ResourceOperationGatekeepers. */
    public ResourceOperationGatekeepers resourceOperationGatekeepers() {
        if (this.resourceOperationGatekeepers == null) {
            this.resourceOperationGatekeepers =
                new ResourceOperationGatekeepersImpl(clientObject.getResourceOperationGatekeepers(), this);
        }
        return resourceOperationGatekeepers;
    }
