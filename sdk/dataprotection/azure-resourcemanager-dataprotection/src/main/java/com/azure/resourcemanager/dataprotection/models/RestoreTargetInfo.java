...
public final class RestoreTargetInfo extends RestoreTargetInfoBase {
    ...
    /*
     * Credentails to use to authenticate with data source provider.
     */
    ...
    /**
     * Get the datasourceAuthCredentials property: Credentails to use to authenticate with data source provider.
     *
    ...
    /**
     * Set the datasourceAuthCredentials property: Credentails to use to authenticate with data source provider.
     *
