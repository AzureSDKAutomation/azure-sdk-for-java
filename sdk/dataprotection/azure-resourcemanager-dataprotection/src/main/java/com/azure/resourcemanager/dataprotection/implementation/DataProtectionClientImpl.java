...
public final class DataProtectionClientImpl implements DataProtectionClient {
    ...
    /** The ResourceOperationGatekeepersClient object to access its operations. */
    private final ResourceOperationGatekeepersClient resourceOperationGatekeepers;

    /**
     * Gets the ResourceOperationGatekeepersClient object to access its operations.
     *
     * @return the ResourceOperationGatekeepersClient object.
     */
    public ResourceOperationGatekeepersClient getResourceOperationGatekeepers() {
        return this.resourceOperationGatekeepers;
    }
    ...
    DataProtectionClientImpl(
        ...
        this.resourceOperationGatekeepers = new ResourceOperationGatekeepersClientImpl(this);
    }
