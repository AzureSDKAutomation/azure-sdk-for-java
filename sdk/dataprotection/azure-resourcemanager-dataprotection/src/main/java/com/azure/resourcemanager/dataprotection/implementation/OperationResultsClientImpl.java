...
public final class OperationResultsClientImpl implements OperationResultsClient {
    ...
    private interface OperationResultsService {
        ...
        Mono<Response<OperationJobExtendedInfoInner>> get(
    ...
    private Mono<Response<OperationJobExtendedInfoInner>> getWithResponseAsync(String operationId, String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<OperationJobExtendedInfoInner>> getWithResponseAsync(
    ...
    private Mono<OperationJobExtendedInfoInner> getAsync(String operationId, String location) {
        return getWithResponseAsync(operationId, location)
            .flatMap(
                (Response<OperationJobExtendedInfoInner> res) -> {
