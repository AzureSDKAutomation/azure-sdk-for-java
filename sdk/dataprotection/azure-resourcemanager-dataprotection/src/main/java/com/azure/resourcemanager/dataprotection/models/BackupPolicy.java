...
public final class BackupPolicy extends BaseBackupPolicy {
    ...
    /*
     * Policy rule dictionary that contains rules for each backptype i.e
    ...
    /**
     * Get the policyRules property: Policy rule dictionary that contains rules for each backptype i.e
     * Full/Incremental/Logs etc.
     *
    ...
    /**
     * Set the policyRules property: Policy rule dictionary that contains rules for each backptype i.e
     * Full/Incremental/Logs etc.
     *
