...
public final class InnerError {
    ...
    /**
     * Get the additionalInfo property: Any Key value pairs that can be provided to the cleint for additional verbose
     * information.
     *
    ...
    /**
     * Set the additionalInfo property: Any Key value pairs that can be provided to the cleint for additional verbose
     * information.
     *
