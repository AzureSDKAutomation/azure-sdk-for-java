...
public final class JobExtendedInfo {
     ...
     */
    @JsonProperty(value = "dataTransferedInBytes", access = JsonProperty.Access.WRITE_ONLY)
    private Double dataTransferedInBytes;
    ...
    /**
     * Get the dataTransferedInBytes property: Number of bytes transfered.
     *
     * @return the dataTransferedInBytes value.
     */
    public Double dataTransferedInBytes() {
        return this.dataTransferedInBytes;
    }
