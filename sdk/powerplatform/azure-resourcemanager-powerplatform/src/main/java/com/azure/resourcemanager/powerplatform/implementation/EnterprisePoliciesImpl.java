...
public final class EnterprisePoliciesImpl implements EnterprisePolicies {
    ...
    public EnterprisePoliciesImpl(EnterprisePoliciesClient innerClient, PowerPlatformManager serviceManager) {
    ...
    public PagedIterable<EnterprisePolicy> listByResourceGroup(String resourceGroupName) {
        ...
        return inner.mapPage(inner1 -> new EnterprisePolicyImpl(inner1, this.manager()));
    }
