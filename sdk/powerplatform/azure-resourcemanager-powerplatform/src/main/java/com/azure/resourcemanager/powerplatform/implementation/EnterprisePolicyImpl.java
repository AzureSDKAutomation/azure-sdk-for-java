...
public final class EnterprisePolicyImpl
    ...
    public String trackedResourceLocation() {
        return this.innerModel().trackedResourceLocation();
    }
    ...
    EnterprisePolicyImpl(String name, PowerPlatformManager serviceManager) {
    ...
    EnterprisePolicyImpl(EnterprisePolicyInner innerObject, PowerPlatformManager serviceManager) {
    ...
    public EnterprisePolicyImpl withTrackedResourceLocation(String trackedResourceLocation) {
        this.innerModel().withTrackedResourceLocation(trackedResourceLocation);
        return this;
    }
}
