...
class NotebookWorkspacesImpl extends WrapperImpl<NotebookWorkspacesInner> implements NotebookWorkspaces {
    ...
    @Override
    public Observable<NotebookWorkspaceConnectionInfoResult> getConnectionInfoAsync(String resourceGroupName, String accountName) {
        NotebookWorkspacesInner client = this.inner();
        return client.getConnectionInfoAsync(resourceGroupName, accountName)
