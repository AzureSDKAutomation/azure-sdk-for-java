...
@JsonFlatten
@Fluent
public class PrivateZoneAutoGeneratedInner extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(PrivateZoneAutoGeneratedInner.class);
     ...
     * @return the PrivateZoneAutoGeneratedInner object itself.
     */
    public PrivateZoneAutoGeneratedInner withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public PrivateZoneAutoGeneratedInner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public PrivateZoneAutoGeneratedInner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
