...
/** An immutable client-side representation of PrivateZoneAutoGenerated. */
public interface PrivateZoneAutoGenerated {
    /**
    ...
    /**
     * Gets the inner com.azure.resourcemanager.privatedns.generated.fluent.models.PrivateZoneAutoGeneratedInner object.
     *
     * @return the inner object.
     */
    PrivateZoneAutoGeneratedInner innerModel();

    /** The entirety of the PrivateZoneAutoGenerated definition. */
    ...
    /** The PrivateZoneAutoGenerated definition stages. */
    interface DefinitionStages {
        /** The first stage of the PrivateZoneAutoGenerated definition. */
        interface Blank extends WithLocation {
        }
        /** The stage of the PrivateZoneAutoGenerated definition allowing to specify location. */
        ...
        /** The stage of the PrivateZoneAutoGenerated definition allowing to specify parent resource. */
        ...
        /**
         * The stage of the PrivateZoneAutoGenerated definition which contains all the minimum required properties for
        ...
        interface WithCreate
             ...
             */
            PrivateZoneAutoGenerated create();
             ...
             * @return the created resource.
             */
            PrivateZoneAutoGenerated create(Context context);
        }
        /** The stage of the PrivateZoneAutoGenerated definition allowing to specify tags. */
        interface WithTags {
            /**
        ...
        /** The stage of the PrivateZoneAutoGenerated definition allowing to specify etag. */
        interface WithEtag {
            /**
        ...
        /** The stage of the PrivateZoneAutoGenerated definition allowing to specify ifMatch. */
        ...
        /** The stage of the PrivateZoneAutoGenerated definition allowing to specify ifNoneMatch. */
    ...
    /**
     * Begins update for the PrivateZoneAutoGenerated resource.
     *
     * @return the stage of resource update.
     */
    PrivateZoneAutoGenerated.Update update();

    /** The template for PrivateZoneAutoGenerated update. */
    interface Update extends UpdateStages.WithTags, UpdateStages.WithEtag, UpdateStages.WithIfMatch {
         ...
         */
        PrivateZoneAutoGenerated apply();
         ...
         * @return the updated resource.
         */
        PrivateZoneAutoGenerated apply(Context context);
    }
    /** The PrivateZoneAutoGenerated update stages. */
    interface UpdateStages {
        /** The stage of the PrivateZoneAutoGenerated update allowing to specify tags. */
        interface WithTags {
            /**
             * Specifies the tags property: Resource tags..
             *
        ...
        /** The stage of the PrivateZoneAutoGenerated update allowing to specify etag. */
        interface WithEtag {
            /**
             * Specifies the etag property: The ETag of the zone..
             *
        ...
        /** The stage of the PrivateZoneAutoGenerated update allowing to specify ifMatch. */
        interface WithIfMatch {
            /**
             * Specifies the ifMatch property: The ETag of the Private DNS zone. Omit this value to always overwrite the
             * current zone. Specify the last-seen ETag value to prevent accidentally overwriting any concurrent
     ...
     */
    PrivateZoneAutoGenerated refresh();
     ...
     * @return the refreshed resource.
     */
    PrivateZoneAutoGenerated refresh(Context context);
}
