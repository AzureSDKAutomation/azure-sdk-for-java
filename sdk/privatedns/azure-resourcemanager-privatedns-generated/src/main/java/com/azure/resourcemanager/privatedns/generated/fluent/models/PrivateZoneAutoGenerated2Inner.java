...
@JsonFlatten
@Fluent
public class PrivateZoneAutoGenerated2Inner extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(PrivateZoneAutoGenerated2Inner.class);
     ...
     * @return the PrivateZoneAutoGenerated2Inner object itself.
     */
    public PrivateZoneAutoGenerated2Inner withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public PrivateZoneAutoGenerated2Inner withLocation(String location) {
    ...
    /** {@inheritDoc} */
    @Override
    public PrivateZoneAutoGenerated2Inner withTags(Map<String, String> tags) {
        super.withTags(tags);
        return this;
    }
