...
import com.microsoft.azure.management.privatedns.v2020_01_01.RecordType;
...
public class RecordSetsInner {
    ...
    interface RecordSetsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets createOrUpdate" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets update" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets listByType" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets listByTypeNext" })
        @GET
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.privatedns.v2020_01_01.RecordSets listNext" })
        @GET
