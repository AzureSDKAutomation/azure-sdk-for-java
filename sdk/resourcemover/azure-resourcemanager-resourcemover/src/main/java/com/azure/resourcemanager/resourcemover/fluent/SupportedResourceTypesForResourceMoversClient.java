 ...
 */
public interface SupportedResourceTypesForResourceMoversClient {
    /**
    ...
    SupportedResourceTypesForResourceMoverInner get();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<SupportedResourceTypesForResourceMoverInner> getWithResponse(Context context);
}
