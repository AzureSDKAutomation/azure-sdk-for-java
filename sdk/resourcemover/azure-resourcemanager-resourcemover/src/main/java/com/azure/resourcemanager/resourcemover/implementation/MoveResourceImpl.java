...
public final class MoveResourceImpl implements MoveResource, MoveResource.Definition {
    ...
    public MoveResourceImpl(MoveResourceInner innerObject, ResourceMoverManager serviceManager) {
    ...
    public MoveResourceImpl(String name, ResourceMoverManager serviceManager) {
