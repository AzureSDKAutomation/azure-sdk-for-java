...
public class ReplicationStatusInner {
    ...
    /**
     * Get status of the mirror relationship.
     *
    ...
    /**
     * Set status of the mirror relationship.
     *
     * @param relationshipStatus the relationshipStatus value to set
     * @return the ReplicationStatusInner object itself.
     */
    public ReplicationStatusInner withRelationshipStatus(String relationshipStatus) {
    ...
    /**
     * Set the status of the replication.
     *
     * @param mirrorState the mirrorState value to set
     * @return the ReplicationStatusInner object itself.
     */
    public ReplicationStatusInner withMirrorState(String mirrorState) {
