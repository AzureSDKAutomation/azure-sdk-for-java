    ...
    public Backup apply() {
        this.innerObject =
            serviceManager
                ...
                .getBackups()
                .updateWithResponse(
                    resourceGroupName, accountName, poolName, volumeName, backupName, updateBody, Context.NONE)
                .getValue();
        return this;
    }
    ...
    public Backup apply(Context context) {
        this.innerObject =
            serviceManager
                ...
                .getBackups()
                .updateWithResponse(
                    resourceGroupName, accountName, poolName, volumeName, backupName, updateBody, context)
                .getValue();
        return this;
    }
