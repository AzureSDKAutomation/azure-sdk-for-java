...
import com.azure.resourcemanager.netapp.implementation.VolumeRestoreStatusImpl;
...
public final class NetAppFilesManager {
    ...
    private VolumeRestoreStatus volumeRestoreStatus;
    ...
    /** @return Resource collection API of VolumeRestoreStatus. */
    public VolumeRestoreStatus volumeRestoreStatus() {
        if (this.volumeRestoreStatus == null) {
            this.volumeRestoreStatus = new VolumeRestoreStatusImpl(clientObject.getVolumeRestoreStatus(), this);
        }
        return volumeRestoreStatus;
    }
