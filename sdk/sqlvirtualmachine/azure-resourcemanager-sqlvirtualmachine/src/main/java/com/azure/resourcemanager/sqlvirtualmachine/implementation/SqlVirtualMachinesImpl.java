...
public final class SqlVirtualMachinesImpl implements SqlVirtualMachines {
    ...
    public void redeploy(String resourceGroupName, String sqlVirtualMachineName, String locationName) {
        this.serviceClient().redeploy(resourceGroupName, sqlVirtualMachineName, locationName);
    }

    public void redeploy(String resourceGroupName, String sqlVirtualMachineName, String locationName, Context context) {
        this.serviceClient().redeploy(resourceGroupName, sqlVirtualMachineName, locationName, context);
    }
