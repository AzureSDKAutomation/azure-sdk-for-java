...
import com.azure.resourcemanager.quantum.models.ProviderListResult;
...
public final class OfferingsClientImpl implements OfferingsClient {
    private final ClientLogger logger = new ClientLogger(OfferingsClientImpl.class);
    ...
    private interface OfferingsService {
     ...
     * @return the response of a list Providers operation.
     */
