...
public final class QuotaDimension {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(QuotaDimension.class);
    ...
    /*
     * The standard unit of measurement used for this quota dimension in plural
     * form.
     */
