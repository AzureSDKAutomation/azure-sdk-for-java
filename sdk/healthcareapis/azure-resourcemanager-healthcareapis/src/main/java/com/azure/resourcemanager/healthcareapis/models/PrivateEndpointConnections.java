...
public interface PrivateEndpointConnections {
     ...
     */
    PagedIterable<PrivateEndpointConnectionAutoGenerated> listByService(String resourceGroupName, String resourceName);
     ...
     * @return list of private endpoint connection associated with the specified storage account.
     */
    PagedIterable<PrivateEndpointConnectionAutoGenerated> listByService(
