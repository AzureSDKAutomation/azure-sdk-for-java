...
public final class ServicesDescriptionImpl
    ...
    public ServicesDescriptionImpl(String name, HealthcareApisManager serviceManager) {
    ...
    public ServicesDescriptionImpl(ServicesDescriptionInner innerObject, HealthcareApisManager serviceManager) {
