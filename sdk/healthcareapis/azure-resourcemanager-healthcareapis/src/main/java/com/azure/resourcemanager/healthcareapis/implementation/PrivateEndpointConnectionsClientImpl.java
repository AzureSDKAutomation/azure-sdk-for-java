...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
    ...
    private Mono<PagedResponse<PrivateEndpointConnectionAutoGeneratedInner>> listByServiceSinglePageAsync(
    ...
    private PagedFlux<PrivateEndpointConnectionAutoGeneratedInner> listByServiceAsync(
        String resourceGroupName, String resourceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<PrivateEndpointConnectionAutoGeneratedInner> listByService(
        String resourceGroupName, String resourceName) {
