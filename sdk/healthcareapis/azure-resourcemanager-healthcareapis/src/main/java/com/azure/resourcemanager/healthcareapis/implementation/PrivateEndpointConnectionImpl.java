...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl(String name, HealthcareApisManager serviceManager) {
    ...
    public PrivateEndpointConnectionImpl(
        PrivateEndpointConnectionInner innerObject, HealthcareApisManager serviceManager) {
