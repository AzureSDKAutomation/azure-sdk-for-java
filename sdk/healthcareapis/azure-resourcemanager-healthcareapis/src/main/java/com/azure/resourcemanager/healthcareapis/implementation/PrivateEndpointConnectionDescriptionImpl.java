...
public final class PrivateEndpointConnectionDescriptionImpl
    ...
    PrivateEndpointConnectionDescriptionImpl(String name, HealthcareApisManager serviceManager) {
    ...
    PrivateEndpointConnectionDescriptionImpl(
        PrivateEndpointConnectionDescriptionInner innerObject, HealthcareApisManager serviceManager) {
