...
public final class BlobContainersImpl implements BlobContainers {
    ...
    public void versionLevelWorm(String resourceGroupName, String accountName, String containerName) {
        this.serviceClient().versionLevelWorm(resourceGroupName, accountName, containerName);
    }

    public void versionLevelWorm(String resourceGroupName, String accountName, String containerName, Context context) {
        this.serviceClient().versionLevelWorm(resourceGroupName, accountName, containerName, context);
    }
