...
public interface BlobContainersClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<PollResult<Void>, Void> beginVersionLevelWorm(
        String resourceGroupName, String accountName, String containerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void versionLevelWorm(String resourceGroupName, String accountName, String containerName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    void versionLevelWorm(String resourceGroupName, String accountName, String containerName, Context context);
}
