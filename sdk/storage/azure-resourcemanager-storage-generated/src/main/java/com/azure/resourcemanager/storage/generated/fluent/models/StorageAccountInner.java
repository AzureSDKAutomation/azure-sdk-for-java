...
public class StorageAccountInner extends Resource {
    ...
    /*
     * True if the account supports ABAC, otherwise false if the subscription
     * is registered with the AFEC
     * Microsoft.Storage/AllowAttributeBasedAccessControl, otherwise null
     */
    @JsonProperty(value = "properties.isAttributeBasedAccessControlEnabled", access = JsonProperty.Access.WRITE_ONLY)
    private Boolean isAttributeBasedAccessControlEnabled;
    ...
    /**
     * Get the isAttributeBasedAccessControlEnabled property: True if the account supports ABAC, otherwise false if the
     * subscription is registered with the AFEC Microsoft.Storage/AllowAttributeBasedAccessControl, otherwise null.
     *
     * @return the isAttributeBasedAccessControlEnabled value.
     */
    public Boolean isAttributeBasedAccessControlEnabled() {
        return this.isAttributeBasedAccessControlEnabled;
    }
