...
public final class BlobInventoryPolicyDefinition {
     ...
     * of the object to be included in the inventory. Valid values for this
     * field for the blob object type include Name, Creation-Time,
     ...
     * LastAccessedTime. Valid values for container object type include Name,
     * Last-Modified, Metadata, LeaseStatus, LeaseState, LeaseDuration,
     ...
     * object to be included in the inventory. Valid values for this field for the blob object type include Name,
     * Creation-Time, Last-Modified, Content-Length, Content-MD5, BlobType, AccessTier, AccessTierChangeTime,
     * Expiry-Time, hdi_isfolder, Owner, Group, Permissions, Acl, Snapshot, VersionId, IsCurrentVersion, Metadata,
     * LastAccessedTime. Valid values for container object type include Name, Last-Modified, Metadata, LeaseStatus,
