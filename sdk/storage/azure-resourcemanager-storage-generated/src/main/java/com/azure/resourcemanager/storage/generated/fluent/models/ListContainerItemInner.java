...
import com.azure.resourcemanager.storage.generated.models.MigrationState;
...
public class ListContainerItemInner extends AzureEntityResource {
    ...
    /*
     * This is an immutable property, when set to true enables version level
     * worm at the container level.
     */
    @JsonProperty(value = "properties.versionLevelWorm.enabled")
    private Boolean enabled;

    /*
     * Returns the date and time the version level worm was enabled.
     */
    @JsonProperty(value = "properties.versionLevelWorm.timeStamp", access = JsonProperty.Access.WRITE_ONLY)
    private OffsetDateTime timestamp;

    /*
     * This property denotes the container level worm to version level worm
     * migration state.
     */
    @JsonProperty(value = "properties.versionLevelWorm.migrationState", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the enabled property: This is an immutable property, when set to true enables version level worm at the
     * container level.
     *
    ...
    /**
     * Set the enabled property: This is an immutable property, when set to true enables version level worm at the
     * container level.
     *
     * @param enabled the enabled value to set.
     * @return the ListContainerItemInner object itself.
     */
    public ListContainerItemInner withEnabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
    }

    /**
     * Get the timestamp property: Returns the date and time the version level worm was enabled.
     *
    ...
    /**
     * Get the migrationState property: This property denotes the container level worm to version level worm migration
     * state.
     *
