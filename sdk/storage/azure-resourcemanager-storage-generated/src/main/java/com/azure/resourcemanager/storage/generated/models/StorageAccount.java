...
public interface StorageAccount {
    ...
    /**
     * Gets the isAttributeBasedAccessControlEnabled property: True if the account supports ABAC, otherwise false if the
     ...
     */
    Boolean isAttributeBasedAccessControlEnabled();
