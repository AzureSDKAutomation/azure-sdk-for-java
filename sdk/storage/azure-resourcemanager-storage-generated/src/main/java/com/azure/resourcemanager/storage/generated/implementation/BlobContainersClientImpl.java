...
public final class BlobContainersClientImpl implements BlobContainersClient {
    ...
    private interface BlobContainersService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> versionLevelWorm(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @PathParam("containerName") String containerName,
    ...
    /**
     * This operation migrates a blob container from container level WORM to version level WORM enabled container.
     * Prerequisites require a container level immutability policy either in locked or unlocked state, Account level
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> versionLevelWormWithResponseAsync(
        String resourceGroupName, String accountName, String containerName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<Void>, Void> beginVersionLevelWormAsync(
        String resourceGroupName, String accountName, String containerName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            versionLevelWormWithResponseAsync(resourceGroupName, accountName, containerName);
        return this
            .client
    ...
    private PollerFlux<PollResult<Void>, Void> beginVersionLevelWormAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            versionLevelWormWithResponseAsync(resourceGroupName, accountName, containerName, context);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<Void>, Void> beginVersionLevelWorm(
        String resourceGroupName, String accountName, String containerName) {
        return beginVersionLevelWormAsync(resourceGroupName, accountName, containerName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<Void>, Void> beginVersionLevelWorm(
        String resourceGroupName, String accountName, String containerName, Context context) {
        return beginVersionLevelWormAsync(resourceGroupName, accountName, containerName, context).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> versionLevelWormAsync(String resourceGroupName, String accountName, String containerName) {
        return beginVersionLevelWormAsync(resourceGroupName, accountName, containerName)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> versionLevelWormAsync(
        String resourceGroupName, String accountName, String containerName, Context context) {
        return beginVersionLevelWormAsync(resourceGroupName, accountName, containerName, context)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void versionLevelWorm(String resourceGroupName, String accountName, String containerName) {
        versionLevelWormAsync(resourceGroupName, accountName, containerName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void versionLevelWorm(String resourceGroupName, String accountName, String containerName, Context context) {
        versionLevelWormAsync(resourceGroupName, accountName, containerName, context).block();
    }
