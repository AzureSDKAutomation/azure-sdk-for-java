...
public final class BlobContainersClientImpl implements BlobContainersClient {
    ...
    private interface BlobContainersService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> objectLevelWorm(
            @HostParam("$host") String endpoint,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @PathParam("containerName") String containerName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> objectLevelWormWithResponseAsync(
        String resourceGroupName, String accountName, String containerName) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
    ...
    private Mono<Void> objectLevelWormAsync(String resourceGroupName, String accountName, String containerName) {
        return objectLevelWormWithResponseAsync(resourceGroupName, accountName, containerName)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> objectLevelWormWithResponse(
        String resourceGroupName, String accountName, String containerName, Context context) {
        return objectLevelWormWithResponseAsync(resourceGroupName, accountName, containerName, context).block();
    }
