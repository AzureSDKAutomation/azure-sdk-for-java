...
public final class FileSharesClientImpl implements FileSharesClient {
    ...
    private Mono<FileSharesLeaseResponse> leaseWithResponseAsync(
        String resourceGroupName, String accountName, String shareName, LeaseShareRequest parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<FileSharesLeaseResponse> leaseWithResponseAsync(
        String resourceGroupName, String accountName, String shareName, LeaseShareRequest parameters, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private Mono<LeaseShareResponseInner> leaseAsync(
        String resourceGroupName, String accountName, String shareName, LeaseShareRequest parameters) {
        return leaseWithResponseAsync(resourceGroupName, accountName, shareName, parameters)
            .flatMap(
    ...
    public LeaseShareResponseInner lease(String resourceGroupName, String accountName, String shareName) {
        final LeaseShareRequest parameters = null;
        return leaseAsync(resourceGroupName, accountName, shareName, parameters).block();
    }
    ...
    public FileSharesLeaseResponse leaseWithResponse(
        String resourceGroupName, String accountName, String shareName, LeaseShareRequest parameters, Context context) {
        return leaseWithResponseAsync(resourceGroupName, accountName, shareName, parameters, context).block();
    }
