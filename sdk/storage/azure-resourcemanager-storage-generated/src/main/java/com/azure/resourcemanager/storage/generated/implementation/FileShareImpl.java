...
public final class FileShareImpl implements FileShare, FileShare.Definition, FileShare.Update {
    ...
    public Response<LeaseShareResponse> leaseWithResponse(LeaseShareRequest parameters, Context context) {
        return serviceManager
            .fileShares()
            .leaseWithResponse(resourceGroupName, accountName, shareName, parameters, context);
    }
