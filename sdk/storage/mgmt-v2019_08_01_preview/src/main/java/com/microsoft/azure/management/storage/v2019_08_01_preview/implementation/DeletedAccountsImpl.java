...
class DeletedAccountsImpl extends WrapperImpl<DeletedAccountsInner> implements DeletedAccounts {
    ...
    @Override
    public Observable<DeletedAccount> getAsync(final String deletedAccountName) {
        DeletedAccountsInner client = this.inner();
        return client.getAsync(deletedAccountName)
    ...
    @Override
    public Observable<DeletedAccount> listWithLocationAsync(final String location) {
        DeletedAccountsInner client = this.inner();
        return client.listWithLocationAsync(location)
        .flatMapIterable(new Func1<Page<DeletedAccountInner>, Iterable<DeletedAccountInner>>() {
            @Override
            public Iterable<DeletedAccountInner> call(Page<DeletedAccountInner> page) {
                return page.items();
    ...
    @Override
    public Observable<DeletedAccount> getWithLocationAsync(final String deletedAccountName, final String location) {
        DeletedAccountsInner client = this.inner();
        return client.getWithLocationAsync(deletedAccountName, location)
        .flatMapIterable(new Func1<Page<DeletedAccountInner>, Iterable<DeletedAccountInner>>() {
            @Override
            public Iterable<DeletedAccountInner> call(Page<DeletedAccountInner> page) {
                return page.items();
