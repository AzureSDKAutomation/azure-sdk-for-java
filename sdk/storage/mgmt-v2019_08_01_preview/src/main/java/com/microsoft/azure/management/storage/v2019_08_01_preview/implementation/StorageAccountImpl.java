...
class StorageAccountImpl extends GroupableResourceCoreImpl<StorageAccount, StorageAccountInner, StorageAccountImpl, StorageManager> implements StorageAccount, StorageAccount.Definition, StorageAccount.Update {
    ...
    public Boolean isLocalUserEnabled() {
        return this.inner().isLocalUserEnabled();
    }
    ...
    public StorageAccountImpl withIsLocalUserEnabled(Boolean isLocalUserEnabled) {
        if (isInCreateMode()) {
            this.createParameter.withIsLocalUserEnabled(isLocalUserEnabled);
        } else {
            this.updateParameter.withIsLocalUserEnabled(isLocalUserEnabled);
        }
        return this;
    }
