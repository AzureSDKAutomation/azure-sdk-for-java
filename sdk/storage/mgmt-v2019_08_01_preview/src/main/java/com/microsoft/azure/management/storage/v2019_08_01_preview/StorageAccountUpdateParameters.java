...
public class StorageAccountUpdateParameters {
     ...
     */
    @JsonProperty(value = "properties.isSftpEnabled")
    ...
    /**
     * Get enables Secure File Transfer Protocol, if set to true.
     *
    ...
    /**
     * Set enables Secure File Transfer Protocol, if set to true.
     *
