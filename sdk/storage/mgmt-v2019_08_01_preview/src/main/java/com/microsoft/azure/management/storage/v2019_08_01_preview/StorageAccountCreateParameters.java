...
public class StorageAccountCreateParameters {
    ...
    /**
     * Enable or disable local user feature of the storage account.
     */
    @JsonProperty(value = "properties.isLocalUserEnabled")
    ...
    /**
     * Get enable or disable local user feature of the storage account.
     *
    ...
    /**
     * Set enable or disable local user feature of the storage account.
     *
