...
public final class CloudEndpointsImpl implements CloudEndpoints {
    ...
    public CloudEndpointsImpl(CloudEndpointsClient innerClient, StoragesyncManager serviceManager) {
    ...
    public Response<CloudEndpoint> getWithResponse(
        ...
        Context context) {
        Response<CloudEndpointInner> inner =
            this
                .serviceClient()
    ...
    public PagedIterable<CloudEndpoint> listBySyncGroup(
        ...
        return inner.mapPage(inner1 -> new CloudEndpointImpl(inner1, this.manager()));
    }
