...
public final class ServerEndpointImpl implements ServerEndpoint, ServerEndpoint.Definition, ServerEndpoint.Update {
    ...
    public ServerEndpointImpl(String name, StoragesyncManager serviceManager) {
    ...
    public ServerEndpointImpl(ServerEndpointInner innerObject, StoragesyncManager serviceManager) {
