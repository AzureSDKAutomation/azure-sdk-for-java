...
public final class CloudEndpointImpl implements CloudEndpoint, CloudEndpoint.Definition {
    ...
    CloudEndpointImpl(CloudEndpointInner innerObject, StoragesyncManager serviceManager) {
    ...
    CloudEndpointImpl(String name, StoragesyncManager serviceManager) {
    ...
    public Response<Void> restoreheartbeatWithResponse(Context context) {
        return serviceManager
            .cloudEndpoints()
