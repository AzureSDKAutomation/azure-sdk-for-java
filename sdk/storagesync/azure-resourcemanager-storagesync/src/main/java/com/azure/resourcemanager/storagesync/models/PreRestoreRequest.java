...
public final class PreRestoreRequest {
    ...
    private Long pauseWaitForSyncDrainTimePeriodInSeconds;
     ...
     */
    public Long pauseWaitForSyncDrainTimePeriodInSeconds() {
    ...
    public PreRestoreRequest withPauseWaitForSyncDrainTimePeriodInSeconds(
        Long pauseWaitForSyncDrainTimePeriodInSeconds) {
