...
public final class ServerEndpointsImpl implements ServerEndpoints {
    ...
    public ServerEndpointsImpl(ServerEndpointsClient innerClient, StoragesyncManager serviceManager) {
    ...
    public Response<ServerEndpoint> getWithResponse(
        ...
        Context context) {
        Response<ServerEndpointInner> inner =
            this
                .serviceClient()
    ...
    public PagedIterable<ServerEndpoint> listBySyncGroup(
        ...
        return inner.mapPage(inner1 -> new ServerEndpointImpl(inner1, this.manager()));
    }
