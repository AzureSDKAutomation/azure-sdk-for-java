...
public final class StorageSyncServicesClientImpl implements StorageSyncServicesClient {
     ...
     * @param parameters Parameters for a check name availability request.
     ...
     * @param parameters The parameters used when creating a storage sync service.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<StorageSyncServiceInner> getByResourceGroupWithResponse(
        String resourceGroupName, String storageSyncServiceName, Context context) {
     ...
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param storageSyncServiceName Name of Storage Sync Service resource.
     * @param parameters Parameters for updating an Storage sync service.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws StorageSyncApiErrorException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return storage Sync Service object.
