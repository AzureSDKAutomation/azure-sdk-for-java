...
public final class RegisteredServersImpl implements RegisteredServers {
    ...
    public RegisteredServersImpl(RegisteredServersClient innerClient, StoragesyncManager serviceManager) {
    ...
    public PagedIterable<RegisteredServer> listByStorageSyncService(
        ...
        return inner.mapPage(inner1 -> new RegisteredServerImpl(inner1, this.manager()));
    }
    ...
    public Response<RegisteredServer> getWithResponse(
        ...
        Response<RegisteredServerInner> inner =
