...
public final class PrivateEndpointConnectionImpl
    ...
    public PrivateEndpointConnectionImpl(
        PrivateEndpointConnectionInner innerObject, StoragesyncManager serviceManager) {
    ...
    public PrivateEndpointConnectionImpl(String name, StoragesyncManager serviceManager) {
