...
public final class PrivateEndpointConnectionImpl
    ...
    PrivateEndpointConnectionImpl(PrivateEndpointConnectionInner innerObject, StoragesyncManager serviceManager) {
    ...
    PrivateEndpointConnectionImpl(String name, StoragesyncManager serviceManager) {
