...
public final class RegisteredServerImpl implements RegisteredServer, RegisteredServer.Definition {
    ...
    public RegisteredServerImpl(RegisteredServerInner innerObject, StoragesyncManager serviceManager) {
    ...
    public RegisteredServerImpl(String name, StoragesyncManager serviceManager) {
