...
public final class RegisteredServerImpl implements RegisteredServer, RegisteredServer.Definition {
    ...
    RegisteredServerImpl(RegisteredServerInner innerObject, StoragesyncManager serviceManager) {
    ...
    RegisteredServerImpl(String name, StoragesyncManager serviceManager) {
