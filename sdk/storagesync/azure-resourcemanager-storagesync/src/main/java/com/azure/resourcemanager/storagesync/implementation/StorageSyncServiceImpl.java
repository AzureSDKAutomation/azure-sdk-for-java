...
public final class StorageSyncServiceImpl
    ...
    public StorageSyncServiceImpl(String name, StoragesyncManager serviceManager) {
    ...
    public StorageSyncServiceImpl(StorageSyncServiceInner innerObject, StoragesyncManager serviceManager) {
