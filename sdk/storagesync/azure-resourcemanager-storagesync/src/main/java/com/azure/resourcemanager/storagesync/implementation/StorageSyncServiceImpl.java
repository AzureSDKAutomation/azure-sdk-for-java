...
public final class StorageSyncServiceImpl
    ...
    StorageSyncServiceImpl(String name, StoragesyncManager serviceManager) {
    ...
    StorageSyncServiceImpl(StorageSyncServiceInner innerObject, StoragesyncManager serviceManager) {
