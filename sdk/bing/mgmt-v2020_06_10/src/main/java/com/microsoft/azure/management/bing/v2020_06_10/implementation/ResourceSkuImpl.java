...
import com.microsoft.azure.management.bing.v2020_06_10.ResourceSku;
import com.microsoft.azure.arm.model.implementation.WrapperImpl;
import rx.Observable;
import java.util.List;
import com.microsoft.azure.management.bing.v2020_06_10.ResourceSkuLocationInfo;
import com.microsoft.azure.management.bing.v2020_06_10.ResourceSkuRestrictions;

class ResourceSkuImpl extends WrapperImpl<ResourceSkuInner> implements ResourceSku {
    private final BingManager manager;

    ResourceSkuImpl(ResourceSkuInner inner,  BingManager manager) {
        super(inner);
