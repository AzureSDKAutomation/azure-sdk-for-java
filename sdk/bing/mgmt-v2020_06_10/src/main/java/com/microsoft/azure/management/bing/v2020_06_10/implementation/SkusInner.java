...
public class SkusInner {
     ...
     */
    public SkusInner(Retrofit retrofit, BingManagementClientImpl client) {
    ...
    interface SkusService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10.Skus list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.Bing/skus")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10.Skus listNext" })
        @GET
