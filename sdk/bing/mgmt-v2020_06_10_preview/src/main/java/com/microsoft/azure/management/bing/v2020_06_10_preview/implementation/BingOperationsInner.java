 ...
 * in BingOperations.
 */
public class BingOperationsInner {
    /** The Retrofit service to perform REST calls. */
    private BingOperationsService service;
    /** The service client containing this operation class. */
    private BingManagementClientImpl client;

    /**
     * Initializes an instance of BingOperationsInner.
     *
     * @param retrofit the Retrofit instance built from a Retrofit Builder.
     * @param client the instance of the service client containing this operation class.
     */
    public BingOperationsInner(Retrofit retrofit, BingManagementClientImpl client) {
        this.service = retrofit.create(BingOperationsService.class);
        this.client = client;
    }

    /**
     * The interface defining all the services for BingOperations to be
     * used by Retrofit to perform actually REST calls.
     */
    interface BingOperationsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10_preview.BingOperations list" })
        @GET("providers/Microsoft.Bing/operations")
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10_preview.BingOperations listNext" })
        @GET
    ...
    private ServiceResponse<PageImpl<OperationEntityInner>> listDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
    ...
    private ServiceResponse<PageImpl<OperationEntityInner>> listNextDelegate(Response<ResponseBody> response) throws ErrorException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<OperationEntityInner>, ErrorException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<OperationEntityInner>>() { }.getType())
                .registerError(ErrorException.class)
                .build(response);
