...
import com.microsoft.azure.management.bing.v2020_06_10_preview.CheckSkuAvailabilityParameter;
...
public class BingManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * The BingAccountsInner object to access its operations.
     */
    private BingAccountsInner bingAccounts;

    /**
     * Gets the BingAccountsInner object to access its operations.
     * @return the BingAccountsInner object.
     */
    public BingAccountsInner bingAccounts() {
    ...
    /**
     * The BingOperationsInner object to access its operations.
     */
    private BingOperationsInner bingOperations;

    /**
     * Gets the BingOperationsInner object to access its operations.
     * @return the BingOperationsInner object.
     */
    public BingOperationsInner bingOperations() {
    ...
    protected void initialize() {
        this.apiVersion = "2020-06-10-preview";
        this.acceptLanguage = "en-US";
        this.longRunningOperationRetryTimeout = 30;
        this.generateClientRequestId = true;
        this.bingAccounts = new BingAccountsInner(restClient().retrofit(), this);
        this.resourceSkus = new ResourceSkusInner(restClient().retrofit(), this);
        this.bingOperations = new BingOperationsInner(restClient().retrofit(), this);
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "BingManagementClient", "2020-06-10-preview");
    }
    ...
    interface BingManagementClientService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10_preview.BingManagementClient checkSkuAvailability" })
