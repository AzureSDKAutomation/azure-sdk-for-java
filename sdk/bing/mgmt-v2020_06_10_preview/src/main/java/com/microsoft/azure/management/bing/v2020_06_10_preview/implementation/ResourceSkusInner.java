...
public class ResourceSkusInner {
     ...
     */
    public ResourceSkusInner(Retrofit retrofit, BingManagementClientImpl client) {
    ...
    interface ResourceSkusService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10_preview.ResourceSkus list" })
        @GET("subscriptions/{subscriptionId}/providers/Microsoft.Bing/skus")
        Observable<Response<ResponseBody>> list(@Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.bing.v2020_06_10_preview.ResourceSkus listNext" })
        @GET
