...
public final class MicrosoftResourceHealthImpl implements MicrosoftResourceHealth {
    ...
    /** The PotentialOutagesClient object to access its operations. */
    private final PotentialOutagesClient potentialOutages;

    /**
     * Gets the PotentialOutagesClient object to access its operations.
     *
     * @return the PotentialOutagesClient object.
     */
    public PotentialOutagesClient getPotentialOutages() {
        return this.potentialOutages;
    }
    ...
    MicrosoftResourceHealthImpl(
        ...
        this.potentialOutages = new PotentialOutagesClientImpl(this);
    }
