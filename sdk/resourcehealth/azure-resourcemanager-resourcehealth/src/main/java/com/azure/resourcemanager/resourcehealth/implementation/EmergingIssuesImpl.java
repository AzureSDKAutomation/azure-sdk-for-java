...
public final class EmergingIssuesImpl implements EmergingIssues {
    ...
    public EmergingIssuesImpl(EmergingIssuesClient innerClient, ResourcehealthManager serviceManager) {
    ...
    public PagedIterable<EmergingIssuesGetResult> list() {
        ...
        return inner.mapPage(inner1 -> new EmergingIssuesGetResultImpl(inner1, this.manager()));
    }
