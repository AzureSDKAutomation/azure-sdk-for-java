...
public final class AvailabilityStatusesImpl implements AvailabilityStatuses {
    ...
    public AvailabilityStatusesImpl(AvailabilityStatusesClient innerClient, ResourcehealthManager serviceManager) {
    ...
    public PagedIterable<AvailabilityStatus> listBySubscriptionId() {
        ...
        return inner.mapPage(inner1 -> new AvailabilityStatusImpl(inner1, this.manager()));
    }
