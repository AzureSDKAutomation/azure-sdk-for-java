...
public final class PotentialOutagesImpl implements PotentialOutages {
    ...
    public PotentialOutagesGetResult get() {
        PotentialOutagesGetResultInner inner = this.serviceClient().get();
        if (inner != null) {
    ...
    public Response<PotentialOutagesGetResult> getWithResponse(Context context) {
        Response<PotentialOutagesGetResultInner> inner = this.serviceClient().getWithResponse(context);
        if (inner != null) {
