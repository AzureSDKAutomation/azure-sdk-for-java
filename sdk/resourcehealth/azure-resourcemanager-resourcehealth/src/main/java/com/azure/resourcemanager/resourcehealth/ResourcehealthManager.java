...
import com.azure.resourcemanager.resourcehealth.implementation.PotentialOutagesImpl;
...
public final class ResourcehealthManager {
    ...
    private PotentialOutages potentialOutages;
    ...
    /** @return Resource collection API of PotentialOutages. */
    public PotentialOutages potentialOutages() {
        if (this.potentialOutages == null) {
            this.potentialOutages = new PotentialOutagesImpl(clientObject.getPotentialOutages(), this);
        }
