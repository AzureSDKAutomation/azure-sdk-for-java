...
@Fluent
public final class PotentialoutageInner {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(PotentialoutageInner.class);

    /*
     * Id for the potential outage.
     */
    @JsonProperty(value = "outageId", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "impactedRegions", access = JsonProperty.Access.WRITE_ONLY)
    private List<String> impactedRegions;

    /*
     * Time and date the potential outage is detected.
     */
    @JsonProperty(value = "detectedDateTime", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "symptoms", access = JsonProperty.Access.WRITE_ONLY)
     ...
     * @return the PotentialoutageInner object itself.
     */
    public PotentialoutageInner withIncidents(List<IcmIncidents> incidents) {
