...
public final class PotentialOutagesClientImpl implements PotentialOutagesClient {
    ...
    private interface PotentialOutagesService {
        ...
        @Get("/providers/Microsoft.ResourceHealth/potentialOutages/default")
    ...
    private Mono<Response<PotentialOutagesGetResultInner>> getWithResponseAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<PotentialOutagesGetResultInner>> getWithResponseAsync(Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PotentialOutagesGetResultInner> getAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public PotentialOutagesGetResultInner get() {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<PotentialOutagesGetResultInner> getWithResponse(Context context) {
