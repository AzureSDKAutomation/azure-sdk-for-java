...
public interface PotentialOutagesClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<PotentialoutageInner> getWithResponse(Context context);
    ...
    PagedIterable<PotentialoutageInner> list();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<PotentialoutageInner> list(Context context);
}
