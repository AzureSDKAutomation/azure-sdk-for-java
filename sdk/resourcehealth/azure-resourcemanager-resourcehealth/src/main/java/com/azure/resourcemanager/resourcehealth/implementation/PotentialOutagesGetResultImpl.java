...
public final class PotentialOutagesGetResultImpl implements PotentialOutagesGetResult {
    private PotentialOutagesGetResultInner innerObject;

    private final ResourcehealthManager serviceManager;

    PotentialOutagesGetResultImpl(PotentialOutagesGetResultInner innerObject, ResourcehealthManager serviceManager) {
    ...
    public PotentialOutagesGetResultInner innerModel() {
