 ...
 */
public class SecretCloudErrorError {
    /**
     ...
     * @return the SecretCloudErrorError object itself.
     */
    public SecretCloudErrorError withCode(String code) {
        this.code = code;
        return this;
    }
     ...
     * @return the SecretCloudErrorError object itself.
     */
    public SecretCloudErrorError withMessage(String message) {
