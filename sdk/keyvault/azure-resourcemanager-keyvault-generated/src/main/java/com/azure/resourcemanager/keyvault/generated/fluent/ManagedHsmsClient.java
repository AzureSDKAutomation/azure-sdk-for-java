...
public interface ManagedHsmsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ManagedHsmInner> listDeleted();
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    PagedIterable<ManagedHsmInner> listDeleted(Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    ManagedHsmInner getDeleted(String name, String location);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<ManagedHsmInner> getDeletedWithResponse(String name, String location, Context context);
