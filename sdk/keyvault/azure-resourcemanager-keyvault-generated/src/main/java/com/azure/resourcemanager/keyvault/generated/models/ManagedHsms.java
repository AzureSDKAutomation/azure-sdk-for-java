...
public interface ManagedHsms {
     ...
     * @return list of managed HSM Pools.
     */
    PagedIterable<ManagedHsm> listDeleted();
     ...
     * @return list of managed HSM Pools.
     */
    PagedIterable<ManagedHsm> listDeleted(Context context);
     ...
     */
    ManagedHsm getDeleted(String name, String location);
     ...
     * @return the specified deleted managed HSM.
     */
    Response<ManagedHsm> getDeletedWithResponse(String name, String location, Context context);
