...
public class PrivateEndpointConnectionInner extends Resource {
    ...
    /**
     * Get the etag property: Modified whenever the user or NRP changes the state of PE connection.
     *
    ...
    /**
     * Set the etag property: Modified whenever the user or NRP changes the state of PE connection.
     *
