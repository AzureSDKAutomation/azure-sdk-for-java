...
public final class DataLakeStoreAccountProperties extends DataLakeStoreAccountPropertiesBasic {
     ...
     * Store account.
     */
    @JsonProperty(value = "initialUser", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "firewallAllowDataLakeAnalytics", access = JsonProperty.Access.WRITE_ONLY)
     ...
     */
    @JsonProperty(value = "dataLakePerformanceTierState", access = JsonProperty.Access.WRITE_ONLY)
