...
import com.azure.resourcemanager.datalakestore.implementation.VirtualNetworkOrSubnetsImpl;
...
public final class DataLakeStoreManager {
    ...
    private VirtualNetworkOrSubnets virtualNetworkOrSubnets;
        ...
        public DataLakeStoreManager authenticate(TokenCredential credential, AzureProfile profile) {
            ...
            policies
                .add(
                    new UserAgentPolicy(
                        null,
                        "com.azure.resourcemanager.datalakestore",
                        "1.0.0-beta.1",
    ...
    /** @return Resource collection API of VirtualNetworkOrSubnets. */
    public VirtualNetworkOrSubnets virtualNetworkOrSubnets() {
        if (this.virtualNetworkOrSubnets == null) {
            this.virtualNetworkOrSubnets =
                new VirtualNetworkOrSubnetsImpl(clientObject.getVirtualNetworkOrSubnets(), this);
        }
        return virtualNetworkOrSubnets;
    }
