...
public final class DataLakeStoreAccountManagementClientImpl implements DataLakeStoreAccountManagementClient {
    ...
    /** The VirtualNetworkOrSubnetsClient object to access its operations. */
    private final VirtualNetworkOrSubnetsClient virtualNetworkOrSubnets;

    /**
     * Gets the VirtualNetworkOrSubnetsClient object to access its operations.
     *
     * @return the VirtualNetworkOrSubnetsClient object.
     */
    public VirtualNetworkOrSubnetsClient getVirtualNetworkOrSubnets() {
        return this.virtualNetworkOrSubnets;
    }
    ...
    DataLakeStoreAccountManagementClientImpl(
        ...
        this.virtualNetworkOrSubnets = new VirtualNetworkOrSubnetsClientImpl(this);
