...
public class DataLakeStoreAccountInner extends Resource {
    ...
    /*
     * The default user for all new folders and files created in the Data Lake
     * Store account.
     */
    @JsonProperty(value = "properties.initialUser", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /*
     * The current state of allowing datalakeanalytics through the firewall. If
     * the firewall is disabled, this is not enforced.
     */
    @JsonProperty(value = "properties.firewallAllowDataLakeAnalytics", access = JsonProperty.Access.WRITE_ONLY)
    private String firewallAllowDataLakeAnalytics;
    ...
    /*
     * dataLake Performance Tier State.
     */
    @JsonProperty(value = "properties.dataLakePerformanceTierState", access = JsonProperty.Access.WRITE_ONLY)
    private String dataLakePerformanceTierState;
    ...
    /**
     * Get the initialUser property: The default user for all new folders and files created in the Data Lake Store
     * account.
     *
     * @return the initialUser value.
     */
    ...
    /**
     * Get the firewallAllowDataLakeAnalytics property: The current state of allowing datalakeanalytics through the
     * firewall. If the firewall is disabled, this is not enforced.
     *
     * @return the firewallAllowDataLakeAnalytics value.
     */
    public String firewallAllowDataLakeAnalytics() {
        return this.firewallAllowDataLakeAnalytics;
    }
    ...
    /**
     * Get the dataLakePerformanceTierState property: dataLake Performance Tier State.
     *
     * @return the dataLakePerformanceTierState value.
     */
    public String dataLakePerformanceTierState() {
        return this.dataLakePerformanceTierState;
    }
