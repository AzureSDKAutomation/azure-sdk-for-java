...
public interface DataLakeStoreAccount {
    ...
    /**
     * Gets the initialUser property: The default user for all new folders and files created in the Data Lake Store
     * account.
     *
    ...
    /**
     * Gets the firewallAllowDataLakeAnalytics property: The current state of allowing datalakeanalytics through the
     * firewall. If the firewall is disabled, this is not enforced.
     *
     * @return the firewallAllowDataLakeAnalytics value.
     */
    String firewallAllowDataLakeAnalytics();
    ...
    /**
     * Gets the dataLakePerformanceTierState property: dataLake Performance Tier State.
     *
     * @return the dataLakePerformanceTierState value.
     */
    String dataLakePerformanceTierState();
