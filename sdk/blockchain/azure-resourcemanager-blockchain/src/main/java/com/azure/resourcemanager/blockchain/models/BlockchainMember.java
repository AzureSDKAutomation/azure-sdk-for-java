...
public interface BlockchainMember {
    ...
    /**
     * Gets the nodeProvisioningState property: Gets or sets Node Provisioning state of default transaction node.
     *
    ...
    /**
     * Gets the egressIp property: Gets or sets Node Provisioning state of default transaction node.
     *
     * @return the egressIp value.
     */
    NodeProvisioningState egressIp();
    ...
    /**
     * Gets the kind property: The Kind of Blockchain Protocol.
     *
