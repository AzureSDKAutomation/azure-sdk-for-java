...
public class BlockchainMemberInner extends Resource {
     ...
     */
    @JsonProperty(value = "properties.nodeProvisioningState", access = JsonProperty.Access.WRITE_ONLY)
    private NodeProvisioningState nodeProvisioningState;

    /*
     * Gets or sets Node Provisioning state of default transaction node.
     */
    @JsonProperty(value = "properties.egressIP", access = JsonProperty.Access.WRITE_ONLY)
    private NodeProvisioningState egressIp;
    ...
    /*
     * The Kind of Blockchain Protocol
     */
    ...
    /**
     * Get the nodeProvisioningState property: Gets or sets Node Provisioning state of default transaction node.
     *
     * @return the nodeProvisioningState value.
     */
    public NodeProvisioningState nodeProvisioningState() {
        return this.nodeProvisioningState;
    }

    /**
     * Get the egressIp property: Gets or sets Node Provisioning state of default transaction node.
     *
     * @return the egressIp value.
     */
    public NodeProvisioningState egressIp() {
    ...
    /**
     * Get the kind property: The Kind of Blockchain Protocol.
     *
