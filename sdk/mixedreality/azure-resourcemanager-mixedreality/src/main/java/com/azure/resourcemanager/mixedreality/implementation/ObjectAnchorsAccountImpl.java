...
public final class ObjectAnchorsAccountImpl
    ...
    ObjectAnchorsAccountImpl(String name, MixedRealityManager serviceManager) {
    ...
    ObjectAnchorsAccountImpl(ObjectAnchorsAccountInner innerObject, MixedRealityManager serviceManager) {
    ...
    public ObjectAnchorsAccountImpl withIdentity(Identity identity) {
