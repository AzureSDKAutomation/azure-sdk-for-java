...
public final class OrganizationResourceImpl
    ...
    public OrganizationResourceImpl(String name, ConfluentManager serviceManager) {
    ...
    public OrganizationResourceImpl(OrganizationResourceInner innerObject, ConfluentManager serviceManager) {
