...
public interface DeletedAccountsClient {
    ...
    AccountInner get(String location, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    Response<AccountInner> getWithResponse(String location, String accountName, Context context);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<PollResult<Void>, Void> beginPurge(String location, String accountName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<PollResult<Void>, Void> beginPurge(String location, String accountName, Context context);
