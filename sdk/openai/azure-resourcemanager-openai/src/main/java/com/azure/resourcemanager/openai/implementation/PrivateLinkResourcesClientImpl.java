...
public final class PrivateLinkResourcesClientImpl implements PrivateLinkResourcesClient {
     ...
     */
    PrivateLinkResourcesClientImpl(OpenAIManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    /**
     * The interface defining all the services for OpenAIManagementClientPrivateLinkResources to be used by the proxy
    ...
    /**
     * Gets the private link resources that need to be created for a OpenAI account.
     *
     ...
     * @return the private link resources that need to be created for a OpenAI account.
     */
