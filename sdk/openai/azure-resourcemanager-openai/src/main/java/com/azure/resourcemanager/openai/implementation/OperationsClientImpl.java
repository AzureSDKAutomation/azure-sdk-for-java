...
import com.azure.resourcemanager.openai.fluent.models.OperationInner;
import com.azure.resourcemanager.openai.models.OperationListResult;
...
public final class OperationsClientImpl implements OperationsClient {
     ...
     */
    OperationsClientImpl(OpenAIManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for OpenAIManagementClientOperations to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface OperationsService {
        ...
        @Get("/providers/Microsoft.OpenAI/operations")
