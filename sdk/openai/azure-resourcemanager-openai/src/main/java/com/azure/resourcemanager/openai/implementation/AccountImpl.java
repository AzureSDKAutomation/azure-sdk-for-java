...
public final class AccountImpl implements Account, Account.Definition, Account.Update {
    ...
    AccountImpl(String name, com.azure.resourcemanager.openai.OpenAIManager serviceManager) {
    ...
    AccountImpl(AccountInner innerObject, com.azure.resourcemanager.openai.OpenAIManager serviceManager) {
