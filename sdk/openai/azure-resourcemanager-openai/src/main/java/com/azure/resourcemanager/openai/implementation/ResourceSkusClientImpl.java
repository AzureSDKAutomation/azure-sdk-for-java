...
import com.azure.resourcemanager.openai.models.ResourceSkuListResult;
...
public final class ResourceSkusClientImpl implements ResourceSkusClient {
     ...
     */
    ResourceSkusClientImpl(OpenAIManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for OpenAIManagementClientResourceSkus to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
    ...
    private interface ResourceSkusService {
        ...
        @Get("/subscriptions/{subscriptionId}/providers/Microsoft.OpenAI/skus")
