...
public final class PrivateEndpointConnectionsClientImpl implements PrivateEndpointConnectionsClient {
     ...
     */
    PrivateEndpointConnectionsClientImpl(OpenAIManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for OpenAIManagementClientPrivateEndpointConnections to be used by the
