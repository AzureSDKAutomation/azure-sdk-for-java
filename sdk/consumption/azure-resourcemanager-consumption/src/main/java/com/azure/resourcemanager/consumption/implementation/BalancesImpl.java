...
public final class BalancesImpl implements Balances {
    ...
    public void download(String billingAccountId, String billingPeriodName, String ln) {
        this.serviceClient().download(billingAccountId, billingPeriodName, ln);
    }

    public Response<Void> downloadWithResponse(
        String billingAccountId, String billingPeriodName, String ln, Context context) {
        return this.serviceClient().downloadWithResponse(billingAccountId, billingPeriodName, ln, context);
    }
