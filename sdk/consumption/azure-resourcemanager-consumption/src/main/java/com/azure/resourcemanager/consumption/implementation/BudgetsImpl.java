...
public final class BudgetsImpl implements Budgets {
    ...
    public Budget createOrUpdate(String scope, String budgetName, BudgetInner parameters) {
        BudgetInner inner = this.serviceClient().createOrUpdate(scope, budgetName, parameters);
        if (inner != null) {
            return new BudgetImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Response<Budget> createOrUpdateWithResponse(
        String scope, String budgetName, BudgetInner parameters, Context context) {
        Response<BudgetInner> inner =
            this.serviceClient().createOrUpdateWithResponse(scope, budgetName, parameters, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
