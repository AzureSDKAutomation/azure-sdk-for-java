...
public class ModernUsageDetail extends UsageDetailInner {
    ...
    /*
     * Identifier that indicates how the meter is priced. (Values: On Demand,
     * Reservation, Spot)
     */
    @JsonProperty(value = "properties.pricingModel", access = JsonProperty.Access.WRITE_ONLY)
    ...
    /**
     * Get the pricingModel property: Identifier that indicates how the meter is priced. (Values: On Demand,
     * Reservation, Spot).
     *
