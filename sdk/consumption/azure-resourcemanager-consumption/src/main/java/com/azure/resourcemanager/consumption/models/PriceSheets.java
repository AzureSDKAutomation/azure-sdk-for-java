...
public interface PriceSheets {
     ...
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     */
    void download(String billingAccountId, String billingPeriodName, String ln);
     ...
     * @return the response.
     */
    Response<Void> downloadWithResponse(String billingAccountId, String billingPeriodName, String ln, Context context);
}
