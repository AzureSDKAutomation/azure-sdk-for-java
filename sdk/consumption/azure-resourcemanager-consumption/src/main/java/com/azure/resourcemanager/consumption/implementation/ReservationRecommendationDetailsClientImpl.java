...
import com.azure.resourcemanager.consumption.models.HighCasedErrorResponseException;
...
public final class ReservationRecommendationDetailsClientImpl implements ReservationRecommendationDetailsClient {
    ...
    private interface ReservationRecommendationDetailsService {
        ...
        @UnexpectedResponseExceptionType(HighCasedErrorResponseException.class)
     ...
     * @throws HighCasedErrorResponseException thrown if the request is rejected by server.
