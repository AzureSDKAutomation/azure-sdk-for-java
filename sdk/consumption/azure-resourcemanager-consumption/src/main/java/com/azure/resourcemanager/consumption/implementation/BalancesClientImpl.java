...
public final class BalancesClientImpl implements BalancesClient {
    ...
    private interface BalancesService {
        ...
        @Get(
            "/providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingPeriods/{billingPeriodName}"
                + "/providers/Microsoft.Consumption/balances/download")
    ...
    /**
     * Download balances for a scope by billing period and billing account id.
     *
     * @param billingAccountId BillingAccount ID.
     * @param billingPeriodName Billing Period Name.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> downloadWithResponseAsync(
        String billingAccountId, String billingPeriodName, String ln) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> downloadWithResponseAsync(
        String billingAccountId, String billingPeriodName, String ln, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> downloadAsync(String billingAccountId, String billingPeriodName, String ln) {
        return downloadWithResponseAsync(billingAccountId, billingPeriodName, ln)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public void download(String billingAccountId, String billingPeriodName, String ln) {
        downloadAsync(billingAccountId, billingPeriodName, ln).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> downloadWithResponse(
        String billingAccountId, String billingPeriodName, String ln, Context context) {
        return downloadWithResponseAsync(billingAccountId, billingPeriodName, ln, context).block();
    }
}
