...
public class TagsResultInner extends ProxyResource {
    ...
    /*
     * eTag of the resource. To handle the concurrent update scenario, this
     * field will be used to determine whether the user is updating the latest
     * version or not.
     */
    ...
    /**
     * Get the etag property: eTag of the resource. To handle the concurrent update scenario, this field will be used to
    ...
    /**
     * Set the etag property: eTag of the resource. To handle the concurrent update scenario, this field will be used to
     * determine whether the user is updating the latest version or not.
     *
