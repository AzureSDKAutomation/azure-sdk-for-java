...
public final class MarketplacesClientImpl implements MarketplacesClient {
    ...
    private interface MarketplacesService {
        ...
        @Headers({"Content-Type: application/json"})
        @Get("/{scope}/providers/Microsoft.Consumption/marketplaces/download")
    ...
    /**
     * Download marketplaces for a scope by billing period and billing account id.
     *
     * @param scope The scope associated with marketplace operations. This includes '/subscriptions/{subscriptionId}/'
     *     for subscription scope, '/providers/Microsoft.Billing/billingAccounts/{billingAccountId}' for Billing Account
     *     scope, '/providers/Microsoft.Billing/departments/{departmentId}' for Department scope,
     ...
     *     specify billing period at department scope use
     *     '/providers/Microsoft.Billing/departments/{departmentId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}'.
     * @param ln Language in which the response data should be.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> downloadWithResponseAsync(String scope, String ln) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (ln == null) {
            return Mono.error(new IllegalArgumentException("Parameter ln is required and cannot be null."));
        }
        final String accept = "application/json";
        return FluxUtil
            .withContext(
                context ->
                    service
                        .download(this.client.getEndpoint(), scope, this.client.getApiVersion(), ln, accept, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> downloadWithResponseAsync(String scope, String ln, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        final String accept = "application/json";
        context = this.client.mergeContext(context);
        return service.download(this.client.getEndpoint(), scope, this.client.getApiVersion(), ln, accept, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> downloadAsync(String scope, String ln) {
        return downloadWithResponseAsync(scope, ln).flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public Response<Void> downloadWithResponse(String scope, String ln, Context context) {
        return downloadWithResponseAsync(scope, ln, context).block();
    }
