...
public final class ArmDisasterRecoveryImpl
    ...
    ArmDisasterRecoveryImpl(String name, ServiceBusManager serviceManager) {
    ...
    ArmDisasterRecoveryImpl(ArmDisasterRecoveryInner innerObject, ServiceBusManager serviceManager) {
