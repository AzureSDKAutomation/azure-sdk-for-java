...
public final class VirtualNetworkRuleImpl
    ...
    VirtualNetworkRuleImpl(String name, ServiceBusManager serviceManager) {
    ...
    VirtualNetworkRuleImpl(VirtualNetworkRuleInner innerObject, ServiceBusManager serviceManager) {
