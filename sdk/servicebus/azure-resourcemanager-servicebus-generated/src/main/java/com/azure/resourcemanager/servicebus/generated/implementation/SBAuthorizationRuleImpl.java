...
public final class SBAuthorizationRuleImpl
    ...
    SBAuthorizationRuleImpl(String name, ServiceBusManager serviceManager) {
    ...
    SBAuthorizationRuleImpl(SBAuthorizationRuleInner innerObject, ServiceBusManager serviceManager) {
