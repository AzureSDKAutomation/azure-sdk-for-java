...
public class ConnectedRegistriesInner {
    ...
    private ServiceResponse<ConnectedRegistryInner> getDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ConnectedRegistryInner, CloudException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<ConnectedRegistryInner> beginCreateDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ConnectedRegistryInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ConnectedRegistryInner>() { }.getType())
    ...
    private ServiceResponse<ConnectedRegistryInner> beginUpdateDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<ConnectedRegistryInner, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<ConnectedRegistryInner>() { }.getType())
                .register(201, new TypeToken<ConnectedRegistryInner>() { }.getType())
                .registerError(CloudException.class)
    ...
    public Observable<ServiceResponse<Page<ConnectedRegistryInner>>> listSinglePageAsync(final String resourceGroupName, final String registryName) {
        ...
        final String apiVersion = "2020-11-01-preview";
        return service.list(this.client.subscriptionId(), resourceGroupName, registryName, apiVersion, this.client.filter(), this.client.acceptLanguage(), this.client.userAgent())
    ...
    private ServiceResponse<PageImpl<ConnectedRegistryInner>> listDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<ConnectedRegistryInner>, CloudException>newInstance(this.client.serializerAdapter())
    ...
    private ServiceResponse<Void> beginDeactivateDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<Void, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<Void>() { }.getType())
                .register(202, new TypeToken<Void>() { }.getType())
                .registerError(CloudException.class)
    ...
    private ServiceResponse<PageImpl<ConnectedRegistryInner>> listNextDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<ConnectedRegistryInner>, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<ConnectedRegistryInner>>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
