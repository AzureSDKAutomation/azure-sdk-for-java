...
public class ContainerRegistryManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * Gets An OData filter expression that describes a subset of connectedRegistries to return. The parameters that can be filtered are parent.id (the resource id of the connectedRegistry parent), mode, and connectionState. The supported operator is eq.
     *
    ...
    /**
     * Sets An OData filter expression that describes a subset of connectedRegistries to return. The parameters that can be filtered are parent.id (the resource id of the connectedRegistry parent), mode, and connectionState. The supported operator is eq.
     *
     * @param filter the filter value.
     * @return the service client itself
     */
    public ContainerRegistryManagementClientImpl withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    /**
     * The ConnectedRegistriesInner object to access its operations.
     */
    private ConnectedRegistriesInner connectedRegistries;

    /**
     * Gets the ConnectedRegistriesInner object to access its operations.
     * @return the ConnectedRegistriesInner object.
     */
    public ConnectedRegistriesInner connectedRegistries() {
    ...
    /**
     * The ScopeMapsInner object to access its operations.
     */
    private ScopeMapsInner scopeMaps;

    /**
     * Gets the ScopeMapsInner object to access its operations.
     * @return the ScopeMapsInner object.
     */
    public ScopeMapsInner scopeMaps() {
        return this.scopeMaps;
    }

    /**
     * The TokensInner object to access its operations.
     */
    private TokensInner tokens;

    /**
     * Gets the TokensInner object to access its operations.
     * @return the TokensInner object.
     */
    public TokensInner tokens() {
        return this.tokens;
    }
    ...
    protected void initialize() {
        ...
        this.connectedRegistries = new ConnectedRegistriesInner(restClient().retrofit(), this);
        ...
        this.scopeMaps = new ScopeMapsInner(restClient().retrofit(), this);
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "ContainerRegistryManagementClient", "2020-11-01-preiew");
    }
}
