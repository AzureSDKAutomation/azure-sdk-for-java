...
import com.azure.resourcemanager.synapse.fluent.AttachedDatabaseConfigurationsClient;
...
public final class AttachedDatabaseConfigurationsClientImpl implements AttachedDatabaseConfigurationsClient {
     ...
     */
    AttachedDatabaseConfigurationsClientImpl(SynapseManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for SynapseManagementClientAttachedDatabaseConfigurations to be used by
