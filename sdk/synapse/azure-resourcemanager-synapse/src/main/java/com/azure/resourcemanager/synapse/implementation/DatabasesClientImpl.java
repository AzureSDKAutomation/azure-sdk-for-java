...
public final class DatabasesClientImpl implements DatabasesClient {
     ...
     */
    DatabasesClientImpl(SynapseManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for SynapseManagementClientDatabases to be used by the proxy service to
     * perform REST calls.
     */
    @Host("{$host}")
