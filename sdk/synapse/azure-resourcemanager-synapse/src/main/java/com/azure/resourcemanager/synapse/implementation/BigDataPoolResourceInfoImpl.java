...
public final class BigDataPoolResourceInfoImpl
    ...
    public BigDataPoolResourceInfoImpl withLastSucceededTimestamp(OffsetDateTime lastSucceededTimestamp) {
        this.innerModel().withLastSucceededTimestamp(lastSucceededTimestamp);
        return this;
    }
