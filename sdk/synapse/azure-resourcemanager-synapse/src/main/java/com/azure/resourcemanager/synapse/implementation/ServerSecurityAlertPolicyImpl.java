...
public final class ServerSecurityAlertPolicyImpl
    ...
    ServerSecurityAlertPolicyImpl(SecurityAlertPolicyNameAutoGenerated name, SynapseManager serviceManager) {
    ...
    ServerSecurityAlertPolicyImpl(ServerSecurityAlertPolicyInner innerObject, SynapseManager serviceManager) {
