...
public final class IntegrationRuntimeResourceImpl
    ...
    IntegrationRuntimeResourceImpl(String name, SynapseManager serviceManager) {
    ...
    IntegrationRuntimeResourceImpl(IntegrationRuntimeResourceInner innerObject, SynapseManager serviceManager) {
