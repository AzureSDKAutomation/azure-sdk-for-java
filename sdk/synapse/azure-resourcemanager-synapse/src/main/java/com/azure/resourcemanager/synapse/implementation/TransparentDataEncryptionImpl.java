...
public final class TransparentDataEncryptionImpl
    ...
    TransparentDataEncryptionImpl(TransparentDataEncryptionName name, SynapseManager serviceManager) {
    ...
    TransparentDataEncryptionImpl(TransparentDataEncryptionInner innerObject, SynapseManager serviceManager) {
