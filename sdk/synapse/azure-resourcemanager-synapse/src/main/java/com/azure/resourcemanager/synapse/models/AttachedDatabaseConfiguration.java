...
public interface AttachedDatabaseConfiguration {
    ...
    /**
     * Gets the clusterResourceId property: The resource id of the kusto pool where the databases you would like to
     * attach reside.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithClusterResourceId {
            /**
             * Specifies the clusterResourceId property: The resource id of the kusto pool where the databases you would
             * like to attach reside..
             *
             * @param clusterResourceId The resource id of the kusto pool where the databases you would like to attach
             *     reside.
             * @return the next definition stage.
             */
