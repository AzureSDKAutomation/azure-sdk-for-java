...
public final class DataConnectionsClientImpl implements DataConnectionsClient {
     ...
     */
    DataConnectionsClientImpl(SynapseManagementClientImpl client) {
        this.service =
    ...
    /**
     * The interface defining all the services for SynapseManagementClientDataConnections to be used by the proxy
