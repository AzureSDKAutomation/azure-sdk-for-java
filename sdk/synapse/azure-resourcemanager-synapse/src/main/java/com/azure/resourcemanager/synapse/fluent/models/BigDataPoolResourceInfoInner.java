...
public class BigDataPoolResourceInfoInner extends Resource {
     ...
     */
    @JsonProperty(value = "properties.lastSucceededTimestamp")
    ...
    /**
     * Set the lastSucceededTimestamp property: The time when the Big Data pool was updated successfully.
     *
     * @param lastSucceededTimestamp the lastSucceededTimestamp value to set.
     * @return the BigDataPoolResourceInfoInner object itself.
     */
    public BigDataPoolResourceInfoInner withLastSucceededTimestamp(OffsetDateTime lastSucceededTimestamp) {
