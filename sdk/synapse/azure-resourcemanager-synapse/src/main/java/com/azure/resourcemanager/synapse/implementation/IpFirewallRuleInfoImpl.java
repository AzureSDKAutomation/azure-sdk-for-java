...
public final class IpFirewallRuleInfoImpl
    ...
    IpFirewallRuleInfoImpl(String name, SynapseManager serviceManager) {
    ...
    IpFirewallRuleInfoImpl(IpFirewallRuleInfoInner innerObject, SynapseManager serviceManager) {
