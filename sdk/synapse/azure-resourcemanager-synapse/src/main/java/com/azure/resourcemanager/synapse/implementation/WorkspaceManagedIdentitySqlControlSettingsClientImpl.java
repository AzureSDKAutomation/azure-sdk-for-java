...
public final class WorkspaceManagedIdentitySqlControlSettingsClientImpl
    ...
    private interface WorkspaceManagedIdentitySqlControlSettingsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagedIdentitySqlControlSettingsModelInner>> createOrUpdate(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<ManagedIdentitySqlControlSettingsModelInner>> createOrUpdateWithResponseAsync(
    ...
    private Mono<ManagedIdentitySqlControlSettingsModelInner> createOrUpdateAsync(
        ...
        String workspaceName,
        ManagedIdentitySqlControlSettingsModelInner managedIdentitySqlControlSettings) {
        return createOrUpdateWithResponseAsync(resourceGroupName, workspaceName, managedIdentitySqlControlSettings)
            .flatMap(
                (Response<ManagedIdentitySqlControlSettingsModelInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ManagedIdentitySqlControlSettingsModelInner> createOrUpdateWithResponse(
        String resourceGroupName,
        String workspaceName,
        ManagedIdentitySqlControlSettingsModelInner managedIdentitySqlControlSettings,
        Context context) {
