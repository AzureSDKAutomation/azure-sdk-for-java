...
public final class WorkloadClassifierImpl
    ...
    WorkloadClassifierImpl(String name, SynapseManager serviceManager) {
    ...
    WorkloadClassifierImpl(WorkloadClassifierInner innerObject, SynapseManager serviceManager) {
