...
public final class ServerBlobAuditingPolicyImpl
    ...
    ServerBlobAuditingPolicyImpl(BlobAuditingPolicyName name, SynapseManager serviceManager) {
    ...
    ServerBlobAuditingPolicyImpl(ServerBlobAuditingPolicyInner innerObject, SynapseManager serviceManager) {
