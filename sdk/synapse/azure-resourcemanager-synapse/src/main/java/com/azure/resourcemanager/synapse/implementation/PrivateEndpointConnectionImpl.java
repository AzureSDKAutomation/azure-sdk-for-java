...
public final class PrivateEndpointConnectionImpl
    ...
    PrivateEndpointConnectionImpl(PrivateEndpointConnectionInner innerObject, SynapseManager serviceManager) {
    ...
    PrivateEndpointConnectionImpl(String name, SynapseManager serviceManager) {
