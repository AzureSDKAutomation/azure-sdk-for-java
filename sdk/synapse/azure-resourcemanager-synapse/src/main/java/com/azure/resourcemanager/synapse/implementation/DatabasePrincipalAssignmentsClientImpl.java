...
public final class DatabasePrincipalAssignmentsClientImpl implements DatabasePrincipalAssignmentsClient {
     ...
     */
    DatabasePrincipalAssignmentsClientImpl(SynapseManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    /**
     * The interface defining all the services for SynapseManagementClientDatabasePrincipalAssignments to be used by the
