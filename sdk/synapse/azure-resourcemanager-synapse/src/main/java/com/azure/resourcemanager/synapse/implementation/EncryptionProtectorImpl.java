...
public final class EncryptionProtectorImpl
    ...
    EncryptionProtectorImpl(EncryptionProtectorName name, SynapseManager serviceManager) {
    ...
    EncryptionProtectorImpl(EncryptionProtectorInner innerObject, SynapseManager serviceManager) {
