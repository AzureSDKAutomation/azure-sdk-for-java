...
public final class GeoBackupPolicyImpl implements GeoBackupPolicy, GeoBackupPolicy.Definition, GeoBackupPolicy.Update {
    ...
    GeoBackupPolicyImpl(GeoBackupPolicyName name, SynapseManager serviceManager) {
    ...
    GeoBackupPolicyImpl(GeoBackupPolicyInner innerObject, SynapseManager serviceManager) {
