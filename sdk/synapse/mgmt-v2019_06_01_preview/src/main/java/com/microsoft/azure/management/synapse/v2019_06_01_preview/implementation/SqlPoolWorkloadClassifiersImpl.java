...
class SqlPoolWorkloadClassifiersImpl extends WrapperImpl<SqlPoolWorkloadClassifiersInner> implements SqlPoolWorkloadClassifiers {
    ...
    @Override
    public Observable<WorkloadClassifier> listByWorkloadGroupAsync(final String resourceGroupName, final String workspaceName, final String sqlPoolName, final String workloadGroupName) {
        SqlPoolWorkloadClassifiersInner client = this.inner();
        return client.listByWorkloadGroupAsync(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName)
