...
public class SqlPoolWorkloadClassifiersInner {
    ...
    interface SqlPoolWorkloadClassifiersService {
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.synapse.v2019_06_01_preview.SqlPoolWorkloadClassifiers listByWorkloadGroup" })
        ...
        Observable<Response<ResponseBody>> listByWorkloadGroup(@Path("subscriptionId") String subscriptionId, @Path("resourceGroupName") String resourceGroupName, @Path("workspaceName") String workspaceName, @Path("sqlPoolName") String sqlPoolName, @Path("workloadGroupName") String workloadGroupName, @Query("api-version") String apiVersion, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);

        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.synapse.v2019_06_01_preview.SqlPoolWorkloadClassifiers listByWorkloadGroupNext" })
        @GET
        Observable<Response<ResponseBody>> listByWorkloadGroupNext(@Url String nextUrl, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
     ...
     */
    public PagedList<WorkloadClassifierInner> listByWorkloadGroup(final String resourceGroupName, final String workspaceName, final String sqlPoolName, final String workloadGroupName) {
        ServiceResponse<Page<WorkloadClassifierInner>> response = listByWorkloadGroupSinglePageAsync(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName).toBlocking().single();
        return new PagedList<WorkloadClassifierInner>(response.body()) {
            ...
            public Page<WorkloadClassifierInner> nextPage(String nextPageLink) {
                return listByWorkloadGroupNextSinglePageAsync(nextPageLink).toBlocking().single().body();
            }
        };
    }
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<WorkloadClassifierInner>> listByWorkloadGroupAsync(final String resourceGroupName, final String workspaceName, final String sqlPoolName, final String workloadGroupName, final ListOperationCallback<WorkloadClassifierInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByWorkloadGroupSinglePageAsync(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName),
            new Func1<String, Observable<ServiceResponse<Page<WorkloadClassifierInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> call(String nextPageLink) {
                    return listByWorkloadGroupNextSinglePageAsync(nextPageLink);
                }
            },
            serviceCallback);
    }
     ...
     */
    public Observable<Page<WorkloadClassifierInner>> listByWorkloadGroupAsync(final String resourceGroupName, final String workspaceName, final String sqlPoolName, final String workloadGroupName) {
        return listByWorkloadGroupWithServiceResponseAsync(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName)
     ...
     * @return the observable to the PagedList&lt;WorkloadClassifierInner&gt; object
     */
    public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> listByWorkloadGroupWithServiceResponseAsync(final String resourceGroupName, final String workspaceName, final String sqlPoolName, final String workloadGroupName) {
        return listByWorkloadGroupSinglePageAsync(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName)
            .concatMap(new Func1<ServiceResponse<Page<WorkloadClassifierInner>>, Observable<ServiceResponse<Page<WorkloadClassifierInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> call(ServiceResponse<Page<WorkloadClassifierInner>> page) {
                    ...
                    return Observable.just(page).concatWith(listByWorkloadGroupNextWithServiceResponseAsync(nextPageLink));
                }
            });
    }
    ...
    ServiceResponse<PageImpl<WorkloadClassifierInner>> * @param workloadGroupName The name of the workload group from which to receive the classifiers from.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;WorkloadClassifierInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> listByWorkloadGroupSinglePageAsync(final String resourceGroupName, final String workspaceName, final String sqlPoolName, final String workloadGroupName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
        ...
        return service.listByWorkloadGroup(this.client.subscriptionId(), resourceGroupName, workspaceName, sqlPoolName, workloadGroupName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<WorkloadClassifierInner>>>>() {
                ...
                public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<WorkloadClassifierInner>> result = listByWorkloadGroupDelegate(response);
    ...
    private ServiceResponse<PageImpl<WorkloadClassifierInner>> listByWorkloadGroupDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
     ...
     * @return the PagedList&lt;WorkloadClassifierInner&gt; object if successful.
     */
    public PagedList<WorkloadClassifierInner> listByWorkloadGroupNext(final String nextPageLink) {
        ServiceResponse<Page<WorkloadClassifierInner>> response = listByWorkloadGroupNextSinglePageAsync(nextPageLink).toBlocking().single();
        return new PagedList<WorkloadClassifierInner>(response.body()) {
            @Override
            public Page<WorkloadClassifierInner> nextPage(String nextPageLink) {
                return listByWorkloadGroupNextSinglePageAsync(nextPageLink).toBlocking().single().body();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<WorkloadClassifierInner>> listByWorkloadGroupNextAsync(final String nextPageLink, final ServiceFuture<List<WorkloadClassifierInner>> serviceFuture, final ListOperationCallback<WorkloadClassifierInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listByWorkloadGroupNextSinglePageAsync(nextPageLink),
            new Func1<String, Observable<ServiceResponse<Page<WorkloadClassifierInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> call(String nextPageLink) {
                    return listByWorkloadGroupNextSinglePageAsync(nextPageLink);
     ...
     * @return the observable to the PagedList&lt;WorkloadClassifierInner&gt; object
     */
    public Observable<Page<WorkloadClassifierInner>> listByWorkloadGroupNextAsync(final String nextPageLink) {
        return listByWorkloadGroupNextWithServiceResponseAsync(nextPageLink)
            .map(new Func1<ServiceResponse<Page<WorkloadClassifierInner>>, Page<WorkloadClassifierInner>>() {
                @Override
                public Page<WorkloadClassifierInner> call(ServiceResponse<Page<WorkloadClassifierInner>> response) {
                    return response.body();
     ...
     * @return the observable to the PagedList&lt;WorkloadClassifierInner&gt; object
     */
    public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> listByWorkloadGroupNextWithServiceResponseAsync(final String nextPageLink) {
        return listByWorkloadGroupNextSinglePageAsync(nextPageLink)
            .concatMap(new Func1<ServiceResponse<Page<WorkloadClassifierInner>>, Observable<ServiceResponse<Page<WorkloadClassifierInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> call(ServiceResponse<Page<WorkloadClassifierInner>> page) {
     ...
     * @return the PagedList&lt;WorkloadClassifierInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> listByWorkloadGroupNextSinglePageAsync(final String nextPageLink) {
        if (nextPageLink == null) {
            throw new IllegalArgumentException("Parameter nextPageLink is required and cannot be null.");
        }
        String nextUrl = String.format("%s", nextPageLink);
        return service.listByWorkloadGroupNext(nextUrl, this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<Page<WorkloadClassifierInner>>>>() {
                @Override
                public Observable<ServiceResponse<Page<WorkloadClassifierInner>>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<PageImpl<WorkloadClassifierInner>> result = listByWorkloadGroupNextDelegate(response);
                        return Observable.just(new ServiceResponse<Page<WorkloadClassifierInner>>(result.body(), result.response()));
                    } catch (Throwable t) {
                        return Observable.error(t);
                    }
    ...
    private ServiceResponse<PageImpl<WorkloadClassifierInner>> listByWorkloadGroupNextDelegate(Response<ResponseBody> response) throws CloudException, IOException, IllegalArgumentException {
        return this.client.restClient().responseBuilderFactory().<PageImpl<WorkloadClassifierInner>, CloudException>newInstance(this.client.serializerAdapter())
                .register(200, new TypeToken<PageImpl<WorkloadClassifierInner>>() { }.getType())
                .registerError(CloudException.class)
                .build(response);
