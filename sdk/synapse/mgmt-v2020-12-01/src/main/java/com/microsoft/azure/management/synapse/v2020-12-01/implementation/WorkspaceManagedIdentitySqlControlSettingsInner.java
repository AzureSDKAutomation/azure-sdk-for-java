...
public class WorkspaceManagedIdentitySqlControlSettingsInner {
    ...
    interface WorkspaceManagedIdentitySqlControlSettingsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.synapse.v2020-12-01.WorkspaceManagedIdentitySqlControlSettings get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.synapse.v2020-12-01.WorkspaceManagedIdentitySqlControlSettings createOrUpdate" })
