...
public final class NodesClientImpl implements NodesClient {
    ...
    private interface NodesService {
        ...
        Mono<Response<NodeListInner>> listByDataBoxEdgeDevice(
    ...
    private Mono<Response<NodeListInner>> listByDataBoxEdgeDeviceWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<NodeListInner> listByDataBoxEdgeDeviceAsync(String deviceName, String resourceGroupName) {
        return listByDataBoxEdgeDeviceWithResponseAsync(deviceName, resourceGroupName)
            .flatMap(
                (Response<NodeListInner> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public NodeListInner listByDataBoxEdgeDevice(String deviceName, String resourceGroupName) {
        return listByDataBoxEdgeDeviceAsync(deviceName, resourceGroupName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<NodeListInner> listByDataBoxEdgeDeviceWithResponse(
        String deviceName, String resourceGroupName, Context context) {
        return listByDataBoxEdgeDeviceWithResponseAsync(deviceName, resourceGroupName, context).block();
    }
}
