...
public final class AvailableSkusImpl implements AvailableSkus {
    ...
    public AvailableSkusImpl(AvailableSkusClient innerClient, DataBoxEdgeManager serviceManager) {
    ...
    public PagedIterable<DataBoxEdgeSku> list() {
        ...
        return inner.mapPage(inner1 -> new DataBoxEdgeSkuImpl(inner1, this.manager()));
    }
