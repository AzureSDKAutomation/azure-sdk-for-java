...
public final class UsersClientImpl implements UsersClient {
     ...
     * @param expand Specify $filter='Type eq &lt;type&gt;' to filter on user type property.
    ...
    private Mono<PagedResponse<UserInner>> listByDataBoxEdgeDeviceSinglePageAsync(
        String deviceName, String resourceGroupName, String expand) {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<UserInner>> listByDataBoxEdgeDeviceSinglePageAsync(
        String deviceName, String resourceGroupName, String expand, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<UserInner> listByDataBoxEdgeDeviceAsync(
        String deviceName, String resourceGroupName, String expand, Context context) {
        return new PagedFlux<>(
            () -> listByDataBoxEdgeDeviceSinglePageAsync(deviceName, resourceGroupName, expand, context),
    ...
    public PagedIterable<UserInner> listByDataBoxEdgeDevice(String deviceName, String resourceGroupName) {
        final String expand = null;
        return new PagedIterable<>(listByDataBoxEdgeDeviceAsync(deviceName, resourceGroupName, expand));
    }
    ...
    public PagedIterable<UserInner> listByDataBoxEdgeDevice(
        String deviceName, String resourceGroupName, String expand, Context context) {
        return new PagedIterable<>(listByDataBoxEdgeDeviceAsync(deviceName, resourceGroupName, expand, context));
    }
