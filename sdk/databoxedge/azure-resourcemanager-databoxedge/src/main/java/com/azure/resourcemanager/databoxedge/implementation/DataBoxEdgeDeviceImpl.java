...
public final class DataBoxEdgeDeviceImpl
    ...
    public DataBoxEdgeDeviceImpl withResourceMoveDetails(ResourceMoveDetails resourceMoveDetails) {
        this.innerModel().withResourceMoveDetails(resourceMoveDetails);
        return this;
    }

    public DataBoxEdgeDeviceImpl withEdgeProfile(EdgeProfile edgeProfile) {
        this.innerModel().withEdgeProfile(edgeProfile);
        return this;
    }
