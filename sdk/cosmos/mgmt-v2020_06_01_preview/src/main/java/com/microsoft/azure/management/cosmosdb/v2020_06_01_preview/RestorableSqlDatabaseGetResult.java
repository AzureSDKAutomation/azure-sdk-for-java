 ...
 */
public interface RestorableSqlDatabaseGetResult extends HasInner<RestorableSqlDatabaseGetResultInner>, Indexable, Refreshable<RestorableSqlDatabaseGetResult>, HasManager<CosmosDBManager> {
    /**
     * @return the id value.
     */
    String id();
