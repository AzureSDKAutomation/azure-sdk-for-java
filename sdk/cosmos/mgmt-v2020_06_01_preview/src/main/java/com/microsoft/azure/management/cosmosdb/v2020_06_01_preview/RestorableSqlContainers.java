...
public interface RestorableSqlContainers extends HasInner<RestorableSqlContainersInner> {
     ...
     */
    Observable<RestorableSqlContainerGetResult> getAsync(String location, String instanceId, String restorableSqlContainerId);
     ...
     * @return the observable for the request
     */
    Observable<RestorableSqlContainerGetResult> listAsync(String location, String instanceId, String restorableSqlDatabaseRid);
