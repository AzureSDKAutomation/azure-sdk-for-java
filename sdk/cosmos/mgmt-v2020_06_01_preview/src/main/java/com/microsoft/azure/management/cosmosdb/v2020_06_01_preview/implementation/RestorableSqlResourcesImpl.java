...
class RestorableSqlResourcesImpl extends WrapperImpl<RestorableSqlResourcesInner> implements RestorableSqlResources {
    ...
    @Override
    public Observable<RestorableDatabaseAccountLocationDatabaseRestoreResource> listAsync(String location, String instanceId, String restoreLocation, String restoreTimestampInUtc) {
