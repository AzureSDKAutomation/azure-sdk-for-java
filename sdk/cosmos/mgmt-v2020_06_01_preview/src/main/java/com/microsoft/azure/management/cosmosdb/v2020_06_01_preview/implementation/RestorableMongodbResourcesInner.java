...
public class RestorableMongodbResourcesInner {
     ...
     * @param restoreLocation The location where the resources are located.
     * @param restoreTimestampInUtc The timestamp when the resources exist.
    ...
    public Observable<ServiceResponse<List<DatabaseRestoreResourceInner>>> listWithServiceResponseAsync(String location, String instanceId, String restoreLocation, String restoreTimestampInUtc) {
        ...
        if (restoreLocation == null) {
            throw new IllegalArgumentException("Parameter restoreLocation is required and cannot be null.");
        }
        if (restoreTimestampInUtc == null) {
            throw new IllegalArgumentException("Parameter restoreTimestampInUtc is required and cannot be null.");
        }
