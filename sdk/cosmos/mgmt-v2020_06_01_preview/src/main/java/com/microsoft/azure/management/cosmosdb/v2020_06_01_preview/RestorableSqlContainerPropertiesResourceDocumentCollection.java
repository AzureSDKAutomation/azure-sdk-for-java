...
/**
 * The RestorableSqlContainerPropertiesResourceDocumentCollection model.
 */
public class RestorableSqlContainerPropertiesResourceDocumentCollection {
    /**
     ...
     * @return the RestorableSqlContainerPropertiesResourceDocumentCollection object itself.
     */
    public RestorableSqlContainerPropertiesResourceDocumentCollection withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the RestorableSqlContainerPropertiesResourceDocumentCollection object itself.
     */
    public RestorableSqlContainerPropertiesResourceDocumentCollection withIndexingPolicy(IndexingPolicy indexingPolicy) {
     ...
     * @return the RestorableSqlContainerPropertiesResourceDocumentCollection object itself.
     */
    public RestorableSqlContainerPropertiesResourceDocumentCollection withPartitionKey(ContainerPartitionKey partitionKey) {
     ...
     * @return the RestorableSqlContainerPropertiesResourceDocumentCollection object itself.
     */
    public RestorableSqlContainerPropertiesResourceDocumentCollection withDefaultTtl(Integer defaultTtl) {
     ...
     * @return the RestorableSqlContainerPropertiesResourceDocumentCollection object itself.
     */
    public RestorableSqlContainerPropertiesResourceDocumentCollection withUniqueKeyPolicy(UniqueKeyPolicy uniqueKeyPolicy) {
     ...
     * @return the RestorableSqlContainerPropertiesResourceDocumentCollection object itself.
     */
    public RestorableSqlContainerPropertiesResourceDocumentCollection withConflictResolutionPolicy(ConflictResolutionPolicy conflictResolutionPolicy) {
