...
/**
 * The RestorableMongodbCollectionPropertiesResourceDocumentCollection model.
 */
public class RestorableMongodbCollectionPropertiesResourceDocumentCollection {
    /**
     ...
     * @return the RestorableMongodbCollectionPropertiesResourceDocumentCollection object itself.
     */
    public RestorableMongodbCollectionPropertiesResourceDocumentCollection withId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the RestorableMongodbCollectionPropertiesResourceDocumentCollection object itself.
     */
    public RestorableMongodbCollectionPropertiesResourceDocumentCollection withShardKey(Map<String, String> shardKey) {
     ...
     * @return the RestorableMongodbCollectionPropertiesResourceDocumentCollection object itself.
     */
    public RestorableMongodbCollectionPropertiesResourceDocumentCollection withIndexes(List<MongoIndex> indexes) {
     ...
     * @return the RestorableMongodbCollectionPropertiesResourceDocumentCollection object itself.
     */
    public RestorableMongodbCollectionPropertiesResourceDocumentCollection withAnalyticalStorageTtl(Integer analyticalStorageTtl) {
    ...
    /**
     * Get a system generated property that specifies the addressable path of the collection resource.
     *
    ...
    /**
     * Set a system generated property that specifies the addressable path of the collection resource.
     *
     * @param _self the _self value to set
     * @return the RestorableMongodbCollectionPropertiesResourceDocumentCollection object itself.
     */
    public RestorableMongodbCollectionPropertiesResourceDocumentCollection with_self(String _self) {
        this._self = _self;
        return this;
    }
