...
public final class SqlResourcesImpl implements SqlResources {
    ...
    public BackupInformation getBackupInformation(
        ...
        BackupInformationInner inner =
            this
                .serviceClient()
                .getBackupInformation(resourceGroupName, accountName, databaseName, containerName, location);
        if (inner != null) {
    ...
    public BackupInformation getBackupInformation(
        ...
        BackupInformationInner inner =
            this
                .serviceClient()
                .getBackupInformation(resourceGroupName, accountName, databaseName, containerName, location, context);
        if (inner != null) {
            return new BackupInformationImpl(inner, this.manager());
        } else {
            return null;
    ...
    public PagedIterable<SqlRoleDefinitionGetResults> listSqlRoleDefinitions(
        ...
        return inner.mapPage(inner1 -> new SqlRoleDefinitionGetResultsImpl(inner1, this.manager()));
    }
    ...
    public PagedIterable<SqlRoleAssignmentGetResults> listSqlRoleAssignments(
        ...
        return inner.mapPage(inner1 -> new SqlRoleAssignmentGetResultsImpl(inner1, this.manager()));
    }
