...
public final class SqlResourcesClientImpl implements SqlResourcesClient {
    ...
    private interface SqlResourcesService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Flux<ByteBuffer>>> getBackupInformation(
            @HostParam("$host") String endpoint,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return backup information of a container resource.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Flux<ByteBuffer>>> getBackupInformationWithResponseAsync(
        String resourceGroupName, String accountName, String databaseName, String containerName, String location) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<BackupInformationInner>, BackupInformationInner> beginGetBackupInformationAsync(
        String resourceGroupName, String accountName, String databaseName, String containerName, String location) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            getBackupInformationWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<BackupInformationInner>, BackupInformationInner> beginGetBackupInformation(
        String resourceGroupName, String accountName, String databaseName, String containerName, String location) {
        return beginGetBackupInformationAsync(resourceGroupName, accountName, databaseName, containerName, location)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<BackupInformationInner>, BackupInformationInner> beginGetBackupInformation(
        ...
        String location,
        Context context) {
        return beginGetBackupInformationAsync(
                resourceGroupName, accountName, databaseName, containerName, location, context)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<BackupInformationInner> getBackupInformationAsync(
        String resourceGroupName, String accountName, String databaseName, String containerName, String location) {
        return beginGetBackupInformationAsync(resourceGroupName, accountName, databaseName, containerName, location)
            .last()
            .flatMap(this.client::getLroFinalResultOrError);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public BackupInformationInner getBackupInformation(
        String resourceGroupName, String accountName, String databaseName, String containerName, String location) {
        return getBackupInformationAsync(resourceGroupName, accountName, databaseName, containerName, location).block();
    }
    ...
    public BackupInformationInner getBackupInformation(
        ...
        String location,
        Context context) {
        return getBackupInformationAsync(resourceGroupName, accountName, databaseName, containerName, location, context)
            .block();
    }
