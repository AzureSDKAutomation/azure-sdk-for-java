...
/** The List operation response, that contains the restorable MongoDB collections and their properties. */
@Immutable
public final class RestorableMongodbCollectionsListResult {
    ...
    /*
     * List of restorable MongoDB collections and their properties.
     */
    @JsonProperty(value = "value", access = JsonProperty.Access.WRITE_ONLY)
    private List<RestorableMongodbCollectionGetResultInner> value;

    /**
     * Get the value property: List of restorable MongoDB collections and their properties.
     *
