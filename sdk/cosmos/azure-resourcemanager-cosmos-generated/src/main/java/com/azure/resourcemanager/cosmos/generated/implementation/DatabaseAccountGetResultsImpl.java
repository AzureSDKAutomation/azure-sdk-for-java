...
public final class DatabaseAccountGetResultsImpl
    ...
    public AnalyticalStorageConfig analyticalStorageConfig() {
        return this.innerModel().analyticalStorageConfig();
    }
    ...
    public DatabaseAccountGetResultsImpl withAnalyticalStorageConfig(AnalyticalStorageConfig analyticalStorageConfig) {
        if (isInCreateMode()) {
            this.createCreateUpdateParameters.withAnalyticalStorageConfig(analyticalStorageConfig);
            return this;
        } else {
            this.updateUpdateParameters.withAnalyticalStorageConfig(analyticalStorageConfig);
            return this;
        }
    }
