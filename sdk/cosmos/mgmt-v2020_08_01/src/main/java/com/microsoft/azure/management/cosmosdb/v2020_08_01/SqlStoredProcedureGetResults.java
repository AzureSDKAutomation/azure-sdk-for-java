...
import com.microsoft.azure.management.cosmosdb.v2020_08_01.implementation.SqlStoredProcedureGetResultsInner;
...
public interface SqlStoredProcedureGetResults extends HasInner<SqlStoredProcedureGetResultsInner>, Indexable, Refreshable<SqlStoredProcedureGetResults>, Updatable<SqlStoredProcedureGetResults.Update>, HasManager<CosmosDBManager> {
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends Creatable<SqlStoredProcedureGetResults>, DefinitionStages.WithIdentity, DefinitionStages.WithTags {
        }
    }
    /**
     * The template for a SqlStoredProcedureGetResults update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<SqlStoredProcedureGetResults>, UpdateStages.WithIdentity, UpdateStages.WithTags {
    }
