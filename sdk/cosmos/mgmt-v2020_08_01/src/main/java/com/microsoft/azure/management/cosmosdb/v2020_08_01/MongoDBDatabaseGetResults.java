...
import com.microsoft.azure.management.cosmosdb.v2020_08_01.implementation.MongoDBDatabaseGetResultsInner;
...
public interface MongoDBDatabaseGetResults extends HasInner<MongoDBDatabaseGetResultsInner>, Indexable, Refreshable<MongoDBDatabaseGetResults>, Updatable<MongoDBDatabaseGetResults.Update>, HasManager<CosmosDBManager> {
    ...
    interface DefinitionStages {
         ...
         */
        interface WithCreate extends Creatable<MongoDBDatabaseGetResults>, DefinitionStages.WithIdentity, DefinitionStages.WithTags {
        }
    }
    /**
     * The template for a MongoDBDatabaseGetResults update operation, containing all the settings that can be modified.
     */
    interface Update extends Appliable<MongoDBDatabaseGetResults>, UpdateStages.WithIdentity, UpdateStages.WithTags {
    }
