...
public class TableResourcesInner {
    ...
    public Observable<ServiceResponse<ThroughputSettingsGetResultsInner>> migrateTableToAutoscaleWithServiceResponseAsync(String resourceGroupName, String accountName, String tableName) {
        ...
        Observable<Response<ResponseBody>> observable = service.migrateTableToAutoscale(this.client.subscriptionId(), resourceGroupName, accountName, tableName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
    ...
    public Observable<ServiceResponse<ThroughputSettingsGetResultsInner>> beginMigrateTableToAutoscaleWithServiceResponseAsync(String resourceGroupName, String accountName, String tableName) {
        ...
        return service.beginMigrateTableToAutoscale(this.client.subscriptionId(), resourceGroupName, accountName, tableName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ThroughputSettingsGetResultsInner>>>() {
                @Override
                public Observable<ServiceResponse<ThroughputSettingsGetResultsInner>> call(Response<ResponseBody> response) {
                    try {
    ...
    public Observable<ServiceResponse<ThroughputSettingsGetResultsInner>> migrateTableToManualThroughputWithServiceResponseAsync(String resourceGroupName, String accountName, String tableName) {
        ...
        Observable<Response<ResponseBody>> observable = service.migrateTableToManualThroughput(this.client.subscriptionId(), resourceGroupName, accountName, tableName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent());
        return client.getAzureClient().getPostOrDeleteResultAsync(observable, new TypeToken<ThroughputSettingsGetResultsInner>() { }.getType());
    }
    ...
    public Observable<ServiceResponse<ThroughputSettingsGetResultsInner>> beginMigrateTableToManualThroughputWithServiceResponseAsync(String resourceGroupName, String accountName, String tableName) {
        ...
        return service.beginMigrateTableToManualThroughput(this.client.subscriptionId(), resourceGroupName, accountName, tableName, this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ThroughputSettingsGetResultsInner>>>() {
                @Override
                public Observable<ServiceResponse<ThroughputSettingsGetResultsInner>> call(Response<ResponseBody> response) {
                    try {
