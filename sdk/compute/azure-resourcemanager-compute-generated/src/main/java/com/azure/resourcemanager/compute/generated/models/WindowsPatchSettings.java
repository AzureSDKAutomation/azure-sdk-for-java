...
@Fluent
public final class WindowsPatchSettings {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(WindowsPatchSettings.class);
     ...
     * @return the WindowsPatchSettings object itself.
     */
    public WindowsPatchSettings withPatchMode(WindowsVMGuestPatchMode patchMode) {
     ...
     * @return the WindowsPatchSettings object itself.
     */
    public WindowsPatchSettings withEnableHotpatching(Boolean enableHotpatching) {
