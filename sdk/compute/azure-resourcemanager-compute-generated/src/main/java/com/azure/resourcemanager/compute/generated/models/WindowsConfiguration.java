...
public final class WindowsConfiguration {
    ...
    private WindowsPatchSettings patchSettings;
    ...
    /**
     * Get the patchSettings property: Specifies settings related to VM Guest Patching on Windows.
     *
     * @return the patchSettings value.
     */
    public WindowsPatchSettings patchSettings() {
        return this.patchSettings;
    }

    /**
     * Set the patchSettings property: Specifies settings related to VM Guest Patching on Windows.
     *
     * @param patchSettings the patchSettings value to set.
     * @return the WindowsConfiguration object itself.
     */
    public WindowsConfiguration withPatchSettings(WindowsPatchSettings patchSettings) {
