...
public final class HardwareProfile {
     ...
     * region](https://docs.microsoft.com/en-us/rest/api/compute/resourceskus/list) &lt;br&gt;&lt;br&gt; [List all
     ...
     * the subsequent REST API specification. Use [List all available virtual machine sizes in a
