...
public final class ResourceSkusImpl implements ResourceSkus {
    ...
    public PagedIterable<ResourceSku> list(String includeExtendedLocations, String filter, Context context) {
        PagedIterable<ResourceSkuInner> inner = this.serviceClient().list(includeExtendedLocations, filter, context);
        return inner.mapPage(inner1 -> new ResourceSkuImpl(inner1, this.manager()));
    }
