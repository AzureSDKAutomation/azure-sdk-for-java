...
public final class RestorePointsClientImpl implements RestorePointsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<RestorePointInner>, RestorePointInner> beginCreateOrUpdateAsync(
        String resourceGroupName,
        String restorePointCollectionName,
        String restorePointName,
        RestorePointInner parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(
                resourceGroupName, restorePointCollectionName, restorePointName, parameters);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<RestorePointInner>, RestorePointInner> beginCreateOrUpdate(
        String resourceGroupName,
        String restorePointCollectionName,
        String restorePointName,
        RestorePointInner parameters) {
        return beginCreateOrUpdateAsync(resourceGroupName, restorePointCollectionName, restorePointName, parameters)
            .getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<RestorePointInner> createOrUpdateAsync(
        String resourceGroupName,
        String restorePointCollectionName,
        String restorePointName,
        RestorePointInner parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public RestorePointInner createOrUpdate(
        String resourceGroupName,
        String restorePointCollectionName,
        String restorePointName,
        RestorePointInner parameters) {
        return createOrUpdateAsync(resourceGroupName, restorePointCollectionName, restorePointName, parameters).block();
    }
    ...
    public RestorePointInner createOrUpdate(
        ...
        RestorePointInner parameters,
        Context context) {
        return createOrUpdateAsync(resourceGroupName, restorePointCollectionName, restorePointName, parameters, context)
            .block();
    }
