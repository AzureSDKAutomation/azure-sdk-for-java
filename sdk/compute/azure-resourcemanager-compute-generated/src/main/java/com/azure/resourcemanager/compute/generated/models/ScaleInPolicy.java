...
public final class ScaleInPolicy {
    ...
    /*
     * Indicates if virtual machines chosen for removal has to force deleted
     * when a virtual machine scale set is being scaled-in.(Feature in Preview)
     */
    ...
    /**
     * Get the forceDeletion property: Indicates if virtual machines chosen for removal has to force deleted when a
    ...
    /**
     * Set the forceDeletion property: Indicates if virtual machines chosen for removal has to force deleted when a
     * virtual machine scale set is being scaled-in.(Feature in Preview).
     *
