...
public final class ResourceSkuLocationInfo {
    ...
    /*
     * The locationDetails property.
     */
    @JsonProperty(value = "locationDetails", access = JsonProperty.Access.WRITE_ONLY)
    private List<ResourceSkuLocationInfoLocationDetailsItem> locationDetails;
    ...
    /**
     * Get the locationDetails property: The locationDetails property.
     *
     * @return the locationDetails value.
     */
    public List<ResourceSkuLocationInfoLocationDetailsItem> locationDetails() {
