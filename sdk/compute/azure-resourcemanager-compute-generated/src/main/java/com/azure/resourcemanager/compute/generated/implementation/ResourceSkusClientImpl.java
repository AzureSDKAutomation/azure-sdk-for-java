...
public final class ResourceSkusClientImpl implements ResourceSkusClient {
    ...
    private Mono<PagedResponse<ResourceSkuInner>> listSinglePageAsync(String includeExtendedLocations, String filter) {
    ...
    private Mono<PagedResponse<ResourceSkuInner>> listSinglePageAsync(
        String includeExtendedLocations, String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<ResourceSkuInner> listAsync(String includeExtendedLocations, String filter) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(includeExtendedLocations, filter), nextLink -> listNextSinglePageAsync(nextLink));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    private PagedFlux<ResourceSkuInner> listAsync(String includeExtendedLocations, String filter, Context context) {
        return new PagedFlux<>(
            () -> listSinglePageAsync(includeExtendedLocations, filter, context),
    ...
    public PagedIterable<ResourceSkuInner> list() {
        final String includeExtendedLocations = null;
        final String filter = null;
        return new PagedIterable<>(listAsync(includeExtendedLocations, filter));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<ResourceSkuInner> list(String includeExtendedLocations, String filter, Context context) {
        return new PagedIterable<>(listAsync(includeExtendedLocations, filter, context));
    }
