...
public final class RestorePointSourceVMDataDisk {
    ...
    /**
     * Get the lun property: Gets or sets the logical unit number.
     *
    ...
    /**
     * Set the lun property: Gets or sets the logical unit number.
     *
    ...
    /**
     * Get the diskSizeGB property: Gets or sets the initial disk size in GB for blank data disks, and the new desired
    ...
    /**
     * Set the diskSizeGB property: Gets or sets the initial disk size in GB for blank data disks, and the new desired
     * size for existing OS and Data disks.
     *
