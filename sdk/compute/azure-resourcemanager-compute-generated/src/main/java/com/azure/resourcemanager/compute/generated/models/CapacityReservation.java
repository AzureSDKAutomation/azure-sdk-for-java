...
public interface CapacityReservation {
     ...
     * and can be assigned only during creation. If not provided, the reservation supports only non-zonal deployments.
     * If provided, enforces VM/VMSS using this capacity reservation to be in same zone.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithZones {
             ...
             * single value and can be assigned only during creation. If not provided, the reservation supports only
             * non-zonal deployments. If provided, enforces VM/VMSS using this capacity reservation to be in same zone..
             *
             * @param zones Availability Zone to use for this capacity reservation. The zone has to be single value and
             *     can be assigned only during creation. If not provided, the reservation supports only non-zonal
