...
public interface CapacityReservation {
    ...
    /**
     * Gets the sku property: SKU of the capacity reservation. Currently skus with the sku capability called
    ...
    /**
     * Gets the zones property: Availability Zone to use for this capacity reservation. The zone can be assigned only
    ...
    /**
     * Gets the virtualMachinesAssociated property: A list of references to all virtual machines associated in the
    ...
    /**
     * Gets the provisioningTime property: The date when the capacity reservation was last time updated.
     *
    ...
    interface DefinitionStages {
        ...
        interface WithSku {
            /**
             * Specifies the sku property: SKU of the capacity reservation. Currently skus with the sku capability
             * called 'CapacityReservationSupported' set as true are only supported for creating the capacity
             * reservation..
             *
             * @param sku SKU of the capacity reservation. Currently skus with the sku capability called
             *     'CapacityReservationSupported' set as true are only supported for creating the capacity reservation.
             * @return the next definition stage.
             */
        ...
        interface WithZones {
            /**
             * Specifies the zones property: Availability Zone to use for this capacity reservation. The zone can be
             * assigned only during creation. If not provided, the reservation supports only non-zonal deployments. If
             * provided, enforces VM/VMSS using this capacity reservation to be in same zone..
             *
             * @param zones Availability Zone to use for this capacity reservation. The zone can be assigned only during
             *     creation. If not provided, the reservation supports only non-zonal deployments. If provided, enforces
             *     VM/VMSS using this capacity reservation to be in same zone.
             * @return the next definition stage.
             */
