...
public class GalleryImageInner extends Resource {
    ...
    /*
     * Optional. This property allows user to specify the targeted architecture
     * for the VMImage.
     */
    @JsonProperty(value = "properties.architecture")
    ...
    /**
     * Get the architecture property: Optional. This property allows user to specify the targeted architecture for the
     * VMImage.
     *
    ...
    /**
     * Set the architecture property: Optional. This property allows user to specify the targeted architecture for the
     * VMImage.
     *
