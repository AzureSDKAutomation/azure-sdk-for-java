 ...
 * time. An existing capacity reservation cannot be added to another capacity reservation group.
 */
@JsonFlatten
@Fluent
public class CapacityReservationGroupInner extends Resource {
     ...
     * supports only non-zonal resources in the region. If provided, enforces
