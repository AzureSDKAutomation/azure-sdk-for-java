...
public interface CapacityReservationGroup {
     ...
     * only during creation. If not provided, the group supports only non-zonal resources in the region. If provided,
    ...
    /**
     * Gets the capacityReservations property: A list of references to all capacity reservations in the capacity
     * reservation group.
     *
    ...
    /**
     * Gets the instanceView property: The Capacity Reservation group instance view, which has the list of instance view
    ...
    interface DefinitionStages {
        ...
        interface WithZones {
             ...
             * can be assigned only during creation. If not provided, the group supports only non-zonal resources in the
             ...
             *     only during creation. If not provided, the group supports only non-zonal resources in the region. If
