...
public final class RestorePointCollectionImpl
    ...
    RestorePointCollectionImpl(String name, ComputeManager serviceManager) {
    ...
    RestorePointCollectionImpl(RestorePointCollectionInner innerObject, ComputeManager serviceManager) {
    ...
    public RestorePointCollectionImpl withSource(SubResource source) {
        if (isInCreateMode()) {
    ...
    public RestorePointCollectionImpl withRestorePoints(List<RestorePointInner> restorePoints) {
        if (isInCreateMode()) {
            this.innerModel().withRestorePoints(restorePoints);
            return this;
        } else {
            this.updateParameters.withRestorePoints(restorePoints);
            return this;
        }
    }
