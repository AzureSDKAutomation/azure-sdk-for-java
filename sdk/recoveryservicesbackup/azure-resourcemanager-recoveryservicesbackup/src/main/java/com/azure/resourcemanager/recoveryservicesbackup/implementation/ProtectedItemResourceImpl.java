...
public final class ProtectedItemResourceImpl
    ...
    public ProtectedItemResourceImpl(String name, RecoveryServicesBackupManager serviceManager) {
    ...
    public ProtectedItemResourceImpl(
        ProtectedItemResourceInner innerObject, RecoveryServicesBackupManager serviceManager) {
