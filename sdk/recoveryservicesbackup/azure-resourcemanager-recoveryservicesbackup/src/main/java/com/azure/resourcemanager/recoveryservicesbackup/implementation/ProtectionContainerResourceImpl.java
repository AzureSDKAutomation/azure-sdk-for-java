...
public final class ProtectionContainerResourceImpl
    ...
    public ProtectionContainerResourceImpl(String name, RecoveryServicesBackupManager serviceManager) {
    ...
    public ProtectionContainerResourceImpl(
        ProtectionContainerResourceInner innerObject, RecoveryServicesBackupManager serviceManager) {
