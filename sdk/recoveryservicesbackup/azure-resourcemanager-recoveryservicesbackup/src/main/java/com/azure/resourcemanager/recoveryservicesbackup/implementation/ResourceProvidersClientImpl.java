...
public final class ResourceProvidersClientImpl implements ResourceProvidersClient {
    ...
    private interface ResourceProvidersService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Void>> bmsPrepareDataMove(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("vaultName") String vaultName,
            @PathParam("resourceGroupName") String resourceGroupName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<Void>> bmsPrepareDataMoveWithResponseAsync(
    ...
    private Mono<Void> bmsPrepareDataMoveAsync(
        String vaultName, String resourceGroupName, PrepareDataMoveRequest parameters) {
        return bmsPrepareDataMoveWithResponseAsync(vaultName, resourceGroupName, parameters)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<Void> bmsPrepareDataMoveWithResponse(
        String vaultName, String resourceGroupName, PrepareDataMoveRequest parameters, Context context) {
        return bmsPrepareDataMoveWithResponseAsync(vaultName, resourceGroupName, parameters, context).block();
    }
