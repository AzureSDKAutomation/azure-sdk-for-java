...
public final class TargetRestoreInfo {
    ...
    /*
     * This will contain the target folder mapping for the
     * Full/Diff/Log/Incremental pits.
     */
    @JsonProperty(value = "targetDirectoryMapping")
    private Map<String, String> targetDirectoryMapping;
    ...
    /**
     * Get the targetDirectoryMapping property: This will contain the target folder mapping for the
     * Full/Diff/Log/Incremental pits.
     *
     * @return the targetDirectoryMapping value.
     */
    public Map<String, String> targetDirectoryMapping() {
        return this.targetDirectoryMapping;
    }

    /**
     * Set the targetDirectoryMapping property: This will contain the target folder mapping for the
     * Full/Diff/Log/Incremental pits.
     *
     * @param targetDirectoryMapping the targetDirectoryMapping value to set.
     * @return the TargetRestoreInfo object itself.
     */
    public TargetRestoreInfo withTargetDirectoryMapping(Map<String, String> targetDirectoryMapping) {
