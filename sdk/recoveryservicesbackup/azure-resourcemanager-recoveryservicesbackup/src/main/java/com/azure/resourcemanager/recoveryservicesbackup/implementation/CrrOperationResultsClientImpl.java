...
public final class CrrOperationResultsClientImpl implements CrrOperationResultsClient {
    ...
    private Mono<Response<Flux<ByteBuffer>>> getWithResponseAsync(String azureRegion, String operationId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<Void>, Void> beginGetAsync(String azureRegion, String operationId) {
        Mono<Response<Flux<ByteBuffer>>> mono = getWithResponseAsync(azureRegion, operationId);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<Void>, Void> beginGetAsync(String azureRegion, String operationId, Context context) {
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono = getWithResponseAsync(azureRegion, operationId, context);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<Void>, Void> beginGet(String azureRegion, String operationId) {
        return beginGetAsync(azureRegion, operationId).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<Void>, Void> beginGet(String azureRegion, String operationId, Context context) {
        return beginGetAsync(azureRegion, operationId, context).getSyncPoller();
    }
    ...
    private Mono<Void> getAsync(String azureRegion, String operationId) {
        return beginGetAsync(azureRegion, operationId).last().flatMap(this.client::getLroFinalResultOrError);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Void> getAsync(String azureRegion, String operationId, Context context) {
        return beginGetAsync(azureRegion, operationId, context).last().flatMap(this.client::getLroFinalResultOrError);
    }
    ...
    public void get(String azureRegion, String operationId, Context context) {
        getAsync(azureRegion, operationId, context).block();
    }
}
