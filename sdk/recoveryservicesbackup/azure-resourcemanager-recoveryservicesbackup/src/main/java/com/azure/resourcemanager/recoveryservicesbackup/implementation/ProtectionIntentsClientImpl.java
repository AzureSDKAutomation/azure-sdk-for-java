...
public final class ProtectionIntentsClientImpl implements ProtectionIntentsClient {
     ...
     * @param parameters Contract to validate if backup can be enabled on the given resource in a given vault and given
     *     configuration. It will validate followings 1. Vault capacity 2. VM is already protected 3. Any VM related
     *     configuration passed in properties.
     ...
     * @param parameters Base class for backup ProtectionIntent.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return base class for backup ProtectionIntent.
