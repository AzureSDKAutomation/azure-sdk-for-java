...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public ResourceProvidersImpl(ResourceProvidersClient innerClient, RecoveryServicesBackupManager serviceManager) {
    ...
    public Response<Void> bmsPrepareDataMoveWithResponse(
        ...
        return this.serviceClient().bmsPrepareDataMoveWithResponse(vaultName, resourceGroupName, parameters, context);
    }
