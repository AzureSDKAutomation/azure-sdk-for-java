...
public final class RecoveryPointsRecommendedForMovesClientImpl implements RecoveryPointsRecommendedForMovesClient {
    ...
    public PagedIterable<RecoveryPointResourceInner> list(
        ...
        return new PagedIterable<>(
            listAsync(vaultName, resourceGroupName, fabricName, containerName, protectedItemName));
    }
    ...
    public PagedIterable<RecoveryPointResourceInner> list(
        ...
        Context context) {
        return new PagedIterable<>(
            listAsync(vaultName, resourceGroupName, fabricName, containerName, protectedItemName, context));
    }
