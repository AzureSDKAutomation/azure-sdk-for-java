...
public final class ConfigurationStoresClientImpl implements ConfigurationStoresClient {
     ...
     *     If a previous response contains a nextLink element, the value of the nextLink element will include a
     *     skipToken parameter that specifies a starting point to use for subsequent calls.
     * @param filter The filter to apply on the access keys. For example, you can use "$filter=readOnly eq true" to
     *     retrieve only read-only access keys. Properties that support filtering include 'name' and 'readOnly'.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
    ...
    private Mono<PagedResponse<ApiKeyInner>> listKeysSinglePageAsync(
        String resourceGroupName, String configStoreName, String skipToken, String filter) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<PagedResponse<ApiKeyInner>> listKeysSinglePageAsync(
        String resourceGroupName, String configStoreName, String skipToken, String filter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
    ...
    private PagedFlux<ApiKeyInner> listKeysAsync(
        String resourceGroupName, String configStoreName, String skipToken, String filter) {
        return new PagedFlux<>(
            () -> listKeysSinglePageAsync(resourceGroupName, configStoreName, skipToken, filter),
    ...
    private PagedFlux<ApiKeyInner> listKeysAsync(
        String resourceGroupName, String configStoreName, String skipToken, String filter, Context context) {
        return new PagedFlux<>(
            () -> listKeysSinglePageAsync(resourceGroupName, configStoreName, skipToken, filter, context),
    ...
    public PagedIterable<ApiKeyInner> listKeys(String resourceGroupName, String configStoreName) {
        final String skipToken = null;
        final String filter = null;
        return new PagedIterable<>(listKeysAsync(resourceGroupName, configStoreName, skipToken, filter));
    }
    ...
    public PagedIterable<ApiKeyInner> listKeys(
        String resourceGroupName, String configStoreName, String skipToken, String filter, Context context) {
        return new PagedIterable<>(listKeysAsync(resourceGroupName, configStoreName, skipToken, filter, context));
    }
