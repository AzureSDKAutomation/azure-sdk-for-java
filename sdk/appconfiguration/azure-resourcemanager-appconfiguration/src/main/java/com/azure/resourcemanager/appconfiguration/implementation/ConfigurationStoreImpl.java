...
public final class ConfigurationStoreImpl
    ...
    public PagedIterable<ApiKey> listKeys(String skipToken, String filter, Context context) {
        return serviceManager
            .configurationStores()
            .listKeys(resourceGroupName, configStoreName, skipToken, filter, context);
    }
