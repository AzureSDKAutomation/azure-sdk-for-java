...
public final class AppConfigurationManager extends ManagerCore<AppConfigurationManager, AppConfigurationManagementClientImpl> {
    ...
    private EventGridFilters eventGridFilters;
    /**
    ...
    */
    ...
    /**
     * @return Entry point to manage EventGridFilters.
     */
    public EventGridFilters eventGridFilters() {
        if (this.eventGridFilters == null) {
            this.eventGridFilters = new EventGridFiltersImpl(this);
        }
