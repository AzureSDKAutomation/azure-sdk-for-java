...
public class AppConfigurationManagementClientImpl extends AzureServiceClient {
    ...
    /**
     * The EventGridFiltersInner object to access its operations.
     */
    private EventGridFiltersInner eventGridFilters;

    /**
     * Gets the EventGridFiltersInner object to access its operations.
     * @return the EventGridFiltersInner object.
     */
    public EventGridFiltersInner eventGridFilters() {
        return this.eventGridFilters;
    }
    ...
    protected void initialize() {
        ...
        this.eventGridFilters = new EventGridFiltersInner(restClient().retrofit(), this);
