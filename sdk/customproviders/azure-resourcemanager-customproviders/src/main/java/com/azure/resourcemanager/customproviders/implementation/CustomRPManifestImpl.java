...
public final class CustomRPManifestImpl
    ...
    CustomRPManifestImpl(String name, CustomprovidersManager serviceManager) {
    ...
    CustomRPManifestImpl(CustomRPManifestInner innerObject, CustomprovidersManager serviceManager) {
