...
public interface CustomDomains extends SupportsCreating<CustomDomainResource.DefinitionStages.Blank>, HasInner<CustomDomainsInner> {
     ...
     */
    Observable<CustomDomainResourceCollection> listAsync(String resourceGroupName, String serviceName, String appName);
     ...
     * @return the observable for the request
     */
    Observable<NameAvailability> checkNameAvailabilityAsync(String resourceGroupName, String serviceName, String appName, NameAvailabilityParameters availabilityParameters);
