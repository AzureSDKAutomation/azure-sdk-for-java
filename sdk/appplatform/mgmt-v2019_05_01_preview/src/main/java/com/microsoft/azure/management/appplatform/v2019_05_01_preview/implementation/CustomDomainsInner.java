...
public class CustomDomainsInner {
     ...
     */
    public PagedList<CustomDomainResourceInner> list(final String resourceGroupName, final String serviceName, final String appName, final String domainName) {
        ServiceResponse<Page<CustomDomainResourceInner>> response = listSinglePageAsync(resourceGroupName, serviceName, appName, domainName).toBlocking().single();
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<List<CustomDomainResourceInner>> listAsync(final String resourceGroupName, final String serviceName, final String appName, final String domainName, final ListOperationCallback<CustomDomainResourceInner> serviceCallback) {
        return AzureServiceFuture.fromPageResponse(
            listSinglePageAsync(resourceGroupName, serviceName, appName, domainName),
     ...
     */
    public Observable<Page<CustomDomainResourceInner>> listAsync(final String resourceGroupName, final String serviceName, final String appName, final String domainName) {
        return listWithServiceResponseAsync(resourceGroupName, serviceName, appName, domainName)
     ...
     * @return the observable to the PagedList&lt;CustomDomainResourceInner&gt; object
     */
    public Observable<ServiceResponse<Page<CustomDomainResourceInner>>> listWithServiceResponseAsync(final String resourceGroupName, final String serviceName, final String appName, final String domainName) {
        return listSinglePageAsync(resourceGroupName, serviceName, appName, domainName)
    ...
    ServiceResponse<PageImpl<CustomDomainResourceInner>> * @param domainName The name of the custom domain resource.
     * @throws IllegalArgumentException thrown if parameters fail the validation
     * @return the PagedList&lt;CustomDomainResourceInner&gt; object wrapped in {@link ServiceResponse} if successful.
     */
    public Observable<ServiceResponse<Page<CustomDomainResourceInner>>> listSinglePageAsync(final String resourceGroupName, final String serviceName, final String appName, final String domainName) {
        if (this.client.subscriptionId() == null) {
            throw new IllegalArgumentException("Parameter this.client.subscriptionId() is required and cannot be null.");
        }
        if (resourceGroupName == null) {
