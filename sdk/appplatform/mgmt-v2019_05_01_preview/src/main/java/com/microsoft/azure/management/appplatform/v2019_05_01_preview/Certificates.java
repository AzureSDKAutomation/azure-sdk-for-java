...
public interface Certificates extends SupportsCreating<CertificateResource.DefinitionStages.Blank>, HasInner<CertificatesInner> {
     ...
     */
    Observable<CertificateResource> getAsyncAsync(String certificateName, String resourceGroupName, String serviceName);
     ...
     * @return the observable for the request
     */
    Observable<CertificateResource> deleteAsyncAsync(String certificateName, String resourceGroupName, String serviceName);
     ...
     * @return the observable for the request
     */
    Observable<CertificateResourceCollection> listAsyncAsync(String certificateName, String resourceGroupName, String serviceName);
