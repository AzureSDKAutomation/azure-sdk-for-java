...
public class SkusInner {
     ...
     */
    public ServiceFuture<ResourceTypeSkuCollectionInner> listAsync(final ServiceCallback<ResourceTypeSkuCollectionInner> serviceCallback) {
     ...
     */
    public Observable<ResourceTypeSkuCollectionInner> listAsync() {
        return listWithServiceResponseAsync().map(new Func1<ServiceResponse<ResourceTypeSkuCollectionInner>, ResourceTypeSkuCollectionInner>() {
            @Override
     ...
     * @return the observable to the ResourceTypeSkuCollectionInner object
     */
    public Observable<ServiceResponse<ResourceTypeSkuCollectionInner>> listWithServiceResponseAsync() {
        return service.list(this.client.apiVersion(), this.client.acceptLanguage(), this.client.userAgent())
            .flatMap(new Func1<Response<ResponseBody>, Observable<ServiceResponse<ResourceTypeSkuCollectionInner>>>() {
                ...
                public Observable<ServiceResponse<ResourceTypeSkuCollectionInner>> call(Response<ResponseBody> response) {
                    try {
                        ServiceResponse<ResourceTypeSkuCollectionInner> clientResponse = listDelegate(response);
    ...
    private ServiceResponse<ResourceTypeSkuCollectionInner> listDelegate(Response<ResponseBody> response) throws CloudException, IOException {
