...
class CustomDomainsImpl extends WrapperImpl<CustomDomainsInner> implements CustomDomains {
    ...
    @Override
    public Observable<CustomDomainResourceCollection> listAsync(String resourceGroupName, String serviceName, String appName) {
    ...
    @Override
    public Observable<NameAvailability> checkNameAvailabilityAsync(String resourceGroupName, String serviceName, String appName, NameAvailabilityParameters availabilityParameters) {
        CustomDomainsInner client = this.inner();
        return client.checkNameAvailabilityAsync(resourceGroupName, serviceName, appName, availabilityParameters)
