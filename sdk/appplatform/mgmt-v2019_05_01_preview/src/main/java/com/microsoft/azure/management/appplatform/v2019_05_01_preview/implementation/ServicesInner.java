...
public class ServicesInner implements InnerSupportsGet<ServiceResourceInner>, InnerSupportsDelete<Void>, InnerSupportsListing<ServiceResourceInner> {
    ...
    interface ServicesService {
        ...
        Observable<Response<ResponseBody>> checkNameAvailability(@Path("location") String location, @Path("subscriptionId") String subscriptionId, @Query("api-version") String apiVersion, @Body NameAvailabilityParameters availabilityParameters, @Header("accept-language") String acceptLanguage, @Header("User-Agent") String userAgent);
    ...
    public Observable<ServiceResponse<NameAvailabilityInner>> checkNameAvailabilityWithServiceResponseAsync(String location, NameAvailabilityParameters availabilityParameters) {
        ...
        return service.checkNameAvailability(location, this.client.subscriptionId(), this.client.apiVersion(), availabilityParameters, this.client.acceptLanguage(), this.client.userAgent())
