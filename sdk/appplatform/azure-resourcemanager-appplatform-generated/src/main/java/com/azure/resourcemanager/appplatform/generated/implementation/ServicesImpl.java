...
public final class ServicesImpl implements Services {
    ...
    public VnetRoleAssignment checkVnetRoleAssignment(VnetRoleAssignmentParameter roleAssignmentParameter) {
        VnetRoleAssignmentInner inner = this.serviceClient().checkVnetRoleAssignment(roleAssignmentParameter);
        if (inner != null) {
            return new VnetRoleAssignmentImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public Response<VnetRoleAssignment> checkVnetRoleAssignmentWithResponse(
        VnetRoleAssignmentParameter roleAssignmentParameter, Context context) {
        Response<VnetRoleAssignmentInner> inner =
            this.serviceClient().checkVnetRoleAssignmentWithResponse(roleAssignmentParameter, context);
        if (inner != null) {
            return new SimpleResponse<>(
                inner.getRequest(),
                inner.getStatusCode(),
                inner.getHeaders(),
                new VnetRoleAssignmentImpl(inner.getValue(), this.manager()));
        } else {
            return null;
        }
    }
