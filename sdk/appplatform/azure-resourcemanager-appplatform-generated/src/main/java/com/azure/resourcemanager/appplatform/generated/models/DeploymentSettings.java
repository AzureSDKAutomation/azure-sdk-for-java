...
public final class DeploymentSettings {
     ...
     * 2020-11-01-preview. Please use the resourceRequests field to set the CPU
     * size.
     */
     ...
     * from API version 2020-11-01-preview. Please use the resourceRequests
     ...
     * is deprecated starting from API version 2020-11-01-preview. Please use the resourceRequests field to set the CPU
     * size.
     *
     ...
     * range [1, 8] for Standard tier. This is deprecated starting from API version 2020-11-01-preview. Please use the
    ...
    /**
     * Get the resourceRequests property: The requested resource quantity.
     *
    ...
    /**
     * Set the resourceRequests property: The requested resource quantity.
     *
