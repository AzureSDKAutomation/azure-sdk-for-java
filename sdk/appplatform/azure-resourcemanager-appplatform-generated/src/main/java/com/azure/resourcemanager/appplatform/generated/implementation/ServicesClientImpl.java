...
import com.azure.resourcemanager.appplatform.generated.models.VnetRoleAssignmentParameter;
...
public final class ServicesClientImpl implements ServicesClient {
    ...
    private interface ServicesService {
        ...
        @Headers({"Content-Type: application/json"})
        @Post("/subscriptions/{subscriptionId}/providers/Microsoft.AppPlatform/checkVnetRoleAssignment")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VnetRoleAssignmentInner>> checkVnetRoleAssignment(
            @HostParam("$host") String endpoint,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") VnetRoleAssignmentParameter roleAssignmentParameter,
            @HeaderParam("Accept") String accept,
            Context context);
     ...
     *
     * @param roleAssignmentParameter Parameters supplied to the operation.
     * @throws IllegalArgumentException thrown if parameters fail the validation.
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return check Vnet role assignment response payload.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<VnetRoleAssignmentInner>> checkVnetRoleAssignmentWithResponseAsync(
        VnetRoleAssignmentParameter roleAssignmentParameter) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
        ...
        if (roleAssignmentParameter == null) {
            return Mono
                .error(
                    new IllegalArgumentException("Parameter roleAssignmentParameter is required and cannot be null."));
        } else {
    ...
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<Response<VnetRoleAssignmentInner>> checkVnetRoleAssignmentWithResponseAsync(
        VnetRoleAssignmentParameter roleAssignmentParameter, Context context) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<VnetRoleAssignmentInner> checkVnetRoleAssignmentAsync(
        VnetRoleAssignmentParameter roleAssignmentParameter) {
        return checkVnetRoleAssignmentWithResponseAsync(roleAssignmentParameter)
            .flatMap(
                (Response<VnetRoleAssignmentInner> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public VnetRoleAssignmentInner checkVnetRoleAssignment(VnetRoleAssignmentParameter roleAssignmentParameter) {
        return checkVnetRoleAssignmentAsync(roleAssignmentParameter).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<VnetRoleAssignmentInner> checkVnetRoleAssignmentWithResponse(
        VnetRoleAssignmentParameter roleAssignmentParameter, Context context) {
        return checkVnetRoleAssignmentWithResponseAsync(roleAssignmentParameter, context).block();
    }
