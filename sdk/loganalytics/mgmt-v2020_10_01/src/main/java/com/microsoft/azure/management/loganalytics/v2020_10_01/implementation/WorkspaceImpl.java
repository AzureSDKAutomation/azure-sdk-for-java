...
import com.microsoft.azure.management.loganalytics.v2020_10_01.Workspace;
...
class WorkspaceImpl extends GroupableResourceCoreImpl<Workspace, WorkspaceInner, WorkspaceImpl, LogAnalyticsManager> implements Workspace, Workspace.Definition, Workspace.Update {
    ...
    public Boolean forceQueryCmk() {
        return this.inner().forceQueryCmk();
    }
    ...
    @Override
    public WorkspaceImpl withForceQueryCmk(Boolean forceQueryCmk) {
        if (isInCreateMode()) {
            this.inner().withForceQueryCmk(forceQueryCmk);
        } else {
            this.updateParameter.withForceQueryCmk(forceQueryCmk);
        }
        return this;
    }
