...
public interface VirtualNetworkGatewayConnectionsClient {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    SyncPoller<PollResult<IkeSaParametersInner>, IkeSaParametersInner> beginGetIkeSas(
        String resourceGroupName, String virtualNetworkGatewayConnectionName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    IkeSaParametersInner getIkeSas(String resourceGroupName, String virtualNetworkGatewayConnectionName);
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    IkeSaParametersInner getIkeSas(
        String resourceGroupName, String virtualNetworkGatewayConnectionName, Context context);
}
