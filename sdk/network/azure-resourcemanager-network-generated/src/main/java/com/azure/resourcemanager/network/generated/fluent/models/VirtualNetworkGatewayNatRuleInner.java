...
public class VirtualNetworkGatewayNatRuleInner extends SubResource {
     ...
     */
    @JsonProperty(value = "properties.virtualNetworkGatewayConnections", access = JsonProperty.Access.WRITE_ONLY)
    private List<SubResource> virtualNetworkGatewayConnections;
    ...
    /**
     * Get the virtualNetworkGatewayConnections property: List of VirtualNetworkGatewayConnections.
     *
     * @return the virtualNetworkGatewayConnections value.
     */
    public List<SubResource> virtualNetworkGatewayConnections() {
