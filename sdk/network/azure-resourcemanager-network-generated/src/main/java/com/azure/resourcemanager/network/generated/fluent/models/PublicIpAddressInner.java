...
public class PublicIpAddressInner extends Resource {
    ...
    /**
     * Get the edgeZone property: The edge zone of the public IP address.
     *
    ...
    /**
     * Set the edgeZone property: The edge zone of the public IP address.
     *
     * @param edgeZone the edgeZone value to set.
     * @return the PublicIpAddressInner object itself.
     */
    public PublicIpAddressInner withEdgeZone(String edgeZone) {
