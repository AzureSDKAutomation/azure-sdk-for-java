...
@Fluent
public final class BreakOutCategoryProperties {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BreakOutCategoryProperties.class);
     ...
     * @return the BreakOutCategoryProperties object itself.
     */
    public BreakOutCategoryProperties withAllow(Boolean allow) {
        this.allow = allow;
        return this;
    }
     ...
     * @return the BreakOutCategoryProperties object itself.
     */
    public BreakOutCategoryProperties withOptimize(Boolean optimize) {
     ...
     * @return the BreakOutCategoryProperties object itself.
     */
    public BreakOutCategoryProperties withDefaultProperty(Boolean defaultProperty) {
