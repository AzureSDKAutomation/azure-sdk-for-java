...
public class NetworkInterfaceInner extends Resource {
    ...
    /**
     * Get the edgeZone property: The edge zone of the network interface.
     *
    ...
    /**
     * Set the edgeZone property: The edge zone of the network interface.
     *
     * @param edgeZone the edgeZone value to set.
     * @return the NetworkInterfaceInner object itself.
     */
    public NetworkInterfaceInner withEdgeZone(String edgeZone) {
