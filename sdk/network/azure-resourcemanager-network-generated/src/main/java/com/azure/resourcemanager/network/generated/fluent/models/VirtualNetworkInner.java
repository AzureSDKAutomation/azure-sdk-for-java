...
public class VirtualNetworkInner extends Resource {
    ...
    /*
     * The flowTimeoutInMinutes property tells the timeout value for intra-VM
     * connection tracking
     */
    ...
    /**
     * Get the flowTimeoutInMinutes property: The flowTimeoutInMinutes property tells the timeout value for intra-VM
     * connection tracking.
     *
    ...
    /**
     * Set the flowTimeoutInMinutes property: The flowTimeoutInMinutes property tells the timeout value for intra-VM
     * connection tracking.
     *
    ...
    /**
     * Get the edgeZone property: The edge zone of the virtual network.
     *
    ...
    /**
     * Set the edgeZone property: The edge zone of the virtual network.
     *
     * @param edgeZone the edgeZone value to set.
     * @return the VirtualNetworkInner object itself.
     */
    public VirtualNetworkInner withEdgeZone(String edgeZone) {
