...
public final class SecurityConfigurationImpl
    ...
    SecurityConfigurationImpl(String name, NetworkManager serviceManager) {
    ...
    SecurityConfigurationImpl(SecurityConfigurationInner innerObject, NetworkManager serviceManager) {
