...
public final class DscpConfigurationImpl
    ...
    public List<QosCollection> qosCollection() {
        List<QosCollection> inner = this.innerModel().qosCollection();
        if (inner != null) {
    ...
    public DscpConfigurationImpl withQosCollection(List<QosCollection> qosCollection) {
        this.innerModel().withQosCollection(qosCollection);
        return this;
    }
}
