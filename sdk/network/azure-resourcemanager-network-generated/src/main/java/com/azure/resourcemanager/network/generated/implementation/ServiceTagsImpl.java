...
public final class ServiceTagsImpl implements ServiceTags {
    ...
    public Response<ServiceTagsListResult> listWithResponse(
        String location, Boolean noaddressprefixes, String tagName, Context context) {
        Response<ServiceTagsListResultInner> inner =
            this.serviceClient().listWithResponse(location, noaddressprefixes, tagName, context);
        if (inner != null) {
