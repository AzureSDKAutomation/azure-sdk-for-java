...
public class LoadBalancerInner extends Resource {
    ...
    /**
     * Get the edgeZone property: The edge zone of the load balancer.
     *
    ...
    /**
     * Set the edgeZone property: The edge zone of the load balancer.
     *
     * @param edgeZone the edgeZone value to set.
     * @return the LoadBalancerInner object itself.
     */
    public LoadBalancerInner withEdgeZone(String edgeZone) {
