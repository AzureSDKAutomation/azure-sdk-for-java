...
public final class VirtualNetworkGatewayConnectionsImpl implements VirtualNetworkGatewayConnections {
    ...
    public IkeSaParameters getIkeSas(String resourceGroupName, String virtualNetworkGatewayConnectionName) {
        IkeSaParametersInner inner =
            this.serviceClient().getIkeSas(resourceGroupName, virtualNetworkGatewayConnectionName);
        if (inner != null) {
            return new IkeSaParametersImpl(inner, this.manager());
        } else {
            return null;
        }
    }

    public IkeSaParameters getIkeSas(
        String resourceGroupName, String virtualNetworkGatewayConnectionName, Context context) {
        IkeSaParametersInner inner =
            this.serviceClient().getIkeSas(resourceGroupName, virtualNetworkGatewayConnectionName, context);
        if (inner != null) {
            return new IkeSaParametersImpl(inner, this.manager());
        } else {
            return null;
