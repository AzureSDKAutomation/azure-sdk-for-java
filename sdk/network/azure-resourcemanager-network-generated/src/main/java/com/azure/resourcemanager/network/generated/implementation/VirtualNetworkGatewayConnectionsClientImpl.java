...
public final class VirtualNetworkGatewayConnectionsClientImpl implements VirtualNetworkGatewayConnectionsClient {
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return iKE security association parameters for virtual network gateway connection.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private PollerFlux<PollResult<IkeSaParametersInner>, IkeSaParametersInner> beginGetIkeSasAsync(
        String resourceGroupName, String virtualNetworkGatewayConnectionName) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            getIkeSasWithResponseAsync(resourceGroupName, virtualNetworkGatewayConnectionName);
        return this
            .client
            .<IkeSaParametersInner, IkeSaParametersInner>getLroResult(
                mono,
                this.client.getHttpPipeline(),
                IkeSaParametersInner.class,
                IkeSaParametersInner.class,
                Context.NONE);
    }
    ...
    private PollerFlux<PollResult<IkeSaParametersInner>, IkeSaParametersInner> beginGetIkeSasAsync(
        ...
        return this
            .client
            .<IkeSaParametersInner, IkeSaParametersInner>getLroResult(
                mono, this.client.getHttpPipeline(), IkeSaParametersInner.class, IkeSaParametersInner.class, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public SyncPoller<PollResult<IkeSaParametersInner>, IkeSaParametersInner> beginGetIkeSas(
        String resourceGroupName, String virtualNetworkGatewayConnectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<IkeSaParametersInner> getIkeSasAsync(
        String resourceGroupName, String virtualNetworkGatewayConnectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public IkeSaParametersInner getIkeSas(String resourceGroupName, String virtualNetworkGatewayConnectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public IkeSaParametersInner getIkeSas(
        String resourceGroupName, String virtualNetworkGatewayConnectionName, Context context) {
