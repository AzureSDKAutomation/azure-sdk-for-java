...
import com.azure.resourcemanager.network.generated.models.BastionHostSkuName;
...
public class BastionHostInner extends Resource {
    ...
    private BastionHostSkuName sku;
     ...
     * @return the BastionHostInner object itself.
     */
    public BastionHostInner withSku(BastionHostSkuName sku) {
        this.sku = sku;
        return this;
    }
