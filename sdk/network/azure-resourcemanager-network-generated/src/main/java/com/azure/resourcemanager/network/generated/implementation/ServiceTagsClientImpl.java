...
public final class ServiceTagsClientImpl implements ServiceTagsClient {
    ...
    private Mono<Response<ServiceTagsListResultInner>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    private Mono<ServiceTagsListResultInner> listAsync(String location, Boolean noaddressprefixes, String tagName) {
        return listWithResponseAsync(location, noaddressprefixes, tagName)
            .flatMap(
    ...
    public ServiceTagsListResultInner list(String location) {
        final Boolean noaddressprefixes = null;
        final String tagName = null;
        return listAsync(location, noaddressprefixes, tagName).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ServiceTagsListResultInner> listWithResponse(
        String location, Boolean noaddressprefixes, String tagName, Context context) {
        return listWithResponseAsync(location, noaddressprefixes, tagName, context).block();
    }
}
