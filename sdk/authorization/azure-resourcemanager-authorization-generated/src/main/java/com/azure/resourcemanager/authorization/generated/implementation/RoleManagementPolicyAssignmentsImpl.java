...
public final class RoleManagementPolicyAssignmentsImpl implements RoleManagementPolicyAssignments {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RoleManagementPolicyAssignmentsImpl.class);
    ...
    public void deleteById(String id) {
        ...
        this.deleteWithResponse(scope, roleManagementPolicyAssignmentName, Context.NONE).getValue();
    }
