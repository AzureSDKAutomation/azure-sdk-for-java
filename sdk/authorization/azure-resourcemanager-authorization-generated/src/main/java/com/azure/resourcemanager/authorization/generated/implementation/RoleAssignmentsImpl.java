...
public final class RoleAssignmentsImpl implements RoleAssignments {
    ...
    public PagedIterable<RoleAssignment> listForScope(String scope, String filter, String skipToken, Context context) {
        PagedIterable<RoleAssignmentInner> inner = this.serviceClient().listForScope(scope, filter, skipToken, context);
        return Utils.mapPage(inner, inner1 -> new RoleAssignmentImpl(inner1, this.manager()));
    }
