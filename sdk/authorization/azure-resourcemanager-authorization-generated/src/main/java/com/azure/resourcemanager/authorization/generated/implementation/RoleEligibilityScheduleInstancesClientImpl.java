...
public final class RoleEligibilityScheduleInstancesClientImpl implements RoleEligibilityScheduleInstancesClient {
    private final ClientLogger logger = new ClientLogger(RoleEligibilityScheduleInstancesClientImpl.class);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role eligibility schedule instance list operation result.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
