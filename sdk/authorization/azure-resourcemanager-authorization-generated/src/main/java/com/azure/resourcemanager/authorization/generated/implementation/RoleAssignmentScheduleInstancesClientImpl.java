...
public final class RoleAssignmentScheduleInstancesClientImpl implements RoleAssignmentScheduleInstancesClient {
    private final ClientLogger logger = new ClientLogger(RoleAssignmentScheduleInstancesClientImpl.class);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role assignment schedule instance list operation result.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
