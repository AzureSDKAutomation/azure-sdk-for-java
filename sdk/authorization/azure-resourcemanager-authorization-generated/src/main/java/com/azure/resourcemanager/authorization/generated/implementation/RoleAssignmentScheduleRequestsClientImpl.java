...
public final class RoleAssignmentScheduleRequestsClientImpl implements RoleAssignmentScheduleRequestsClient {
    private final ClientLogger logger = new ClientLogger(RoleAssignmentScheduleRequestsClientImpl.class);
     ...
     *     for a resource.
     * @param roleAssignmentScheduleRequestName The name of the role assignment to create. It can be any valid GUID.
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role assignment schedule request list operation result.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
