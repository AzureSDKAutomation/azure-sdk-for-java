...
public final class RoleManagementPolicyAssignmentsClientImpl implements RoleManagementPolicyAssignmentsClient {
    private final ClientLogger logger = new ClientLogger(RoleManagementPolicyAssignmentsClientImpl.class);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role management policy assignment list operation result.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
