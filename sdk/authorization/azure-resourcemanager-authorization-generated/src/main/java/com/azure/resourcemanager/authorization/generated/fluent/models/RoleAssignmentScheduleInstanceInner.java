...
@JsonFlatten
@Fluent
public class RoleAssignmentScheduleInstanceInner {
     ...
     */
    @JsonProperty(value = "properties.roleAssignmentScheduleId")
    private String roleAssignmentScheduleId;

    /*
     * Role Assignment Id in external system
     */
    @JsonProperty(value = "properties.originRoleAssignmentId")
     ...
     */
    @JsonProperty(value = "properties.linkedRoleEligibilityScheduleInstanceId")
