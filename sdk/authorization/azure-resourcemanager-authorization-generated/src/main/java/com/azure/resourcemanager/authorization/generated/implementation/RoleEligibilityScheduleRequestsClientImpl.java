...
public final class RoleEligibilityScheduleRequestsClientImpl implements RoleEligibilityScheduleRequestsClient {
    private final ClientLogger logger = new ClientLogger(RoleEligibilityScheduleRequestsClientImpl.class);
     ...
     * @throws ManagementException thrown if the request is rejected by server.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return role eligibility schedule request list operation result.
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
