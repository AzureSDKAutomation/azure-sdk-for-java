...
import com.azure.resourcemanager.sql.generated.models.ConnectionPolicies;
...
public final class ConnectionPoliciesImpl implements ConnectionPolicies {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ConnectionPoliciesImpl.class);

    private final ConnectionPoliciesClient innerClient;

    private final com.azure.resourcemanager.sql.generated.SqlManager serviceManager;

    public ConnectionPoliciesImpl(
        ConnectionPoliciesClient innerClient, com.azure.resourcemanager.sql.generated.SqlManager serviceManager) {
    ...
    private ConnectionPoliciesClient serviceClient() {
