...
public final class SqlManagementClientImpl implements SqlManagementClient {
    ...
    /** The HybridLinksClient object to access its operations. */
    private final HybridLinksClient hybridLinks;

    /**
     * Gets the HybridLinksClient object to access its operations.
     *
     * @return the HybridLinksClient object.
     */
    public HybridLinksClient getHybridLinks() {
        return this.hybridLinks;
    }
    ...
    SqlManagementClientImpl(
        ...
        this.hybridLinks = new HybridLinksClientImpl(this);
