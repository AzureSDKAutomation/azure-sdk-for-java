...
public final class SqlManagementClientImpl implements SqlManagementClient {
    ...
    /** The DatabaseExtensionsClient object to access its operations. */
    private final DatabaseExtensionsClient databaseExtensions;

    /**
     * Gets the DatabaseExtensionsClient object to access its operations.
     *
     * @return the DatabaseExtensionsClient object.
     */
    public DatabaseExtensionsClient getDatabaseExtensions() {
    ...
    SqlManagementClientImpl(
        ...
        this.databaseExtensions = new DatabaseExtensionsClientImpl(this);
