...
public class RestorableDroppedDatabaseInner extends ProxyResource {
    ...
    /*
     * The backup storage account type.
     */
    @JsonProperty(value = "properties.backupStorageAccountType", access = JsonProperty.Access.WRITE_ONLY)
    private String backupStorageAccountType;
    ...
    /**
     * Get the backupStorageAccountType property: The backup storage account type.
     *
     * @return the backupStorageAccountType value.
     */
    public String backupStorageAccountType() {
        return this.backupStorageAccountType;
    }
