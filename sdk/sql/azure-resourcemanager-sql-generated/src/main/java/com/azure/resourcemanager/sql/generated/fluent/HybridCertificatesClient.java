...
public interface HybridCertificatesClient {
    /**
    ...
    SyncPoller<PollResult<HybridCertificateInner>, HybridCertificateInner> beginCreateOrUpdate(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    HybridCertificateInner createOrUpdate(
        String resourceGroupName, String managedInstanceName, HybridCertificateInner parameters);
