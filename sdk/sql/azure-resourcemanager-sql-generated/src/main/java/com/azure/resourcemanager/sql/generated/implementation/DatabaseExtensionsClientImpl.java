...
import com.azure.resourcemanager.sql.generated.models.DatabaseExtensionsDefinition;
import com.azure.resourcemanager.sql.generated.models.ImportExportExtensionsOperationListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in DatabaseExtensionsClient. */
public final class DatabaseExtensionsClientImpl implements DatabaseExtensionsClient {
    private final ClientLogger logger = new ClientLogger(DatabaseExtensionsClientImpl.class);

    /** The proxy service used to perform REST calls. */
    private final DatabaseExtensionsService service;

    /** The service client containing this operation class. */
    private final SqlManagementClientImpl client;

    /**
     * Initializes an instance of DatabaseExtensionsClientImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DatabaseExtensionsClientImpl(SqlManagementClientImpl client) {
        this.service =
            RestProxy.create(DatabaseExtensionsService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for SqlManagementClientDatabaseExtensions to be used by the proxy service
     * to perform REST calls.
     */
    @Host("{$host}")
    @ServiceInterface(name = "SqlManagementClientD")
    private interface DatabaseExtensionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") DatabaseExtensionsDefinition parameters,
    ...
    private Mono<Response<Flux<ByteBuffer>>> createOrUpdateWithResponseAsync(
        ...
        DatabaseExtensionsDefinition parameters) {
        if (this.client.getEndpoint() == null) {
            return Mono
                .error(
                    new IllegalArgumentException(
