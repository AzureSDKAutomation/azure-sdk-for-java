...
import com.azure.resourcemanager.sql.generated.implementation.HybridCertificatesImpl;
...
public final class SqlManager {
    ...
    private HybridCertificates hybridCertificates;
    ...
    /** @return Resource collection API of HybridCertificates. */
    public HybridCertificates hybridCertificates() {
        if (this.hybridCertificates == null) {
            this.hybridCertificates = new HybridCertificatesImpl(clientObject.getHybridCertificates(), this);
        }
        return hybridCertificates;
    }
