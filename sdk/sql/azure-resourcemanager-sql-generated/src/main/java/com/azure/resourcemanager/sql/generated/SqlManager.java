...
import com.azure.resourcemanager.sql.generated.implementation.DatabaseExtensionsImpl;
...
public final class SqlManager {
    ...
    private DatabaseExtensions databaseExtensions;
    ...
    /** @return Resource collection API of DatabaseExtensions. */
    public DatabaseExtensions databaseExtensions() {
        if (this.databaseExtensions == null) {
            this.databaseExtensions = new DatabaseExtensionsImpl(clientObject.getDatabaseExtensions(), this);
        }
