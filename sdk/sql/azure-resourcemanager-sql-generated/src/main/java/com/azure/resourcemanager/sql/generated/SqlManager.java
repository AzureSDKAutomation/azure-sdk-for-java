...
import com.azure.resourcemanager.sql.generated.implementation.ConnectionPoliciesImpl;
...
public final class SqlManager {
    ...
    /** @return Resource collection API of ConnectionPolicies. */
    public ConnectionPolicies connectionPolicies() {
        if (this.connectionPolicies == null) {
            this.connectionPolicies = new ConnectionPoliciesImpl(clientObject.getConnectionPolicies(), this);
        }
