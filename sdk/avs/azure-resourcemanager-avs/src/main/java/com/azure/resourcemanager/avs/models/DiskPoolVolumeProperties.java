...
@Fluent
public final class DiskPoolVolumeProperties {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DiskPoolVolumeProperties.class);
     ...
     * @return the DiskPoolVolumeProperties object itself.
     */
    public DiskPoolVolumeProperties withEndpoints(List<String> endpoints) {
     ...
     * @return the DiskPoolVolumeProperties object itself.
     */
    public DiskPoolVolumeProperties withLunName(String lunName) {
