...
public final class DatastoresClientImpl implements DatastoresClient {
    ...
    private PollerFlux<PollResult<DatastoreInner>, DatastoreInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore);
        return this
            .client
    ...
    public SyncPoller<PollResult<DatastoreInner>, DatastoreInner> beginCreate(
        ...
        String datastoreName,
        DatastoreInner datastore) {
        return beginCreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore)
            .getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatastoreInner>, DatastoreInner> beginCreate(
        ...
        DatastoreInner datastore,
        Context context) {
        return beginCreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore, context)
            .getSyncPoller();
    }
    ...
    public DatastoreInner create(
        ...
        String datastoreName,
        DatastoreInner datastore) {
        return createAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore).block();
    }
    ...
    public DatastoreInner create(
        ...
        DatastoreInner datastore,
        Context context) {
        return createAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, datastore, context).block();
    }
