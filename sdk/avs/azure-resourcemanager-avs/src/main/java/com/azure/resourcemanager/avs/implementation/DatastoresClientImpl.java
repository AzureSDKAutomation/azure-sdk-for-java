...
public final class DatastoresClientImpl implements DatastoresClient {
    ...
    private PollerFlux<PollResult<DatastoreInner>, DatastoreInner> beginCreateAsync(
        ...
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceGroupName, privateCloudName, clusterName, datastoreName);
        return this
            .client
    ...
    private PollerFlux<PollResult<DatastoreInner>, DatastoreInner> beginCreateAsync(
        ...
        context = this.client.mergeContext(context);
        Mono<Response<Flux<ByteBuffer>>> mono =
            createWithResponseAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, context);
        return this
            .client
            .<DatastoreInner, DatastoreInner>getLroResult(
    ...
    public SyncPoller<PollResult<DatastoreInner>, DatastoreInner> beginCreate(
        String resourceGroupName, String privateCloudName, String clusterName, String datastoreName) {
        return beginCreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName).getSyncPoller();
    }
    ...
    public SyncPoller<PollResult<DatastoreInner>, DatastoreInner> beginCreate(
        String resourceGroupName, String privateCloudName, String clusterName, String datastoreName, Context context) {
        return beginCreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, context)
            .getSyncPoller();
    }
    ...
    private Mono<DatastoreInner> createAsync(
        String resourceGroupName, String privateCloudName, String clusterName, String datastoreName) {
        return beginCreateAsync(resourceGroupName, privateCloudName, clusterName, datastoreName)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DatastoreInner create(
        String resourceGroupName, String privateCloudName, String clusterName, String datastoreName) {
        return createAsync(resourceGroupName, privateCloudName, clusterName, datastoreName).block();
    }
    ...
    public DatastoreInner create(
        String resourceGroupName, String privateCloudName, String clusterName, String datastoreName, Context context) {
        return createAsync(resourceGroupName, privateCloudName, clusterName, datastoreName, context).block();
    }
