...
public final class DatastoresImpl implements Datastores {
    ...
    public DatastoresImpl(DatastoresClient innerClient, AvsManager serviceManager) {
    ...
    public PagedIterable<Datastore> list(String resourceGroupName, String privateCloudName, String clusterName) {
        ...
        return inner.mapPage(inner1 -> new DatastoreImpl(inner1, this.manager()));
    }
    ...
    public Datastore create(
        ...
        DatastoreInner inner =
            this.serviceClient().create(resourceGroupName, privateCloudName, clusterName, datastoreName);
        if (inner != null) {
            return new DatastoreImpl(inner, this.manager());
        } else {
            return null;
    ...
    public Datastore create(
        String resourceGroupName, String privateCloudName, String clusterName, String datastoreName, Context context) {
        DatastoreInner inner =
            this.serviceClient().create(resourceGroupName, privateCloudName, clusterName, datastoreName, context);
        if (inner != null) {
            return new DatastoreImpl(inner, this.manager());
        } else {
            return null;
