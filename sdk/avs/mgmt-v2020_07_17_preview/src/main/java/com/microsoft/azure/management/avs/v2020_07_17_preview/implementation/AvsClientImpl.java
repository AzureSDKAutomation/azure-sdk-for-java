...
public class AvsClientImpl extends AzureServiceClient {
    ...
    /**
     * The GlobalReachConnectionsInner object to access its operations.
     */
    private GlobalReachConnectionsInner globalReachConnections;

    /**
     * Gets the GlobalReachConnectionsInner object to access its operations.
     * @return the GlobalReachConnectionsInner object.
     */
    public GlobalReachConnectionsInner globalReachConnections() {
        return this.globalReachConnections;
    }

    /**
     * The WorkloadNetworksInner object to access its operations.
     */
    private WorkloadNetworksInner workloadNetworks;

    /**
     * Gets the WorkloadNetworksInner object to access its operations.
     * @return the WorkloadNetworksInner object.
     */
    public WorkloadNetworksInner workloadNetworks() {
    ...
    protected void initialize() {
        ...
        this.globalReachConnections = new GlobalReachConnectionsInner(restClient().retrofit(), this);
