...
class WorkloadNetworksImpl extends WrapperImpl<WorkloadNetworksInner> implements WorkloadNetworks {
    ...
    public WorkloadNetworkDnsServiceImpl defineDnsService(String name) {
        return wrapDnsServiceModel(name);
    }

    @Override
    public WorkloadNetworkDnsZoneImpl defineDnsZone(String name) {
        return wrapDnsZoneModel(name);
    }
    ...
    private WorkloadNetworkDnsServiceImpl wrapDnsServiceModel(String name) {
        return new WorkloadNetworkDnsServiceImpl(name, this.manager());
    }

    private WorkloadNetworkDnsZoneImpl wrapDnsZoneModel(String name) {
    ...
    private WorkloadNetworkDnsServiceImpl wrapWorkloadNetworkDnsServiceModel(WorkloadNetworkDnsServiceInner inner) {
        return  new WorkloadNetworkDnsServiceImpl(inner, manager());
    }

    private WorkloadNetworkDnsZoneImpl wrapWorkloadNetworkDnsZoneModel(WorkloadNetworkDnsZoneInner inner) {
        return  new WorkloadNetworkDnsZoneImpl(inner, manager());
    }
    ...
    @Override
    public Observable<WorkloadNetworkDnsService> listDnsServicesAsync(final String resourceGroupName, final String privateCloudName) {
        WorkloadNetworksInner client = this.inner();
        return client.listDnsServicesAsync(resourceGroupName, privateCloudName)
        .flatMapIterable(new Func1<Page<WorkloadNetworkDnsServiceInner>, Iterable<WorkloadNetworkDnsServiceInner>>() {
            @Override
            public Iterable<WorkloadNetworkDnsServiceInner> call(Page<WorkloadNetworkDnsServiceInner> page) {
                return page.items();
            }
        })
        .map(new Func1<WorkloadNetworkDnsServiceInner, WorkloadNetworkDnsService>() {
            @Override
            public WorkloadNetworkDnsService call(WorkloadNetworkDnsServiceInner inner) {
                return new WorkloadNetworkDnsServiceImpl(inner, manager());
            }
        });
    }
    ...
    @Override
    public Observable<WorkloadNetworkDnsService> getDnsServiceAsync(String resourceGroupName, String privateCloudName, String dnsServiceId) {
        WorkloadNetworksInner client = this.inner();
        return client.getDnsServiceAsync(resourceGroupName, privateCloudName, dnsServiceId)
        .map(new Func1<WorkloadNetworkDnsServiceInner, WorkloadNetworkDnsService>() {
            @Override
            public WorkloadNetworkDnsService call(WorkloadNetworkDnsServiceInner inner) {
                return new WorkloadNetworkDnsServiceImpl(inner, manager());
    ...
    @Override
    public Completable deleteDnsServiceAsync(String resourceGroupName, String dnsServiceId, String privateCloudName) {
        WorkloadNetworksInner client = this.inner();
        return client.deleteDnsServiceAsync(resourceGroupName, dnsServiceId, privateCloudName).toCompletable();
    }

    @Override
    public Observable<WorkloadNetworkDnsZone> listDnsZonesAsync(final String resourceGroupName, final String privateCloudName) {
        WorkloadNetworksInner client = this.inner();
        return client.listDnsZonesAsync(resourceGroupName, privateCloudName)
        .flatMapIterable(new Func1<Page<WorkloadNetworkDnsZoneInner>, Iterable<WorkloadNetworkDnsZoneInner>>() {
            @Override
            public Iterable<WorkloadNetworkDnsZoneInner> call(Page<WorkloadNetworkDnsZoneInner> page) {
                return page.items();
            }
        })
        .map(new Func1<WorkloadNetworkDnsZoneInner, WorkloadNetworkDnsZone>() {
            @Override
            public WorkloadNetworkDnsZone call(WorkloadNetworkDnsZoneInner inner) {
                return new WorkloadNetworkDnsZoneImpl(inner, manager());
            }
        });
    }
    ...
    @Override
    public Observable<WorkloadNetworkDnsZone> getDnsZoneAsync(String resourceGroupName, String privateCloudName, String dnsZoneId) {
        WorkloadNetworksInner client = this.inner();
        return client.getDnsZoneAsync(resourceGroupName, privateCloudName, dnsZoneId)
        .map(new Func1<WorkloadNetworkDnsZoneInner, WorkloadNetworkDnsZone>() {
            @Override
            public WorkloadNetworkDnsZone call(WorkloadNetworkDnsZoneInner inner) {
                return new WorkloadNetworkDnsZoneImpl(inner, manager());
    ...
    @Override
    public Completable deleteDnsZoneAsync(String resourceGroupName, String dnsZoneId, String privateCloudName) {
        WorkloadNetworksInner client = this.inner();
        return client.deleteDnsZoneAsync(resourceGroupName, dnsZoneId, privateCloudName).toCompletable();
    }
