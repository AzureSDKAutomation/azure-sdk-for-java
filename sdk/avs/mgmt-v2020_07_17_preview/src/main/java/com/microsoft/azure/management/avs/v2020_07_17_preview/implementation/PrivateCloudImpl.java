...
import com.microsoft.azure.management.avs.v2020_07_17_preview.PrivateCloud;
import rx.Observable;
import com.microsoft.azure.management.avs.v2020_07_17_preview.PrivateCloudUpdate;
import java.util.List;
import com.microsoft.azure.management.avs.v2020_07_17_preview.Sku;
import com.microsoft.azure.management.avs.v2020_07_17_preview.ManagementCluster;
import com.microsoft.azure.management.avs.v2020_07_17_preview.InternetEnum;
import com.microsoft.azure.management.avs.v2020_07_17_preview.IdentitySource;
import com.microsoft.azure.management.avs.v2020_07_17_preview.VcsaAdminRotateEnum;
import com.microsoft.azure.management.avs.v2020_07_17_preview.NsxtAdminRotateEnum;
import com.microsoft.azure.management.avs.v2020_07_17_preview.PrivateCloudProvisioningState;
import com.microsoft.azure.management.avs.v2020_07_17_preview.Circuit;
import com.microsoft.azure.management.avs.v2020_07_17_preview.Endpoints;
...
class PrivateCloudImpl extends GroupableResourceCoreImpl<PrivateCloud, PrivateCloudInner, PrivateCloudImpl, AVSManager> implements PrivateCloud, PrivateCloud.Definition, PrivateCloud.Update {
    ...
    @Override
    public PrivateCloudImpl withNsxtPassword(NsxtAdminRotateEnum nsxtPassword) {
        if (isInCreateMode()) {
            this.inner().withNsxtPassword(nsxtPassword);
        } else {
            this.updateParameter.withNsxtPassword(nsxtPassword);
        }
        return this;
    }

    @Override
    public PrivateCloudImpl withVcenterPassword(VcsaAdminRotateEnum vcenterPassword) {
        if (isInCreateMode()) {
            this.inner().withVcenterPassword(vcenterPassword);
        } else {
            this.updateParameter.withVcenterPassword(vcenterPassword);
        }
        return this;
    }
