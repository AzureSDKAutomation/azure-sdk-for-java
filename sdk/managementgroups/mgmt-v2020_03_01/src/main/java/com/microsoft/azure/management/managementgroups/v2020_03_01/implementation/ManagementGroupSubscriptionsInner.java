...
public class ManagementGroupSubscriptionsInner implements InnerSupportsDelete<Void> {
    ...
    interface ManagementGroupSubscriptionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2020_03_01.ManagementGroupSubscriptions create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: com.microsoft.azure.management.managementgroups.v2020_03_01.ManagementGroupSubscriptions delete" })
