...
public final class JobDefinitionImpl implements JobDefinition, JobDefinition.Definition, JobDefinition.Update {
    ...
    public void cancel(Context context) {
        serviceManager
            .jobDefinitions()
            .cancel(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }

    public void retry() {
        serviceManager.jobDefinitions().retry(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }

    public Response<Void> retryWithResponse(Context context) {
    ...
    public void skip() {
        serviceManager.jobDefinitions().skip(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }

    public Response<Void> skipWithResponse(Context context) {
        return serviceManager
            .jobDefinitions()
