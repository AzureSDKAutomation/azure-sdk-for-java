...
public final class JobDefinitionsImpl implements JobDefinitions {
    ...
    public void cancel(
        ...
        String dataManagerName,
        Context context) {
        this.serviceClient().cancel(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }

    public void checkStatus(
        String dataServiceName, String jobDefinitionName, String resourceGroupName, String dataManagerName) {
        this.serviceClient().checkStatus(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }
    ...
    public void checkStatus(
        ...
        this
            .serviceClient()
            .checkStatus(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }

    public void retry(
        String dataServiceName, String jobDefinitionName, String resourceGroupName, String dataManagerName) {
        this.serviceClient().retry(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }
    ...
    public Response<Void> retryWithResponse(
        ...
        return this
            .serviceClient()
            .retryWithResponse(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }
    ...
    public void skip(
        String dataServiceName, String jobDefinitionName, String resourceGroupName, String dataManagerName) {
        this.serviceClient().skip(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName);
    }
    ...
    public Response<Void> skipWithResponse(
        ...
        return this
            .serviceClient()
            .skipWithResponse(dataServiceName, jobDefinitionName, resourceGroupName, dataManagerName, context);
    }
