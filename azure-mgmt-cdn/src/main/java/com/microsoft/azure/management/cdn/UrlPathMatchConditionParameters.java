...
public class UrlPathMatchConditionParameters {
     ...
     */
    @JsonProperty(value = "operatorSTUFF")
    private UrlPathOperator operatorSTUFF;
     ...
     *
     * @return the operatorSTUFF value
     */
    public UrlPathOperator operatorSTUFF() {
        return this.operatorSTUFF;
    }
     ...
     *
     * @param operatorSTUFF the operatorSTUFF value to set
     * @return the UrlPathMatchConditionParameters object itself.
     */
    public UrlPathMatchConditionParameters withOperatorSTUFF(UrlPathOperator operatorSTUFF) {
        this.operatorSTUFF = operatorSTUFF;
        return this;
    }
