...
public class RequestMethodMatchConditionParameters {
     ...
     */
    @JsonProperty(value = "negateConditionAPPLES")
    private Boolean negateConditionAPPLES;
     ...
     *
     * @return the negateConditionAPPLES value
     */
    public Boolean negateConditionAPPLES() {
        return this.negateConditionAPPLES;
    }

    /**
     * Set describes if this is negate condition or not.
     *
     * @param negateConditionAPPLES the negateConditionAPPLES value to set
     * @return the RequestMethodMatchConditionParameters object itself.
     */
    public RequestMethodMatchConditionParameters withNegateConditionAPPLES(Boolean negateConditionAPPLES) {
        this.negateConditionAPPLES = negateConditionAPPLES;
        return this;
    }
